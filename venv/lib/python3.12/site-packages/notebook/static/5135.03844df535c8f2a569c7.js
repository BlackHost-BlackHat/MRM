    ...
    /***/ 45135: /***/ (
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        defaultNotebookPathOpener: () =>
          /* reexport */ defaultNotebookPathOpener,
      });
      ...
      var messaging_dist_index_es6_js_ = __webpack_require__(34993); // CONCATENATED MODULE: ../packages/application/lib/panelhandler.js
      ...
      class PanelHandler {
        constructor() {
              ...
              case "child-removed":
                {
                  ...
                  dist_index_es6_js_.ArrayExt.removeFirstWhere(
                    this._items,
                    (v) => v.widget === widget,
                  );
                }
          ...
          messaging_dist_index_es6_js_.MessageLoop.installMessageHook(
            this._panel,
        ...
        addWidget(widget, rank) {
          ...
          const index = dist_index_es6_js_.ArrayExt.upperBound(
            this._items,
            item,
            Private.itemCmp,
          );
      ...
      class SidePanelHandler extends PanelHandler {
        ...
        constructor(area) {
          ...
          const icon = new widgets_dist_index_es6_js_.Widget({
            node: this._closeButton,
          });
        ...
        collapse() {
          var _a;
          (_a = this._currentWidget) === null || _a === void 0
            ? void 0
            : _a.hide();
          this._currentWidget = null;
        }
        ...
        _findInsertIndex(item) {
          return dist_index_es6_js_.ArrayExt.upperBound(
            this._items,
            item,
            Private.itemCmp,
          );
        ...
        _findWidgetIndex(widget) {
          return dist_index_es6_js_.ArrayExt.findFirstIndex(
            this._items,
            (i) => i.widget === widget,
          );
        }
         ...
         */
        _findWidgetByID(id) {
          const item = (0, dist_index_es6_js_.find)(
            this._items,
            (value) => value.widget.id === id,
          );
        ...
        _onWidgetRemoved(sender, widget) {
          ...
          dist_index_es6_js_.ArrayExt.removeAt(
            this._items,
            this._findWidgetIndex(widget),
          );
          this._refreshVisibility();
      ...
      })(Private || (Private = {})); // CONCATENATED MODULE: ../packages/application/lib/shell.js
       ...
       */
      const INotebookShell = new dist_index_js_.Token(
      ...
      class NotebookShell extends widgets_dist_index_es6_js_.Widget {
        constructor() {
          ...
          const topWrapper = (this._topWrapper =
            new widgets_dist_index_es6_js_.Panel());
          const menuWrapper = (this._menuWrapper =
            new widgets_dist_index_es6_js_.Panel());
          ...
          const middlePanel = new widgets_dist_index_es6_js_.Panel({
            layout: middleLayout,
          });
          ...
          widgets_dist_index_es6_js_.SplitPanel.setStretch(
            leftHandler.panel,
            0,
          );
          widgets_dist_index_es6_js_.SplitPanel.setStretch(
        ...
        get currentWidget() {
          var _a;
          return (_a = this._main.widgets[0]) !== null && _a !== void 0
            ? _a
            : null;
        }
        /**
        ...
        get translator() {
          var _a;
          return (_a = this._translator) !== null && _a !== void 0
            ? _a
            : translation_lib_index_js_.nullTranslator;
        }
        ...
        activateById(id) {
          ...
          for (const area of ["main", "top", "left", "right", "menu", "down"]) {
            const widget = (0, dist_index_es6_js_.find)(
              this.widgets(area),
              (w) => w.id === id,
            );
            if (widget) {
          ...
          area =
            (_a =
              userPosition === null || userPosition === void 0
                ? void 0
                : userPosition.area) !== null && _a !== void 0
              ? _a
              : area;
          options =
            options ||
      ...
      (function (Private) {
        class SkipLinkWidgetHandler {
          ...
          constructor(shell) {
            ...
            const skipLinkWidget = (this._skipLinkWidget =
              new widgets_dist_index_es6_js_.Widget());
      ...
      })(shell_Private || (shell_Private = {})); // CONCATENATED MODULE: ../packages/application/lib/app.js
      ...
      class NotebookApp extends index_js_.JupyterFrontEnd {
        ...
        constructor(options = { shell: new NotebookShell() }) {
          ...
          super({
            ...options,
            shell:
              (_a = options.shell) !== null && _a !== void 0
                ? _a
                : new NotebookShell(),
          });
          /**
          ...
          this.version =
            (_b =
              coreutils_lib_index_js_.PageConfig.getOption("appVersion")) !==
              null && _b !== void 0
              ? _b
              : "unknown";
          ...
          this.docRegistry.addModelFactory(
            new lib_index_js_.Base64ModelFactory(),
          );
          if (options.mimeExtensions) {
            for (const plugin of (0,
            mimerenderers /* createRendermimePlugins */.as)(
          ...
          const info = Object.keys(index_js_.JupyterLab.defaultInfo).reduce(
            (acc, val) => {
              if (val in options) {
        ...
        get paths() {
          return {
            urls: {
              ...
              notFound:
                coreutils_lib_index_js_.PageConfig.getOption("notFoundUrl"),
              app: coreutils_lib_index_js_.PageConfig.getOption("appUrl"),
              static: coreutils_lib_index_js_.PageConfig.getOption("staticUrl"),
              settings:
                coreutils_lib_index_js_.PageConfig.getOption("settingsUrl"),
              themes: coreutils_lib_index_js_.PageConfig.getOption("themesUrl"),
              doc: coreutils_lib_index_js_.PageConfig.getOption("docUrl"),
              translations:
                coreutils_lib_index_js_.PageConfig.getOption(
                  "translationsApiUrl",
                ),
              hubHost:
                coreutils_lib_index_js_.PageConfig.getOption("hubHost") ||
                undefined,
              hubPrefix:
                coreutils_lib_index_js_.PageConfig.getOption("hubPrefix") ||
                undefined,
              hubUser:
                coreutils_lib_index_js_.PageConfig.getOption("hubUser") ||
                undefined,
              hubServerName:
                coreutils_lib_index_js_.PageConfig.getOption("hubServerName") ||
                undefined,
            },
            directories: {
              appSettings:
                coreutils_lib_index_js_.PageConfig.getOption("appSettingsDir"),
              schemas:
                coreutils_lib_index_js_.PageConfig.getOption("schemasDir"),
              static: coreutils_lib_index_js_.PageConfig.getOption("staticDir"),
              templates:
                coreutils_lib_index_js_.PageConfig.getOption("templatesDir"),
              themes: coreutils_lib_index_js_.PageConfig.getOption("themesDir"),
              userSettings:
                coreutils_lib_index_js_.PageConfig.getOption("userSettingsDir"),
              serverRoot:
                coreutils_lib_index_js_.PageConfig.getOption("serverRoot"),
              workspaces:
                coreutils_lib_index_js_.PageConfig.getOption("workspacesDir"),
            },
          };
        }
        /**
      ...
      (function (Private) {
        ...
        function setFormat(app) {
          app.format = window.matchMedia(MOBILE_QUERY).matches
            ? "mobile"
            : "desktop";
        }
        Private.setFormat = setFormat;
      })(app_Private || (app_Private = {})); // CONCATENATED MODULE: ../packages/application/lib/pathopener.js
      ...
      class DefaultNotebookPathOpener {
        ...
        open(options) {
          ...
          const url = new URL(
            coreutils_lib_index_js_.URLExt.join(
              prefix,
              coreutils_lib_index_js_.URLExt.encodeParts(
      ...
      const defaultNotebookPathOpener = new DefaultNotebookPathOpener(); // CONCATENATED MODULE: ../packages/application/lib/tokens.js
       ...
       */
      const INotebookPathOpener = new dist_index_js_.Token(
