(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [7957, 7061],
  {
    /***/ 79504: /***/ (
       ...
       */
      const flatten = (arr) =>
        fold(arr, /** @type {Array<ELEM>} */ ([]), (acc, val) =>
          acc.concat(val),
        );
        ...
        on(name, f) {
          _map_js__WEBPACK_IMPORTED_MODULE_0__ /* .setIfUndefined */
            .Yu(
              this._observers,
              name,
              _set_js__WEBPACK_IMPORTED_MODULE_1__ /* .create */.Ue,
            )
            .add(f);
        }
    ...
    /***/ 67957: /***/ (
      ...
      var map = __webpack_require__(22592); // CONCATENATED MODULE: ../node_modules/lib0/string.js
      /**
       ...
       * @param {number} n
       */
      const repeat = (source, n) =>
        lib0_array /* unfold */
          .JJ(n, () => source)
          .join(""); // CONCATENATED MODULE: ../node_modules/lib0/conditions.js
       ...
       */
      /* c8 ignore next */
      const offChange = (eventHandler) =>
        usePolyfill ||
        removeEventListener("storage", /** @type {any} */ (eventHandler));

      // EXTERNAL MODULE: ../node_modules/lib0/function.js
      var lib0_function = __webpack_require__(38828); // CONCATENATED MODULE: ../node_modules/lib0/environment.js
      ...
      const computeParams = () => {
        if (params === undefined) {
          if (isNode) {
            ...
            params = map /* create */
              .Ue(); // eslint-disable-next-line no-undef
            (location.search || "?")
              .slice(1)
              .split("&")
              .forEach((kv) => {
      ...
      const forceColor =
        ...
        lib0_function /* isOneOf */
          .gB(process.env.FORCE_COLOR, ["true", "1", "2"]);
       ...
       * @param {string} base64
       */
      const fromBase64UrlEncoded = (base64) =>
      ...
      const writeUint8Array = (encoder, uint8Array) => {
        ...
        const leftCopyLen = lib0_math /* min */
          .VV(bufferLen - cpos, uint8Array.length);
      ...
      class IntDiffEncoder
        extends /* unused pure expression or super */ (null && Encoder)
      {
        /**
         * @param {number} start
         */
       ...
       * @return {boolean}
       */
      const decoding_hasContent = (decoder) =>
       ...
       * @return {string}
       */
      const readTerminatedString = (decoder) =>
      ...
      class IntDiffDecoder
        extends /* unused pure expression or super */ (null && Decoder)
      {
        /**
         * @param {Uint8Array} uint8Array
         * @param {number} start
      ...
      const webcrypto_getRandomValues = crypto.getRandomValues.bind(crypto); // CONCATENATED MODULE: ../node_modules/lib0/random.js
      ...
      var lib0_set = __webpack_require__(79287); // CONCATENATED MODULE: ../node_modules/lib0/pair.js
      /**
       ...
       * @param {EventListener} f
       */
      const dom_removeEventListener = (el, name, f) =>
      ...
      const removeEventListeners = (node, listeners) => {
        pair.forEach(listeners, (name, f) =>
          dom_removeEventListener(node, name, f),
        );
        return node;
      };
      ...
      var lib0_time = __webpack_require__(2431); // CONCATENATED MODULE: ../node_modules/lib0/logging.common.js
       ...
       * @return {function(...any):void}
       */
      const logging_createModuleLogger = (moduleName) =>
        common.createModuleLogger(print, moduleName); // CONCATENATED MODULE: ../node_modules/lib0/iterator.js
      ...
      var object = __webpack_require__(36498); // CONCATENATED MODULE: ../node_modules/yjs/dist/yjs.mjs
      /**
          ...
          for (i = 1, j = 1; i < dels.length; i++) {
            ...
            if (left.clock + left.len >= right.clock) {
              left.len = lib0_math /* max */
                .Fp(left.len, right.clock + right.len - left.clock);
            } else {
              if (j < i) {
                dels[j] = right;
              }
          ...
          dss[dssI].clients.forEach((delsLeft, client) => {
            if (!merged.clients.has(client)) {
              ...
              for (let i = dssI + 1; i < dss.length; i++) {
                lib0_array /* appendTo */
                  .s7(dels, dss[i].clients.get(client) || []);
              }
      ...
      const addToDeleteSet = (ds, client, clock, length) => {
        map /* setIfUndefined */
          .Yu(ds.clients, client, () => /** @type {Array<DeleteItem>} */ ([]))
      ...
      const writeStructs = (encoder, structs, client, clock) => {
        // write first id
        clock = lib0_math /* max */
          .Fp(clock, structs[0].id.clock); // make sure the first id exists
      ...
      const integrateStructs = (transaction, store, clientsStructRefs) => {
        ...
        let clientsStructRefsIds = lib0_array /* from */
       ...
       */
      const snapshotContainsUpdateV2 = (
        snapshot,
        update,
        YDecoder = UpdateDecoderV2,
      ) => {
        ...
        for (
          ...
          if (
            (snapshot.sv.get(curr.id.client) || 0) <
       ...
       * @param {Uint8Array} update
       */
      const snapshotContainsUpdate = (snapshot, update) =>
      ...
      const findIndexSS = (structs, clock) => {
        ...
        let midindex = lib0_math /* floor */
          .GW((clock / (midclock + mid.length - 1)) * right); // pivoting the search
        while (left <= right) {
      ...
      const addChangedTypeToTransaction = (transaction, type, parentSub) => {
        ...
        if (
          ...
          map /* setIfUndefined */
            .Yu(transaction.changed, type, lib0_set /* create */.Ue)
            .add(parentSub);
        }
      };
            ...
            transaction.afterState.forEach((clock, client) => {
              ...
              if (beforeClock !== clock) {
                ...
                const firstChangePos = lib0_math /* max */
                  .Fp(findIndexSS(structs, beforeClock), 1);
            ...
            case Item: {
                  ...
                  if (yxml) {
                    ...
                    if (type instanceof YXmlElement) {
                      type.nodeName = map /* setIfUndefined */
                        .Yu(nodeNameCache, type.nodeName, () => "node-" + i);
                    }
                    if (type instanceof YXmlHook) {
                      type.hookName = map /* setIfUndefined */
                        .Yu(nodeNameCache, type.hookName, () => "hook-" + i);
                    }
                  }
                  break;
                }
                ...
                case ContentFormat: {
                  ...
                  if (formatting) {
                    c.key = map /* setIfUndefined */
                      .Yu(formattingKeyCache, c.key, () => i + "");
                    c.value = map /* setIfUndefined */
                      .Yu(formattingValueCache, c.value, () => ({ i }));
                  }
                  break;
                }
                case ContentJSON: {
              ...
              if (item.parentSub) {
                item.parentSub = map /* setIfUndefined */
                  .Yu(mapKeyCache, item.parentSub, () => i + "");
              }
              i++;
              return block;
            }
       ...
       */
      const obfuscateUpdate = (update, opts) =>
        convertUpdateFormat(
          update,
       ...
       * @param {ObfuscatorOptions} [opts]
       */
      const obfuscateUpdateV2 = (update, opts) =>
        convertUpdateFormat(
          update,
          createObfuscator(opts),
          UpdateDecoderV2,
      ...
      class YEvent {
        ...
        get path() {
          return (
            this._path ||
            (this._path = getPathTo(this.currentTarget, this.target))
          );
        }
                ...
                if (this.adds(item)) {
                  ...
                  if (this.deletes(item)) {
                    if (prev !== null && this.deletes(prev)) {
                      action = "delete";
                      oldValue = lib0_array /* last */
                        .Z$(prev.content.getContent());
                    } else {
                      return;
                    }
                  } else {
                  ...
                  if (this.deletes(item)) {
                    action = "delete";
                    oldValue = lib0_array /* last */
                      .Z$(/** @type {Item} */ item.content.getContent());
                  } else {
                    return; // nop
                  }
                }
