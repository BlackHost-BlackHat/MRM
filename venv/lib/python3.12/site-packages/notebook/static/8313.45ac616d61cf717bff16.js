  ...
  [8313],
  {
    /***/ 28313: /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */ closeSearchPanel: () =>
          /* binding */ closeSearchPanel,
        ...
        /* harmony export */ highlightSelectionMatches: () =>
          /* binding */ highlightSelectionMatches,
        /* harmony export */ openSearchPanel: () =>
          /* binding */ openSearchPanel,
        /* harmony export */ replaceAll: () => /* binding */ replaceAll,
        /* harmony export */ replaceNext: () => /* binding */ replaceNext,
        /* harmony export */ search: () => /* binding */ search,
        /* harmony export */ searchKeymap: () => /* binding */ searchKeymap,
        /* harmony export */ searchPanelOpen: () =>
          /* binding */ searchPanelOpen,
        /* harmony export */ selectMatches: () => /* binding */ selectMatches,
        /* harmony export */ selectNextOccurrence: () =>
          /* binding */ selectNextOccurrence,
        /* harmony export */ selectSelectionMatches: () =>
          /* binding */ selectSelectionMatches,
        /* harmony export */ setSearchQuery: () => /* binding */ setSearchQuery,
        /* harmony export */
      });
      /* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(21486);
      /* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_0___default =
        /*#__PURE__*/ __webpack_require__.n(
          _codemirror_view__WEBPACK_IMPORTED_MODULE_0__,
        );
      /* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(82990);
      /* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_1___default =
        /*#__PURE__*/ __webpack_require__.n(
          _codemirror_state__WEBPACK_IMPORTED_MODULE_1__,
        );
      /* harmony import */ var crelt__WEBPACK_IMPORTED_MODULE_2__ =
    ...
    */
        nextOverlapping() {
          for (;;) {
            ...
            let str = (0,
              _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.fromCodePoint)(
                next,
              ),
              start = this.bufferStart + this.bufferPos;
            this.bufferPos += (0,
            _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.codePointSize)(next);
...
*/
    ...
    */
      ...
      function createLineDialog(view) {
        ...
        let input = (0, crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
          "input",
          { class: "cm-textfield", name: "line", value: line },
        );
        let dom = (0, crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
          "form",
          {
            class: "cm-gotoLine",
            onkeydown: (event) => {
          ...
          (0, crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
            "label",
        ...
        function go() {
          ...
          view.dispatch({
            effects: [
              ...
              _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.scrollIntoView(
                selection.from,
                { y: "center" },
              ),
            ],
        ...
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define(
          {
            ...
            provide: (f) =>
              _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.showPanel.from(
                f,
                (val) => (val ? createLineDialog : null),
              ),
          },
        );
      /**
...
*/
      const gotoLine = (view) => {
        let panel = (0, _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.getPanel)(
          view,
          createLineDialog,
        );
        if (!panel) {
          ...
          if (view.state.field(dialogField, false) == null)
            effects.push(
              _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.appendConfig.of(
                [dialogField, baseTheme$1],
              ),
            );
          view.dispatch({ effects });
          panel = (0, _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.getPanel)(
            view,
            createLineDialog,
          );
        }
      ...
      const baseTheme$1 =
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.baseTheme(
          {
...
*/
      ...
      const matchDeco =
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.mark(
        ...
        return (
          (from == 0 ||
            check(state.sliceDoc(from - 1, from)) !=
              _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.CharCategory
                .Word) &&
          (to == state.doc.length ||
            check(state.sliceDoc(to, to + 1)) !=
              _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.CharCategory.Word)
        );
      }
      ...
      const matchHighlighter =
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.ViewPlugin.fromClass(
          class {
            constructor(view) {
            ...
            getDeco(view) {
              ...
              if (sel.ranges.length > 1)
                return _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration
                  .none;
              let range = sel.main,
                query,
                check = null;
              if (range.empty) {
                if (!conf.highlightWordAroundCursor)
                  return _codemirror_view__WEBPACK_IMPORTED_MODULE_0__
                    .Decoration.none;
              ...
              return _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.set(
                deco,
              );
            }
          },
      ...
      const selectWord = ({ state, dispatch }) => {
        let { selection } = state;
        let newSel =
          _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorSelection.create(
...
*/
    ...
    */
        getCursor(state, from = 0, to) {
          let st = state.doc
            ? state
            : _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.create(
                { doc: state },
              );
      ...
      function charBefore(str, index) {
        return str.slice(
          (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.findClusterBreak)(
            str,
            index,
            false,
          ),
...
*/
      const findNext = /*@__PURE__*/ searchCommand((view, { query }) => {
        ...
        let selection =
          _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorSelection.single(
            next.from,
            next.to,
          );
...
*/
      const replaceNext = /*@__PURE__*/ searchCommand((view, { query }) => {
        ...
        if (next.from == from && next.to == to) {
          ...
          effects.push(
            _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.announce.of(
              state.phrase(
...
*/
      ...
      class SearchPanel {
        constructor(view) {
          ...
          this.searchField = (0,
          crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)("input", {
            value: query.search,
          ...
          function button(name, onclick, content) {
            return (0, crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
              "button",
          ...
          this.dom = (0,
          crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
            "div",
            ...
            [
              ...
              (0, crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
                "label",
                null,
                [this.caseField, phrase(view, "match case")],
              ),
              (0, crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
                "label",
                null,
                [this.reField, phrase(view, "regexp")],
              ),
              (0, crelt__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
                "label",
                null,
                [this.wordField, phrase(view, "by word")],
              ),
              ...(view.state.readOnly
                ? []
                : [
        ...
        keydown(e) {
          if (
            (0, _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.runScopeHandlers)(
              this.view,
              e,
              "search-panel",
            )
      ...
      function announceMatch(view, { from, to }) {
        ...
        return _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.announce.of(
      ...
      const searchExtensions = [
        searchState,
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Prec.low(
          searchHighlighter,
        ),
        baseTheme,
      ];
