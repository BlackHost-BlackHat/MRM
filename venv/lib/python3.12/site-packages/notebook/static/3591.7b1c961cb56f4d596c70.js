...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [3591],
  {
    ...
    /***/ 33591: /***/ (
      ...
      /* harmony import */ var _chunk_4BX2VUAB_mjs__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(18556);
      /* harmony import */ var _chunk_QZHKN3VN_mjs__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(17479);
      /* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(17175);
      /* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(61805);
      /* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(74999);
      /* harmony import */ var _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_5__ =
      ...
      var DEFAULT_GITGRAPH_CONFIG =
        _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .defaultConfig_default */
          .vZ.gitGraph;
      var getConfig3 = /* @__PURE__ */ (0,
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(() => {
        const config = (0,
        _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .cleanAndMerge */.Rb)(
          {
            ...DEFAULT_GITGRAPH_CONFIG,
            ...(0,
            _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig */.iE)()
              .gitGraph,
          },
        );
        return config;
      ...
      var state =
        new _chunk_QZHKN3VN_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .ImperativeState */.A(
          () => {
      ...
      function getID() {
        return (0,
        _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .random */.MX)({
          length: 7,
        });
      }
      (0, _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        getID,
        "getID",
      );
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        function (rawOptString) {
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug("options str", rawOptString);
          ...
          try {
            ...
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
              .error("error while parsing gitGraph options", e.message);
          }
        },
        "setOptions",
      );
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        function (commitDB) {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .info("commit", msg, id, type, tags);
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug("Entering commit:", msg, id, type, tags);
          const config = getConfig3();
          id =
            _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.sanitizeText(
              id,
              config,
            );
          msg =
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .info("main branch", config.mainBranchName);
          if (state.records.commits.has(newCommit.id)) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
              .warn(`Commit ID ${newCommit.id} already exists`);
          }
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        (mergeDB) => {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug(state.records.branches);
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug("in mergeBranch");
        },
        "merge",
      );
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        function (cherryPickDB) {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
            .debug("Entering cherryPick:", sourceId, targetId, tags);
          const config = getConfig3();
          sourceId =
            _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.SY.sanitizeText(
              sourceId,
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        function () {
          state.reset();
          (0,
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .clear */.ZH)();
        },
        "clear",
      );
      ...
      var db = {
        ...
        getHead,
        setAccTitle:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .setAccTitle */.GN,
        getAccTitle:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getAccTitle */.eu,
        getAccDescription:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getAccDescription */.Mx,
        setAccDescription:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .setAccDescription */.U$,
        setDiagramTitle:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .setDiagramTitle */.g2,
        getDiagramTitle:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getDiagramTitle */.Kr,
      };
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        (ast, db2) => {
          (0,
          _chunk_4BX2VUAB_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .populateCommonDb */.A)(
            ast,
            db2,
          );
          if (ast.dir) {
      ...
      var parser = {
        ...
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
          async (input) => {
            const ast = await (0,
            _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_5__ /* .parse */.Qc)(
              "gitGraph",
              input,
            );
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.cM
      ...
      _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.nV)();
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.eW)(
        function (txt, id, ver, diagObj) {
          ...
          const diagram2 = (0,
          d3__WEBPACK_IMPORTED_MODULE_6__ /* .select */.Ys)(`[id="${id}"]`);
          let pos = 0;
          branches.forEach((branch2, index) => {
          ...
          _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .utils_default */.w8
            .insertTitle(
              diagram2,
              "gitTitleText",
          ...
          (0,
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .setupGraphViewbox2 */.Rw)(
            void 0,
            diagram2,
