  ...
  [5573],
  {
    /***/ 5573: /***/ (
      ...
      var react_index_js_default =
        /*#__PURE__*/ __webpack_require__.n(react_index_js_); // CONCATENATED MODULE: ../packages/notebook-extension/lib/trusted.js
      /**
      ...
      const TrustedButton = ({ notebook, translator }) => {
        ...
        const [trusted, setTrusted] = (0, react_index_js_.useState)(
          isTrusted(notebook),
        );
        const checkTrust = () => {
        ...
        const trust = async () => {
          await notebook_lib_index_js_.NotebookActions.trust(
            notebook,
            translator,
          );
          checkTrust();
      ...
      (function (TrustedComponent) {
        ...
        TrustedComponent.create = ({ notebook, translator }) => {
          return index_js_.ReactWidget.create(
            react_index_js_default().createElement(TrustedButton, {
              notebook: notebook,
              translator: translator,
            }),
          );
        };
      })(TrustedComponent || (TrustedComponent = {})); // CONCATENATED MODULE: ../packages/notebook-extension/lib/index.js
      ...
      const checkpoints = {
        ...
        autoStart: true,
        requires: [
          docmanager_lib_index_js_.IDocumentManager,
        ...
        activate: (
          ...
          const onChange = async () => {
            ...
            const checkpoints = await (context === null || context === void 0
              ? void 0
              : context.listCheckpoints());
            ...
            node.textContent = trans.__(
              "Last Checkpoint: %1",
              lib_index_js_.Time.formatHuman(
      ...
      const openTreeTab = {
        ...
        activate: (app, translator) => {
          ...
          commands.addCommand(id, {
            label: trans.__("Open…"),
            execute: async () => {
              const url = lib_index_js_.URLExt.join(
                lib_index_js_.PageConfig.getBaseUrl(),
                "tree",
              );
              window.open(url);
            },
        ...
        activate: (app, tracker, palette, settingRegistry, translator) => {
          ...
          if (settingRegistry) {
            ...
            const updateSettings = (settings) => {
              const newFullWidth = settings.get("fullWidthNotebook").composite;
        ...
        activate: (app, shell, toolbarRegistry) => {
          ...
          const onChange = async () => {
            ...
            const name =
              (_c =
                (_b =
                  (_a = current.sessionContext.session) === null ||
                  _a === void 0
                    ? void 0
                    : _a.kernel) === null || _b === void 0
                  ? void 0
            ...
            const spec =
              (_e =
                (_d = serviceManager.kernelspecs) === null || _d === void 0
                  ? void 0
                  : _d.specs) === null || _e === void 0
                ? void 0
                : _e.kernelspecs[name];
            if (!spec) {
      ...
      const scrollOutput = {
        ...
        activate: async (app, tracker, settingRegistry) => {
          ...
          tracker.widgetAdded.connect((sender, notebook) => {
            ...
            (_a = notebook.model) === null || _a === void 0
              ? void 0
              : _a.cells.changed.connect((sender, args) => {
                  notebook.content.widgets.forEach(setAutoScroll);
                });
          });
          if (settingRegistry) {
            ...
            const updateSettings = (settings) => {
              autoScrollOutputs = settings.get("autoScrollOutputs").composite;
            };
            Promise.all([loadSettings, app.restored])
              .then(([settings]) => {
                updateSettings(settings);
      ...
      const tabIcon = {
        ...
        activate: (app, tracker) => {
          ...
          const notebookIcon = lib_index_js_.URLExt.join(
            baseURL,
            "static/favicons/favicon-notebook.ico",
          );
          const busyIcon = lib_index_js_.URLExt.join(
            baseURL,
      ...
      const editNotebookMetadata = {
        ...
        optional: [
          index_js_.ICommandPalette,
          translation_lib_index_js_.ITranslator,
          notebook_lib_index_js_.INotebookTools,
        ],
        activate: (app, palette, translator, notebookTools) => {
          ...
          commands.addCommand(CommandIDs.openEditNotebookMetadata, {
            ...
            execute: async () => {
              ...
              if (!commands.isToggled(command, args)) {
                await commands.execute(command, args).then((_) => {
                  ...
                  if (notebookTools) {
                    const tools = (
                      notebookTools === null || notebookTools === void 0
                        ? void 0
                        : notebookTools.layout
                    ).widgets;
                    tools.forEach((tool) => {
                      if (
                        tool.widget.title.label ===
                          trans.__("Advanced Tools") &&
                        tool.collapsed
                      ) {
                        tool.toggle();
                      }
            ...
            isVisible: () =>
              ...
              shell.currentWidget instanceof
                notebook_lib_index_js_.NotebookPanel,
          });
          if (palette) {
            palette.addItem({
