...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [2552],
  {
    /***/ 12552: /***/ (
      ...
      var index_js_ = __webpack_require__(92209); // CONCATENATED MODULE: ../node_modules/@lezer/python/dist/index.js
      ...
      const newlines = new dist /* ExternalTokenizer */.Jq(
        (input, stack) => {
          let prev;
          if (input.next < 0) {
      ...
      const indentation = new dist /* ExternalTokenizer */.Jq(
        (input, stack) => {
      ...
      const trackIndent = new dist /* ContextTracker */.IK({
        start: topIndent,
        reduce(context, term) {
          return context.depth < 0 && bracketed.has(term)
            ? context.parent
            : context;
        },
      ...
      const formatString2 = formatString(
        doubleQuote,
        1,
      ...
      const formatString1l = formatString(
        singleQuote,
        3,
      ...
      const formatString2l = formatString(
        doubleQuote,
        3,
      ...
      var autocomplete_dist = __webpack_require__(56318); // CONCATENATED MODULE: ../node_modules/@codemirror/lang-python/dist/index.js
...
*/
      ...
      autocomplete_dist /* ifNotIn */.eC)(
        dontComplete,
        /*@__PURE__*/ (0, autocomplete_dist /* completeFromList */.Mb)(
