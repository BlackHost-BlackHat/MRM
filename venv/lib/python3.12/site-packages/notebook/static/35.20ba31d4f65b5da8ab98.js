...
|----------------------------------------------------------------------------*/
      ...
      var yjs_mjs_ = __webpack_require__(17843); // CONCATENATED MODULE: ../node_modules/y-protocols/awareness.js
      /**
...
|----------------------------------------------------------------------------*/
      ...
      const createCell = (cell, notebook) => {
        ...
        ymodel.set(
          "id",
          (_a = cell.id) !== null && _a !== void 0
            ? _a
            : index_js_.UUID.uuid4(),
        );
        let ycell;
