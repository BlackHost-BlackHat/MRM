  ...
  [4047],
  {
    /***/ 43203: /***/ function (
      ...
      (function webpackUniversalModuleDefinition(root, factory) {
        if (true) module.exports = factory(__webpack_require__(54899));
        else {
        }
    ...
    /***/ 35302: /***/ function (
      ...
      (function webpackUniversalModuleDefinition(root, factory) {
        if (true) module.exports = factory(__webpack_require__(43203));
        else {
        }
      })(this, function (__WEBPACK_EXTERNAL_MODULE_0__) {
        return /******/ (function (modules) {
    ...
    /***/ 34047: /***/ (
      ...
      /* harmony import */ var cytoscape__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(23207);
      /* harmony import */ var cytoscape_cose_bilkent__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(35302);
      /* harmony import */ var cytoscape_cose_bilkent__WEBPACK_IMPORTED_MODULE_2___default =
        /*#__PURE__*/ __webpack_require__.n(
          cytoscape_cose_bilkent__WEBPACK_IMPORTED_MODULE_2__,
        );
      ...
      cytoscape__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z.use(
        cytoscape_cose_bilkent__WEBPACK_IMPORTED_MODULE_2___default(),
      );
      ...
      function createCytoscapeInstance(data) {
        return new Promise((resolve) => {
          const renderEl = (0,
          d3__WEBPACK_IMPORTED_MODULE_3__ /* .select */.Ys)("body")
            .append("div")
            .attr("id", "cy")
            .attr("style", "display:none");
          const cy = (0,
          cytoscape__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z)({
          ...
          cy.ready((e) => {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .log */.cM
              .info("Cytoscape ready", e);
            resolve(cy);
          });
        });
      }
      ...
      async function executeCoseBilkentLayout(data, _config) {
        ...
        try {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .log */.cM
            .error("Error in cose-bilkent layout algorithm:", error);
          throw error;
        }
      }
      (0, _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.eW)(
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.eW)(
        async (
          ...
          layoutResult.edges.forEach((positionedEdge) => {
            const edge = data4Layout.edges.find(
              (e) => e.id === positionedEdge.id,
            );
            if (edge) {
              edge.points = [
