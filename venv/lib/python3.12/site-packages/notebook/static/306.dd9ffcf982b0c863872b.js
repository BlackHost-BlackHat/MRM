      ...
      class ChoiceExpression extends Expression {
        ...
        walk(f) {
          ...
          return f(
            exprs == this.exprs
              ? this
              : new ChoiceExpression(this.start, exprs),
          );
        }
      }
      ...
      class Prop extends Node {
        ...
        eq(other) {
          return (
            ...
            this.value.every(
              (v, i) =>
                v.value == other.value[i].value &&
                v.name == other.value[i].name,
            )
          );
        }
        toString() {
      ...
      class LocalTokenSet extends TokenSet {
        ...
        buildLocalGroup(states, skipInfo, id) {
          ...
          return {
            groupID: id,
            create: () =>
              new _lezer_lr__WEBPACK_IMPORTED_MODULE_1__ /* .LocalTokenGroup */.RA(
                fullData,
                precOffset,
