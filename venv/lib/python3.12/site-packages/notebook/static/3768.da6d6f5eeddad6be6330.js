...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [3768, 7302],
  {
    /***/ 83768: /***/ (
      ...
      // EXTERNAL MODULE: consume shared module (default) @jupyterlab/filebrowser@~4.4.9 (singleton) (fallback: ../node_modules/@jupyterlab/filebrowser/lib/index.js)
      var filebrowser_lib_index_js_ = __webpack_require__(13178);
      ...
      // EXTERNAL MODULE: consume shared module (default) @jupyterlab/running@^4.4.9 (strict) (fallback: ../node_modules/@jupyterlab/running/lib/index.js)
      var running_lib_index_js_ = __webpack_require__(89184);
      // EXTERNAL MODULE: consume shared module (default) @jupyterlab/settingeditor@~4.4.9 (singleton) (fallback: ../node_modules/@jupyterlab/settingeditor/lib/index.js)
      var settingeditor_lib_index_js_ = __webpack_require__(87829);
      ...
      // EXTERNAL MODULE: consume shared module (default) @jupyter-notebook/tree@~7.4.7 (singleton) (fallback: ../packages/tree/lib/index.js)
      var tree_lib_index_js_ = __webpack_require__(22930);
      // EXTERNAL MODULE: consume shared module (default) react@~18.2.0 (singleton) (fallback: ../node_modules/react/index.js)
      var react_index_js_ = __webpack_require__(78156);
      var react_index_js_default =
        /*#__PURE__*/ __webpack_require__.n(react_index_js_); // CONCATENATED MODULE: ../packages/tree-extension/lib/fileactions.js
      ...
      class FilesActionButtons {
        ...
        constructor(options) {
          ...
          this._onSelectionChanged = () => {
            ...
            const oneFolder = selectedItems.some(
              (item) => item.type === "directory",
            );
            (_a = this._widgets.get("placeholder")) === null || _a === void 0
              ? void 0
              : _a.setHidden(selection);
            (_b = this._widgets.get("delete")) === null || _b === void 0
              ? void 0
              : _b.setHidden(!selection);
            (_c = this._widgets.get("duplicate")) === null || _c === void 0
              ? void 0
              : _c.setHidden(!selection || oneFolder);
            (_d = this._widgets.get("download")) === null || _d === void 0
              ? void 0
              : _d.setHidden(!selection || oneFolder);
            (_e = this._widgets.get("open")) === null || _e === void 0
              ? void 0
              : _e.setHidden(!selection || oneFolder);
            (_f = this._widgets.get("rename")) === null || _f === void 0
              ? void 0
              : _f.setHidden(selectedItems.length !== 1);
          };
          ...
          const placeholder = index_js_.ReactWidget.create(
          ...
          actions.forEach((action) => {
            const widget = index_js_.ReactWidget.create(
              react_index_js_default().createElement(
                index_js_.CommandToolbarButtonComponent,
                {
                  key: action,
                  commands: commands,
      ...
      const createNew = {
        ...
        activate: (app, translator, toolbarRegistry) => {
          ...
          const populateNewMenu = () => {
            ...
            const specs =
              (_b =
                (_a = serviceManager.kernelspecs) === null || _a === void 0
                  ? void 0
                  : _a.specs) === null || _b === void 0
                ? void 0
                : _b.kernelspecs;
      ...
      const loadPlugins = {
        ...
        activate(app, settingRegistry) {
          ...
          const allPluginsOption =
            lib_index_js_.PageConfig.getOption("allPlugins");
          if (!allPluginsOption) {
            return;
          }
      ...
      const openFileBrowser = {
        ...
        requires: [
          tree_lib_index_js_.INotebookTree,
          filebrowser_lib_index_js_.IDefaultFileBrowser,
        ],
        autoStart: true,
      ...
      const notebookTreeWidget = {
        ...
        activate: (
          ...
          factory,
          manager,
          settingEditorTracker,
          jsonSettingEditorTracker,
        ) => {
          ...
          toolbarRegistry.addFactory(
            ...
            "uploader",
            (browser) =>
              new filebrowser_lib_index_js_.Uploader({
                model: browser.model,
                translator,
                label: trans.__("Upload"),
              }),
          );
          (0, index_js_.setToolbar)(
            browser,
            (0, index_js_.createToolbarFactory)(
              toolbarRegistry,
              settingRegistry,
              FILE_BROWSER_FACTORY,
          ...
          if (manager) {
            const running = new running_lib_index_js_.RunningSessions(
              manager,
              translator,
            );
...
//# sourceMappingURL=3768.da6d6f5eeddad6be6330.js.map?v=da6d6f5eeddad6be6330
