...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [7674],
  {
    /***/ 87674: /***/ (
      ...
      var index_js_ = __webpack_require__(92209); // CONCATENATED MODULE: ../node_modules/@lezer/cpp/dist/index.js
      ...
      const fallback = new dist /* ExternalTokenizer */.Jq(
        (input) => {
      ...
      const cppHighlighting = (0, index_js_.styleTags)({
        ...
        "TypeSize PrimitiveType": index_js_.tags.standard(
          index_js_.tags.typeName,
        ),
        ...
        "CallExpression/ScopedIdentifier/Identifier": index_js_.tags.function(
          index_js_.tags.variableName,
        ),
        "FunctionDeclarator/Identifier FunctionDeclarator/DestructorName":
          index_js_.tags.function(
        ...
        "RawString SystemLibString": index_js_.tags.special(
          index_js_.tags.string,
        ),
        ...
        "PreprocDirectiveName #include #ifdef #ifndef #if #define #else #endif #elif":
          index_js_.tags.processingInstruction,
      ...
      const parser = dist /* LRParser */.WQ.deserialize({
        ...
        specialized: [
          { term: 356, get: (value) => spec_identifier[value] || -1 },
          { term: 32, get: (value) => spec_[value] || -1 },
          { term: 66, get: (value) => spec_templateArgsEnd[value] || -1 },
          { term: 363, get: (value) => spec_scopedIdentifier[value] || -1 },
        ],
        tokenPrec: 24891,
      });
      ...
      var dist_index_js_ = __webpack_require__(27914); // CONCATENATED MODULE: ../node_modules/@codemirror/lang-cpp/dist/index.js
      /**
