    ...
    /***/ 55726: /***/ (
        ...
        async function (text, id, _version, diag) {
          ...
          try {
            ...
            links.forEach((linkInfo, key) => {
              ...
              _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
                .info(
                  "\u{1F517} Wrapped node in <a> tag for:",
                  stateId,
                  linkInfo.url,
                );
            });
            ...
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
              .error("\u274C Error injecting clickable links:", err);
          }
              ...
              case STMT_RELATION:
                {
                  ...
                  const edgeData = {
                    ...
                    labelStyle: "",
                    label:
                      _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .common_default */.SY.sanitizeText(
                        item.description ?? "",
                        (0,
                        _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.nV)(),
                      ),
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .__name */.eW)(
        (
          ...
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.nV)();
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
            .info("dataFetcher parsedItem", parsedItem, dbState, style);
          if (itemId !== "root") {
            ...
            if (parsedItem.description) {
              ...
              newNode.description =
                _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .common_default */.SY.sanitizeTextOrArray(
                  newNode.description,
                  config,
                );
            }
            ...
            if (!newNode.type && parsedItem.doc) {
              _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
                .info("Setting cluster for XCX", itemId, getDir2(parsedItem));
              newNode.type = "group";
      ...
      var StateDB = class {
        ...
        docTranslator(parent, node, first) {
          ...
          if (doc.length > 0 && currentDoc.length > 0) {
            const newNode = {
              stmt: STMT_STATE,
              id: (0,
              _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .generateId */.Ox)(),
              type: "divider",
        ...
        addState(
          ...
          if (!this.currentDocument.states.has(trimmedId)) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
              .info("Adding state ", trimmedId, descr);
          ...
          if (descr) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
              .info("Setting state description", trimmedId, descr);
          ...
          if (classes) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
              .info("Setting state classes", trimmedId, classes);
          ...
          if (styles) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
              .info("Setting state styles", trimmedId, styles);
        ...
        addLink(stateId, url, tooltip) {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .log */.cM
            .warn("Adding link", stateId, url, tooltip);
        }
        /**
        ...
        addStyleClass(id, styleAttributes = "") {
          ...
          if (styleAttributes && foundClass) {
            styleAttributes
              .split(CONSTANTS.STYLECLASS_SEP)
              .forEach((attrib) => {
