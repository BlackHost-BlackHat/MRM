  ...
  [5634],
  {
    /***/ 29287: /***/ function (
      ...
      (function webpackUniversalModuleDefinition(root, factory) {
        if (true) module.exports = factory(__webpack_require__(75925));
        else {
        }
...
*/
    ...
    /***/ 75925: /***/ function (
      ...
      (function webpackUniversalModuleDefinition(root, factory) {
        if (true) module.exports = factory(__webpack_require__(12591));
        else {
        }
...
*/
    ...
    /***/ 75634: /***/ (
      ...
      /* harmony import */ var _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(2111);
      /* harmony import */ var _chunk_4BX2VUAB_mjs__WEBPACK_IMPORTED_MODULE_2__ =
      ...
      /* harmony import */ var _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_6__ =
        __webpack_require__(13197);
      /* harmony import */ var cytoscape__WEBPACK_IMPORTED_MODULE_7__ =
        __webpack_require__(23207);
      /* harmony import */ var cytoscape_fcose__WEBPACK_IMPORTED_MODULE_8__ =
        __webpack_require__(29287);
      /* harmony import */ var cytoscape_fcose__WEBPACK_IMPORTED_MODULE_8___default =
        /*#__PURE__*/ __webpack_require__.n(
          cytoscape_fcose__WEBPACK_IMPORTED_MODULE_8__,
        );
      /* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_9__ =
      ...
      var DEFAULT_ARCHITECTURE_CONFIG =
        _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .defaultConfig_default */
          .vZ.architecture;
      var ArchitectureDB = class {
        ...
        getConfig() {
          return (0,
          _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .cleanAndMerge */.Rb)(
            {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .__name */.eW)(
        (ast, db) => {
          (0,
          _chunk_4BX2VUAB_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .populateCommonDb */.A)(
            ast,
            db,
          );
          ast.groups.map((group) => db.addGroup(group));
          ast.services.map((service) =>
            db.addService({ ...service, type: "service" }),
          );
      ...
      var parser = {
        ...
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .__name */.eW)(
          async (input) => {
            const ast = await (0,
            _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_6__ /* .parse */.Qc)(
              "architecture",
              input,
            );
...
`,
      ...
      var architectureIcons = {
        ...
        icons: {
          ...
          unknown:
            _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .unknownIcon */.cN,
          blank: {
            body: wrapIcon(""),
          },
        },
              ...
              if (edge[0]._private.rscratch) {
                ...
                g.insert("path")
                  ...
                  .attr(
                    "id",
                    (0,
                    _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getEdgeId */.Ln)(
                      source,
                      target,
                      { prefix: "L" },
                    ),
                ...
                if (label) {
                  ...
                  await (0,
                  _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .createText */.rw)(
                    textElem,
                    label,
                    {
                      useHtmlLabels: false,
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .__name */.eW)(
        async function (db, elem, services) {
          const config = (0,
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.nV)();
      ...
      // src/diagrams/architecture/architectureRenderer.ts
      (0,
      _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .registerIconPacks */.ef)(
        [
          {
      ...
      cytoscape__WEBPACK_IMPORTED_MODULE_7__ /* ["default"] */.Z.use(
        cytoscape_fcose__WEBPACK_IMPORTED_MODULE_8___default(),
      );
      ...
      function layoutArchitecture(
        ...
        return new Promise((resolve) => {
          const renderEl = (0,
          d3__WEBPACK_IMPORTED_MODULE_9__ /* .select */.Ys)("body")
            .append("div")
            .attr("id", "cy")
            .attr("style", "display:none");
          const cy = (0,
          cytoscape__WEBPACK_IMPORTED_MODULE_7__ /* ["default"] */.Z)({
          ...
          const relativePlacementConstraint = getRelativeConstraints(
            spatialMaps,
            db,
          );
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .__name */.eW)(
        async (text, id, _version, diagObj) => {
          ...
          positionNodes(db, cy);
          (0,
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .setupGraphViewbox */.j7)(
            void 0,
            svg,
