...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [5850],
  {
    /***/ 65850: /***/ (
      ...
      var index_js_ = __webpack_require__(92209); // CONCATENATED MODULE: ../node_modules/@lezer/javascript/dist/index.js
   ...
   expressed by lezer's built-in tokenizer. */
      ...
      const insertSemicolon = new dist /* ExternalTokenizer */.Jq(
        (input, stack) => {
          let { next } = input;
      ...
      const noSemicolon = new dist /* ExternalTokenizer */.Jq(
        (input, stack) => {
          let { next } = input,
            after;
      ...
      const incdecToken = new dist /* ExternalTokenizer */.Jq(
        (input, stack) => {
          let { next } = input;
      ...
      const parser = dist /* LRParser */.WQ.deserialize({
        ...
        specialized: [
          { term: 314, get: (value) => spec_identifier[value] || -1 },
          { term: 330, get: (value) => spec_word[value] || -1 },
      ...
      var common_dist_index_js_ = __webpack_require__(79352); // CONCATENATED MODULE: ../node_modules/@codemirror/lang-javascript/dist/index.js
      /**
A collection of JavaScript-related
[snippets](https://codemirror.net/6/docs/ref/#autocomplete.snippet).
*/
      const snippets = [
        /*@__PURE__*/ (0, autocomplete_dist /* snippetCompletion */.Gn)(
      ...
      function javascript(config = {}) {
        ...
        return new dist_index_js_.LanguageSupport(lang, [
          javascriptLanguage.data.of({
            autocomplete: (0, autocomplete_dist /* ifNotIn */.eC)(
              dontComplete,
              (0, autocomplete_dist /* completeFromList */.Mb)(completions),
            ),
          }),
          javascriptLanguage.data.of({
