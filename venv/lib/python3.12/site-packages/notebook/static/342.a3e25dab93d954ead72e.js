  ...
  [342],
  {
    ...
    /***/ 26616: /***/ (
      ...
      const channel = (color, channel) => {
        return _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z.lang
          .round(
            _color_index_js__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z.parse(
              color,
            )[channel],
          );
      };
    ...
    /***/ 20190: /***/ (
      ...
      function clone(value) {
        return (0,
        _baseClone_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z)(
          value,
          CLONE_SYMBOLS_FLAG,
        );
      }
    ...
    /***/ 70342: /***/ (
      ...
      /* harmony import */ var _chunk_FMBD7UC4_mjs__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(28862);
      /* harmony import */ var _chunk_HN2XXSSU_mjs__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(67894);
      /* harmony import */ var _chunk_CVBHYZKI_mjs__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(22462);
      /* harmony import */ var _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(2111);
      /* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(17175);
      /* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ =
        __webpack_require__(61805);
      /* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ =
        __webpack_require__(74999);
      /* harmony import */ var lodash_es_clone_js__WEBPACK_IMPORTED_MODULE_7__ =
        __webpack_require__(20190);
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_8__ =
        __webpack_require__(26616);
      ...
      /* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_11__ =
        __webpack_require__(67406);

      // src/diagrams/block/parser/block.jison
      var parser = (function () {
        var o = /* @__PURE__ */ (0,
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
            function (k, v, o2, l) {
        ...
        (0, _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
          Parser,
          "Parser",
        );
      ...
      var STYLECLASS_SEP = ",";
      var config = (0,
      _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .getConfig2 */.nV)();
      var classes = /* @__PURE__ */ new Map();
      var sanitizeText2 = /* @__PURE__ */ (0,
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        (txt) =>
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .common_default */.SY.sanitizeText(
            txt,
            config,
          ),
        "sanitizeText",
        ...
        (_blockList, parent) => {
          ...
          for (const block of blockList) {
            if (
              ...
              _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
                .warn(
            ...
            if (block.type === "column-setting") {
              ...
              if (block.type === "space") {
                ...
                for (let j = 0; j < w; j++) {
                  const newBlock = (0,
                  lodash_es_clone_js__WEBPACK_IMPORTED_MODULE_7__ /* ["default"] */.Z)(
                    block,
                  );
      ...
      function typeStr2Type(typeStr) {
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
          .debug("typeStr2Type", typeStr);
        switch (typeStr) {
          case "[]":
            return "square";
          case "()":
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .debug("we have a round");
            return "round";
          case "(())":
            return "circle";
          case ">]":
      ...
      var db = {
        ...
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
          () =>
            (0,
            _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .getConfig */.iE)()
              .block,
          "getConfig",
        ),
        typeStr2Type,
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        (color, opacity) => {
          const channel2 =
            khroma__WEBPACK_IMPORTED_MODULE_8__ /* ["default"] */.Z;
          const r = channel2(color, "r");
          const g = channel2(color, "g");
          const b = channel2(color, "b");
          return khroma__WEBPACK_IMPORTED_MODULE_9__ /* ["default"] */
            .Z(r, g, b, opacity);
        },
        "fade",
      );
...
`,
      ...
      function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
        ...
        if (block.children?.length > 0) {
          ...
          if (width < siblingWidth) {
            ...
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .debug("Size indata abc88 xSize", xSize, "padding", padding);
            for (const child of block.children) {
              if (child.size) {
      ...
      function layoutBlocks(block, db2) {
        ...
        const columns = block.columns ?? -1;
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
          .debug("layoutBlocks columns abc95", block.id, "=>", columns, block);
        if (
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
            .debug("widthOfChildren 88", widthOfChildren, "posX");
          let columnPos = 0;
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
            .debug("abc91 block?.size?.x", block.id, block?.size?.x);
          ...
          for (const child of block.children) {
            ...
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .debug("abc88 columnsPos", child, columnPos);
          }
        }
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
          .debug(
      ...
      function layout(db2) {
        ...
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
          .debug("getBlocks", JSON.stringify(root, null, 2));
      ...
      function addHtmlLabel(node, config2) {
        const fo = (0, d3__WEBPACK_IMPORTED_MODULE_10__ /* .select */.Ys)(
        ...
        span.html(
          (0,
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .sanitizeText */.oO)(
            label,
            config2,
          ),
        );
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        async (_vertexText, style, isTitle, isNode) => {
          ...
          if (
            (0,
            _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .evaluate */.ku)(
              config2.flowchart.htmlLabels,
            )
          ) {
            vertexText = vertexText.replace(/\\n|\n/g, "<br />");
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .debug("vertexText" + vertexText);
            const label = await (0,
            _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .replaceIconSubstring */.EY)(
              (0,
              _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .decodeEntities */.SH)(
                vertexText,
              ),
            );
            const node = {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        (svgPath, position, arrowType, url, id, diagramType) => {
          ...
          if (!endMarkerType) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .warn(`Unknown arrow type: ${arrowType}`);
            return;
          }
        ...
        async (elem, edge) => {
          ...
          const labelElement =
            edge.labelType === "markdown"
              ? (0,
                _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .createText */.rw)(
                  elem,
                  edge.label,
                  {
          ...
          if (useHtmlLabels) {
            ...
            const dv = (0, d3__WEBPACK_IMPORTED_MODULE_10__ /* .select */.Ys)(
              labelElement,
            );
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        (edge, paths) => {
          ...
          _chunk_CVBHYZKI_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getSubGraphTitleMargins */.L)(
            siteConfig,
          );
          if (edge.label) {
            ...
            if (path) {
              const pos =
                _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .utils_default */.w8
  ...
  node        : x:${node.x} y:${node.y} w:${node.width} h:${node.height}`);
          ...
          if (
            ...
            let _y =
              insidePoint.y < outsidePoint.y
                ...
                : insidePoint.y - q;
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .debug(`sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`, {
                _x,
                _y,
              });
            if (r === 0) {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        (_points, boundaryNode) => {
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
            .debug("abc88 cutPathAtIntersect", _points, boundaryNode);
          let points = [];
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        function (elem, e, edge, clusterDb, diagramType, graph, id) {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
            .debug("abc88 InsertEdge: edge=", edge, "e=", e);
          ...
          if (edge.toCluster) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .debug("to cluster abc88", clusterDb[edge.toCluster]);
          ...
          if (edge.fromCluster) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .debug("from cluster abc88", clusterDb[edge.fromCluster]);
            points = cutPathAtIntersect(
              points.reverse(),
          ...
          const { x, y } = (0,
          _chunk_HN2XXSSU_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .getLineFunctionsWithOffset */.om)(
            edge,
          );
          const lineFunction = (0,
          d3__WEBPACK_IMPORTED_MODULE_10__ /* .line */.jvg)()
            .x(x)
            .y(y)
            .curve(curve);
          let strokeClasses;
          ...
          if (
            ...
            url = (0,
            _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .getUrl */.Gr)(
              true,
            );
          }
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        async (parent, node) => {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
            .info("Question main (Circle)");
          const questionElem = insertPolygonShape(shapeSvg, s, s, points);
          questionElem.attr("style", node.style);
          updateNodeBounds(node, questionElem);
          node.intersect = function (point2) {
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .warn("Intersect called");
        ...
        async (parent, node) => {
          ...
          if (node.props) {
            ...
            propKeys.forEach((propKey) => {
              _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
                .warn(`Unknown node property ${propKey}`);
            });
          }
          updateNodeBounds(node, rect2);
          node.intersect = function (point2) {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        async (parent, node) => {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
            .info("Label text abc79", title, text2, typeof text2 === "object");
          const text = label
            .node()
            .appendChild(
              await createLabel_default(title, node.labelStyle, true, true),
            );
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        async (parent, node) => {
          ...
          (0, d3__WEBPACK_IMPORTED_MODULE_10__ /* .select */.Ys)(
            classTitleLabel,
      ...
      function getNodeFromBlock(block, db2, positioned = false) {
        ...
        const styles = (0,
        _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getStylesFromArray */.be)(
          vertex?.styles ?? [],
        );
      ...
      async function insertEdges(elem, edges, blocks2, db2, id) {
        const g =
          new dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_11__ /* .Graph */.k(
            {
              multigraph: true,
              compound: true,
            },
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .__name */.eW)(
        async function (text, id, _version, diagObj) {
          ...
          if (securityLevel === "sandbox") {
            sandboxElement = (0,
            d3__WEBPACK_IMPORTED_MODULE_10__ /* .select */.Ys)("#i" + id);
          }
          const root =
            securityLevel === "sandbox"
              ? (0, d3__WEBPACK_IMPORTED_MODULE_10__ /* .select */.Ys)(
              ...
              : (0, d3__WEBPACK_IMPORTED_MODULE_10__ /* .select */.Ys)("body");
          const svg =
            securityLevel === "sandbox"
              ? root.select(`[id="${id}"]`)
              : (0, d3__WEBPACK_IMPORTED_MODULE_10__ /* .select */.Ys)(
          ...
          if (bounds) {
            ...
            (0,
            _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .configureSvgSize */.v2)(
              svg,
              height,
              width,
              !!useMaxWidth,
            ...
            _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .log */.cM
              .debug("Here Bounds", bounds, bounds2);
            svg.attr(
              "viewBox",
