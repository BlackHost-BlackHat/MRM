(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [1871, 7634, 9531, 8701],
  {
    /***/ 40018: /***/ (
      ...
      const Fe = (e, t, n) => ({ children: He(t, e[2], n) });
      function Ge() {
        return {};
      }
      function We() {
      ...
      function Qe(n = "", i = {}) {
        function d(e, n, ...r) {
          ...
          return i.createElement(
            ...
            t({}, n, l, {
              className:
                Ze(null == n ? void 0 : n.className, l.className) || void 0,
            }),
            ...r,
          );
        }
        function W(e) {
          ...
          if (n.length > 1 || i.forceWrapper) l = n;
            ...
            if (1 === n.length)
              return (
                (l = n[0]),
                "string" == typeof l ? d("span", { key: "outer" }, l) : l
              );
            l = null;
          }
                ...
                if (-1 !== r) {
                  ...
                  const s = (t[c] = (function (e, t, n, r) {
                    return "style" === t
                      ? n.split(/;\s?/).reduce(function (e, t) {
                          ...
                          return (
                            (e[
                              n
                                .trim()
                                .replace(/(-[a-z])/g, (e) => e[1].toUpperCase())
                      ...
                      : "href" === t || "src" === t
                        ? r(n, e, t)
                        : (n.match(R) && (n = n.slice(1, n.length - 1)),
                          "true" === n || ("false" !== n && n));
                  })(e, a, o, i.sanitizer));
                  "string" == typeof s &&
                    (A.test(s) || M.test(s)) &&
        ...
        ((i.overrides = i.overrides || {}),
          (i.sanitizer = i.sanitizer || Ne),
          (i.slugify = i.slugify || ze),
        ...
        const q = [],
          ...
          V = {
            [r.blockQuote]: {
              ...
              render(e, t, n) {
                ...
                return (
                  e.alert &&
                    ((l.className =
                      "markdown-alert-" + i.slugify(e.alert.toLowerCase(), ze)),
                    e.children.unshift({
                      attrs: {},
            ...
            [r.footnoteReference]: {
              match: Me(C),
              order: 1,
              parse: (e) => ({ target: `#${i.slugify(e[1], ze)}`, text: e[1] }),
              render: (e, t, n) =>
                d(
                  "a",
            ...
            [r.image]: {
              match: Re($e),
              order: 1,
              parse: (e) => ({ alt: e[1], target: je(e[2]), title: e[3] }),
              render: (e, t, n) =>
                d("img", {
                  key: n.key,
                  alt: e.alt || void 0,
            ...
            [r.linkBareUrlDetector]: {
              match: Oe((e, t) =>
                t.inAnchor || i.disableAutoLink ? null : Me(I)(e, t),
              ),
              order: 0,
              parse: (e) => ({
                children: [{ text: e[1], type: r.text }],
            ...
            [r.refLink]: {
              ...
              render: (e, t, n) =>
                Q[e.ref]
                  ...
                  : d("span", { key: n.key }, e.fallbackChildren),
            },
            [r.table]: {
              match: Ie(j),
              order: 1,
                  ...
                  d(
                    ...
                    d(
                      ...
                      r.header.map(function (e, i) {
                        return d("th", { key: i, style: Be(r, i) }, t(e, n));
                      }),
                    ),
                  ),
                  d(
                    ...
                    r.cells.map(function (e, i) {
                      return d(
                        ...
                        { key: i },
                        e.map(function (e, i) {
                          return d("td", { key: i, style: Be(r, i) }, t(e, n));
                        }),
                      );
                    }),
                  ),
            ...
            [r.textBolded]: {
              ...
              render: (e, t, n) =>
                d("strong", { key: n.key }, t(e.children, n)),
            },
            [r.textEmphasized]: {
              match: Re(J),
              order: 3,
          ...
          ? d(
              ...
              d(
                ...
                q.map(function (e) {
                  return d(
                    "div",
                    { id: i.slugify(e.identifier, ze), key: e.identifier },
                    e.identifier,
                    ae(le(e.footnote, { inline: !0 })),
                  );
                }),
              ),
            )
      ...
      /* harmony default export */ const index_modern = (t) => {
        ...
        return index_js_.cloneElement(Qe(r, i), l);
      };
    ...
    /***/ 62034: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 51833: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 66720: /***/ (__unused_webpack_module, exports) => {
      "use strict";
