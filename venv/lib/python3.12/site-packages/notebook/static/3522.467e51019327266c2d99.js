...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [3522],
  {
    ...
    /***/ 3522: /***/ (
      ...
      var chunk_AGHRB4JF = __webpack_require__(74999); // CONCATENATED MODULE: ../node_modules/mermaid/node_modules/uuid/dist/esm-browser/native.js
      const randomUUID =
        typeof crypto !== "undefined" &&
        crypto.randomUUID &&
        crypto.randomUUID.bind(crypto);
      /* harmony default export */ const esm_browser_native = { randomUUID }; // CONCATENATED MODULE: ../node_modules/mermaid/node_modules/uuid/dist/esm-browser/rng.js
      ...
      /* harmony default export */ const esm_browser_stringify =
        /* unused pure expression or super */ null && stringify; // CONCATENATED MODULE: ../node_modules/mermaid/node_modules/uuid/dist/esm-browser/v4.js
      ...
      var darken = __webpack_require__(57838); // CONCATENATED MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/mindmap-definition-VGOIOE7T.mjs
      // src/diagrams/mindmap/parser/mindmap.jison
      var parser = (function () {
        var o = /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(function (
            k,
            v,
            o2,
            l,
        ...
        var parser2 = {
          trace: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
            function trace() {},
            "trace",
          ),
          yy: {},
          ...
          performAction: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
          ...
          parseError: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
        ...
        var lexer = /* @__PURE__ */ (function () {
          var lexer2 = {
            ...
            setInput: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function (input, yy) {
                this.yy = yy || this.yy || {};
                this._input = input;
            ...
            input: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function () {
            ...
            unput: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function (ch) {
                var len = ch.length;
                var lines = ch.split(/(?:\r\n?|\n)/g);
            ...
            more: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function () {
                this._more = true;
                return this;
              },
            ...
            reject: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function () {
            ...
            less: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(function (
              n,
            ) {
              this.unput(this.match.slice(n));
            }, "less"),
            // displays already matched input, i.e. for error messages
            pastInput: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function () {
            ...
            upcomingInput: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function () {
                var next = this.match;
                if (next.length < 20) {
            ...
            showPosition: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function () {
            ...
            test_match: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
            ...
            next: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function () {
                if (this.done) {
                  return this.EOF;
                }
            ...
            lex: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function lex() {
                var r = this.next();
                if (r) {
                  return r;
            ...
            begin: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
            ...
            popState: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function popState() {
            ...
            _currentRules: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
            ...
            topState: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
              function topState(n) {
            ...
            pushState: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
            ...
            stateStackSize: /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
      ...
      var MindmapDB = class {
        ...
        addNode(level, id, descr, type) {
          chunk_AGHRB4JF /* log */.cM
            .info("addNode", level, id, descr, type);
          let isRoot = false;
          ...
          let padding =
            ...
            chunk_ABZYJK2D /* defaultConfig_default */.vZ.mindmap.padding;
          switch (type) {
          ...
          const node = {
            ...
            width:
              ...
              chunk_ABZYJK2D /* defaultConfig_default */.vZ.mindmap
                .maxNodeWidth,
            padding,
            isRoot,
          };
        ...
        getType(startStr, endStr) {
          chunk_AGHRB4JF /* log */.cM
            .debug("In get type", startStr, endStr);
          switch (startStr) {
            case "[":
        ...
        decorateNode(decoration) {
          ...
          if (decoration.icon) {
            node.icon = (0, chunk_ABZYJK2D /* sanitizeText */.oO)(
              decoration.icon,
              config,
            );
          }
          if (decoration.class) {
            node.class = (0, chunk_ABZYJK2D /* sanitizeText */.oO)(
              decoration.class,
              config,
            );
          }
          ...
          if (node.children) {
            for (const [index, child] of node.children.entries()) {
              const childSectionNumber =
                node.level === 0 ? index : sectionNumber;
        ...
        flattenNodes(node, processedNodes) {
          ...
          const getShapeFromType = /* @__PURE__ */ (0,
          chunk_AGHRB4JF /* __name */.eW)((type) => {
            switch (type) {
        ...
        getData() {
          ...
          const config = (0, chunk_ABZYJK2D /* getConfig2 */.nV)();
          const userDefinedConfig = (0,
          chunk_ABZYJK2D /* getUserDefinedConfig */.qO)();
          ...
          chunk_AGHRB4JF /* log */.cM
            .debug("getData: mindmapRoot", mindmapRoot, config);
      ...
      var draw = /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
        async (text, id, _version, diagObj) => {
          chunk_AGHRB4JF /* log */.cM
            .debug("Rendering mindmap diagram\n" + text);
          const db = diagObj.db;
          const data4Layout = db.getData();
          const svg = (0, chunk_55IACEB6 /* getDiagramElement */.q)(
            id,
            data4Layout.config.securityLevel,
          );
          data4Layout.type = diagObj.type;
          data4Layout.layoutAlgorithm = (0,
          chunk_N4CR4FBY /* getRegisteredLayoutAlgorithm */._b)(
          ...
          (0, chunk_QN33PNHL /* setupViewPortForSVG */.j)(
            svg,
            data4Layout.config.mindmap?.padding ??
              chunk_ABZYJK2D /* defaultConfig_default */.vZ.mindmap.padding,
            "mindmapDiagram",
            data4Layout.config.mindmap?.useMaxWidth ??
              chunk_ABZYJK2D /* defaultConfig_default */.vZ.mindmap.useMaxWidth,
          );
        },
        "draw",
      );
      ...
      var genSections = /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
        (options) => {
          let sections = "";
          for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
            ...
            if ((0, is_dark /* default */.Z)(options["lineColor" + i])) {
              options["lineColor" + i] = (0, lighten /* default */.Z)(
                options["lineColor" + i],
                20,
              );
            } else {
              options["lineColor" + i] = (0, darken /* default */.Z)(
                options["lineColor" + i],
                20,
              );
            }
    ...
    `;
      ...
      var getStyles = /* @__PURE__ */ (0, chunk_AGHRB4JF /* __name */.eW)(
        (options) => `
  .edge {
    stroke-width: 3;
  }
