    ...
    /***/ 95468: /***/ (
      ...
      var TextDimensionCalculatorWithFont = class {
        ...
        getMaxDimension(texts, fontSize) {
          ...
          for (const t of texts) {
            const bbox = (0,
            _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .computeDimensionOfText */.QA)(
              elem,
              1,
              t,
            );
      ...
      var BandAxis = class extends BaseAxis {
        ...
        constructor(
          ...
          this.scale = (0,
          d3__WEBPACK_IMPORTED_MODULE_5__ /* .scaleBand */.tiA)()
      ...
      var LinearAxis = class extends BaseAxis {
        ...
        constructor(
          ...
          this.domain = domain;
          this.scale = (0,
          d3__WEBPACK_IMPORTED_MODULE_5__ /* .scaleLinear */.BYU)()
            .domain(this.domain)
            .range(this.getRange());
        }
        getTickValues() {
      ...
      var LinePlot = class {
        ...
        getDrawableElement() {
          ...
          if (this.orientation === "horizontal") {
            path = (0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .line */.jvg)()
              .y((d) => d[0])
              .x((d) => d[1])(finalData);
          } else {
            path = (0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .line */.jvg)()
      ...
      function getChartDefaultThemeConfig() {
        ...
        _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getThemeVariables */.xN)();
        const config = (0,
      ...
      function textSanitizer(text) {
        ...
        _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig */.iE)();
        return (0,
        _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .sanitizeText */.oO)(
          text.trim(),
          config,
        );
      }
                ...
                if (chartConfig.showDataLabel) {
                  if (chartConfig.chartOrientation === "horizontal") {
                    let fitsHorizontally2 = function (item, fontSize) {
                      ...
                      const textWidth =
                        fontSize * label.length * charWidthFactor;
                    ...
                    const candidateFontSizes = validItems.map((item) => {
                      ...
                      while (
                        !fitsHorizontally2(item, fontSize) &&
                        fontSize > 0
                      ) {
                        fontSize -= 1;
                      }
                    ...
                    const uniformFontSize = Math.floor(
                      Math.min(...candidateFontSizes),
                    );
                    shapeGroup
                      .selectAll("text")
                      .data(validItems)
                    ...
                    const candidateFontSizes = validItems.map((item) => {
                      ...
                      while (
                        !fitsInBar2(item, fontSize, yOffset) &&
                        fontSize > 0
                      ) {
                        fontSize -= 1;
                      }
