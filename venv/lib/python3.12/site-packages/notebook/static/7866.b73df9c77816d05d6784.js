...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [7866],
  {
    /***/ 77866: /***/ (
      ...
      var dist_index_js_ = __webpack_require__(79352); // CONCATENATED MODULE: ../node_modules/@lezer/html/dist/index.js
      ...
      const tagStart = new dist /* ExternalTokenizer */.Jq(
        (input, stack) => {
            ...
            if (tagName)
              for (let tag of other) {
                if (
                  tag.tag == tagName &&
                  (!tag.attrs ||
                    tag.attrs(attrs || (attrs = getAttrs(n, input))))
                ) {
      ...
      var language_dist_index_js_ = __webpack_require__(27914); // CONCATENATED MODULE: ../node_modules/@codemirror/lang-html/dist/index.js
