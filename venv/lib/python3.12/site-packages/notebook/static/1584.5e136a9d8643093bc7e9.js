        ...
        if (!topLang || topLang.allowsNesting) {
          for (
            ...
            node = node.enter(
              pos,
              side,
              _lezer_common__WEBPACK_IMPORTED_MODULE_0__.IterMode
                .ExcludeBuffers,
            )
          )
...
*/
    ...
    */
          ...
          function def(spec) {
            let cls =
              style_mod__WEBPACK_IMPORTED_MODULE_4__ /* .StyleModule */.V.newName();
          ...
          _lezer_highlight__WEBPACK_IMPORTED_MODULE_3__.tagHighlighter)(
            specs.map((style) => ({
              tag: style.tag,
              class:
                style.class || def(Object.assign({}, style, { tag: null })),
            })),
            {
              all,
            },
          ...
          this.module = modSpec
            ? new style_mod__WEBPACK_IMPORTED_MODULE_4__ /* .StyleModule */.V(
                modSpec,
              )
            : null;
      ...
      class Parse {
        constructor(lang, input, fragments, ranges) {
          ...
          if (
            ...
            ranges.some(
              (r) =>
                r.from <= context.viewport.from &&
                r.to >= context.viewport.from,
            )
          ) {
