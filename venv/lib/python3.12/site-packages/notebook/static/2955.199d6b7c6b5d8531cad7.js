...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] =
  ...
  [2955],
  {
    /***/ 22955: /***/ (
      ...
      var style_mod = __webpack_require__(4434); // CONCATENATED MODULE: ../node_modules/w3c-keyname/index.js
      var base = {
        8: "Backspace",
        9: "Tab",
        10: "Enter",
      ...
      var crelt = __webpack_require__(76767); // CONCATENATED MODULE: ../node_modules/@codemirror/view/dist/index.js
...
*/
    ...
    */
      ...
      const baseThemeID = /*@__PURE__*/ style_mod /* StyleModule */.V.newName(),
        baseLightID = /*@__PURE__*/ style_mod /* StyleModule */.V.newName(),
        baseDarkID = /*@__PURE__*/ style_mod /* StyleModule */.V.newName();
      const lightDarkIDs = {
        "&light": "." + baseLightID,
        "&dark": "." + baseDarkID,
      };
...
*/
      function showDialog(view, config) {
        ...
        if (view.state.field(dialogField, false)) {
          ...
          view.dispatch({
            effects: index_js_.StateEffect.appendConfig.of(
