...
`,
    ...
    /***/ 34885: /***/ (
      ...
      /* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(61805);
      /* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(74999);
      ...
      var parser = (function () {
        var o = /* @__PURE__ */ (0,
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
            function (k, v, o2, l) {
        ...
        (0, _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
          Parser,
          "Parser",
        );
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
        function () {
          ...
          rawTasks.length = 0;
          (0,
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .clear */.ZH)();
        },
        "clear",
      );
      ...
      var journeyDb_default = {
        ...
        _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
          () =>
            (0,
            _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getConfig2 */.nV)()
              .journey,
          "getConfig",
        ),
        clear: clear2,
        setDiagramTitle:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .setDiagramTitle */.g2,
        getDiagramTitle:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getDiagramTitle */.Kr,
        setAccTitle:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .setAccTitle */.GN,
        getAccTitle:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getAccTitle */.eu,
        setAccDescription:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .setAccDescription */.U$,
        getAccDescription:
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getAccDescription */.Mx,
        addSection,
        getSections,
        getTasks,
        addTask,
...
`,
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
        function (element, faceData) {
          ...
          function smile(face2) {
            const arc = (0, d3__WEBPACK_IMPORTED_MODULE_4__ /* .arc */.Nb1)()
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
        function (elem, textData) {
          return (0,
          _chunk_TZMSLE5B_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .drawText */.yU)(
            elem,
            textData,
          );
        },
      ...
      function drawActorLegend(diagram2) {
        ...
        Object.keys(actors).forEach((person) => {
          ...
          let measureText = diagram2
            ...
            .text(person);
          const fullTextWidth = measureText
            .node()
          ...
          if (fullTextWidth <= maxLabelWidth) {
            ...
            words.forEach((word) => {
              ...
              if (textWidth > maxLabelWidth) {
                ...
                if (
                  measureText.node().getBoundingClientRect().width >
                  maxLabelWidth
                ) {
                  let brokenWord = "";
          ...
          lines.forEach((line, index) => {
            ...
            if (
              lineWidth > maxWidth &&
              lineWidth > conf2.leftMargin - lineWidth
            ) {
              maxWidth = lineWidth;
            }
          });
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.eW)(
        function (text, id, version, diagObj) {
          ...
          if (securityLevel === "sandbox") {
            sandboxElement = (0,
            d3__WEBPACK_IMPORTED_MODULE_4__ /* .select */.Ys)("#i" + id);
          }
          const root =
            securityLevel === "sandbox"
              ? (0, d3__WEBPACK_IMPORTED_MODULE_4__ /* .select */.Ys)(
                  sandboxElement.nodes()[0].contentDocument.body,
                )
              : (0, d3__WEBPACK_IMPORTED_MODULE_4__ /* .select */.Ys)("body");
          bounds.init();
          ...
          (0,
          _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .configureSvgSize */.v2)(
            diagram2,
            height,
            width,
            conf.useMaxWidth,
