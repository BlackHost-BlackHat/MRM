  ...
  [6926],
  {
    35645: (e, t, s) => {
      ...
      var r = (0, i.K2)((e, t, s, r) => {
        e.attr("class", s);
        const { width: l, height: c, x: o, y: h } = n(e, t);
        (0, i.a$)(e, c, l, r);
        const u = a(o, h, l, c, t);
        e.attr("viewBox", u);
    ...
    56926: (e, t, s) => {
      ...
      var m = (function () {
        ...
        var oe = {
          ...
          performAction: (0, f.K2)(function e(t, s, i, r, n, a, l) {
            var c = a.length - 1;
            switch (n) {
              case 4:
                this.$ = a[c].trim();
          ...
          parseError: (0, f.K2)(function e(t, s) {
            if (s.recoverable) {
              this.trace(t);
            } else {
              var i = new Error(t);
          ...
          parse: (0, f.K2)(function e(t) {
            var s = this,
              ...
              y = 2,
              m = 1;
            var d = a.slice.call(arguments, 1);
            ...
            var R = p.yylloc;
            a.push(R);
            var k = p.options && p.options.ranges;
        ...
        var he = (function () {
          var e = {
            ...
            more: (0, f.K2)(function () {
              this._more = true;
              return this;
            }, "more"),
            reject: (0, f.K2)(function () {
            ...
            less: (0, f.K2)(function (e) {
              this.unput(this.match.slice(e));
            }, "less"),
            pastInput: (0, f.K2)(function () {
            ...
            showPosition: (0, f.K2)(function () {
              var e = this.pastInput();
              var t = new Array(e.length + 1).join("-");
              return e + this.upcomingInput() + "\n" + t + "^";
            }, "showPosition"),
            test_match: (0, f.K2)(function (e, t) {
              var s, i, r;
              if (this.options.backtrack_lexer) {
                r = {
            ...
            begin: (0, f.K2)(function e(t) {
              this.conditionStack.push(t);
            }, "begin"),
            popState: (0, f.K2)(function e() {
            ...
            _currentRules: (0, f.K2)(function e() {
              if (
            ...
            pushState: (0, f.K2)(function e(t) {
              this.begin(t);
            }, "pushState"),
            stateStackSize: (0, f.K2)(function e() {
              return this.conditionStack.length;
            }, "stateStackSize"),
            options: { "case-insensitive": true },
            performAction: (0, f.K2)(function e(t, s, i, r) {
              var n = r;
              switch (i) {
                case 0:
                  return "title";
      ...
      var p = class {
        constructor() {
          ...
          this.setAccTitle = f.SV;
          this.getAccTitle = f.iN;
          this.setAccDescription = f.EI;
          this.getAccDescription = f.m7;
          this.setDiagramTitle = f.ke;
          this.getDiagramTitle = f.ab;
          this.getConfig = (0, f.K2)(
            () => (0, f.D7)().requirement,
            "getConfig",
          );
          this.clear();
      ...
      var R = {};
      (0, f.VA)(R, { draw: () => k });
      var k = (0, f.K2)(async function (e, t, s, a) {
        f.Rm.info("REF0:");
        f.Rm.info("Drawing requirement diagram (unified)", t);
        const { securityLevel: l, state: c, layout: o } = (0, f.D7)();
        const h = a.db.getData();
        const u = (0, i.A)(t, l);
        h.type = a.type;
        h.layoutAlgorithm = (0, n.q7)(o);
        h.nodeSpacing = c?.nodeSpacing ?? 50;
        h.rankSpacing = c?.rankSpacing ?? 50;
        h.markers = ["requirement_contains", "requirement_arrow"];
        h.diagramId = t;
        await (0, n.XX)(h, u);
        const m = 8;
        y._K.insertTitle(
        ...
        (0, r.P)(u, m, "requirementDiagram", c?.useMaxWidth ?? true);
      }, "draw");
      var _ = {
        parser: d,
        get db() {
