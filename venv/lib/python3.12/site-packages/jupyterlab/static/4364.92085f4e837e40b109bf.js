  ...
  [4364],
  {
    54364: (e, t, n) => {
        ...
        let n = typeof e == "string" ? e : e.source,
          r = {
            replace: (e, t) => {
              ...
              return ((s = s.replace(o.caret, "$1")), (n = n.replace(e, s)), r);
            },
      ...
      var o = {
        ...
        H = a(G, "u").replace(/punct/g, E).getRegex(),
        W = a(G, "u").replace(/punct/g, j).getRegex(),
        X =
        ...
        V = a(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
          ...
          .getRegex(),
        Y = a(S).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
        ee = a(
        ...
        ce = {
          ...oe,
          br: a(B).replace("{2,}", "*").getRegex(),
          text: a(oe.text)
            .replace("\\b_", "\\b_| {2,}\\n")
            .replace(/\{2,\}/g, "*")
            .getRegex(),
        },
        he = { normal: _, gfm: I, pedantic: L },
        pe = { normal: ie, gfm: oe, breaks: ce, pedantic: ae };
      var ue = {
          "&": "&amp;",
          "<": "&lt;",
          ">": "&gt;",
      ...
      function ke(e, t) {
        if (t) {
          if (o.escapeTest.test(e)) return e.replace(o.escapeReplace, ge);
        } else if (o.escapeTestNoEncode.test(e))
          return e.replace(o.escapeReplaceNoEncode, ge);
        return e;
      }
      function de(e) {
        try {
      ...
      function fe(e, t) {
        ...
        for (; s < r.length; s++) r[s] = r[s].trim().replace(o.slashPipe, "|");
        return r;
      }
      function xe(e, t, n) {
        let r = e.length;
      ...
      var ye = class {
        ...
        code(e) {
          ...
          if (t) {
            ...
            return {
              ...
              text: this.options.pedantic ? e : xe(e, `\n`),
            };
          }
        }
        fences(e) {
        ...
        hr(e) {
          ...
          if (t) return { type: "hr", raw: xe(t[0], `\n`) };
        }
        blockquote(e) {
          ...
          if (t) {
            ...
            for (let e = 0; e < s.items.length; e++)
              if (
                ...
                let t = s.items[e].tokens.filter((e) => e.type === "space"),
                  n =
                    t.length > 0 &&
        ...
        reflink(e, t) {
          ...
          if (
            ...
            return we(n, r, n[0], this.lexer, this.rules);
          }
        }
        emStrong(e, t, n = "") {
      ...
      var $e = class e {
        ...
        constructor(e) {
          ...
          let t = { other: o, block: he.normal, inline: pe.normal };
          (this.options.pedantic
            ? ((t.block = he.pedantic), (t.inline = pe.pedantic))
            : this.options.gfm &&
              ((t.block = he.gfm),
              this.options.breaks
                ? (t.inline = pe.breaks)
        ...
        blockTokens(e, t = [], n = !1) {
          for (
            this.options.pedantic &&
            (e = e.replace(o.tabCharGlobal, "    ").replace(o.spaceLine, ""));
            e;
        ...
        inlineTokens(e, t = []) {
          ...
          for (; e; ) {
            ...
            if ((r = this.tokenizer.emStrong(e, n, l))) {
              ((e = e.substring(r.raw.length)), t.push(r));
              continue;
            }
      ...
      var Re = class {
        ...
        code({ text: e, lang: t, escaped: n }) {
          let r = (t || "").match(o.notSpaceStart)?.[0],
            s = e.replace(o.endingNewline, "") + `\n`;
          return r
            ...
            e.forEach((e) => {
              ...
              if (
                ...
                for (let n in e.renderer) {
                  ...
                  t[r] = (...e) => {
                    let n = s.apply(t, e);
                    return (n === !1 && (n = l.apply(t, e)), n || "");
                  };
                }
                n.renderer = t;
              }
              if (e.tokenizer) {
                let t = this.defaults.tokenizer || new ye(this.defaults);
      ...
      Pe.defaults = s;
      Pe.use = function (...e) {
        return (_e.use(...e), (Pe.defaults = _e.defaults), l(Pe.defaults), Pe);
      };
      Pe.walkTokens = function (e, t) {
        return _e.walkTokens(e, t);
      };
      Pe.parseInline = _e.parseInline;
      Pe.Parser = Te;
      Pe.parser = Te.parse;
      Pe.Renderer = Re;
      Pe.TextRenderer = Se;
