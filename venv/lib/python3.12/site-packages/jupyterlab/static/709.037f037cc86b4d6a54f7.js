...
(self["webpackChunk_jupyterlab_application_top"] =
  ...
  [709],
  {
    ...
    35645: (t, e, i) => {
      i.d(e, { P: () => r });
      var s = i(6047);
      var r = (0, s.K2)((t, e, i, r) => {
        t.attr("class", i);
        const { width: c, height: o, x: l, y: h } = n(t, e);
        (0, s.a$)(t, o, c, r);
        const u = a(l, h, c, o, e);
        t.attr("viewBox", u);
    ...
    70709: (t, e, i) => {
      ...
      var k = (function () {
        ...
        var j = {
          ...
          performAction: (0, d.K2)(function t(e, i, s, r, n, a, c) {
            var o = a.length - 1;
            switch (n) {
              case 1:
                break;
          ...
          parseError: (0, d.K2)(function t(e, i) {
            if (i.recoverable) {
              this.trace(e);
            } else {
              var s = new Error(e);
        ...
        var W = (function () {
          var t = {
            ...
            begin: (0, d.K2)(function t(e) {
              this.conditionStack.push(e);
            }, "begin"),
            popState: (0, d.K2)(function t() {
            ...
            _currentRules: (0, d.K2)(function t() {
              if (
            ...
            pushState: (0, d.K2)(function t(e) {
              this.begin(e);
            }, "pushState"),
            stateStackSize: (0, d.K2)(function t() {
              return this.conditionStack.length;
            }, "stateStackSize"),
            options: { "case-insensitive": true },
            performAction: (0, d.K2)(function t(e, i, s, r) {
              var n = r;
              switch (s) {
                case 0:
      ...
      var g = class {
        constructor() {
          ...
          this.setAccTitle = d.SV;
          this.getAccTitle = d.iN;
          this.setAccDescription = d.EI;
          this.getAccDescription = d.m7;
          this.setDiagramTitle = d.ke;
          this.getDiagramTitle = d.ab;
          this.getConfig = (0, d.K2)(() => (0, d.D7)().er, "getConfig");
          this.clear();
        ...
        addEntity(t, e = "") {
          if (!this.entities.has(t)) {
            this.entities.set(t, {
              ...
              alias: e,
              shape: "erBox",
              look: (0, d.D7)().look ?? "default",
              cssClasses: "default",
              cssStyles: [],
            });
            d.Rm.info("Added new entity :", t);
          } else if (!this.entities.get(t)?.alias && e) {
            this.entities.get(t).alias = e;
            d.Rm.info(`Add alias '${e}' to entity '${t}'`);
          }
        ...
        addAttributes(t, e) {
          ...
          for (s = e.length - 1; s >= 0; s--) {
            ...
            d.Rm.debug("Added attribute ", e[s].name);
          }
        }
        addRelationship(t, e, i, s) {
          ...
          d.Rm.debug("Added new relationship :", a);
        }
        getRelationships() {
      ...
      var m = {};
      (0, d.VA)(m, { draw: () => E });
      var E = (0, d.K2)(async function (t, e, i, a) {
        d.Rm.info("REF0:");
        d.Rm.info("Drawing er diagram (unified)", e);
        const { securityLevel: c, er: o, layout: l } = (0, d.D7)();
        const h = a.db.getData();
        const u = (0, s.A)(e, c);
        h.type = a.type;
        h.layoutAlgorithm = (0, n.q7)(l);
        h.config.flowchart.nodeSpacing = o?.nodeSpacing || 140;
        h.config.flowchart.rankSpacing = o?.rankSpacing || 80;
        h.direction = a.db.getDirection();
        h.markers = ["only_one", "zero_or_one", "one_or_more", "zero_or_more"];
        h.diagramId = e;
        await (0, n.XX)(h, u);
        if (h.layoutAlgorithm === "elk") {
          u.select(".edges").lower();
        }
        const p = u.selectAll('[id*="-background"]');
        if (Array.from(p).length > 0) {
          p.each(function () {
            const t = (0, b.Ltv)(this);
            const e = t.attr("id");
            const i = e.replace("-background", "");
            const s = u.select(`#${CSS.escape(i)}`);
            if (!s.empty()) {
        ...
        (0, r.P)(u, f, "erDiagram", o?.useMaxWidth ?? true);
      }, "draw");
      var v = (0, d.K2)((t, e) => {
        const i = p.A;
        const s = i(t, "r");
      ...
      var S = (0, d.K2)(
        (t) =>
          `\n  .entityBox {\n    fill: ${t.mainBkg};\n    stroke: ${t.nodeBorder};\n  }\n\n  .relationshipLabelBox {\n    fill: ${t.tertiaryColor};\n    opacity: 0.7;\n    background-color: ${t.tertiaryColor};\n      rect {\n        opacity: 0.5;\n      }\n  }\n\n  .labelBkg {\n    background-color: ${v(t.tertiaryColor, 0.5)};\n  }\n\n  .edgeLabel .label {\n    fill: ${t.nodeBorder};\n    font-size: 14px;\n  }\n\n  .label {\n    font-family: ${t.fontFamily};\n    color: ${t.nodeTextColor || t.textColor};\n  }\n\n  .edge-pattern-dashed {\n    stroke-dasharray: 8,8;\n  }\n\n  .node rect,\n  .node circle,\n  .node ellipse,\n  .node polygon\n  {\n    fill: ${t.mainBkg};\n    stroke: ${t.nodeBorder};\n    stroke-width: 1px;\n  }\n\n  .relationshipLine {\n    stroke: ${t.lineColor};\n    stroke-width: 1;\n    fill: none;\n  }\n\n  .marker {\n    fill: none !important;\n    stroke: ${t.lineColor} !important;\n    stroke-width: 1;\n  }\n`,
        "getStyles",
      );
      var O = S;
      var T = {
