"use strict";
(self["webpackChunk_jupyterlab_galata_extension"] =
  self["webpackChunk_jupyterlab_galata_extension"] || []).push([
  ...
  \**********************************/
      /***/ (
        ...
        /* harmony import */ var _tokens__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./tokens */ "../lib/extension/tokens.js");
        ...
        class GalataInpage {
          ...
          async getNotifications() {
            ...
            const plugin = await this.getPlugin(
              _tokens__WEBPACK_IMPORTED_MODULE_2__.PLUGIN_ID_GALATA_HELPERS,
            );
            return (_a =
              plugin === null || plugin === void 0
                ? void 0
                : plugin.notifications.notifications) !== null && _a !== void 0
              ? _a
              : [];
          }
          off(event, listener) {
            ...
            return new Promise((resolve, reject) => {
              ...
              if (timeout) {
                timeoutTimer = window.setTimeout(() => {
                  ...
                  reject(
                    new Error(
                      "Timed out waiting for condition to be fulfilled.",
                    ),
                  );
                }, timeout);
              }
          ...
          async waitForLaunch(path = "/lab") {
            ...
            const listener = async (sender, args) => {
              if (args.path === path) {
                ...
                await (docManager === null || docManager === void 0
                  ? void 0
                  : docManager.closeAll());
                resolver();
              }
            ...
            if (nb) {
              if (nb.model) {
                if (cellIndex === undefined) {
                  ...
                  ((_a = nb.model.cells.get(cellIndex)) === null ||
                  _a === void 0
                    ? void 0
                    : _a.type) === "code"
                ) {
                  nb.model.cells.get(cellIndex).executionCount = null;
                }
              }
            }
          }
          ...
          async waitForMarkdownCellRendered(cell) {
            ...
            const onRenderedChanged = () => {
              _lumino_signaling__WEBPACK_IMPORTED_MODULE_1__.Signal.disconnectReceiver(
                onRenderedChanged,
              );
              resolver();
            };
            ...
            if (nb) {
              if (nb.model) {
                if (cellIndex === undefined) {
                  ...
                  if (
                    (cell === null || cell === void 0 ? void 0 : cell.type) ===
                    "code"
                  ) {
                    counter +=
                      cell.sharedModel.getSource().length > 0 &&
          ...
          getNotebookToolbarItemIndex(itemName) {
            const nbPanel = this._app.shell.currentWidget;
            return (0,
            _lumino_algorithm__WEBPACK_IMPORTED_MODULE_0__.findIndex)(
              nbPanel.toolbar.names(),
              (name) => name === itemName,
            );
          }
          /**
  ...
  \*********************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ IGalataHelpers: () =>
            /* reexport safe */ _tokens__WEBPACK_IMPORTED_MODULE_2__.IGalataHelpers,
        ...
        /* harmony import */ var _global__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./global */ "../lib/extension/global.js");
        /* harmony import */ var _tokens__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./tokens */ "../lib/extension/tokens.js");
        // Copyright (c) Jupyter Development Team.
        // Distributed under the terms of the Modified BSD License.
            ...
            return Object.freeze({
              notifications:
                _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Notification
                  .manager,
              dialogs:
                _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Dialog
                  .tracker,
            });
          },
        };
  ...
  \**********************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ IGalataHelpers: () =>
            /* binding */ IGalataHelpers,
          /* harmony export */ PLUGIN_ID_GALATA_HELPERS: () =>
            /* binding */ PLUGIN_ID_GALATA_HELPERS,
          /* harmony export */
        });
