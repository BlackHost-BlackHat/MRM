...
import { w as Fo, E as Oo } from "./withFullScreenWrapper.zothJIsI.js";
import { S as cn, T as Ro } from "./Toolbar.D8nHCkuz.js";
function ae(t, e, r) {
  var i = new mo();
  return (
    (e = e == null ? 0 : +e),
...
function Ye(t) {
  ...
  return (
    ...
    ln.hasOwnProperty(e) ? { space: ln[e], local: t } : t
  );
}
function So(t) {
  return function () {
    var e = this.ownerDocument,
      r = this.namespaceURI;
    return r === or && e.documentElement.namespaceURI === or
      ? e.createElement(t)
...
function zo(t) {
  ...
  for (var e = this._groups, r = e.length, i = new Array(r), a = 0; a < r; ++a)
    for (
      var c = e[a], u = c.length, f = (i[a] = new Array(u)), d, _, v = 0;
      v < u;
      ++v
    )
      (d = c[v]) &&
        (_ = t.call(d, d.__data__, v, c)) &&
        ("__data__" in d && (_.__data__ = d.__data__), (f[v] = _));
...
function Co(t) {
  typeof t == "function" ? (t = Yo(t)) : (t = Rn(t));
  for (var e = this._groups, r = e.length, i = [], a = [], c = 0; c < r; ++c)
    for (var u = e[c], f = u.length, d, _ = 0; _ < f; ++_)
      (d = u[_]) && (i.push(t.call(d, d.__data__, _, u)), a.push(d));
  return new Et(i, a);
}
function Sn(t) {
  return function () {
...
function Ho(t) {
  return this.select(t == null ? Wo : Uo(typeof t == "function" ? t : $n(t)));
}
...
function No(t) {
  return this.selectAll(
    t == null ? Qo : Xo(typeof t == "function" ? t : $n(t)),
  );
}
function Vo(t) {
  typeof t != "function" && (t = Sn(t));
  for (var e = this._groups, r = e.length, i = new Array(r), a = 0; a < r; ++a)
    for (var c = e[a], u = c.length, f = (i[a] = []), d, _ = 0; _ < u; ++_)
      (d = c[_]) && t.call(d, d.__data__, _, c) && f.push(d);
  return new Et(i, this._parents);
}
function Pn(t) {
...
function jo() {
  return new Et(this._enter || this._groups.map(Pn), this._parents);
}
function Se(t, e) {
...
function qo(t, e, r, i, a, c) {
  for (var u = 0, f, d = e.length, _ = c.length; u < _; ++u)
    (f = e[u]) ? ((f.__data__ = c[u]), (i[u] = f)) : (r[u] = new Se(t, c[u]));
  for (; u < d; ++u) (f = e[u]) && (a[u] = f);
}
function Jo(t, e, r, i, a, c, u) {
  var f,
    d,
    _ = new Map(),
    v = e.length,
  ...
  for (f = 0; f < v; ++f)
    (d = e[f]) &&
      ((b[f] = E = u.call(d, d.__data__, f, e) + ""),
      _.has(E) ? (a[f] = d) : _.set(E, d));
  for (f = 0; f < x; ++f)
    ((E = u.call(t, c[f], f, c) + ""),
      (d = _.get(E))
        ? ((i[f] = d), (d.__data__ = c[f]), _.delete(E))
        : (r[f] = new Se(t, c[f])));
  for (f = 0; f < v; ++f) (d = e[f]) && _.get(b[f]) === d && (a[f] = d);
}
function Ao(t) {
  return t.__data__;
}
function ta(t, e) {
  ...
  for (
    ...
    var v = i[_],
      x = a[_],
      b = x.length,
      E = br(t.call(v, v && v.__data__, _, i)),
      R = E.length,
      B = (f[_] = new Array(R)),
      M = (u[_] = new Array(R)),
      G = (d[_] = new Array(b));
    r(v, x, B, M, G, E, e);
    for (var Y = 0, O = 0, T, P; Y < R; ++Y)
      if ((T = B[Y])) {
        for (Y >= O && (O = Y + 1); !(P = M[O]) && ++O < R; );
        T._next = P || null;
      }
  }
  return ((u = new Et(u, i)), (u._enter = f), (u._exit = d), u);
}
function ea() {
  return new Et(this._exit || this._groups.map(Pn), this._parents);
}
function ra(t, e, r) {
  var i = this.enter(),
    a = this,
    c = this.exit();
  return (
    (i = typeof t == "function" ? t(i) : i.append(t + "")),
    e != null && (a = e(a)),
    r == null ? c.remove() : r(c),
...
function na(t) {
  if (!(t instanceof Et)) throw new Error("invalid merge");
  for (
    var e = this._groups,
      r = t._groups,
      i = e.length,
    ...
    for (
      var d = e[f], _ = r[f], v = d.length, x = (u[f] = new Array(v)), b, E = 0;
      E < v;
      ++E
    )
      (b = d[E] || _[E]) && (x[E] = b);
...
function ia() {
  for (var t = this._groups, e = -1, r = t.length; ++e < r; )
    for (var i = t[e], a = i.length - 1, c = i[a], u; --a >= 0; )
      (u = i[a]) &&
        (c &&
          u.compareDocumentPosition(c) ^ 4 &&
...
function oa(t) {
  t || (t = aa);
  function e(x, b) {
    return x && b ? t(x.__data__, b.__data__) : !x - !b;
  }
  for (
    var r = this._groups, i = r.length, a = new Array(i), c = 0;
    c < i;
    ++c
  ) {
    for (
      var u = r[c], f = u.length, d = (a[c] = new Array(f)), _, v = 0;
      v < f;
      ++v
    )
      (_ = u[v]) && (d[v] = _);
  ...
  return new Et(a, this._parents).order();
}
function aa(t, e) {
...
function fa(t) {
  for (var e = this._groups, r = 0, i = e.length; r < i; ++r)
    for (var a = e[r], c = 0, u = a.length, f; c < u; ++c)
      (f = a[c]) && t.call(f, f.__data__, c, a);
  return this;
}
function da(t) {
  return function () {
...
function ba(t, e, r) {
  return arguments.length > 1
    ? this.each(
        (e == null ? ma : typeof e == "function" ? xa : Ea)(t, e, r ?? ""),
      )
    : se(this.node(), t);
}
function se(t, e) {
  return (
    ...
    zn(t).getComputedStyle(t, null).getPropertyValue(e)
  );
}
function Ba(t) {
  return function () {
...
function Da(t, e) {
  return arguments.length > 1
    ? this.each((e == null ? Ba : typeof e == "function" ? Ia : La)(t, e))
    : this.node()[t];
}
function Tn(t) {
...
function Cn(t, e) {
  for (var r = Br(t), i = -1, a = e.length; ++i < a; ) r.add(e[i]);
}
function Zn(t, e) {
  for (var r = Br(t), i = -1, a = e.length; ++i < a; ) r.remove(e[i]);
}
function Ga(t) {
  return function () {
    Cn(this, t);
...
function Fa(t, e) {
  return function () {
    (e.apply(this, arguments) ? Cn : Zn)(this, t);
  };
}
function Oa(t, e) {
  var r = Tn(t + "");
  if (arguments.length < 2) {
    for (var i = Br(this.node()), a = -1, c = r.length; ++a < c; )
      if (!i.contains(r[a])) return !1;
    return !0;
  }
  return this.each((typeof e == "function" ? Fa : e ? Ga : Ma)(r, e));
}
function Ra() {
  this.textContent = "";
}
...
function Pa(t) {
  return arguments.length
    ? this.each(t == null ? Ra : (typeof t == "function" ? $a : Sa)(t))
...
function Ca(t) {
  return arguments.length
    ? this.each(t == null ? za : (typeof t == "function" ? Ya : Ta)(t))
    : this.node().innerHTML;
}
function Za() {
...
function Xa(t, e) {
  var r = typeof t == "function" ? t : On(t),
    i = e == null ? Qa : typeof e == "function" ? e : xr(e);
  return this.select(function () {
...
function es(t) {
  return function () {
    var e = this.__on;
    if (e) {
      for (var r = 0, i = -1, a = e.length, c; r < a; ++r)
        ((c = e[r]),
  ...
  return function () {
    ...
    if (i) {
      for (var u = 0, f = i.length; u < f; ++u)
        if ((a = i[u]).type === t.type && a.name === t.name) {
          (this.removeEventListener(a.type, a.listener, a.options),
            this.addEventListener(a.type, (a.listener = c), (a.options = r)),
            (a.value = e));
          return;
        }
    }
    (this.addEventListener(t.type, c, r),
      (a = { type: t.type, name: t.name, value: e, listener: c, options: r }),
...
function ns(t, e, r) {
  ...
  if (arguments.length < 2) {
    ...
    if (f) {
      for (var d = 0, _ = f.length, v; d < _; ++d)
        for (a = 0, v = f[d]; a < c; ++a)
          if ((u = i[a]).type === v.type && u.name === v.name) return v.value;
    }
    return;
  }
  for (f = e ? rs : es, a = 0; a < c; ++a) this.each(f(i[a], e, r));
  return this;
}
function Un(t, e, r) {
  var i = zn(t),
...
function as(t, e) {
  return this.each((typeof e == "function" ? os : is)(t, e));
}
function* ss() {
  for (var t = this._groups, e = 0, r = t.length; e < r; ++e)
    for (var i = t[e], a = 0, c = i.length, u; a < c; ++a)
      (u = i[a]) && (yield u);
}
var Lr = [null];
function Et(t, e) {
...
function jt() {
  return new Et([[document.documentElement]], Lr);
}
function us() {
  return this;
}
...
function Ir(t) {
  return typeof t == "string"
    ...
    : new Et([t == null ? [] : br(t)], Lr);
}
var cs = Te("start", "end", "cancel", "interrupt"),
  ls = [],
  Wn = 0,
  ar = 1,
  sr = 2,
...
function Yt(t, e) {
  var r = $t(t, e);
  if (r.state > Ie) throw new Error("too late; already running");
  return r;
}
function $t(t, e) {
...
function hs(t, e, r) {
  var i = t.__transition,
    a;
  ((i[e] = r), (r.timer = Bn(c, 0, r.time)));
  function c(_) {
    ((r.state = ar),
      r.timer.restart(u, r.delay, r.time),
      r.delay <= _ && u(_ - r.delay));
  }
  function u(_) {
    var v, x, b, E;
    if (r.state !== ar) return d();
    for (v in i)
      if (((E = i[v]), E.name === r.name)) {
        if (E.state === Ie) return ae(u);
        E.state === hn
          ? ((E.state = De),
            E.timer.stop(),
          ...
          : +v < e &&
            ((E.state = De),
            E.timer.stop(),
            E.on.call("cancel", t, t.__data__, E.index, E.group),
            delete i[v]);
      }
    if (
      (ae(function () {
        r.state === Ie &&
          ((r.state = hn), r.timer.restart(f, r.delay, r.time), f(_));
      }),
      (r.state = sr),
      ...
      for (
        r.state = Ie, a = new Array((b = r.tween.length)), v = 0, x = -1;
        v < b;
        ++v
      )
        (E = r.tween[v].value.call(t, t.__data__, r.index, r.group)) &&
          (a[++x] = E);
      a.length = x + 1;
    }
  }
  function f(_) {
    for (
      var v =
          _ < r.duration
            ? r.ease.call(null, _ / r.duration)
            : (r.timer.restart(d), (r.state = ur), 1),
        x = -1,
        b = a.length;
      ++x < b;
      ...
      a[x].call(t, v);
    r.state === ur && (r.on.call("end", t, t.__data__, r.index, r.group), d());
  }
  function d() {
    ((r.state = De), r.timer.stop(), delete i[e]);
    for (var _ in i) return;
...
function fs(t, e) {
  ...
  if (r) {
    ...
    for (u in r) {
      ...
      ((a = i.state > sr && i.state < ur),
        (i.state = De),
        i.timer.stop(),
        i.on.call(a ? "interrupt" : "cancel", t, t.__data__, i.index, i.group),
        delete r[u]);
    }
...
function _s(t, e, r) {
  ...
  return function () {
    ...
    if (u !== i) {
      a = (i = u).slice();
      for (var f = { name: e, value: r }, d = 0, _ = a.length; d < _; ++d)
        if (a[d].name === e) {
          a[d] = f;
          break;
        }
...
function vs(t, e) {
  ...
  if (((t += ""), arguments.length < 2)) {
    for (var i = $t(this.node(), r).tween, a = 0, c = i.length, u; a < c; ++a)
      if ((u = i[a]).name === t) return u.value;
    return null;
  }
  return this.each((e == null ? ps : _s)(r, t, e));
}
function Gr(t, e, r) {
  var i = t._id;
  return (
...
function ws(t, e, r) {
  ...
  return function () {
    ...
    return u === a ? null : u === i ? c : (c = e((i = u), r));
  };
}
function ms(t, e, r) {
  var i,
...
function bs(t, e) {
  ...
  return this.attrTween(
    t,
    typeof e == "function"
      ? (r.local ? xs : Es)(r, i, Gr(this, "attr." + t, e))
      : e == null
        ? (r.local ? gs : ys)(r)
        : (r.local ? ms : ws)(r, i, e),
  );
...
function Gs(t, e) {
  ...
  var i = Ye(t);
  return this.tween(r, (i.local ? Is : Ds)(i, e));
}
function Ms(t, e) {
  return function () {
...
function Os(t) {
  var e = this._id;
  return arguments.length
    ? this.each((typeof t == "function" ? Ms : Fs)(e, t))
    : $t(this.node(), e).delay;
}
function Rs(t, e) {
  return function () {
...
function $s(t) {
  var e = this._id;
  return arguments.length
    ? this.each((typeof t == "function" ? Rs : Ss)(e, t))
    : $t(this.node(), e).duration;
}
function Ps(t, e) {
  if (typeof e != "function") throw new Error();
  return function () {
...
function zs(t) {
  var e = this._id;
  return arguments.length ? this.each(Ps(e, t)) : $t(this.node(), e).ease;
}
function Ts(t, e) {
  return function () {
    var r = e.apply(this, arguments);
...
function Ys(t) {
  ...
  return this.each(Ts(this._id, t));
}
function Cs(t) {
  typeof t != "function" && (t = Sn(t));
  for (var e = this._groups, r = e.length, i = new Array(r), a = 0; a < r; ++a)
...
function Zs(t) {
  ...
  for (
    ...
    for (
      ...
      (b = d[E] || _[E]) && (x[E] = b);
  for (; f < i; ++f) u[f] = e[f];
  return new Tt(u, this._parents, this._name, this._id);
}
function Us(t) {
  return (t + "")
    .trim()
...
function Ws(t, e, r) {
  ...
  return function () {
    var u = c(this, t),
      f = u.on;
    (f !== i && (a = (i = f).copy()).on(e, r), (u.on = a));
  };
}
function Hs(t, e) {
  var r = this._id;
  return arguments.length < 2
    ? $t(this.node(), r).on.on(t)
    : this.each(Ws(r, t, e));
}
function Ks(t) {
  return function () {
...
function Xs(t) {
  var e = this._name,
    r = this._id;
  typeof t != "function" && (t = xr(t));
  for (var i = this._groups, a = i.length, c = new Array(a), u = 0; u < a; ++u)
    for (
      var f = i[u], d = f.length, _ = (c[u] = new Array(d)), v, x, b = 0;
      b < d;
      ++b
    )
      (v = f[b]) &&
        (x = t.call(v, v.__data__, b, f)) &&
        ("__data__" in v && (x.__data__ = v.__data__),
        (_[b] = x),
        Ce(_[b], e, r, b, _, $t(v, r)));
  return new Tt(c, this._parents, e, r);
}
function Ns(t) {
  var e = this._name,
    r = this._id;
  typeof t != "function" && (t = Rn(t));
  for (var i = this._groups, a = i.length, c = [], u = [], f = 0; f < a; ++f)
    for (var d = i[f], _ = d.length, v, x = 0; x < _; ++x)
      if ((v = d[x])) {
        for (
          var b = t.call(v, v.__data__, x, d),
            E,
            R = $t(v, r),
            B = 0,
            M = b.length;
          ...
          (E = b[B]) && Ce(E, e, r, B, b, R);
        (c.push(b), u.push(v));
      }
  return new Tt(c, u, e, r);
}
var Vs = jt.prototype.constructor;
function js() {
...
function ks(t, e) {
  ...
  return function () {
    var c = se(this, t),
      u = (this.style.removeProperty(t), se(this, t));
    return c === u ? null : c === r && u === i ? a : (a = e((r = c), (i = u)));
  };
}
function Kn(t) {
  return function () {
...
function Js(t, e, r) {
  ...
  return function () {
    var u = se(this, t),
      ...
      d = f + "";
    return (
      f == null && (d = f = (this.style.removeProperty(t), se(this, t))),
      u === d ? null : u === i && d === a ? c : ((a = d), (c = e((i = u), f)))
    );
  };
}
function As(t, e) {
  ...
  return function () {
    var d = Yt(this, t),
      _ = d.on,
      v = d.value[c] == null ? f || (f = Kn(e)) : void 0;
    ((_ !== r || a !== v) && (i = (r = _).copy()).on(u, (a = v)), (d.on = i));
  };
}
function tu(t, e, r) {
  var i = (t += "") == "transform" ? Dn : Hn;
  return e == null
    ? this.styleTween(t, ks(t, i)).on("end.style." + t, Kn(t))
    : typeof e == "function"
      ? this.styleTween(t, Js(t, i, Gr(this, "style." + t, e))).each(
          As(this._id, t),
        )
      : this.styleTween(t, qs(t, i, e), r).on("end.style." + t, null);
}
function eu(t, e, r) {
  return function (i) {
...
function lu() {
  for (
    ...
    for (var u = i[c], f = u.length, d, _ = 0; _ < f; ++_)
      if ((d = u[_])) {
        var v = $t(d, e);
        Ce(d, t, r, _, u, {
  ...
  return new Tt(i, this._parents, t, r);
}
function hu() {
  var t,
    e,
...
var pu = { time: null, delay: 0, duration: 250, ease: du };
function _u(t, e) {
...
function vu(t) {
  ...
  t instanceof Tt
    ? ((e = t._id), (t = t._name))
    : ((e = Qn()), ((r = pu).time = Gn()), (t = t == null ? null : t + ""));
  for (var i = this._groups, a = i.length, c = 0; c < a; ++c)
    for (var u = i[c], f = u.length, d, _ = 0; _ < f; ++_)
      (d = u[_]) && Ce(d, t, e, _, u, r || _u(d, e));
  return new Tt(i, this._parents, t, e);
}
jt.prototype.interrupt = ds;
jt.prototype.transition = vu;
var yu = [null];
function gu(t, e) {
  var r = t.__transition,
    i,
  ...
  if (r) {
    e = e == null ? null : e + "";
    for (a in r)
      if ((i = r[a]).state > ar && i.name === e)
        return new Tt([[t]], yu, e, +a);
  }
  return null;
}
...
function Ze(t) {
  ...
  return (
    r >= 0 && (e = t.slice(0, r)) !== "xmlns" && (t = t.slice(r + 1)),
    fn.hasOwnProperty(e) ? { space: fn[e], local: t } : t
  );
}
function wu(t) {
  return function () {
    var e = this.ownerDocument,
      r = this.namespaceURI;
    return r === cr && e.documentElement.namespaceURI === cr
      ? e.createElement(t)
      : e.createElementNS(r, t);
  };
}
...
function Lu(t) {
  return function () {
    return bu(t.apply(this, arguments));
  };
}
function Iu(t) {
  typeof t == "function" ? (t = Lu(t)) : (t = Nn(t));
  for (var e = this._groups, r = e.length, i = [], a = [], c = 0; c < r; ++c)
    for (var u = e[c], f = u.length, d, _ = 0; _ < f; ++_)
      (d = u[_]) && (i.push(t.call(d, d.__data__, _, u)), a.push(d));
  return new Bt(i, a);
...
function Fu(t) {
  return this.select(t == null ? Mu : Gu(typeof t == "function" ? t : jn(t)));
}
...
function Su(t) {
  return function () {
    return Ou.call(this.children, t);
  };
}
function $u(t) {
  return this.selectAll(
    t == null ? Ru : Su(typeof t == "function" ? t : jn(t)),
  );
}
function Pu(t) {
...
function zu() {
  return new Bt(this._enter || this._groups.map(kn), this._parents);
}
function $e(t, e) {
  ((this.ownerDocument = t.ownerDocument),
    (this.namespaceURI = t.namespaceURI),
...
function Yu(t, e, r, i, a, c) {
  for (var u = 0, f, d = e.length, _ = c.length; u < _; ++u)
    (f = e[u]) ? ((f.__data__ = c[u]), (i[u] = f)) : (r[u] = new $e(t, c[u]));
  for (; u < d; ++u) (f = e[u]) && (a[u] = f);
}
function Cu(t, e, r, i, a, c, u) {
  var f,
    d,
    _ = new Map(),
    v = e.length,
...
function Uu(t, e) {
  ...
  for (
    ...
    var v = i[_],
      x = a[_],
      b = x.length,
      E = Wu(t.call(v, v && v.__data__, _, i)),
      R = E.length,
      B = (f[_] = new Array(R)),
      M = (u[_] = new Array(R)),
      G = (d[_] = new Array(b));
  ...
  return ((u = new Bt(u, i)), (u._enter = f), (u._exit = d), u);
}
function Wu(t) {
  return typeof t == "object" && "length" in t ? t : Array.from(t);
}
function Hu() {
  return new Bt(this._exit || this._groups.map(kn), this._parents);
}
function Ku(t, e, r) {
  var i = this.enter(),
    a = this,
...
function Qu(t) {
  for (
    ...
    for (
      var _ = r[d], v = i[d], x = _.length, b = (f[d] = new Array(x)), E, R = 0;
      R < x;
      ++R
    )
      (E = _[R] || v[R]) && (b[R] = E);
...
function hc(t, e, r) {
  return arguments.length > 1
    ? this.each(
        (e == null ? uc : typeof e == "function" ? lc : cc)(t, e, r ?? ""),
      )
    : ue(this.node(), t);
}
function ue(t, e) {
  return (
    t.style.getPropertyValue(e) ||
    qn(t).getComputedStyle(t, null).getPropertyValue(e)
  );
}
function fc(t) {
  return function () {
...
function _c(t, e) {
  return arguments.length > 1
    ? this.each((e == null ? fc : typeof e == "function" ? pc : dc)(t, e))
    : this.node()[t];
}
function Jn(t) {
  return t.trim().split(/^|\s+/);
...
function ti(t, e) {
  for (var r = Or(t), i = -1, a = e.length; ++i < a; ) r.add(e[i]);
}
function ei(t, e) {
  for (var r = Or(t), i = -1, a = e.length; ++i < a; ) r.remove(e[i]);
}
function vc(t) {
  return function () {
    ti(this, t);
...
function gc(t, e) {
  return function () {
    (e.apply(this, arguments) ? ti : ei)(this, t);
  };
}
function wc(t, e) {
  var r = Jn(t + "");
  if (arguments.length < 2) {
    for (var i = Or(this.node()), a = -1, c = r.length; ++a < c; )
      if (!i.contains(r[a])) return !1;
    return !0;
  }
  return this.each((typeof e == "function" ? gc : e ? vc : yc)(r, e));
}
function mc() {
  this.textContent = "";
}
...
function bc(t) {
  return arguments.length
    ? this.each(t == null ? mc : (typeof t == "function" ? xc : Ec)(t))
    : this.node().textContent;
}
function Bc() {
  this.innerHTML = "";
...
function Dc(t) {
  return arguments.length
    ? this.each(t == null ? Bc : (typeof t == "function" ? Ic : Lc)(t))
    : this.node().innerHTML;
}
function Gc() {
  this.nextSibling && this.parentNode.appendChild(this);
...
function $c(t, e) {
  var r = typeof t == "function" ? t : Xn(t),
    i = e == null ? Sc : typeof e == "function" ? e : Fr(e);
  return this.select(function () {
    return this.insertBefore(
      r.apply(this, arguments),
      i.apply(this, arguments) || null,
...
function Qc(t, e, r) {
  ...
  for (f = e ? Kc : Hc, a = 0; a < c; ++a) this.each(f(i[a], e, r));
  return this;
}
function ri(t, e, r) {
  var i = qn(t),
...
function Vc(t, e) {
  return this.each((typeof e == "function" ? Nc : Xc)(t, e));
}
function* jc() {
  for (var t = this._groups, e = 0, r = t.length; e < r; ++e)
    for (var i = t[e], a = 0, c = i.length, u; a < c; ++a)
...
function ge() {
  return new Bt([[document.documentElement]], ni);
}
function kc() {
  return this;
}
Bt.prototype = ge.prototype = {
  constructor: Bt,
  select: xu,
  selectAll: Iu,
  selectChild: Fu,
...
function Jt(t) {
  return typeof t == "string"
    ? new Bt([[document.querySelector(t)]], [document.documentElement])
    : new Bt([[t]], ni);
}
function qc(t) {
  let e;
...
function qt(t, e) {
  if (((t = qc(t)), e === void 0 && (e = t.currentTarget), e)) {
...
const lr = { capture: !0, passive: !1 };
function hr(t) {
  (t.preventDefault(), t.stopImmediatePropagation());
}
function Jc(t) {
  var e = t.document.documentElement,
    r = Jt(t).on("dragstart.drag", hr, lr);
  "onselectstart" in e
    ? r.on("selectstart.drag", hr, lr)
    : ((e.__noselect = e.style.MozUserSelect),
      (e.style.MozUserSelect = "none"));
}
function Ac(t, e) {
  var r = t.document.documentElement,
    i = Jt(t).on("dragstart.drag", null);
  (e &&
    (i.on("click.drag", hr, lr),
    setTimeout(function () {
...
var tl = Te("start", "end", "cancel", "interrupt"),
  el = [],
  ii = 0,
  dn = 1,
  fr = 2,
...
function Ct(t, e) {
  var r = Pt(t, e);
  if (r.state > Ge) throw new Error("too late; already running");
  return r;
}
function Pt(t, e) {
  var r = t.__transition;
...
function rl(t, e, r) {
  ...
  function u(_) {
    var v, x, b, E;
    if (r.state !== dn) return d();
    for (v in i)
      if (((E = i[v]), E.name === r.name)) {
        if (E.state === Ge) return ae(u);
        E.state === pn
          ? ((E.state = Me),
            E.timer.stop(),
            E.on.call("interrupt", t, t.__data__, E.index, E.group),
    ...
    if (
      (ae(function () {
        r.state === Ge &&
          ((r.state = pn), r.timer.restart(f, r.delay, r.time), f(_));
      }),
      (r.state = fr),
      r.on.call("start", t, t.__data__, r.index, r.group),
      r.state === fr)
      ...
      for (
        r.state = Ge, a = new Array((b = r.tween.length)), v = 0, x = -1;
        v < b;
        ++v
      )
        (E = r.tween[v].value.call(t, t.__data__, r.index, r.group)) &&
  ...
  function f(_) {
    for (
      var v =
          _ < r.duration
            ? r.ease.call(null, _ / r.duration)
            : (r.timer.restart(d), (r.state = dr), 1),
        x = -1,
        b = a.length;
      ++x < b;
      ...
      a[x].call(t, v);
    r.state === dr && (r.on.call("end", t, t.__data__, r.index, r.group), d());
  }
  function d() {
    ((r.state = Me), r.timer.stop(), delete i[e]);
    for (var _ in i) return;
    delete t.__transition;
  }
}
...
function al(t, e) {
  var r = this._id;
  if (((t += ""), arguments.length < 2)) {
    for (var i = Pt(this.node(), r).tween, a = 0, c = i.length, u; a < c; ++a)
      if ((u = i[a]).name === t) return u.value;
    return null;
  }
  return this.each((e == null ? il : ol)(r, t, e));
}
function Sr(t, e, r) {
  var i = t._id;
  return (
...
function dl(t, e) {
  ...
  return this.attrTween(
    t,
    typeof e == "function"
      ? (r.local ? fl : hl)(r, i, Sr(this, "attr." + t, e))
      : e == null
        ? (r.local ? ul : sl)(r)
        : (r.local ? ll : cl)(r, i, e),
  );
...
function gl(t, e) {
  ...
  if (typeof e != "function") throw new Error();
  var i = Ze(t);
  return this.tween(r, (i.local ? vl : yl)(i, e));
}
function wl(t, e) {
  return function () {
    Rr(this, t).delay = +e.apply(this, arguments);
  };
}
function ml(t, e) {
  return (
...
function El(t) {
  var e = this._id;
  return arguments.length
    ? this.each((typeof t == "function" ? wl : ml)(e, t))
    : Pt(this.node(), e).delay;
}
function xl(t, e) {
  return function () {
...
function Bl(t) {
  var e = this._id;
  return arguments.length
    ? this.each((typeof t == "function" ? xl : bl)(e, t))
    : Pt(this.node(), e).duration;
}
function Ll(t, e) {
  if (typeof e != "function") throw new Error();
  return function () {
...
function Il(t) {
  var e = this._id;
  return arguments.length ? this.each(Ll(e, t)) : Pt(this.node(), e).ease;
}
function Dl(t, e) {
  return function () {
    var r = e.apply(this, arguments);
...
function Gl(t) {
  if (typeof t != "function") throw new Error();
  return this.each(Dl(this._id, t));
}
function Ml(t) {
  typeof t != "function" && (t = Vn(t));
  for (var e = this._groups, r = e.length, i = new Array(r), a = 0; a < r; ++a)
  ...
  for (var i = this._groups, a = i.length, c = new Array(a), u = 0; u < a; ++u)
    for (
      ...
      (v = f[b]) &&
        ...
        ("__data__" in v && (x.__data__ = v.__data__),
        (_[b] = x),
        Ue(_[b], e, r, b, _, Pt(v, r)));
  return new Xt(c, this._parents, e, r);
}
function Tl(t) {
  var e = this._name,
    r = this._id;
    ...
    for (var d = i[f], _ = d.length, v, x = 0; x < _; ++x)
      if ((v = d[x])) {
        for (
          ...
          (E = b[B]) && Ue(E, e, r, B, b, R);
        (c.push(b), u.push(v));
      }
  return new Xt(c, u, e, r);
}
var Yl = ge.prototype.constructor;
function Cl() {
...
function Zl(t, e) {
  ...
  return function () {
    var c = ue(this, t),
      u = (this.style.removeProperty(t), ue(this, t));
    return c === u ? null : c === r && u === i ? a : (a = e((r = c), (i = u)));
  };
}
function ai(t) {
...
function Wl(t, e, r) {
  ...
  return function () {
    var u = ue(this, t),
      ...
      d = f + "";
    return (
      f == null && (d = f = (this.style.removeProperty(t), ue(this, t))),
      u === d ? null : u === i && d === a ? c : ((a = d), (c = e((i = u), f)))
    );
  };
}
function Hl(t, e) {
  ...
  return function () {
    var d = Ct(this, t),
      _ = d.on,
      v = d.value[c] == null ? f || (f = ai(e)) : void 0;
    ((_ !== r || a !== v) && (i = (r = _).copy()).on(u, (a = v)), (d.on = i));
  };
}
function Kl(t, e, r) {
  var i = (t += "") == "transform" ? Dn : oi;
  return e == null
    ? this.styleTween(t, Zl(t, i)).on("end.style." + t, ai(t))
    : typeof e == "function"
      ? this.styleTween(t, Wl(t, i, Sr(this, "style." + t, e))).each(
          Hl(this._id, t),
        )
      : this.styleTween(t, Ul(t, i, e), r).on("end.style." + t, null);
}
function Ql(t, e, r) {
  return function (i) {
    this.style.setProperty(t, e.call(this, i), r);
...
var ih = { time: null, delay: 0, duration: 250, ease: nh };
function oh(t, e) {
  for (var r; !(r = t.__transition) || !(r = r[e]); )
    if (!(t = t.parentNode)) throw new Error(`transition ${e} not found`);
  return r;
...
function ah(t) {
  ...
  t instanceof Xt
    ? ((e = t._id), (t = t._name))
    : ((e = si()), ((r = ih).time = Gn()), (t = t == null ? null : t + ""));
  for (var i = this._groups, a = i.length, c = 0; c < a; ++c)
    for (var u = i[c], f = u.length, d, _ = 0; _ < f; ++_)
      (d = u[_]) && Ue(d, t, e, _, u, r || oh(d, e));
  return new Xt(i, this._parents, t, e);
}
ge.prototype.interrupt = nl;
ge.prototype.transition = ah;
const Be = (t) => () => t;
function sh(t, { sourceEvent: e, target: r, transform: i, dispatch: a }) {
...
Qt.prototype = {
  ...
  translate: function (t, e) {
    return (t === 0) & (e === 0)
      ? this
      : new Qt(this.k, this.x + this.k * t, this.y + this.k * e);
  },
  apply: function (t) {
...
var We = new Qt(1, 0, 0);
He.prototype = Qt.prototype;
function He(t) {
  for (; !t.__zoom; ) if (!(t = t.parentNode)) return We;
  return t.__zoom;
}
function rr(t) {
...
function fh(t, e, r) {
  var i = t.invertX(e[0][0]) - r[0][0],
    ...
    u = t.invertY(e[1][1]) - r[1][1];
  return t.translate(
    a > i ? (i + a) / 2 : Math.min(0, i) || Math.max(0, a),
    u > c ? (c + u) / 2 : Math.min(0, c) || Math.max(0, u),
  );
}
function dh() {
  var t = uh,
    ...
    M = 10;
  function G(g) {
    g.property("__zoom", _n)
      .on("wheel.zoom", ht, { passive: !1 })
      .on("mousedown.zoom", ft)
      .on("dblclick.zoom", dt)
      .filter(a)
  ...
  ((G.transform = function (g, I, L, S) {
    var z = g.selection ? g.selection() : g;
    (z.property("__zoom", _n),
      g !== z
        ? P(g, I, L, S)
            ...
            U =
              L == null
                ...
                : typeof L == "function"
                  ...
                  : L,
            N = W.invert(U),
            Q = typeof I == "function" ? I.apply(this, arguments) : I;
          return r(O(Y(W, Q), U, N), z, u);
        },
        L,
        S,
      );
    }),
    (G.translateBy = function (g, I, L, S) {
      G.transform(
        g,
        function () {
          return r(
    ...
    (G.translateTo = function (g, I, L, S, z) {
      G.transform(
        g,
        function () {
  ...
  function Y(g, I) {
    return (
      (I = Math.max(c[0], Math.min(c[1], I))),
      I === g.k ? g : new Qt(I, g.x, g.y)
    );
  }
  function O(g, I, L) {
    var S = I[0] - L[0] * g.k,
      z = I[1] - L[1] * g.k;
    return S === g.x && z === g.y ? g : new Qt(g.k, S, z);
  }
  function T(g) {
    ...
    g.on("start.zoom", function () {
      ...
      .tween("zoom", function () {
        var z = this,
          ...
          U = D(z, W).event(S),
          N = e.apply(z, W),
          Q = L == null ? T(N) : typeof L == "function" ? L.apply(z, W) : L,
          V = Math.max(N[1][0] - N[0][0], N[1][1] - N[0][1]),
          rt = z.__zoom,
          _t = typeof I == "function" ? I.apply(z, W) : I,
          st = d(rt.invert(Q).concat(V / rt.k), _t.invert(Q).concat(V / _t.k));
        return function (ut) {
          if (ut === 1) ut = _t;
          else {
            var A = st(ut),
              wt = V / A[2];
            ut = new Qt(wt, Q[0] - A[0] * wt, Q[1] - A[1] * wt);
          }
          U.zoom(null, ut);
        };
      });
  ...
  function D(g, I, L) {
    return (!L && g.__zooming) || new Z(g, I);
  }
  function Z(g, I) {
    ((this.that = g),
      (this.args = I),
  ...
  function ht(g, ...I) {
    ...
    var L = D(this, I).event(g),
      S = this.__zoom,
      z = Math.max(
        c[0],
        Math.min(c[1], S.k * Math.pow(2, i.apply(this, arguments))),
      ),
      W = qt(g);
    if (L.wheel)
      ((L.mouse[0][0] !== W[0] || L.mouse[0][1] !== W[1]) &&
        (L.mouse[1] = S.invert((L.mouse[0] = W))),
        clearTimeout(L.wheel));
    else {
      if (S.k === z) return;
      ((L.mouse = [W, S.invert(W)]), Fe(this), L.start());
    }
    (pe(g),
      (L.wheel = setTimeout(U, R)),
      L.zoom("mouse", r(O(Y(S, z), L.mouse[0], L.mouse[1]), L.extent, u)));
    function U() {
      ((L.wheel = null), L.end());
    }
  }
  function ft(g, ...I) {
    if (b || !t.apply(this, arguments)) return;
    var L = g.currentTarget,
      S = D(this, I, !0).event(g),
      z = Jt(g.view).on("mousemove.zoom", Q, !0).on("mouseup.zoom", V, !0),
      W = qt(g, L),
      U = g.clientX,
      N = g.clientY;
    (Jc(g.view),
      rr(g),
      (S.mouse = [W, this.__zoom.invert(W)]),
      Fe(this),
      S.start());
    function Q(rt) {
      if ((pe(rt), !S.moved)) {
        var _t = rt.clientX - U,
          st = rt.clientY - N;
        S.moved = _t * _t + st * st > B;
      }
      S.event(rt).zoom(
        "mouse",
        r(O(S.that.__zoom, (S.mouse[0] = qt(rt, L)), S.mouse[1]), S.extent, u),
      );
    }
    function V(rt) {
  ...
  function dt(g, ...I) {
    if (t.apply(this, arguments)) {
      var L = this.__zoom,
        S = qt(g.changedTouches ? g.changedTouches[0] : g, this),
        z = L.invert(S),
        W = L.k * (g.shiftKey ? 0.5 : 2),
        U = r(O(Y(L, W), S, z), e.apply(this, I), u);
      (pe(g),
        f > 0
          ? Jt(this).transition().duration(f).call(P, U, S, g)
          : Jt(this).call(G.transform, U, S, g));
    }
  }
  function F(g, ...I) {
    if (t.apply(this, arguments)) {
      var L = g.touches,
        S = L.length,
        z = D(this, I, g.changedTouches.length === S).event(g),
        W,
        U,
        N,
        Q;
      for (rr(g), U = 0; U < S; ++U)
        ((N = L[U]),
          (Q = qt(N, this)),
          (Q = [Q, this.__zoom.invert(Q), N.identifier]),
          z.touch0
            ? !z.touch1 &&
              z.touch0[2] !== Q[2] &&
              ((z.touch1 = Q), (z.taps = 0))
            : ((z.touch0 = Q), (W = !0), (z.taps = 1 + !!v)));
      (v && (v = clearTimeout(v)),
        W &&
          (z.taps < 2 &&
            ((x = Q[0]),
  ...
  function H(g, ...I) {
    if (this.__zooming) {
      ...
      for (pe(g), W = 0; W < z; ++W)
        ((U = S[W]),
          (N = qt(U, this)),
          L.touch0 && L.touch0[2] === U.identifier
            ? (L.touch0[0] = N)
            : L.touch1 && L.touch1[2] === U.identifier && (L.touch1[0] = N));
      if (((U = L.that.__zoom), L.touch1)) {
        var V = L.touch0[0],
          rt = L.touch0[1],
          _t = L.touch1[0],
          st = L.touch1[1],
          ut = (ut = _t[0] - V[0]) * ut + (ut = _t[1] - V[1]) * ut,
          A = (A = st[0] - rt[0]) * A + (A = st[1] - rt[1]) * A;
        ((U = Y(U, Math.sqrt(ut / A))),
          (N = [(V[0] + _t[0]) / 2, (V[1] + _t[1]) / 2]),
          (Q = [(rt[0] + st[0]) / 2, (rt[1] + st[1]) / 2]));
      } else if (L.touch0) ((N = L.touch0[0]), (Q = L.touch0[1]));
      else return;
      L.zoom("touch", r(O(U, N, Q), L.extent, u));
    }
  }
  function k(g, ...I) {
    if (this.__zooming) {
      ...
      for (
        ...
        ((U = S[W]),
          L.touch0 && L.touch0[2] === U.identifier
            ? delete L.touch0
            : L.touch1 && L.touch1[2] === U.identifier && delete L.touch1);
      if (
        ...
        (L.end(),
        L.taps === 2 &&
          ((U = qt(U, this)), Math.hypot(x[0] - U[0], x[1] - U[1]) < M))
      ) {
        var N = Jt(this).on("dblclick.zoom");
        N && N.apply(this, arguments);
      }
    }
  }
  return (
    (G.wheelDelta = function (g) {
      return arguments.length
        ? ((i = typeof g == "function" ? g : Be(+g)), G)
        : i;
    }),
    (G.filter = function (g) {
      return arguments.length
        ? ((t = typeof g == "function" ? g : Be(!!g)), G)
        : t;
    }),
    (G.touchable = function (g) {
      return arguments.length
        ? ((a = typeof g == "function" ? g : Be(!!g)), G)
        : a;
    }),
    (G.extent = function (g) {
      return arguments.length
    ...
    (G.scaleExtent = function (g) {
      return arguments.length
        ? ((c[0] = +g[0]), (c[1] = +g[1]), G)
        : [c[0], c[1]];
    }),
    (G.translateExtent = function (g) {
      return arguments.length
        ? ((u[0][0] = +g[0][0]),
          (u[1][0] = +g[1][0]),
          (u[0][1] = +g[0][1]),
    ...
    (G.constrain = function (g) {
      return arguments.length ? ((r = g), G) : r;
    }),
    (G.duration = function (g) {
      return arguments.length ? ((f = +g), G) : f;
    }),
    (G.interpolate = function (g) {
      return arguments.length ? ((d = g), G) : d;
    }),
    (G.on = function () {
      var g = _.on.apply(_, arguments);
      return g === _ ? G : g;
    }),
    (G.clickDistance = function (g) {
      return arguments.length ? ((B = (g = +g) * g), G) : Math.sqrt(B);
    }),
    (G.tapDistance = function (g) {
      return arguments.length ? ((M = +g), G) : M;
    }),
    G
  );
}
function ui(t) {
  ...
  if (d && d.baseVal.numberOfItems != 0) {
    var _ = d.baseVal.consolidate().matrix;
    ((e.translation = { x: _.e, y: _.f }), (e.scale = _.a));
  }
  if (
    (r == "ellipse" && (e.center = { x: e.attributes.cx, y: e.attributes.cy }),
    r == "polygon")
  ) {
    var v = t.attr("points").split(" "),
      x = v.map(function (O) {
        return O.split(",")[0];
      }),
      b = v.map(function (O) {
      ...
      E = Math.min.apply(null, x),
      R = Math.max.apply(null, x),
      B = Math.min.apply(null, b),
      M = Math.max.apply(null, b),
      G = { x: E, y: B, width: R - E, height: M - B };
    ((e.bbox = G), (e.center = { x: (E + R) / 2, y: (B + M) / 2 }));
  }
  if (r == "path") {
    var Y = t.attr("d"),
      v = Y.split(/[A-Z ]/);
    v.shift();
    var x = v.map(function (F) {
        return +F.split(",")[0];
      }),
      b = v.map(function (F) {
        return +F.split(",")[1];
      ...
      G = { x: E, y: B, width: R - E, height: M - B };
    ((e.bbox = G),
      (e.center = { x: (E + R) / 2, y: (B + M) / 2 }),
      (e.totalLength = t.node().getTotalLength()));
  }
  return (
    r == "text" && (e.center = { x: t.attr("x"), y: t.attr("y") }),
    r == "#text"
      ? (e.text = t.text())
      : r == "#comment" && (e.comment = t.text()),
    e
...
function _h(t, e) {
  ...
  var i = r.enter().append(function (u) {
      return $r(u);
    }),
    a = r.exit();
  ((a = a.remove()), (r = i.merge(r)));
  var c = {};
  r.each(function (u) {
    var f = u.tag;
    c[f] == null && (c[f] = 0);
...
function we(t, e = 0) {
  ...
  if (a)
    for (var c = 0; c < a.length; c++) {
      var u = a[c],
        f = u.name;
      if (f.split(":")[0] != "xmlns" && u.namespaceURI) {
        var d = u.namespaceURI.split("/"),
          _ = d[d.length - 1];
        f = _ + ":" + f;
      }
      f in i || (i[f] = null);
    }
  for (var v of Object.keys(i)) r.attr(v, i[v]);
  (t.text && r.text(t.text), _h(r, e));
}
function vh(t) {
  return (
    ...
    this._options.zoom && !this._zoomBehavior
      ...
      : !this._options.zoom &&
        this._zoomBehavior &&
        (this._zoomSelection.on(".zoom", null), (this._zoomBehavior = null)),
    this
  );
}
function ci() {
  var t = this;
  function e(u) {
    var f = at(i.node().querySelector("g"));
    (f.attr("transform", u.transform), t._dispatch.call("zoom", t));
  }
  var r = this._selection,
    i = at(r.node().querySelector("svg"));
  ...
  var c = at(i.node().querySelector("g"));
  return (
    i.call(a),
    this._active || vr.call(this, c),
    (this._originalTransform = He(i.node())),
    this
  );
}
function _r(t) {
  var e = this._translation,
    r = this._scale,
    i = t.datum().translation,
    a = t.datum().scale,
    c = He(this._zoomSelection.node());
  return (
    e && ((c = c.scale(1 / r)), (c = c.translate(-e.x, -e.y))),
    (c = c.translate(i.x, i.y)),
    (c = c.scale(a)),
    c
  );
}
function vr(t) {
  (this._zoomBehavior.transform(this._zoomSelection, _r.call(this, t)),
    (this._translation = t.datum().translation),
    (this._scale = t.datum().scale),
    (this._originalTransform = We.translate(
      t.datum().translation.x,
      t.datum().translation.y,
    ).scale(t.datum().scale)));
}
function yh(t) {
  ...
  return (
    t && (e = e.transition(t)),
    e.call(this._zoomBehavior.transform, this._originalTransform),
    this
  );
}
function gh(t) {
...
function bh(t, e, r, i) {
  const a = t,
    c = a.cloneNode(),
    u = a.getTotalLength(),
    f = (c.setAttribute("d", e), c).getTotalLength(),
    d = [0];
  let _ = 0;
  const v = i ? r : r / Math.max(u, f);
  for (; (_ += v) < 1; ) d.push(_);
  return (
    d.push(1),
    d.map(function (b) {
      const E = a.getPointAtLength(b * u),
        R = c.getPointAtLength(b * f);
      return [
        [E.x, E.y],
        [R.x, R.y],
      ];
...
function li(t) {
  return (
    t.attributes.class == "edge" ||
    (t.tag == "a" &&
      t.parent.tag == "g" &&
      t.parent.parent.attributes.class == "edge")
  );
}
function hi(t) {
  return t.parent && li(t.parent);
}
function Lh(t) {
  return t.parent.attributes.class == "edge"
    ? t.parent
    : t.parent.parent.parent;
}
function Ih(t) {
  return Lh(t).children.find(function (e) {
    return e.tag == "title";
  });
}
function Dh(t) {
  return this._busy
    ...
    : (this._dispatch.call("renderStart", this),
      this._transitionFactory
        ? ae(
            function () {
              ((this._transition = Mr(this._transitionFactory())),
                yn.call(this, t));
            }.bind(this),
            0,
          )
...
function yn(t) {
  var e = this._transition,
    r = this._options.fade && e != null,
    i = this._options.tweenPaths,
    a = this._options.tweenShapes,
    c = this._options.convertEqualSidedPolygons,
    u = this._options.growEnteringEdges && e != null,
    f = this._attributer,
    d = this;
  function _(B) {
    var M = B.selectAll(function () {
    ...
    var G = M.enter().append(function (T) {
      var P = $r(T);
      return (T.tag == "#text" && r && (P.nodeValue = T.text), P);
    });
    if (r || (u && li(B.datum()))) {
      var Y = G.filter(function (T) {
        return T.tag[0] == "#" ? null : this;
      }).each(function (T) {
        var P = at(this);
        for (var D of Object.keys(T.attributes)) {
          var Z = T.attributes[D];
          P.attr(D, Z);
        }
      });
      Y.filter(function (T) {
        return T.tag == "svg" || T.tag == "g" ? null : this;
      }).style("opacity", 0);
    }
    var O = M.exit();
    (f && O.each(f),
  ...
  function v(B) {
    ...
    if (B.tag == "svg") {
      ...
      if (G.width != null || G.height != null) {
        var Y = G.width,
          O = G.height;
        (Y == null
          ? (Y = (B.attributes.width.replace("pt", "") * 4) / 3)
          : (M.attr("width", Y), (B.attributes.width = Y)),
          O == null
            ? (O = (B.attributes.height.replace("pt", "") * 4) / 3)
            : (M.attr("height", O), (B.attributes.height = O)),
          G.fit ||
            (M.attr(
              "viewBox",
              `0 0 ${(Y * 3) / 4 / G.scale} ${(O * 3) / 4 / G.scale}`,
            ),
            (B.attributes.viewBox = `0 0 ${(Y * 3) / 4 / G.scale} ${(O * 3) / 4 / G.scale}`)));
      }
      G.scale != 1 &&
        (G.fit || (G.width == null && G.height == null)) &&
        ((Y = B.attributes.viewBox.split(" ")[2]),
        (O = B.attributes.viewBox.split(" ")[3]),
        M.attr("viewBox", `0 0 ${Y / G.scale} ${O / G.scale}`),
        (B.attributes.viewBox = `0 0 ${Y / G.scale} ${O / G.scale}`));
    }
    f && M.each(f);
    var T = B.tag,
      P = B.attributes,
    ...
    if (D)
      for (var Z = 0; Z < D.length; Z++) {
        var ht = D[Z],
          ft = ht.name;
        if (ft.split(":")[0] != "xmlns" && ht.namespaceURI) {
          var dt = ht.namespaceURI.split("/"),
            F = dt[dt.length - 1];
          ft = F + ":" + ft;
        }
        ft in P || (P[ft] = null);
    ...
    if (a && e) {
      if (
        ((this.nodeName == "polygon" || this.nodeName == "ellipse") &&
          B.alternativeOld &&
          (k = !0),
        (T == "polygon" || T == "ellipse") && B.alternativeNew && (H = !0),
        this.nodeName == "polygon" && T == "polygon" && B.alternativeOld)
      ) {
        var g = ui(M),
          I = g.attributes.points;
        if (!c) {
          var L = I.split(" ").length,
            S = B.attributes.points,
            z = S.split(" ").length;
          z == L && ((H = !1), (k = !1));
        }
      }
      if (k) {
        var W = B.alternativeOld,
          U = vn(M, W);
        (U.data([B], function () {
          return B.key;
        }),
      ...
      if (H) {
        var N = B.alternativeNew;
        ((T = "path"), (P = N.attributes));
      }
    }
    var Q = M;
    e &&
      ((Q = Q.transition(e)),
      r &&
        Q.filter(function (vt) {
          return vt.tag[0] == "#" ? null : this;
        }).style("opacity", 1),
      Q.filter(function (vt) {
        return vt.tag[0] == "#" ? null : this;
      }).on("end", function (vt) {
        at(this).attr(
          "style",
          (vt && vt.attributes && vt.attributes.style) || null,
        );
      }));
    var V = u && T == "path" && B.offset;
    if (V) {
      var rt = B.totalLength;
      (M.attr("stroke-dasharray", rt + " " + rt)
        .attr("stroke-dashoffset", rt)
        .attr("transform", "translate(" + B.offset.x + "," + B.offset.y + ")"),
        (P["stroke-dashoffset"] = 0),
        (P.transform = "translate(0,0)"),
        Q.attr("stroke-dashoffset", P["stroke-dashoffset"])
          .attr("transform", P.transform)
          .on("start", function () {
            at(this).style("opacity", null);
          })
          .on("end", function () {
            at(this)
    ...
    var _t =
      ...
      hi(B) &&
      B.offset &&
      B.parent.children[3].tag == "path";
    if (_t) {
      var st = at(M.node().parentNode.querySelector("path")),
        ut = st.node().getPointAtLength(0),
        A = st.node().getPointAtLength(B.totalLength),
        wt = st.node().getPointAtLength(B.totalLength - 1),
        Zt = (Math.atan2(A.y - wt.y, A.x - wt.x) * 180) / Math.PI,
        Gt = ut.x - A.x + B.offset.x,
        Mt = ut.y - A.y + B.offset.y;
      (M.attr("transform", "translate(" + Gt + "," + Mt + ")"),
        Q.attrTween("transform", function () {
          return function (vt) {
            var Ut = st.node().getPointAtLength(B.totalLength * vt),
              ee = st.node().getPointAtLength(B.totalLength * vt + 1),
              le = (Math.atan2(ee.y - Ut.y, ee.x - Ut.x) * 180) / Math.PI - Zt;
            return (
              (Gt = Ut.x - A.x + B.offset.x * (1 - vt)),
              (Mt = Ut.y - A.y + B.offset.y * (1 - vt)),
              "translate(" +
                Gt +
                "," +
                Mt +
          ...
          .on("end", function () {
            at(this).attr("transform", null);
          }));
    }
    var q = i && e && T == "path" && M.attr("d") != null;
    for (var pt of Object.keys(P)) {
      var ce = P[pt];
      if (q && pt == "d") {
        var S = (B.alternativeOld || B).points;
        S && Q.attrTween("d", xh(S, ce));
      } else {
        if (pt == "transform" && B.translation)
          if (e) {
            var Qe = Q.on("end");
            Q.on("start", function () {
              d._zoomBehavior &&
                Q.tween("attr.transform", function () {
                  var vt = this;
                  return function (Ut) {
                    vt.setAttribute(
                      "transform",
                      Er(
                        He(d._zoomSelection.node()).toString(),
                        _r.call(d, M).toString(),
                      )(Ut),
                    );
                  };
                });
            }).on("end", function () {
              (Qe.call(this), d._zoomBehavior && vr.call(d, M));
            });
          } else
            d._zoomBehavior && (vr.call(d, M), (ce = _r.call(d, M).toString()));
        Q.attr(pt, ce);
      }
    }
    (H &&
      Q.on("end", function (vt, Ut, ee) {
        U = at(this);
        var le = vn(U, vt);
        le.data([vt], function () {
          return vt.key;
      ...
      B.text && Q.text(B.text),
      _(M));
  }
  var x = this._selection;
  if (e != null) {
    var b = this._jobs;
    if (d._active) return (b.push(null), this);
    (x
      .transition(e)
      .transition()
      .duration(0)
      .on("end", function () {
        ((d._active = !1), b.length != 0 && (b.shift(), d.render()));
      }),
      (this._active = !0));
  }
  e != null &&
  ...
  var E = this._data,
    R = x.selectAll("svg").data([E], function (B) {
      return B.key;
    });
  return (
    (R = R.enter().append("svg").merge(R)),
    v.call(R.node(), E),
    this._options.zoom && !this._zoomBehavior && ci.call(this),
    d._dispatch.call("renderEnd", d),
    e == null && (this._dispatch.call("end", this), t && t.call(this)),
    this
  );
}
function Gh() {
...
var Mh = ArrayBuffer,
  ...
  Ke = Int32Array,
  nr = function (t, e, r) {
    if (yt.prototype.slice) return yt.prototype.slice.call(t, e, r);
    ((e == null || e < 0) && (e = 0),
  ...
  ve = function (t, e, r, i) {
    if (yt.prototype.fill) return yt.prototype.fill.call(t, e, r, i);
    for (
      (r == null || r < 0) && (r = 0),
  ...
  Oh = function (t, e, r, i) {
    if (yt.prototype.copyWithin)
      return yt.prototype.copyWithin.call(t, e, r, i);
    for (
      (r == null || r < 0) && (r = 0),
        (i == null || i > t.length) && (i = t.length);
      r < i;
  ...
  gt = function (t, e, r) {
    var i = new Error(e || Rh[t]);
    if (
      ((i.code = t),
      Error.captureStackTrace && Error.captureStackTrace(i, gt),
      !r)
    )
      throw i;
    return i;
  ...
  gn = function (t, e, r) {
    for (var i = 0, a = 0; i < r; ++i) a |= t[e++] << (i << 3);
    return a;
  },
  Sh = function (t, e) {
    ...
    if (r == 3126568 && t[3] == 253) {
      ...
      return (
        ...
        (B[8] = 8),
        {
          ...
          l: 0,
          d: v,
          w: e && e != 1 ? e : B.subarray(12),
          e: E,
          o: new Ke(B.buffer, 0, 3),
          u: b,
          c,
          m: Math.min(131072, E),
        }
      );
    } else if (((r >> 4) | (t[3] << 20)) == 25481893) return Sh(t, 4) + 8;
    gt(0);
  },
  At = function (t) {
    for (var e = 0; 1 << e <= t; ++e);
  ...
  me = function (t, e, r) {
    ...
    for (
      ...
      var Y = At(u + 1),
        O = i >> 3,
        T = (1 << (Y + 1)) - 1,
        P = ((t[O] | (t[O + 1] << 8) | (t[O + 2] << 16)) >> (i & 7)) & T,
        D = (1 << Y) - 1,
        Z = T - u - 1,
        ht = P & D;
      if (
        (ht < Z ? ((i += Y), (P = ht)) : ((i += Y + 1), P > D && (P -= Z)),
        (b[++f] = --P),
        P == -1 ? ((u += P), (M[--v] = f)) : (u -= P),
        !P)
      )
    ...
    (f > 255 || u) && gt(0);
    for (
      var dt = 0, F = (c >> 1) + (c >> 3) + 3, H = c - 1, k = 0;
      k <= f;
      ++k
    ) {
      var g = b[k];
    ...
    for (dt && gt(0), _ = 0; _ < c; ++_) {
      var I = E[M[_]]++,
        L = (G[_] = a - At(I));
      R[_] = (I << L) - c;
    }
    return [(i + 7) >> 3, { b: a, s: M, n: G, t: R }];
  },
  Ph = function (t, e) {
    var r = 0,
      i = -1,
      ...
      c = t[e],
      u = a.subarray(0, 256),
      f = a.subarray(256, 268),
      d = new Pe(a.buffer, 268);
    if (c < 128) {
      var _ = me(t, e + 1, 6),
        v = _[0],
        x = _[1];
      ...
      E || gt(0);
      for (
        var R = 0, B = 0, M = x.b, G = M, Y = (++e << 3) - 8 + At(E);
        (Y -= M), !(Y < b);

      ) {
        var O = Y >> 3;
        if (
          ((R += ((t[O] | (t[O + 1] << 8)) >> (Y & 7)) & ((1 << M) - 1)),
          (u[++i] = x.s[R]),
          (Y -= G),
          Y < b)
        )
    ...
    var Z = At(P) + 1,
      ht = 1 << Z,
      ft = ht - P;
    for (ft & (ft - 1) && gt(0), u[i++] = At(ft) + 1, r = 0; r < i; ++r) {
      var D = u[r];
      ++f[(u[r] = D && Z + 1 - D)];
    }
    var dt = new yt(ht << 1),
    ...
    for (d[Z] = 0, r = Z; r > 0; --r) {
      var k = d[r];
      ve(H, r, k, (d[r - 1] = k + f[r] * (1 << (Z - r))));
    }
    for (d[0] != ht && gt(0), r = 0; r < i; ++r) {
      var g = u[r];
      if (g) {
        var I = d[g];
        ve(F, r, I, (d[g] = I + (1 << (Z - g))));
      }
    }
    return [e, { n: H, b: Z, s: F }];
  },
  zh = me(
    new yt([
  ...
  Yh = me(
    new yt([32, 132, 16, 66, 102, 70, 68, 68, 68, 68, 36, 73, 2]),
    0,
    5,
  )[1],
  fi = function (t, e) {
    for (var r = t.length, i = new Ke(r), a = 0; a < r; ++a)
      ((i[a] = e), (e += 1 << t[a]));
    return i;
  },
  yr = new yt(
  ...
  _e = function (t, e, r) {
    ...
    c || gt(0);
    for (
      var d = 0, _ = r.b, v = (i << 3) - 8 + At(c) - _, x = -1;
      v > f && x < a;

    ) {
      var b = v >> 3,
        E = (t[b] | (t[b + 1] << 8) | (t[b + 2] << 16)) >> (v & 7);
      ((d = ((d << _) | E) & u), (e[++x] = r.s[d]), (v -= _ = r.n[d]));
    }
    (v != f || x + 1 != a) && gt(0);
  },
  Uh = function (t, e, r) {
    var i = 6,
      ...
      u = c << 1,
      f = c + u;
    (_e(t.subarray(i, (i += t[0] | (t[1] << 8))), e.subarray(0, c), r),
      _e(t.subarray(i, (i += t[2] | (t[3] << 8))), e.subarray(c, u), r),
      _e(t.subarray(i, (i += t[4] | (t[5] << 8))), e.subarray(u, f), r),
      _e(t.subarray(i), e.subarray(f), r));
  },
  Wh = function (t, e, r) {
    var i,
      a = e.b,
      ...
      u = (c >> 1) & 3;
    e.l = c & 1;
    var f = (c >> 3) | (t[a + 1] << 5) | (t[a + 2] << 13),
      d = (a += 3) + f;
    if (u == 1)
      return a >= t.length
        ? void 0
        : ((e.b = a + 1),
          r ? (ve(r, t[a], e.y, (e.y += f)), r) : ve(new yt(f), t[a]));
    if (!(d > t.length)) {
      if (u == 0)
        return (
          (e.b = d),
          r ? (r.set(t.subarray(a, d), e.y), (e.y += f), r) : nr(t, a, d)
        );
      if (u == 2) {
        var _ = t[a],
          v = _ & 3,
        ...
        (v < 2
          ...
          : ((R = x),
            x < 2
              ? ((b |= (t[++a] & 63) << 4), (E = (t[a] >> 6) | (t[++a] << 2)))
              : x == 2
                ? ((b |= (t[++a] << 4) | ((t[++a] & 3) << 12)),
                  (E = (t[a] >> 2) | (t[++a] << 6)))
                : ((b |= (t[++a] << 4) | ((t[++a] & 63) << 12)),
                  (E = (t[a] >> 6) | (t[++a] << 2) | (t[++a] << 10)))),
          ++a);
        var B = r ? r.subarray(e.y, e.y + e.m) : new yt(e.m),
          M = B.length - b;
        if (v == 0) B.set(t.subarray(a, (a += b)), M);
        else if (v == 1) ve(B, t[a++], M);
        else {
          var G = e.h;
          if (v == 2) {
            var Y = Ph(t, a);
          ...
          (R ? Uh : _e)(t.subarray(a, (a += E)), B.subarray(M), G);
        }
        var O = t[a++];
        if (O) {
          O == 255
          ...
          var T = t[a++];
          T & 3 && gt(0);
          for (var P = [Th, Yh, zh], D = 2; D > -1; --D) {
            var Z = (T >> ((D << 1) + 2)) & 3;
            if (Z == 1) {
              var ht = new yt([0, 0, t[a++]]);
              P[D] = {
                s: ht.subarray(2, 3),
                n: ht.subarray(0, 1),
                t: new Pe(ht.buffer, 0, 1),
                b: 0,
              };
            } else
              Z == 2
                ? ((i = me(t, a, 9 - (D & 1))), (a = i[0]), (P[D] = i[1]))
                : Z == 3 && (e.t || gt(0), (P[D] = e.t[D]));
          }
          var ft = (e.t = P),
            dt = ft[0],
            F = ft[1],
            ...
            k = t[d - 1];
          k || gt(0);
          var g = (d << 3) - 8 + At(k) - H.b,
            I = g >> 3,
            L = 0,
            S = ((t[I] | (t[I + 1] << 8)) >> (g & 7)) & ((1 << H.b) - 1);
          I = (g -= F.b) >> 3;
          var z = ((t[I] | (t[I + 1] << 8)) >> (g & 7)) & ((1 << F.b) - 1);
          I = (g -= dt.b) >> 3;
          var W = ((t[I] | (t[I + 1] << 8)) >> (g & 7)) & ((1 << dt.b) - 1);
          for (++O; --O; ) {
            var U = H.s[S],
              N = H.n[S],
              Q = dt.s[W],
            ...
            if (
              ...
              (S =
                H.t[S] +
                (((t[I] | (t[I + 1] << 8)) >> (g & 7)) & ((1 << N) - 1))),
              (I = (g -= V) >> 3),
              (W =
                dt.t[W] +
                (((t[I] | (t[I + 1] << 8)) >> (g & 7)) & ((1 << V) - 1))),
              (I = (g -= _t) >> 3),
              (z =
                F.t[z] +
                (((t[I] | (t[I + 1] << 8)) >> (g & 7)) & ((1 << _t) - 1))),
              ut > 3)
            )
              ((e.o[2] = e.o[1]), (e.o[1] = e.o[0]), (e.o[0] = ut -= 3));
            else {
              var Zt = ut - (wt != 0);
              Zt
                ? ((ut = Zt == 3 ? e.o[0] - 1 : e.o[Zt]),
                  Zt > 1 && (e.o[2] = e.o[1]),
                  (e.o[1] = e.o[0]),
                  (e.o[0] = ut))
                : (ut = e.o[0]);
            }
            for (var D = 0; D < wt; ++D) B[L + D] = B[M + D];
            ((L += wt), (M += wt));
            var Gt = L - ut;
            if (Gt < 0) {
              var Mt = -Gt,
                q = e.e + Gt;
              Mt > A && (Mt = A);
              for (var D = 0; D < Mt; ++D) B[L + D] = e.w[q + D];
              ((L += Mt), (A -= Mt), (Gt = 0));
            }
            for (var D = 0; D < A; ++D) B[L + D] = B[Gt + D];
            L += A;
          }
          if (L != M) for (; M < B.length; ) B[L++] = B[M++];
          else L = B.length;
          r ? (e.y += L) : (B = nr(B, 0, L));
        } else if (r) {
          if (((e.y += b), M)) for (var D = 0; D < b; ++D) B[D] = B[M + D];
        } else M && (B = nr(B, M));
        return ((e.b = d), B);
      }
      gt(2);
  ...
  Hh = function (t, e) {
    ...
    for (var r = new yt(e), i = 0, a = 0; i < t.length; ++i) {
      var c = t[i];
...
function Kh(t, e) {
  for (var r = [], i = +!e, a = 0, c = 0; t.length; ) {
    var u = $h(t, i || e);
    if (typeof u == "object") {
      for (
        i
          ? ((e = null), u.w.length == u.u && (r.push((e = u.w)), (c += u.u)))
          : (r.push(e), (u.e = 0));
        !u.l;
...
var Qh =
    ...
    function (t = {}) {
      ...
      function ft() {
        var n = M.buffer;
        ((r.HEAP8 = O = new Int8Array(n)),
          (r.HEAP16 = P = new Int16Array(n)),
          (r.HEAPU8 = T = new Uint8Array(n)),
          (r.HEAPU16 = new Uint16Array(n)),
          (r.HEAP32 = D = new Int32Array(n)),
          (r.HEAPU32 = Z = new Uint32Array(n)),
          (r.HEAPF32 = new Float32Array(n)),
          (r.HEAPF64 = ht = new Float64Array(n)));
      }
      var dt = [],
        F = [],
        H = [];
      ...
      function g() {
        (!r.noFSInit && !l.initialized && l.init(),
          (l.ignorePermissions = !1),
          vt(F));
      }
      function I() {
        vt(H);
      ...
      var Q = "data:application/octet-stream;base64,",
        V = (n) => n.startsWith(Q),
        rt = (n) => n.startsWith("file://");
      function _t() {
        var n = "graphvizlib.wasm";
        return V(n) ? n : v(n);
      }
      var st;
      function ut(n) {
        if (n == st && B) return new Uint8Array(B);
        throw "both async and sync fetching of the wasm failed";
      }
      function A(n) {
        return B
          ? Promise.resolve().then(() => ut(n))
          : x(n).then(
              (o) => new Uint8Array(o),
              () => ut(n),
            );
      ...
      function wt(n, o, s) {
        return A(n)
          .then((h) => WebAssembly.instantiate(h, o))
          .then(s, (h) => {
            (R(`failed to asynchronously prepare wasm: ${h}`), N(h));
          });
      }
      function Zt(n, o, s, h) {
        return !n &&
          ...
          ? fetch(o, { credentials: "same-origin" }).then((p) => {
              var y = WebAssembly.instantiateStreaming(p, s);
              return y.then(h, function (w) {
                return (
                  R(`wasm streaming compile failed: ${w}`),
      ...
      function Mt() {
        function n(h, p) {
          return ((lt = h.exports), (M = lt.B), ft(), L(lt.C), U(), lt);
        }
        W();
        function o(h) {
          n(h.instance);
        ...
        var s = Gt();
        return ((st ??= _t()), Zt(B, st, s, o).catch(a), {});
      }
      var q,
        pt,
        ce = {
          173064: (n, o) => {
            var s = Lt(n),
              h = Lt(o);
            (l.createPath("/", ct.dirname(s)), l.writeFile(ct.join("/", s), h));
          },
        };
      class Qe {
        name = "ExitStatus";
      ...
      class Ut {
        ...
        init(o, s) {
          (this.set_adjusted_ptr(0), this.set_type(o), this.set_destructor(s));
        }
        set_adjusted_ptr(o) {
          Z[(this.ptr + 16) >> 2] = o;
        }
      ...
      var ee = 0,
        ...
        ct = {
          ...
          normalizeArray: (n, o) => {
            for (var s = 0, h = n.length - 1; h >= 0; h--) {
              var p = n[h];
              p === "."
                ? n.splice(h, 1)
                : p === ".."
          ...
          dirname: (n) => {
            var o = ct.splitPath(n),
              s = o[0],
              h = o[1];
            return !s && !h
              ? "."
              : (h && (h = h.substr(0, h.length - 1)), s + h);
          },
          basename: (n) => {
            if (n === "/") return "/";
            ((n = ct.normalize(n)), (n = n.replace(/\/$/, "")));
            var o = n.lastIndexOf("/");
            return o === -1 ? n : n.substr(o + 1);
          },
          join: (...n) => ct.normalize(n.join("/")),
          join2: (n, o) => ct.normalize(n + "/" + o),
        },
        Ei = () => {
          if (
        ...
        Nt = {
          resolve: (...n) => {
            for (var o = "", s = !1, h = n.length - 1; h >= -1 && !s; h--) {
              var p = h >= 0 ? n[h] : l.cwd();
              if (typeof p != "string")
                throw new TypeError(
          ...
          relative: (n, o) => {
            ((n = Nt.resolve(n).substr(1)), (o = Nt.resolve(o).substr(1)));
            function s(j) {
              for (var et = 0; et < j.length && j[et] === ""; et++);
              for (var ot = j.length - 1; ot >= 0 && j[ot] === ""; ot--);
              return et > ot ? [] : j.slice(et, ot - et + 1);
            }
            for (
              var h = s(n.split("/")),
                p = s(o.split("/")),
                y = Math.min(h.length, p.length),
                w = y,
                m = 0;
              m < y;
              m++
            ...
            for (var $ = [], m = w; m < h.length; m++) $.push("..");
            return (($ = $.concat(p.slice(w))), $.join("/"));
          },
        },
        Tr = typeof TextDecoder < "u" ? new TextDecoder() : void 0,
        re = (n, o = 0, s = NaN) => {
          for (var h = o + s, p = o; n[p] && !(p >= h); ) ++p;
          if (p - o > 16 && n.buffer && Tr) return Tr.decode(n.subarray(o, p));
          for (var y = ""; o < p; ) {
            var w = n[o++];
            if (!(w & 128)) {
            ...
            var m = n[o++] & 63;
            if ((w & 224) == 192) {
              y += String.fromCharCode(((w & 31) << 6) | m);
              continue;
            }
            var $ = n[o++] & 63;
            if (
              ((w & 240) == 224
                ? (w = ((w & 15) << 12) | (m << 6) | $)
                : (w = ((w & 7) << 18) | (m << 12) | ($ << 6) | (n[o++] & 63)),
              w < 65536)
            )
              y += String.fromCharCode(w);
            else {
              var j = w - 65536;
              y += String.fromCharCode(55296 | (j >> 10), 56320 | (j & 1023));
            }
          }
          return y;
        },
        ...
        Ve = (n, o, s, h) => {
          if (!(h > 0)) return 0;
          for (var p = s, y = s + h - 1, w = 0; w < n.length; ++w) {
            var m = n.charCodeAt(w);
            if (m >= 55296 && m <= 57343) {
              var $ = n.charCodeAt(++w);
              m = (65536 + ((m & 1023) << 10)) | ($ & 1023);
            }
            if (m <= 127) {
              if (s >= y) break;
              o[s++] = m;
      ...
      var xi = () => {
        ...
        kt = {
          ...
          shutdown() {},
          register(n, o) {
            ((kt.ttys[n] = { input: [], output: [], ops: o }),
              l.registerDevice(n, kt.stream_ops));
          },
          stream_ops: {
            open(n) {
              var o = kt.ttys[n.node.rdev];
              if (!o) throw new l.ErrnoError(43);
              ((n.tty = o), (n.seekable = !1));
            },
            close(n) {
            ...
            read(n, o, s, h, p) {
              if (!n.tty || !n.tty.ops.get_char) throw new l.ErrnoError(60);
              for (var y = 0, w = 0; w < h; w++) {
                var m;
                try {
                ...
                if (m === void 0 && y === 0) throw new l.ErrnoError(6);
                if (m == null) break;
                (y++, (o[s + w] = m));
              }
              return (y && (n.node.timestamp = Date.now()), y);
            },
            write(n, o, s, h, p) {
              if (!n.tty || !n.tty.ops.put_char) throw new l.ErrnoError(60);
              try {
                for (var y = 0; y < h; y++) n.tty.ops.put_char(n.tty, o[s + y]);
              } catch {
                throw new l.ErrnoError(29);
              }
              return (h && (n.node.timestamp = Date.now()), y);
            },
          },
          default_tty_ops: {
            get_char(n) {
        ...
        X = {
          ...
          createNode(n, o, s, h) {
            if (l.isBlkdev(s) || l.isFIFO(s)) throw new l.ErrnoError(63);
            X.ops_table ||= {
              dir: {
                node: {
            ...
            var p = l.createNode(n, o, s, h);
            return (
              l.isDir(p.mode)
                ? ((p.node_ops = X.ops_table.dir.node),
                  (p.stream_ops = X.ops_table.dir.stream),
                  (p.contents = {}))
                : l.isFile(p.mode)
                  ? ((p.node_ops = X.ops_table.file.node),
                    (p.stream_ops = X.ops_table.file.stream),
                    (p.usedBytes = 0),
                    (p.contents = null))
                  : l.isLink(p.mode)
                    ? ((p.node_ops = X.ops_table.link.node),
                      (p.stream_ops = X.ops_table.link.stream))
                    : l.isChrdev(p.mode) &&
                      ((p.node_ops = X.ops_table.chrdev.node),
                      (p.stream_ops = X.ops_table.chrdev.stream)),
              (p.timestamp = Date.now()),
              n && ((n.contents[o] = p), (n.timestamp = p.timestamp)),
              p
            );
          },
          ...
          expandFileStorage(n, o) {
            var s = n.contents ? n.contents.length : 0;
            if (!(s >= o)) {
              var h = 1048576;
              ((o = Math.max(o, (s * (s < h ? 2 : 1.125)) >>> 0)),
                s != 0 && (o = Math.max(o, 256)));
              var p = n.contents;
              ((n.contents = new Uint8Array(o)),
                n.usedBytes > 0 &&
                  n.contents.set(p.subarray(0, n.usedBytes), 0));
            }
          },
          resizeFileStorage(n, o) {
            if (n.usedBytes != o)
              if (o == 0) ((n.contents = null), (n.usedBytes = 0));
              else {
                var s = n.contents;
                ((n.contents = new Uint8Array(o)),
                  s && n.contents.set(s.subarray(0, Math.min(o, n.usedBytes))),
                  (n.usedBytes = o));
              }
          },
          node_ops: {
            getattr(n) {
              var o = {};
              return (
                (o.dev = l.isChrdev(n.mode) ? n.id : 1),
                (o.ino = n.id),
                (o.mode = n.mode),
                (o.nlink = 1),
                (o.uid = 0),
                ...
                l.isDir(n.mode)
                  ...
                  : l.isFile(n.mode)
                    ? (o.size = n.usedBytes)
                    : l.isLink(n.mode)
                      ? (o.size = n.link.length)
                      : (o.size = 0),
                (o.atime = new Date(n.timestamp)),
                (o.mtime = new Date(n.timestamp)),
                (o.ctime = new Date(n.timestamp)),
                (o.blksize = 4096),
                (o.blocks = Math.ceil(o.size / o.blksize)),
                o
              );
            },
            setattr(n, o) {
              (o.mode !== void 0 && (n.mode = o.mode),
                o.timestamp !== void 0 && (n.timestamp = o.timestamp),
                o.size !== void 0 && X.resizeFileStorage(n, o.size));
            },
            lookup(n, o) {
              throw X.doesNotExistError;
            },
            mknod(n, o, s, h) {
              return X.createNode(n, o, s, h);
            },
            rename(n, o, s) {
              if (l.isDir(n.mode)) {
                var h;
                ...
                if (h) for (var p in h.contents) throw new l.ErrnoError(55);
              }
              (delete n.parent.contents[n.name],
                (n.parent.timestamp = Date.now()),
                (n.name = s),
                (o.contents[s] = n),
                (o.timestamp = n.parent.timestamp));
            },
            unlink(n, o) {
              (delete n.contents[o], (n.timestamp = Date.now()));
            },
            rmdir(n, o) {
              var s = l.lookupNode(n, o);
              for (var h in s.contents) throw new l.ErrnoError(55);
              (delete n.contents[o], (n.timestamp = Date.now()));
            },
            readdir(n) {
              var o = [".", ".."];
              for (var s of Object.keys(n.contents)) o.push(s);
              return o;
            },
            symlink(n, o, s) {
              var h = X.createNode(n, o, 41471, 0);
              return ((h.link = s), h);
            },
            readlink(n) {
              if (!l.isLink(n.mode)) throw new l.ErrnoError(28);
              return n.link;
            },
          },
          stream_ops: {
            read(n, o, s, h, p) {
              var y = n.node.contents;
              if (p >= n.node.usedBytes) return 0;
              var w = Math.min(n.node.usedBytes - p, h);
              if (w > 8 && y.subarray) o.set(y.subarray(p, p + w), s);
              else for (var m = 0; m < w; m++) o[s + m] = y[p + m];
              return w;
            },
            write(n, o, s, h, p, y) {
              if ((o.buffer === O.buffer && (y = !1), !h)) return 0;
              var w = n.node;
              if (
                ((w.timestamp = Date.now()),
                o.subarray && (!w.contents || w.contents.subarray))
              ) {
                if (y)
                  return (
                    (w.contents = o.subarray(s, s + h)),
                    (w.usedBytes = h),
                    h
                  );
                if (w.usedBytes === 0 && p === 0)
                  return (
                    (w.contents = o.slice(s, s + h)),
                    (w.usedBytes = h),
                    h
                  );
                if (p + h <= w.usedBytes)
                  return (w.contents.set(o.subarray(s, s + h), p), h);
              }
              if (
                (X.expandFileStorage(w, p + h),
                w.contents.subarray && o.subarray)
              )
                w.contents.set(o.subarray(s, s + h), p);
              else for (var m = 0; m < h; m++) w.contents[p + m] = o[s + m];
              return ((w.usedBytes = Math.max(w.usedBytes, p + h)), h);
            },
            llseek(n, o, s) {
              var h = o;
              if (
                (s === 1
                  ? (h += n.position)
                  : s === 2 && l.isFile(n.node.mode) && (h += n.node.usedBytes),
                h < 0)
              )
            ...
            allocate(n, o, s) {
              (X.expandFileStorage(n.node, o + s),
                (n.node.usedBytes = Math.max(n.node.usedBytes, o + s)));
            },
            mmap(n, o, s, h, p) {
              if (!l.isFile(n.node.mode)) throw new l.ErrnoError(43);
              var y,
                w,
                m = n.node.contents;
              if (!(p & 2) && m && m.buffer === O.buffer)
                ((w = !1), (y = m.byteOffset));
              else {
                if (((w = !0), (y = Yr(o)), !y)) throw new l.ErrnoError(48);
                m &&
                  ((s > 0 || s + o < m.length) &&
                    (m.subarray
                      ? (m = m.subarray(s, s + o))
                      : (m = Array.prototype.slice.call(m, s, s + o))),
                  O.set(m, y));
              }
              return { ptr: y, allocated: w };
            },
            msync(n, o, s, h, p) {
              return (X.stream_ops.write(n, o, 0, h, s, !1), 0);
            },
          },
        },
        Bi = (n, o, s, h) => {
        ...
        Di = (n, o, s, h) => {
          ...
          return (
            Ii.forEach((y) => {
              p || (y.canHandle(o) && (y.handle(n, o, s, h), (p = !0)));
            }),
            p
          );
        },
        Gi = (n, o, s, h, p, y, w, m, $, j) => {
          var et = o ? Nt.resolve(ct.join2(n, o)) : n;
          function ot(J) {
            function K(nt) {
              (j?.(), m || Li(n, o, nt, h, p, $), y?.(), U());
            }
            Di(J, et, K, () => {
              (w?.(), U());
            }) || K(J);
          }
          (W(), typeof s == "string" ? Bi(s, ot, w) : ot(s));
        },
        Mi = (n) => {
          var o = { r: 0, "r+": 2, w: 577, "w+": 578, a: 1089, "a+": 1090 },
            s = o[n];
          if (typeof s > "u") throw new Error(`Unknown file open mode: ${n}`);
          return s;
        },
        qe = (n, o) => {
          var s = 0;
          return (n && (s |= 365), o && (s |= 146), s);
        },
        l = {
          root: null,
          mounts: [],
          ...
          lookupPath(n, o = {}) {
            if (((n = Nt.resolve(n)), !n)) return { path: "", node: null };
            var s = { follow_mount: !0, recurse_count: 0 };
            if (((o = Object.assign(s, o)), o.recurse_count > 8))
              throw new l.ErrnoError(32);
            for (
              var h = n.split("/").filter((ot) => !!ot),
                p = l.root,
                y = "/",
                w = 0;
              w < h.length;
              ...
              if (
                ...
                for (var $ = 0; l.isLink(p.mode); ) {
                  var j = l.readlink(y);
                  y = Nt.resolve(ct.dirname(y), j);
                  var et = l.lookupPath(y, {
                    recurse_count: o.recurse_count + 1,
                  });
                  if (((p = et.node), $++ > 40)) throw new l.ErrnoError(32);
                }
            }
            return { path: y, node: p };
          },
          getPath(n) {
            for (var o; ; ) {
              if (l.isRoot(n)) {
                var s = n.mount.mountpoint;
                return o ? (s[s.length - 1] !== "/" ? `${s}/${o}` : s + o) : s;
              }
              ((o = o ? `${n.name}/${o}` : n.name), (n = n.parent));
            }
          },
          hashName(n, o) {
            for (var s = 0, h = 0; h < o.length; h++)
              s = ((s << 5) - s + o.charCodeAt(h)) | 0;
            return ((n + s) >>> 0) % l.nameTable.length;
          },
          hashAddNode(n) {
            var o = l.hashName(n.parent.id, n.name);
            ((n.name_next = l.nameTable[o]), (l.nameTable[o] = n));
          },
          hashRemoveNode(n) {
            var o = l.hashName(n.parent.id, n.name);
            if (l.nameTable[o] === n) l.nameTable[o] = n.name_next;
            else
              for (var s = l.nameTable[o]; s; ) {
                if (s.name_next === n) {
          ...
          lookupNode(n, o) {
            ...
            for (
              var h = l.hashName(n.id, o), p = l.nameTable[h];
              p;
              p = p.name_next
            ) {
              var y = p.name;
              if (p.parent.id === n.id && y === o) return p;
            }
            return l.lookup(n, o);
          },
          createNode(n, o, s, h) {
            var p = new l.FSNode(n, o, s, h);
            return (l.hashAddNode(p), p);
          },
          destroyNode(n) {
            l.hashRemoveNode(n);
          },
          ...
          nodePermissions(n, o) {
            return l.ignorePermissions
              ? 0
              : (o.includes("r") && !(n.mode & 292)) ||
                  (o.includes("w") && !(n.mode & 146)) ||
                  (o.includes("x") && !(n.mode & 73))
                ? 2
                : 0;
          },
          mayLookup(n) {
            if (!l.isDir(n.mode)) return 54;
            var o = l.nodePermissions(n, "x");
            return o || (n.node_ops.lookup ? 0 : 2);
          },
          mayCreate(n, o) {
            try {
              var s = l.lookupNode(n, o);
          ...
          mayDelete(n, o, s) {
            ...
            var p = l.nodePermissions(n, "wx");
            if (p) return p;
            if (s) {
              if (!l.isDir(h.mode)) return 54;
              if (l.isRoot(h) || l.getPath(h) === l.cwd()) return 10;
            } else if (l.isDir(h.mode)) return 31;
            return 0;
          },
          mayOpen(n, o) {
            return n
              ? l.isLink(n.mode)
                ? 32
                : l.isDir(n.mode) &&
                    (l.flagsToPermissionString(o) !== "r" || o & 512)
                  ? 31
                  : l.nodePermissions(n, l.flagsToPermissionString(o))
              : 44;
          },
          MAX_OPEN_FDS: 4096,
          nextfd() {
            for (var n = 0; n <= l.MAX_OPEN_FDS; n++)
              if (!l.streams[n]) return n;
            throw new l.ErrnoError(33);
          },
          getStreamChecked(n) {
            var o = l.getStream(n);
            if (!o) throw new l.ErrnoError(8);
            return o;
          },
          getStream: (n) => l.streams[n],
          createStream(n, o = -1) {
            return (
              (n = Object.assign(new l.FSStream(), n)),
              o == -1 && (o = l.nextfd()),
              (n.fd = o),
              (l.streams[o] = n),
              n
          ...
          dupStream(n, o = -1) {
            var s = l.createStream(n, o);
            return (s.stream_ops?.dup?.(s), s);
          },
          chrdev_stream_ops: {
            open(n) {
              var o = l.getDevice(n.node.rdev);
              ((n.stream_ops = o.stream_ops), n.stream_ops.open?.(n));
            },
            llseek() {
          ...
          makedev: (n, o) => (n << 8) | o,
          registerDevice(n, o) {
            l.devices[n] = { stream_ops: o };
          },
          getDevice: (n) => l.devices[n],
          getMounts(n) {
            for (var o = [], s = [n]; s.length; ) {
              var h = s.pop();
              (o.push(h), s.push(...h.mounts));
            }
            return o;
          },
          syncfs(n, o) {
            (typeof n == "function" && ((o = n), (n = !1)),
              l.syncFSRequests++,
              l.syncFSRequests > 1 &&
                R(
                  `warning: ${l.syncFSRequests} FS.syncfs operations in flight at once, probably just doing extra work`,
                ));
            var s = l.getMounts(l.root.mount),
              h = 0;
            function p(w) {
              return (l.syncFSRequests--, o(w));
            }
            function y(w) {
              if (w) return y.errored ? void 0 : ((y.errored = !0), p(w));
              ++h >= s.length && p(null);
            }
            s.forEach((w) => {
              if (!w.type.syncfs) return y(null);
              w.type.syncfs(w, n, y);
            });
          },
          mount(n, o, s) {
            var h = s === "/",
              p = !s,
              y;
            if (h && l.root) throw new l.ErrnoError(10);
            if (!h && !p) {
              var w = l.lookupPath(s, { follow_mount: !1 });
              if (((s = w.path), (y = w.node), l.isMountpoint(y)))
                throw new l.ErrnoError(10);
              if (!l.isDir(y.mode)) throw new l.ErrnoError(54);
            }
            var m = { type: n, opts: o, mountpoint: s, mounts: [] },
              $ = n.mount(m);
            return (
              ($.mount = m),
              (m.root = $),
              h
                ? (l.root = $)
                : y && ((y.mounted = m), y.mount && y.mount.mounts.push(m)),
              $
            );
          },
          unmount(n) {
            var o = l.lookupPath(n, { follow_mount: !1 });
            if (!l.isMountpoint(o.node)) throw new l.ErrnoError(28);
            var s = o.node,
              h = s.mounted,
              p = l.getMounts(h);
            (Object.keys(l.nameTable).forEach((w) => {
              for (var m = l.nameTable[w]; m; ) {
                var $ = m.name_next;
                (p.includes(m.mount) && l.destroyNode(m), (m = $));
              }
            }),
              (s.mounted = null));
            var y = s.mount.mounts.indexOf(h);
            s.mount.mounts.splice(y, 1);
          },
          lookup(n, o) {
            return n.node_ops.lookup(n, o);
          },
          mknod(n, o, s) {
            var h = l.lookupPath(n, { parent: !0 }),
              p = h.node,
              y = ct.basename(n);
            if (!y || y === "." || y === "..") throw new l.ErrnoError(28);
            var w = l.mayCreate(p, y);
            if (w) throw new l.ErrnoError(w);
            if (!p.node_ops.mknod) throw new l.ErrnoError(63);
            return p.node_ops.mknod(p, y, o, s);
          },
          statfs(n) {
            var o = {
                bsize: 4096,
              ...
              s = l.lookupPath(n, { follow: !0 }).node;
            return (
              s?.node_ops.statfs &&
                Object.assign(o, s.node_ops.statfs(s.mount.opts.root)),
              o
            );
          },
          create(n, o = 438) {
            return ((o &= 4095), (o |= 32768), l.mknod(n, o, 0));
          },
          mkdir(n, o = 511) {
            return ((o &= 1023), (o |= 16384), l.mknod(n, o, 0));
          },
          mkdirTree(n, o) {
            for (var s = n.split("/"), h = "", p = 0; p < s.length; ++p)
              if (s[p]) {
                h += "/" + s[p];
                try {
                  l.mkdir(h, o);
          ...
          mkdev(n, o, s) {
            return (
              typeof s > "u" && ((s = o), (o = 438)),
              (o |= 8192),
              l.mknod(n, o, s)
            );
          },
          symlink(n, o) {
            if (!Nt.resolve(n)) throw new l.ErrnoError(44);
            var s = l.lookupPath(o, { parent: !0 }),
              h = s.node;
            if (!h) throw new l.ErrnoError(44);
            var p = ct.basename(o),
              y = l.mayCreate(h, p);
            if (y) throw new l.ErrnoError(y);
            if (!h.node_ops.symlink) throw new l.ErrnoError(63);
            return h.node_ops.symlink(h, p, n);
          },
          rename(n, o) {
            var s = ct.dirname(n),
              h = ct.dirname(o),
              ...
              $;
            if (
              ((w = l.lookupPath(n, { parent: !0 })),
              (m = w.node),
              (w = l.lookupPath(o, { parent: !0 })),
              ($ = w.node),
              !m || !$)
            )
              throw new l.ErrnoError(44);
            if (m.mount !== $.mount) throw new l.ErrnoError(75);
            var j = l.lookupNode(m, p),
              et = Nt.relative(n, h);
            if (et.charAt(0) !== ".") throw new l.ErrnoError(28);
            if (((et = Nt.relative(o, s)), et.charAt(0) !== "."))
            ...
            if (j !== ot) {
              var J = l.isDir(j.mode),
                K = l.mayDelete(m, p, J);
              if (K) throw new l.ErrnoError(K);
              if (((K = ot ? l.mayDelete($, y, J) : l.mayCreate($, y)), K))
                throw new l.ErrnoError(K);
              if (!m.node_ops.rename) throw new l.ErrnoError(63);
              if (l.isMountpoint(j) || (ot && l.isMountpoint(ot)))
                throw new l.ErrnoError(10);
              if ($ !== m && ((K = l.nodePermissions(m, "w")), K))
                throw new l.ErrnoError(K);
              l.hashRemoveNode(j);
              try {
                (m.node_ops.rename(j, $, y), (j.parent = $));
              } catch (nt) {
                throw nt;
              } finally {
                l.hashAddNode(j);
          ...
          rmdir(n) {
            var o = l.lookupPath(n, { parent: !0 }),
              s = o.node,
              h = ct.basename(n),
              p = l.lookupNode(s, h),
              y = l.mayDelete(s, h, !0);
            if (y) throw new l.ErrnoError(y);
            if (!s.node_ops.rmdir) throw new l.ErrnoError(63);
            if (l.isMountpoint(p)) throw new l.ErrnoError(10);
            (s.node_ops.rmdir(s, h), l.destroyNode(p));
          },
          readdir(n) {
            var o = l.lookupPath(n, { follow: !0 }),
              s = o.node;
            if (!s.node_ops.readdir) throw new l.ErrnoError(54);
            return s.node_ops.readdir(s);
          },
          unlink(n) {
            var o = l.lookupPath(n, { parent: !0 }),
              s = o.node;
            if (!s) throw new l.ErrnoError(44);
            var h = ct.basename(n),
              p = l.lookupNode(s, h),
              y = l.mayDelete(s, h, !1);
            if (y) throw new l.ErrnoError(y);
            if (!s.node_ops.unlink) throw new l.ErrnoError(63);
            if (l.isMountpoint(p)) throw new l.ErrnoError(10);
            (s.node_ops.unlink(s, h), l.destroyNode(p));
          },
          readlink(n) {
            var o = l.lookupPath(n),
              s = o.node;
            if (!s) throw new l.ErrnoError(44);
            if (!s.node_ops.readlink) throw new l.ErrnoError(28);
            return s.node_ops.readlink(s);
          },
          stat(n, o) {
            var s = l.lookupPath(n, { follow: !o }),
              h = s.node;
            if (!h) throw new l.ErrnoError(44);
            if (!h.node_ops.getattr) throw new l.ErrnoError(63);
          ...
          chmod(n, o, s) {
            var h;
            if (typeof n == "string") {
              var p = l.lookupPath(n, { follow: !s });
              h = p.node;
            } else h = n;
            if (!h.node_ops.setattr) throw new l.ErrnoError(63);
            h.node_ops.setattr(h, {
              mode: (o & 4095) | (h.mode & -4096),
              timestamp: Date.now(),
            });
          },
          lchmod(n, o) {
          ...
          fchmod(n, o) {
            var s = l.getStreamChecked(n);
            l.chmod(s.node, o);
          },
          chown(n, o, s, h) {
            var p;
            if (typeof n == "string") {
              var y = l.lookupPath(n, { follow: !h });
              p = y.node;
            } else p = n;
            if (!p.node_ops.setattr) throw new l.ErrnoError(63);
          ...
          fchown(n, o, s) {
            var h = l.getStreamChecked(n);
            l.chown(h.node, o, s);
          },
          truncate(n, o) {
            if (o < 0) throw new l.ErrnoError(28);
            var s;
            if (typeof n == "string") {
              var h = l.lookupPath(n, { follow: !0 });
              s = h.node;
            } else s = n;
            if (!s.node_ops.setattr) throw new l.ErrnoError(63);
            if (l.isDir(s.mode)) throw new l.ErrnoError(31);
            if (!l.isFile(s.mode)) throw new l.ErrnoError(28);
            var p = l.nodePermissions(s, "w");
            if (p) throw new l.ErrnoError(p);
            s.node_ops.setattr(s, { size: o, timestamp: Date.now() });
          },
          ftruncate(n, o) {
            var s = l.getStreamChecked(n);
            if (!(s.flags & 2097155)) throw new l.ErrnoError(28);
            l.truncate(s.node, o);
          },
          utime(n, o, s) {
            var h = l.lookupPath(n, { follow: !0 }),
              p = h.node;
            p.node_ops.setattr(p, { timestamp: Math.max(o, s) });
          },
          open(n, o, s = 438) {
            if (n === "") throw new l.ErrnoError(44);
            ((o = typeof o == "string" ? Mi(o) : o),
              o & 64 ? (s = (s & 4095) | 32768) : (s = 0));
            var h;
            if (typeof n == "object") h = n;
            else {
              n = ct.normalize(n);
              try {
                var p = l.lookupPath(n, { follow: !(o & 131072) });
                h = p.node;
              } catch {}
            }
            var y = !1;
            if (o & 64)
              if (h) {
                if (o & 128) throw new l.ErrnoError(20);
              } else ((h = l.mknod(n, s, 0)), (y = !0));
            if (!h) throw new l.ErrnoError(44);
            if (
              (l.isChrdev(h.mode) && (o &= -513), o & 65536 && !l.isDir(h.mode))
            )
            ...
            (o & 512 && !y && l.truncate(h, 0), (o &= -131713));
            var m = l.createStream({
              node: h,
              path: l.getPath(h),
              flags: o,
              seekable: !0,
              position: 0,
              stream_ops: h.stream_ops,
              ungotten: [],
              error: !1,
            });
            return (m.stream_ops.open && m.stream_ops.open(m), m);
          },
          close(n) {
            if (l.isClosed(n)) throw new l.ErrnoError(8);
          ...
          llseek(n, o, s) {
            if (l.isClosed(n)) throw new l.ErrnoError(8);
            if (!n.seekable || !n.stream_ops.llseek) throw new l.ErrnoError(70);
            if (s != 0 && s != 1 && s != 2) throw new l.ErrnoError(28);
            return (
              (n.position = n.stream_ops.llseek(n, o, s)),
              (n.ungotten = []),
              n.position
            );
          },
          read(n, o, s, h, p) {
            if (h < 0 || p < 0) throw new l.ErrnoError(28);
            if (l.isClosed(n)) throw new l.ErrnoError(8);
            if ((n.flags & 2097155) === 1) throw new l.ErrnoError(8);
            if (l.isDir(n.node.mode)) throw new l.ErrnoError(31);
            if (!n.stream_ops.read) throw new l.ErrnoError(28);
            var y = typeof p < "u";
            if (!y) p = n.position;
            else if (!n.seekable) throw new l.ErrnoError(70);
            var w = n.stream_ops.read(n, o, s, h, p);
            return (y || (n.position += w), w);
          },
          write(n, o, s, h, p, y) {
            if (h < 0 || p < 0) throw new l.ErrnoError(28);
            if (l.isClosed(n)) throw new l.ErrnoError(8);
            if (!(n.flags & 2097155)) throw new l.ErrnoError(8);
            if (l.isDir(n.node.mode)) throw new l.ErrnoError(31);
            if (!n.stream_ops.write) throw new l.ErrnoError(28);
            n.seekable && n.flags & 1024 && l.llseek(n, 0, 2);
            var w = typeof p < "u";
            if (!w) p = n.position;
            else if (!n.seekable) throw new l.ErrnoError(70);
            var m = n.stream_ops.write(n, o, s, h, p, y);
            return (w || (n.position += m), m);
          },
          allocate(n, o, s) {
            if (l.isClosed(n)) throw new l.ErrnoError(8);
            if (o < 0 || s <= 0) throw new l.ErrnoError(28);
            if (!(n.flags & 2097155)) throw new l.ErrnoError(8);
            if (!l.isFile(n.node.mode) && !l.isDir(n.node.mode))
              throw new l.ErrnoError(43);
            if (!n.stream_ops.allocate) throw new l.ErrnoError(138);
            n.stream_ops.allocate(n, o, s);
          },
          mmap(n, o, s, h, p) {
            if (h & 2 && !(p & 2) && (n.flags & 2097155) !== 2)
              throw new l.ErrnoError(2);
            if ((n.flags & 2097155) === 1) throw new l.ErrnoError(2);
            if (!n.stream_ops.mmap) throw new l.ErrnoError(43);
            if (!o) throw new l.ErrnoError(28);
            return n.stream_ops.mmap(n, o, s, h, p);
          },
          msync(n, o, s, h, p) {
            return n.stream_ops.msync ? n.stream_ops.msync(n, o, s, h, p) : 0;
          },
          ioctl(n, o, s) {
            if (!n.stream_ops.ioctl) throw new l.ErrnoError(59);
            return n.stream_ops.ioctl(n, o, s);
          },
          readFile(n, o = {}) {
            if (
              ((o.flags = o.flags || 0),
              (o.encoding = o.encoding || "binary"),
              o.encoding !== "utf8" && o.encoding !== "binary")
            )
              throw new Error(`Invalid encoding type "${o.encoding}"`);
            var s,
              h = l.open(n, o.flags),
              p = l.stat(n),
              y = p.size,
          ...
          writeFile(n, o, s = {}) {
            s.flags = s.flags || 577;
            var h = l.open(n, s.flags, s.mode);
            if (typeof o == "string") {
              var p = new Uint8Array(Ne(o) + 1),
                y = Ve(o, p, 0, p.length);
              l.write(h, p, 0, y, void 0, s.canOwn);
            } else if (ArrayBuffer.isView(o))
              l.write(h, o, 0, o.byteLength, void 0, s.canOwn);
          ...
          chdir(n) {
            var o = l.lookupPath(n, { follow: !0 });
            if (o.node === null) throw new l.ErrnoError(44);
            if (!l.isDir(o.node.mode)) throw new l.ErrnoError(54);
            var s = l.nodePermissions(o.node, "x");
            if (s) throw new l.ErrnoError(s);
            l.currentPath = o.path;
          },
          ...
          createDefaultDevices() {
            (l.mkdir("/dev"),
              l.registerDevice(l.makedev(1, 3), {
                read: () => 0,
                write: (h, p, y, w, m) => w,
                llseek: () => 0,
              }),
              l.mkdev("/dev/null", l.makedev(1, 3)),
              kt.register(l.makedev(5, 0), kt.default_tty_ops),
              kt.register(l.makedev(6, 0), kt.default_tty1_ops),
              l.mkdev("/dev/tty", l.makedev(5, 0)),
              l.mkdev("/dev/tty1", l.makedev(6, 0)));
            var n = new Uint8Array(1024),
              o = 0,
              s = () => (o === 0 && (o = zr(n).byteLength), n[--o]);
            (l.createDevice("/dev", "random", s),
              l.createDevice("/dev", "urandom", s),
              l.mkdir("/dev/shm"),
              l.mkdir("/dev/shm/tmp"));
          },
          createSpecialDirectories() {
            l.mkdir("/proc");
            var n = l.mkdir("/proc/self");
            (l.mkdir("/proc/self/fd"),
              l.mount(
                {
                  mount() {
                    var o = l.createNode(n, "fd", 16895, 73);
                    return (
                      (o.node_ops = {
                        lookup(s, h) {
                          var p = +h,
                            y = l.getStreamChecked(p),
                            w = {
                              parent: null,
                              mount: { mountpoint: "fake" },
                              node_ops: { readlink: () => y.path },
                            };
                          return ((w.parent = w), w);
                        },
                      }),
          ...
          createStandardStreams(n, o, s) {
            (n
              ? l.createDevice("/dev", "stdin", n)
              : l.symlink("/dev/tty", "/dev/stdin"),
              o
                ? l.createDevice("/dev", "stdout", null, o)
                : l.symlink("/dev/tty", "/dev/stdout"),
              s
                ? l.createDevice("/dev", "stderr", null, s)
                : l.symlink("/dev/tty1", "/dev/stderr"),
              l.open("/dev/stdin", 0),
              l.open("/dev/stdout", 1),
              l.open("/dev/stderr", 1));
          },
          staticInit() {
            ((l.nameTable = new Array(4096)),
              l.mount(X, {}, "/"),
              l.createDefaultDirectories(),
              l.createDefaultDevices(),
              l.createSpecialDirectories(),
              (l.filesystems = { MEMFS: X }));
          },
          init(n, o, s) {
            ((l.initialized = !0), l.createStandardStreams(n, o, s));
          },
          quit() {
            l.initialized = !1;
            for (var n = 0; n < l.streams.length; n++) {
              var o = l.streams[n];
              o && l.close(o);
            }
          },
          findObject(n, o) {
            var s = l.analyzePath(n, o);
          ...
          analyzePath(n, o) {
            ...
            try {
              var s = l.lookupPath(n, { parent: !0 });
              ((h.parentExists = !0),
                (h.parentPath = s.path),
                (h.parentObject = s.node),
                (h.name = ct.basename(n)),
                (s = l.lookupPath(n, { follow: !o })),
                (h.exists = !0),
                (h.path = s.path),
                (h.object = s.node),
                (h.name = s.node.name),
          ...
          createPath(n, o, s, h) {
            n = typeof n == "string" ? n : l.getPath(n);
          ...
          createFile(n, o, s, h, p) {
            var y = ct.join2(typeof n == "string" ? n : l.getPath(n), o),
              w = qe(h, p);
            return l.create(y, w);
          },
          createDataFile(n, o, s, h, p, y) {
            var w = o;
            n &&
              ((n = typeof n == "string" ? n : l.getPath(n)),
              (w = o ? ct.join2(n, o) : n));
            ...
            if (s) {
              if (typeof s == "string") {
                for (
                  var j = new Array(s.length), et = 0, ot = s.length;
                  et < ot;
                  ++et
                )
                  j[et] = s.charCodeAt(et);
                s = j;
              }
              l.chmod($, m | 146);
              var J = l.open($, 577);
              (l.write(J, s, 0, s.length, 0, y), l.close(J), l.chmod($, m));
            }
          },
          createDevice(n, o, s, h) {
            var p = ct.join2(typeof n == "string" ? n : l.getPath(n), o),
              y = qe(!!s, !!h);
            l.createDevice.major ??= 64;
            var w = l.makedev(l.createDevice.major++, 0);
            return (
              l.registerDevice(w, {
                open(m) {
                  m.seekable = !1;
                ...
                read(m, $, j, et, ot) {
                  for (var J = 0, K = 0; K < et; K++) {
                    ...
                    if (nt === void 0 && J === 0) throw new l.ErrnoError(6);
                    if (nt == null) break;
                    (J++, ($[j + K] = nt));
                  }
                  return (J && (m.node.timestamp = Date.now()), J);
                },
                write(m, $, j, et, ot) {
                  for (var J = 0; J < et; J++)
                    try {
                  ...
                  return (et && (m.node.timestamp = Date.now()), J);
                },
              }),
              l.mkdev(p, y, w)
            );
          ...
          forceLoadFile(n) {
            ...
            try {
              ((n.contents = b(n.url)), (n.usedBytes = n.contents.length));
            } catch {
              throw new l.ErrnoError(29);
            }
          },
          createLazyFile(n, o, s, h, p) {
            class y {
              lengthKnown = !1;
              chunks = [];
              get(K) {
                if (!(K > this.length - 1 || K < 0)) {
                  var nt = K % this.chunkSize,
                    xt = (K / this.chunkSize) | 0;
                  return this.getter(xt)[nt];
                }
              }
              setDataGetter(K) {
                this.getter = K;
              ...
              cacheLength() {
                ...
                if (
                  (K.open("HEAD", s, !1),
                  K.send(null),
                  !((K.status >= 200 && K.status < 300) || K.status === 304))
                )
                  throw new Error(
                    "Couldn't load " + s + ". Status: " + K.status,
                  );
                var nt = Number(K.getResponseHeader("Content-length")),
                  xt,
                  Ft =
                    (xt = K.getResponseHeader("Accept-Ranges")) &&
                    xt === "bytes",
                  bt =
                    (xt = K.getResponseHeader("Content-Encoding")) &&
                    xt === "gzip",
                  Ot = 1024 * 1024;
                Ft || (Ot = nt);
                var Rt = (zt, ie) => {
                    ...
                    if (ie > nt - 1)
                      throw new Error(
                        "only " + nt + " bytes available! programmer error!",
                      );
                    var mt = new XMLHttpRequest();
                    if (
                      (mt.open("GET", s, !1),
                      nt !== Ot &&
                        mt.setRequestHeader("Range", "bytes=" + zt + "-" + ie),
                      ...
                      mt.send(null),
                      !(
                        (mt.status >= 200 && mt.status < 300) ||
                        mt.status === 304
                      ))
                    )
                      throw new Error(
                        "Couldn't load " + s + ". Status: " + mt.status,
                      );
                    return mt.response !== void 0
                      ? new Uint8Array(mt.response || [])
                      : je(mt.responseText || "", !0);
                  },
                  de = this;
                (de.setDataGetter((zt) => {
                  var ie = zt * Ot,
                  ...
                  if (
                    ((mt = Math.min(mt, nt - 1)),
                    typeof de.chunks[zt] > "u" && (de.chunks[zt] = Rt(ie, mt)),
                    typeof de.chunks[zt] > "u")
                  )
            ...
            if (typeof XMLHttpRequest < "u") {
              ...
              var w, m;
            } else var m = { isDevice: !1, url: s };
            var $ = l.createFile(n, o, m, h, p);
            (m.contents
              ? ($.contents = m.contents)
              : m.url && (($.contents = null), ($.url = m.url)),
            ...
            var j = {},
              et = Object.keys($.stream_ops);
            et.forEach((J) => {
              var K = $.stream_ops[J];
              j[J] = (...nt) => (l.forceLoadFile($), K(...nt));
            });
            function ot(J, K, nt, xt, Ft) {
              var bt = J.node.contents;
              if (Ft >= bt.length) return 0;
              var Ot = Math.min(bt.length - Ft, xt);
              if (bt.slice)
                for (var Rt = 0; Rt < Ot; Rt++) K[nt + Rt] = bt[Ft + Rt];
              else for (var Rt = 0; Rt < Ot; Rt++) K[nt + Rt] = bt.get(Ft + Rt);
              return Ot;
            }
            return (
              (j.read = (J, K, nt, xt, Ft) => (
              ...
              (j.mmap = (J, K, nt, xt, Ft) => {
                l.forceLoadFile($);
                var bt = Yr(K);
                if (!bt) throw new l.ErrnoError(48);
                return (ot(J, O, bt, K, nt), { ptr: bt, allocated: !0 });
              }),
              ($.stream_ops = j),
              $
            );
        ...
        it = {
          DEFAULT_POLLMASK: 5,
          calculateAt(n, o, s) {
            if (ct.isAbs(o)) return o;
            var h;
            if (n === -100) h = l.cwd();
            else {
              var p = it.getStreamFromFD(n);
              h = p.path;
            }
            if (o.length == 0) {
              if (!s) throw new l.ErrnoError(44);
          ...
          doMsync(n, o, s, h, p) {
            if (!l.isFile(o.node.mode)) throw new l.ErrnoError(43);
            if (h & 2) return 0;
            var y = T.slice(n, n + s);
            l.msync(o, y, p, s, h);
          },
          getStreamFromFD(n) {
            var o = l.getStreamChecked(n);
            return o;
          },
          varargs: void 0,
          getStr(n) {
      ...
      function Fi(n, o, s, h) {
        try {
          if (((o = it.getStr(o)), (o = it.calculateAt(n, o)), s & -8))
            return -28;
          var p = l.lookupPath(o, { follow: !0 }),
            y = p.node;
          if (!y) return -44;
          var w = "";
          return (
      ...
      var Ee = () => {
          var n = D[+it.varargs >> 2];
          return ((it.varargs += 4), n);
        },
        ne = Ee;
      function Oi(n, o, s) {
        it.varargs = s;
        try {
          var h = it.getStreamFromFD(n);
          switch (o) {
            case 0: {
              var p = Ee();
              if (p < 0) return -28;
      ...
      function Ri(n, o) {
        try {
          var s = it.getStreamFromFD(n);
          return it.doStat(l.stat, s.path, o);
        } catch (h) {
          if (typeof l > "u" || h.name !== "ErrnoError") throw h;
          return -h.errno;
        }
      }
      function Si(n, o, s) {
          ...
          switch (o) {
            ...
            case 21505: {
              ...
              if (h.tty.ops.ioctl_tcgets) {
                var p = h.tty.ops.ioctl_tcgets(h),
                  y = ne();
                ((D[y >> 2] = p.c_iflag || 0),
                  (D[(y + 4) >> 2] = p.c_oflag || 0),
                  (D[(y + 8) >> 2] = p.c_cflag || 0),
                  (D[(y + 12) >> 2] = p.c_lflag || 0));
                for (var w = 0; w < 32; w++) O[y + w + 17] = p.c_cc[w] || 0;
                return 0;
              }
              return 0;
            }
            ...
            case 21508: {
              ...
              if (h.tty.ops.ioctl_tcsets) {
                for (
                  ...
                  ot.push(O[y + w + 17]);
                return h.tty.ops.ioctl_tcsets(h.tty, o, {
                  c_iflag: m,
                  c_oflag: $,
                  c_cflag: j,
                  c_lflag: et,
            ...
            case 21531: {
              var y = ne();
              return l.ioctl(h, o, y);
            }
            case 21523: {
              if (!h.tty) return -59;
              if (h.tty.ops.ioctl_tiocgwinsz) {
                var J = h.tty.ops.ioctl_tiocgwinsz(h.tty),
                  y = ne();
                ((P[y >> 1] = J[0]), (P[(y + 2) >> 1] = J[1]));
              }
              return 0;
            }
            case 21524:
      ...
      function $i(n, o, s, h) {
        try {
          ...
          return (
            (h = h & -6401),
            (o = it.calculateAt(n, o, y)),
            it.doStat(p ? l.lstat : l.stat, o, s)
          );
        } catch (w) {
          if (typeof l > "u" || w.name !== "ErrnoError") throw w;
          return -w.errno;
        }
      }
      function Pi(n, o, s, h) {
        it.varargs = h;
        try {
          ((o = it.getStr(o)), (o = it.calculateAt(n, o)));
          var p = h ? Ee() : 0;
          return l.open(o, s, p).fd;
        } catch (y) {
          if (typeof l > "u" || y.name !== "ErrnoError") throw y;
          return -y.errno;
        }
      }
      var he = (n, o, s) => Ve(n, T, o, s);
      function zi(n, o, s, h) {
        try {
          if (((o = it.getStr(o)), (o = it.calculateAt(n, o)), h <= 0))
            return -28;
          var p = l.readlink(o),
            y = Math.min(h, Ne(p)),
            w = O[s + y];
          return (he(p, s, h + 1), (O[s + y] = w), y);
        } catch (m) {
          if (typeof l > "u" || m.name !== "ErrnoError") throw m;
          return -m.errno;
        }
      ...
      function Ti(n) {
        try {
          return ((n = it.getStr(n)), l.rmdir(n), 0);
        } catch (o) {
      ...
      function Yi(n, o) {
        try {
          return ((n = it.getStr(n)), it.doStat(l.stat, n, o));
        } catch (s) {
      ...
      function Ci(n, o, s) {
        try {
          return (
            (o = it.getStr(o)),
            (o = it.calculateAt(n, o)),
            s === 0
              ? l.unlink(o)
              : s === 512
                ? l.rmdir(o)
                : N("Invalid flags passed to unlinkat"),
            0
          );
        } catch (h) {
          if (typeof l > "u" || h.name !== "ErrnoError") throw h;
      ...
      var Zi = () => N(""),
        Ui = 1,
        Wi = () => Ui,
        Hi = (n, o, s) => T.copyWithin(n, o, o + s),
        Je = (n, o) =>
          (o + 2097152) >>> 0 < 4194305 - !!n
            ? (n >>> 0) + o * 4294967296
            : NaN;
      function Ki(n, o, s, h, p, y, w, m) {
        var $ = Je(p, y);
        try {
          if (isNaN($)) return 61;
          var j = it.getStreamFromFD(h),
            et = l.mmap(j, n, $, o, s),
            ot = et.ptr;
          return ((D[w >> 2] = et.allocated), (Z[m >> 2] = ot), 0);
        } catch (J) {
          if (typeof l > "u" || J.name !== "ErrnoError") throw J;
          return -J.errno;
        }
      }
      function Qi(n, o, s, h, p, y, w) {
        var m = Je(y, w);
        try {
          var $ = it.getStreamFromFD(p);
          s & 2 && it.doMsync(n, $, o, h, m);
        } catch (j) {
          if (typeof l > "u" || j.name !== "ErrnoError") throw j;
          return -j.errno;
        }
      ...
      var Xi = (n, o, s, h) => {
          ...
          var et = (K) => {
              var nt = K >= 0 ? "-" : "+",
                xt = Math.abs(K),
                Ft = String(Math.floor(xt / 60)).padStart(2, "0"),
                bt = String(xt % 60).padStart(2, "0");
              return `UTC${nt}${Ft}${bt}`;
            },
            ot = et(m),
            J = et($);
          $ < m ? (he(ot, s, 17), he(J, h, 17)) : (he(ot, h, 17), he(J, s, 17));
        },
        Ae = [],
        Ni = (n, o) => {
          Ae.length = 0;
          for (var s; (s = T[n++]); ) {
            ...
            ((h &= s != 112),
              (o += h && o % 8 ? 4 : 0),
              Ae.push(s == 112 ? Z[o >> 2] : s == 105 ? D[o >> 2] : ht[o >> 3]),
              (o += h ? 8 : 4));
          }
          return Ae;
        },
        ...
        Ji = (n) => {
          var o = M.buffer,
            s = ((n - o.byteLength + 65535) / 65536) | 0;
          try {
            return (M.grow(s), ft(), 1);
          } catch {}
        },
        Ai = (n) => {
          var o = T.length;
          ...
          for (var h = 1; h <= 4; h *= 2) {
            var p = o * (1 + 0.2 / h);
            p = Math.min(p, n + 100663296);
            var y = Math.min(s, ke(Math.max(n, p), 65536)),
              w = Ji(y);
            if (w) return !0;
          }
          return !1;
        ...
        fe = () => {
          if (!fe.strings) {
            ...
            for (var s in tr) tr[s] === void 0 ? delete o[s] : (o[s] = tr[s]);
            var h = [];
            for (var s in o) h.push(`${s}=${o[s]}`);
            fe.strings = h;
          }
          return fe.strings;
        },
        eo = (n, o) => {
          for (var s = 0; s < n.length; ++s) O[o++] = n.charCodeAt(s);
          O[o] = 0;
        },
        ro = (n, o) => {
          var s = 0;
          return (
            fe().forEach((h, p) => {
              var y = o + s;
              ((Z[(n + p * 4) >> 2] = y), eo(h, y), (s += h.length + 1));
            }),
            0
          );
        },
        no = (n, o) => {
          ...
          Z[n >> 2] = s.length;
          var h = 0;
          return (s.forEach((p) => (h += p.length + 1)), (Z[o >> 2] = h), 0);
        },
        io = (n) => {
          d(n, new Qe(n));
        },
      ...
      var uo = (n, o, s, h) => {
        for (var p = 0, y = 0; y < s; y++) {
          var w = Z[o >> 2],
            m = Z[(o + 4) >> 2];
          o += 8;
          var $ = l.read(n, O, w, m, h);
          if ($ < 0) return -1;
          if (((p += $), $ < m)) break;
        }
        return p;
      ...
      function lo(n, o, s, h, p) {
        var y = Je(o, s);
        try {
          if (isNaN(y)) return 61;
          var w = it.getStreamFromFD(n);
          return (
            l.llseek(w, y, h),
            (pt = [
              w.position >>> 0,
            ...
            (D[p >> 2] = pt[0]),
            (D[(p + 4) >> 2] = pt[1]),
            w.getdents && y === 0 && h === 0 && (w.getdents = null),
            0
          );
        } catch (m) {
          if (typeof l > "u" || m.name !== "ErrnoError") throw m;
      ...
      ((l.createPreloadedFile = Gi),
        l.staticInit(),
        (X.doesNotExistError = new l.ErrnoError(44)),
        (X.doesNotExistError.stack = "<generic error, no stack>"));
      var po = {
          a: le,
          i: Fi,
          f: Oi,
        ...
        lt = Mt();
      ((r._webidl_free = (n) => (r._webidl_free = lt.D)(n)),
        (r._free = (n) => (r._free = lt.E)(n)),
        (r._webidl_malloc = (n) => (r._webidl_malloc = lt.F)(n)),
        (r._malloc = (n) => (r._malloc = lt.G)(n)));
      var Cr = (r._emscripten_bind_VoidPtr___destroy___0 = (n) =>
          (Cr = r._emscripten_bind_VoidPtr___destroy___0 = lt.H)(n)),
        Zr = (r._emscripten_bind_Graphviz_Graphviz_2 = (n, o) =>
          (Zr = r._emscripten_bind_Graphviz_Graphviz_2 = lt.I)(n, o)),
        Ur = (r._emscripten_bind_Graphviz_version_0 = () =>
          (Ur = r._emscripten_bind_Graphviz_version_0 = lt.J)()),
        Wr = (r._emscripten_bind_Graphviz_lastError_0 = () =>
          (Wr = r._emscripten_bind_Graphviz_lastError_0 = lt.K)()),
        Hr = (r._emscripten_bind_Graphviz_createFile_2 = (n, o, s) =>
          (Hr = r._emscripten_bind_Graphviz_createFile_2 = lt.L)(n, o, s)),
        Kr = (r._emscripten_bind_Graphviz_layout_3 = (n, o, s, h) =>
          (Kr = r._emscripten_bind_Graphviz_layout_3 = lt.M)(n, o, s, h)),
        Qr = (r._emscripten_bind_Graphviz_acyclic_3 = (n, o, s, h) =>
          (Qr = r._emscripten_bind_Graphviz_acyclic_3 = lt.N)(n, o, s, h)),
        Xr = (r._emscripten_bind_Graphviz_tred_3 = (n, o, s, h) =>
          (Xr = r._emscripten_bind_Graphviz_tred_3 = lt.O)(n, o, s, h)),
        Nr = (r._emscripten_bind_Graphviz_unflatten_4 = (n, o, s, h, p) =>
          (Nr = r._emscripten_bind_Graphviz_unflatten_4 = lt.P)(n, o, s, h, p)),
        Vr = (r._emscripten_bind_Graphviz_get_layout_result_0 = (n) =>
          (Vr = r._emscripten_bind_Graphviz_get_layout_result_0 = lt.Q)(n)),
        jr = (r._emscripten_bind_Graphviz_set_layout_result_1 = (n, o) =>
          (jr = r._emscripten_bind_Graphviz_set_layout_result_1 = lt.R)(n, o)),
        kr = (r._emscripten_bind_Graphviz_get_acyclic_outFile_0 = (n) =>
          (kr = r._emscripten_bind_Graphviz_get_acyclic_outFile_0 = lt.S)(n)),
        qr = (r._emscripten_bind_Graphviz_set_acyclic_outFile_1 = (n, o) =>
          (qr = r._emscripten_bind_Graphviz_set_acyclic_outFile_1 = lt.T)(
            n,
            o,
          )),
        Jr = (r._emscripten_bind_Graphviz_get_acyclic_num_rev_0 = (n) =>
          (Jr = r._emscripten_bind_Graphviz_get_acyclic_num_rev_0 = lt.U)(n)),
        Ar = (r._emscripten_bind_Graphviz_set_acyclic_num_rev_1 = (n, o) =>
          (Ar = r._emscripten_bind_Graphviz_set_acyclic_num_rev_1 = lt.V)(
            n,
            o,
          )),
        tn = (r._emscripten_bind_Graphviz_get_tred_out_0 = (n) =>
          (tn = r._emscripten_bind_Graphviz_get_tred_out_0 = lt.W)(n)),
        en = (r._emscripten_bind_Graphviz_set_tred_out_1 = (n, o) =>
          (en = r._emscripten_bind_Graphviz_set_tred_out_1 = lt.X)(n, o)),
        rn = (r._emscripten_bind_Graphviz_get_tred_err_0 = (n) =>
          (rn = r._emscripten_bind_Graphviz_get_tred_err_0 = lt.Y)(n)),
        nn = (r._emscripten_bind_Graphviz_set_tred_err_1 = (n, o) =>
          (nn = r._emscripten_bind_Graphviz_set_tred_err_1 = lt.Z)(n, o)),
        on = (r._emscripten_bind_Graphviz___destroy___0 = (n) =>
          (on = r._emscripten_bind_Graphviz___destroy___0 = lt._)(n)),
        an = (n, o) => (an = lt.aa)(n, o);
      r.UTF8ToString = Lt;
      var xe;
      z = function n() {
      ...
      function sn() {
        if (S > 0 || (k(), S > 0)) return;
        function n() {
          xe || ((xe = !0), (r.calledRun = !0), !G && (g(), i(r), I()));
        }
        n();
      }
      sn();
      function It() {}
      ((It.prototype = Object.create(It.prototype)),
        (It.prototype.constructor = It),
        (It.prototype.__class__ = It),
        (It.__cache__ = {}),
        (r.WrapperObject = It));
      function be(n) {
        return (n || It).__cache__;
      }
      r.getCache = be;
      function er(n, o) {
        var s = be(o),
        ...
        return (
          h ||
          ((h = Object.create((o || It).prototype)), (h.ptr = n), (s[n] = h))
        );
      }
      r.wrapPointer = er;
      function _o(n, o) {
      ...
      ((r.castObject = _o), (r.NULL = er(0)));
      function vo(n) {
        if (!n.__destroy__)
          throw "Error: Cannot destroy object. (Did you create it yourself?)";
        (n.__destroy__(), delete be(n.__class__)[n.ptr]);
      }
      r.destroy = vo;
      function yo(n, o) {
        return n.ptr === o.ptr;
      ...
      var tt = {
        ...
        prepare() {
          if (tt.needed) {
            for (var n = 0; n < tt.temps.length; n++)
              r._webidl_free(tt.temps[n]);
            ((tt.temps.length = 0),
              r._webidl_free(tt.buffer),
              (tt.buffer = 0),
              (tt.size += tt.needed),
              (tt.needed = 0));
          }
          (tt.buffer ||
            ((tt.size += 128),
            (tt.buffer = r._webidl_malloc(tt.size)),
            Y(tt.buffer)),
            (tt.pos = 0));
        },
        alloc(n, o) {
          Y(tt.buffer);
          var s = o.BYTES_PER_ELEMENT,
            h = n.length * s;
          h = ke(h, 8);
          var p;
          return (
            tt.pos + h >= tt.size
              ? (Y(h > 0),
                (tt.needed += h),
                (p = r._webidl_malloc(h)),
                tt.temps.push(p))
              : ((p = tt.buffer + tt.pos), (tt.pos += h)),
            p
          );
        },
        copy(n, o, s) {
          s /= o.BYTES_PER_ELEMENT;
          for (var h = 0; h < n.length; h++) o[s + h] = n[h];
        },
      };
      function Dt(n) {
        if (typeof n == "string") {
      ...
      ((Wt.prototype = Object.create(It.prototype)),
        (Wt.prototype.constructor = Wt),
        (Wt.prototype.__class__ = Wt),
        (Wt.__cache__ = {}),
        (r.VoidPtr = Wt),
        (Wt.prototype.__destroy__ = Wt.prototype.__destroy__ =
          function () {
            var n = this.ptr;
            Cr(n);
          }));
      ...
      return (
        (C.prototype = Object.create(It.prototype)),
        (C.prototype.constructor = C),
        (C.prototype.__class__ = C),
        (C.__cache__ = {}),
        (r.Graphviz = C),
        (C.prototype.version = C.prototype.version =
          function () {
            return Lt(Ur());
          }),
        (C.prototype.lastError = C.prototype.lastError =
          function () {
            return Lt(Wr());
          }),
        (C.prototype.createFile = C.prototype.createFile =
          function (n, o) {
            var s = this.ptr;
            (tt.prepare(),
              n && typeof n == "object" ? (n = n.ptr) : (n = Dt(n)),
              o && typeof o == "object" ? (o = o.ptr) : (o = Dt(o)),
              Hr(s, n, o));
          }),
        (C.prototype.layout = C.prototype.layout =
          function (n, o, s) {
            var h = this.ptr;
            return (
              tt.prepare(),
              n && typeof n == "object" ? (n = n.ptr) : (n = Dt(n)),
              o && typeof o == "object" ? (o = o.ptr) : (o = Dt(o)),
              s && typeof s == "object" ? (s = s.ptr) : (s = Dt(s)),
              Lt(Kr(h, n, o, s))
            );
          }),
        (C.prototype.acyclic = C.prototype.acyclic =
          function (n, o, s) {
            var h = this.ptr;
            return (
              tt.prepare(),
              n && typeof n == "object" ? (n = n.ptr) : (n = Dt(n)),
              o && typeof o == "object" && (o = o.ptr),
              s && typeof s == "object" && (s = s.ptr),
              !!Qr(h, n, o, s)
            );
          }),
        (C.prototype.tred = C.prototype.tred =
          function (n, o, s) {
            var h = this.ptr;
            (tt.prepare(),
              n && typeof n == "object" ? (n = n.ptr) : (n = Dt(n)),
        ...
        (C.prototype.unflatten = C.prototype.unflatten =
          function (n, o, s, h) {
            var p = this.ptr;
            return (
              tt.prepare(),
        ...
        (C.prototype.get_layout_result = C.prototype.get_layout_result =
          function () {
            var n = this.ptr;
            return Lt(Vr(n));
          }),
        (C.prototype.set_layout_result = C.prototype.set_layout_result =
          function (n) {
            var o = this.ptr;
            (tt.prepare(),
              n && typeof n == "object" ? (n = n.ptr) : (n = Dt(n)),
        ...
        Object.defineProperty(C.prototype, "layout_result", {
          get: C.prototype.get_layout_result,
          set: C.prototype.set_layout_result,
        }),
        (C.prototype.get_acyclic_outFile = C.prototype.get_acyclic_outFile =
          function () {
            var n = this.ptr;
            return Lt(kr(n));
          }),
        (C.prototype.set_acyclic_outFile = C.prototype.set_acyclic_outFile =
          function (n) {
            var o = this.ptr;
            (tt.prepare(),
              n && typeof n == "object" ? (n = n.ptr) : (n = Dt(n)),
        ...
        Object.defineProperty(C.prototype, "acyclic_outFile", {
          get: C.prototype.get_acyclic_outFile,
          set: C.prototype.set_acyclic_outFile,
        }),
        (C.prototype.get_acyclic_num_rev = C.prototype.get_acyclic_num_rev =
          function () {
            var n = this.ptr;
            return Jr(n);
          }),
        (C.prototype.set_acyclic_num_rev = C.prototype.set_acyclic_num_rev =
          function (n) {
            var o = this.ptr;
            (n && typeof n == "object" && (n = n.ptr), Ar(o, n));
          }),
        Object.defineProperty(C.prototype, "acyclic_num_rev", {
          get: C.prototype.get_acyclic_num_rev,
          set: C.prototype.set_acyclic_num_rev,
        }),
        (C.prototype.get_tred_out = C.prototype.get_tred_out =
          function () {
            var n = this.ptr;
            return Lt(tn(n));
          }),
        (C.prototype.set_tred_out = C.prototype.set_tred_out =
          function (n) {
            var o = this.ptr;
            (tt.prepare(),
              n && typeof n == "object" ? (n = n.ptr) : (n = Dt(n)),
        ...
        Object.defineProperty(C.prototype, "tred_out", {
          get: C.prototype.get_tred_out,
          set: C.prototype.set_tred_out,
        }),
        (C.prototype.get_tred_err = C.prototype.get_tred_err =
          function () {
            var n = this.ptr;
            return Lt(rn(n));
          }),
        (C.prototype.set_tred_err = C.prototype.set_tred_err =
          function (n) {
            var o = this.ptr;
            (tt.prepare(),
              n && typeof n == "object" ? (n = n.ptr) : (n = Dt(n)),
        ...
        Object.defineProperty(C.prototype, "tred_err", {
          get: C.prototype.get_tred_err,
          set: C.prototype.set_tred_err,
        }),
...
function tf(t, e) {
  ...
  [...r.files, ...Ah(r.images)].forEach((i) => t.createFile(i.path, i.data));
}
var di = class oe {
  constructor(e) {
    this._module = e;
  ...
  layout(e, r = "svg", i = "dot", a) {
    if (!e) return "";
    let c = new this._module.Graphviz(a?.yInvert ? 1 : 0, a?.nop ? a?.nop : 0),
      u = "",
      f = "";
    try {
      tf(c, a);
      ...
      this._module.destroy(c);
    }
    if (!u && f) throw (oe.unload(), new Error(f));
    return u;
  }
  acyclic(e, r = !1, i = !1) {
    if (!e) return { acyclic: !1, num_rev: 0, outFile: "" };
    let a = new this._module.Graphviz(),
      c = !1,
      u = 0,
      f = "",
      d = "";
    ...
    if (d) throw (oe.unload(), new Error(d));
    return { acyclic: c, num_rev: u, outFile: f };
  }
  tred(e, r = !1, i = !1) {
    if (!e) return { out: "", err: "" };
    let a = new this._module.Graphviz(),
    ...
    try {
      try {
        (a.tred(e, r, i), (c = a.tred_out), (u = a.tred_err));
      } catch (d) {
        f = d.message;
      }
      f = a.lastError() || f;
    ...
    if (!c && f) throw (oe.unload(), new Error(f));
    return { out: c, err: u };
  }
  unflatten(e, r = 0, i = !1, a = 0) {
    if (!e) return "";
    let c = new this._module.Graphviz(),
      u = "",
      f = "";
    try {
      try {
        u = c.unflatten(e, r, i, a);
      } catch (d) {
        f = d.message;
      }
      f = c.lastError() || f;
  ...
  circo(e, r = "svg", i) {
    return this.layout(e, r, "circo", i);
  }
  dot(e, r = "svg", i) {
    return this.layout(e, r, "dot", i);
  }
  fdp(e, r = "svg", i) {
    return this.layout(e, r, "fdp", i);
  }
  sfdp(e, r = "svg", i) {
    return this.layout(e, r, "sfdp", i);
  }
  neato(e, r = "svg", i) {
    return this.layout(e, r, "neato", i);
  }
  osage(e, r = "svg", i) {
    return this.layout(e, r, "osage", i);
  }
  patchwork(e, r = "svg", i) {
    return this.layout(e, r, "patchwork", i);
  }
  twopi(e, r = "svg", i) {
    return this.layout(e, r, "twopi", i);
  }
  nop(e) {
  ...
  if (t.tag == "polygon") {
    ...
    if (e.tag == "polygon") {
      ...
      for (
        ...
        if (M != 0) {
          var G = v - (x * B) / M;
          if (0 <= G && G < 1 / 0 && ((v <= G && G <= E) || (E <= G && G <= v)))
            break;
        }
      }
      var Y = [[u.cx + G, u.cy + 0].join(",")];
      ((Y = Y.concat(d.slice(b))),
        (Y = Y.concat(d.slice(0, b))),
        (c = Y.join(" ")));
    }
    ((a.d = "M" + c + "z"), delete a.points, (r.attributes = a));
  } else {
    var r = Le(t);
    r.tag = "path";
    var i = t.attributes,
    ...
    if (e.tag == "polygon") {
      var u = e.bbox;
      ((u.cx = u.x + u.width / 2), (u.cy = u.y + u.height / 2));
      var Z = e.attributes.points.split(" ")[0].split(","),
        ht = Z[0],
        ft = Z[1],
        B = ht - u.cx,
        M = ft - u.cy,
        dt = Math.sqrt(Math.pow(B, 2) + Math.pow(M, 2)),
        F = B / dt,
        H = -M / dt;
    } else
      var F = 1,
...
function ef(c, e, r) {
  var a = c.split(" "),
    ...
    i = a.map(function (u) {
      return [Vt(+e + +u.split(",")[0]), Vt(+r + +u.split(",")[1])];
    }),
    a = i.map(function (u) {
      return u.join(",");
    }),
...
function rf(t, e, r) {
  ...
  return (
    (t = i
      .reduce(function (u, f, d) {
        return u.concat(f, c[d]);
      }, [])
      .join("")),
    t
  );
...
function nf() {
  try {
    di.load().then((r) => {
      (r.layout("", "svg", "dot"),
        (this.layoutSync = r.layout.bind(r)),
        this._worker == null && this._dispatch.call("initEnd", this),
  ...
  if (this._worker != null) {
    var t = this._vizURL,
      e = this;
    ((this._workerPort.onmessage = function (r) {
      var i = e._workerCallbacks.shift();
      i.call(e, r);
    }),
      t.match(/^https?:\/\/|^\/\//i) ||
        (t = new window.URL(t, document.location.href).href),
      wr.call(
        this,
        { type: "layout", dot: "", engine: "dot", vizURL: t },
        function (r) {
          r.data.type;
        },
      ),
      wr.call(this, { type: "version" }, function (r) {
        switch (r.data.type) {
          case "version":
            ((e._graphvizVersion = r.data.version),
...
function of(t, e, r, i) {
  if (this._worker)
    ...
    try {
      var a = this.layoutSync(t, "svg", e, r);
      i.call(this, { type: "done", svg: a });
    } catch (c) {
      i.call(this, { type: "error", error: c.message });
    }
}
function af(t, e) {
  var r = this;
  this._worker;
  var i = this._options.engine,
    a = this._images;
  (this._dispatch.call("start", this),
    (this._busy = !0),
    this._dispatch.call("layoutStart", this));
  var c = { images: a };
  return !this._worker && this.layoutSync == null
    ? ((this._afterInit = this.dot.bind(this, t, e)), this)
    : (this.layout(t, i, c, function (u) {
        switch (u.type) {
          case "error":
            if (r._onerror) r._onerror(u.error);
            else throw u.error.message;
            break;
          case "done":
            var f = u.svg;
            sf.call(this, f, e);
...
function sf(t, e) {
  ...
  if (
    ...
    var c = +this._options.tweenPrecision.split("%")[0] / 100,
      u = this._options.tweenPrecision.includes("%");
  else
    var c = this._options.tweenPrecision,
      u = !1;
  var f = this._options.growEnteringEdges,
    d = {},
    _ = this._dictionary || {},
    v = {},
    x = this._nodeDictionary || {};
  function b(F, H) {
    var k = F.tag;
    if (r == "index") F.key = H;
    else if (k[0] != "#") {
      if (r == "id") F.key = F.attributes.id;
      else if (r == "title") {
        var g = F.children.find(function (I) {
          return I.tag == "title";
        });
        g &&
          (g.children.length > 0 ? (F.key = g.children[0].text) : (F.key = ""));
      }
    }
    F.key == null &&
      (a && (k == "ellipse" || k == "polygon") && (k = "path"),
      (F.key = k + "-" + H));
  }
  function E(F, H) {
    var k = (H ? H.id + "." : "") + F.key;
  ...
  function B(F, H) {
    a &&
      F.id in _ &&
      (H.tag == "polygon" || H.tag == "ellipse" || H.tag == "path") &&
      (H.tag != F.tag || F.tag == "polygon") &&
      (H.tag != "path" && (F.alternativeOld = wn(H, F)),
      F.tag != "path" && (F.alternativeNew = wn(F, H)));
  }
  function M(F, H) {
    if (
      i &&
      H &&
      (H.tag == "path" || (F.alternativeOld && F.alternativeOld.tag == "path"))
    ) {
      var k = (F.alternativeNew || F).attributes.d;
      if (F.alternativeOld) var g = pr(F.alternativeOld);
      else var g = pr(H);
      (F.alternativeOld || (F.alternativeOld = {})).points = bh(g, k, c, u);
    }
  }
  function G(F, H = 0, k) {
    (b(F, H), E(F, k));
  ...
  function Y(F) {
    var H = F.tag;
    if (f && F.parent && F.parent.attributes.class == "node" && H == "title") {
  ...
  function O(F) {
    var H = F.id,
      k = F.tag,
      g = _[H];
    if (f && !g && F.parent && hi(F) && (k == "path" || k == "polygon")) {
      if (k == "polygon") {
        var I = F.parent.children.find(function (A) {
          return A.tag == "path";
        });
        I && (F.totalLength = I.totalLength);
      }
      var L = Ih(F),
        S = L.children[0],
        z = S.text.split("->");
      z.length != 2 && (z = S.text.split("--"));
      var W = z[0],
        U = v[W];
      if (Object.hasOwn(x, W)) {
        var N = x[W],
          V = U.children.findIndex(function (A, wt) {
            return A.tag == "g";
          });
        if (V >= 0) {
          var Q = U.children[V].children.findIndex(function (A, wt) {
            return A.tag == "a";
          });
          U = U.children[V].children[Q];
        }
        var V = N.children.findIndex(function (A, wt) {
          return A.tag == "g";
        });
        if (V >= 0) {
          var Q = N.children[V].children.findIndex(function (wt, Zt) {
            return wt.tag == "a";
          });
          N = N.children[V].children[Q];
        }
        for (var rt = U.children, V = 0; V < rt.length; V++)
          if (
            rt[V].tag == "polygon" ||
            rt[V].tag == "ellipse" ||
            rt[V].tag == "path" ||
        ...
        for (var st = N.children, V = 0; V < st.length; V++)
          if (
            st[V].tag == "polygon" ||
            st[V].tag == "ellipse" ||
            st[V].tag == "path" ||
        ...
        ut && _t
          ? (F.offset = {
              x: ut.center.x - _t.center.x,
              y: ut.center.y - _t.center.y,
            })
          : (F.offset = { x: 0, y: 0 });
      }
    }
  ...
  var P = at(document.createDocumentFragment()).append("div"),
    D = new window.DOMParser(),
    Z = D.parseFromString(t, "image/svg+xml");
  P.append(function () {
  ...
  if (
    ...
    (this._data = ft),
    (this._dictionary = d),
    (this._nodeDictionary = v),
    (this._extractData = function (F, H, k) {
      var g = te(F);
      return (G(g, H, k), T(g), g);
    }),
    (this._busy = !1),
...
function cf(t) {
  return (
    t instanceof Function
      ...
      : (this._transition = Mr(t)),
    this
  );
}
function lf(t) {
  var e = this._selection,
    r = e.selectWithoutDataPropagation("svg");
  return r.size() != 0 ? gu(r.node(), t) : null;
}
function hf(t) {
  if (typeof t > "u") return Object.assign({}, this._options);
  for (var e of Object.keys(t)) this._options[e] = t[e];
  return this;
}
function ff(t) {
      ...
      t
        ? function () {
            ...
            if (
              ((b += "Event "),
              (b += St(" >2")(d) + " "),
              (b += _ + " ".repeat(a - _.length)),
              (b += St(" >5")(v - e) + " "),
              _ != "initEnd" && (b += St(" >5")(v - r.start[x])),
              _ == "dataProcessEnd" &&
                (b +=
                  " prepare                 " + St(" >5")(v - r.layoutEnd[x])),
              _ == "renderEnd" &&
                c._transition &&
                ((b +=
                  " transition start margin " +
                  St(" >5")(c._transition.delay() - (v - r.renderStart[x]))),
                (u = c._transition.delay()),
                (f = c._transition.duration())),
              _ == "transitionStart")
            ) {
              var E = v - r.renderStart[x];
              ((b +=
                " transition delay        " + St(" >5")(v - r.renderStart[x])),
                (b += " expected " + St(" >5")(u)),
                (b += " diff " + St(" >5")(E - u)));
            }
            if (_ == "transitionEnd") {
              var R = v - r.transitionStart[x];
              ((b += " transition duration     " + St(" >5")(R)),
                (b += " expected " + St(" >5")(f)),
                (b += " diff " + St(" >5")(R - f)));
            }
            (console.log(b), (e = v));
...
function Of(t, e, r, i, a, c = {}) {
  if (((a = Object.assign({}, a)), a.style && a.style.includes("invis")))
    var u = at(null);
  else {
    var f = this._selection,
      d = f.selectWithoutDataPropagation("svg"),
      _ = d.selectWithoutDataPropagation("g"),
      v = vi.call(this, a),
      x = te(v),
      u = _.append("g").data([x]);
    (we.call(u.node(), x), pi.call(this, u, t, e, r, i, a, c));
  }
  return (
    (this._drawnEdge = { g: u, x1: t, y1: e, x2: r, y2: i, attributes: a }),
    this
  );
}
function Rf(t, e, r, i, a = {}, c = {}) {
  if (!this._drawnEdge) throw Error("No edge has been drawn");
  var u = this._drawnEdge.g;
  if (
    ((a = Object.assign(this._drawnEdge.attributes, a)),
    (this._drawnEdge.x1 = t),
    (this._drawnEdge.y1 = e),
    (this._drawnEdge.x2 = r),
    (this._drawnEdge.y2 = i),
    u.empty() && !(a.style && a.style.includes("invis")))
  ) {
    var f = this._selection,
      d = f.selectWithoutDataPropagation("svg"),
      _ = d.selectWithoutDataPropagation("g"),
  ...
  return (u.empty() || pi.call(this, u, t, e, r, i, a, c), this);
}
function pi(t, e, r, i, a, c, u) {
  var f = vi.call(this, c),
    d = te(f);
  (t.data([d]), we.call(t.node(), d), _i(t, e, r, i, a, c, u));
}
function _i(t, e, r, i, a, c, u) {
  var f = u.shortening || 0,
    d = 10,
    _ = 7,
    v = 0.1,
    x = [
  ...
  if (
    ...
    var G = t
      ...
      Y = G.selectWithoutDataPropagation("path"),
      O = G.selectWithoutDataPropagation("polygon");
  else
    var Y = t.selectWithoutDataPropagation("path"),
      O = t.selectWithoutDataPropagation("polygon");
  var T = xo();
  (T.moveTo(e, r),
    T.lineTo(i, a),
    Y.attr("d", T),
  ...
  for (var Z = [], P = 0; P < x.length; P++) {
    var D = x[P];
    Z.push(D.join(","));
  }
  var ht = Z.join(" ");
  return (O.attr("points", ht), this);
}
function Sf(t, e, r = {}) {
  if (!this._drawnEdge) throw Error("No edge has been drawn");
  var i = this._drawnEdge.g,
    a = this._drawnEdge.x1,
    c = this._drawnEdge.y1,
    u = this._drawnEdge.attributes;
  return (
...
function mn() {
  if (!this._drawnEdge) return this;
...
function $f(t) {
  ...
  var r = e.selectWithoutDataPropagation("title");
  r.text(t);
  var i = this._selection,
    a = i.selectWithoutDataPropagation("svg"),
    c = a.selectWithoutDataPropagation("g"),
    u = c.datum(),
    f = this._extractData(e, u.children.length, c.datum());
  return (u.children.push(f), Pr(e, f), (this._drawnEdge = null), this);
}
function En() {
  return this._drawnEdge ? this._drawnEdge.g : at(null);
}
function vi(t) {
  var e = "";
  ...
  var i = "digraph {a -> b [" + e + "]}",
    ...
    u = c.parseFromString(a, "image/svg+xml"),
    f = at(document.createDocumentFragment()).append(function () {
      return u.documentElement;
    }),
    d = f.select(".edge");
  return d;
}
function Pf(t, e, r, i = {}, a = {}) {
  if (((i = Object.assign({}, i)), i.style && i.style.includes("invis")))
    var c = at(null);
  else {
    var u = this._selection,
      f = u.selectWithoutDataPropagation("svg"),
      d = f.selectWithoutDataPropagation("g"),
      _ = wi.call(this, r, i),
      v = te(_),
      c = d.append("g").data([v]);
    (we.call(c.node(), v), yi.call(this, c, t, e, r, i, a));
  }
  return (
    (this._drawnNode = { g: c, nodeId: r, x: t, y: e, attributes: i }),
    this
  );
}
function zf(t, e, r, i = {}, a = {}) {
  if (!this._drawnNode) throw Error("No node has been drawn");
  var c = this._drawnNode.g;
  if (
    (r == null && (r = this._drawnNode.nodeId),
    (i = Object.assign(this._drawnNode.attributes, i)),
    (this._drawnNode.nodeId = r),
    (this._drawnNode.x = t),
    (this._drawnNode.y = e),
    c.empty() && !(i.style && i.style.includes("invis")))
  ) {
    var u = this._selection,
      f = u.selectWithoutDataPropagation("svg"),
      d = f.selectWithoutDataPropagation("g"),
  ...
  return (c.empty() || yi.call(this, c, t, e, r, i, a), this);
}
function yi(t, e, r, i, a, c) {
  var u = wi.call(this, i, a),
    f = te(u);
  return (t.data([f]), we.call(t.node(), f), gi(t, e, r, a), this);
}
function gi(t, e, r, i, a) {
  if (i.URL || i.tooltip)
    var c = t
      .selectWithoutDataPropagation("g")
      .selectWithoutDataPropagation("a");
  else var c = t;
  var u = c.selectAll("ellipse,polygon,path,polyline"),
    f = t.selectWithoutDataPropagation("text");
  if (u.size() != 0) {
    var d = u.node().getBBox();
  ...
  return (
    u.each(function (_, v) {
      var x = at(this);
      if (x.attr("cx")) x.attr("cx", Vt(e)).attr("cy", Vt(r));
      else if (x.attr("points")) {
        var b = x.attr("points").trim();
        x.attr("points", ef(b, e - d.cx, r - d.cy));
      } else {
        var E = x.attr("d");
        x.attr("d", rf(E, e - d.cx, r - d.cy));
      }
    }),
    f.size() != 0 &&
      f
        .attr("x", Vt(+f.attr("x") + e - d.cx))
        .attr("y", Vt(+f.attr("y") + r - d.cy)),
    this
  );
}
function Tf(t, e, r = {}) {
...
function Yf(t) {
  ...
  var r = this._drawnNode.attributes,
    i = e.selectWithoutDataPropagation("title");
  if ((i.text(t), r.URL || r.tooltip)) {
    var a = e.selectWithoutDataPropagation("g"),
      c = a.selectWithoutDataPropagation("a");
    c.selectWithoutDataPropagation("ellipse,polygon,path,polyline");
    var u = c.selectWithoutDataPropagation("text");
  } else {
    e.selectWithoutDataPropagation("ellipse,polygon,path,polyline");
    var u = e.selectWithoutDataPropagation("text");
  }
  u.text(r.label || t);
  var f = this._selection,
    d = f.selectWithoutDataPropagation("svg"),
    _ = d.selectWithoutDataPropagation("g"),
    v = _.datum(),
    x = this._extractData(e, v.children.length, _.datum());
  return (v.children.push(x), Pr(e, x), (this._drawnNode = null), this);
}
function bn() {
  return this._drawnNode ? this._drawnNode.g : at(null);
}
function wi(t, e) {
  var r = "";
  for (var i of Object.keys(e))
    e[i] != null && (r += ' "' + i + '"="' + e[i] + '"');
  var a = 'graph {"' + t + '" [' + r + "]}",
    c = this.layoutSync(a, "svg", "dot"),
    u = new window.DOMParser(),
    f = u.parseFromString(c, "image/svg+xml"),
    d = at(document.createDocumentFragment()).append(function () {
  ...
  ((self.document = {}),
    t.addEventListener("message", function (e) {
      ...
      if (
        ...
        r.Graphviz.load().then((i) => {
          t.postMessage({ type: "version", version: i.version() });
        });
        return;
      }
      r.Graphviz.load()
        .then((i) => {
          ...
          a
            ? t.postMessage({ type: "done", svg: a })
            : e.data.vizURL
              ? t.postMessage({ type: "init" })
              : t.postMessage({ type: "skip" });
        })
        .catch((i) => {
          t.postMessage({ type: "error", error: i.message });
        });
    }));
}
function Cf() {
...
function mr(t, e) {
  if (
    ...
    for (var r of Object.keys(e)) this._options[r] = e[r];
  else typeof e == "boolean" && (this._options.useWorker = e);
  var i = this._options.useWorker,
    a = this._options.useSharedWorker;
  if (
    (typeof Worker > "u" && (i = !1),
    typeof SharedWorker > "u" && (a = !1),
    i || a)
  ) {
    var c = Ir("script"),
      u = c.filter(function () {
        return (
          at(this).attr("type") == "javascript/worker" ||
          (at(this).attr("src") &&
            at(this)
              .attr("src")
              .match(/.*\/@hpcc-js\/wasm/))
  ...
  if (a) {
    const _ =
      ...
      btoa(ze.toString() + "(" + Zf.toString() + ")()");
    ((this._worker = this._worker = new SharedWorker(_)),
    ...
    var f = new Blob([ze.toString() + "(" + Cf.toString() + ")()"]),
      d = window.URL.createObjectURL(f);
    ((this._worker = new Worker(d)),
    ...
    di.load().then(
      ((_) => {
        this._graphvizVersion = _.version();
      }).bind(this),
    );
  ((this._selection = t),
    (this._active = !1),
    ...
    (this._dispatch = Te(...this._eventTypes)),
    nf.call(this),
    (t.node().__graphviz__ = this));
}
function mi(t, e) {
  var r = at(t).graphviz(e);
  return r;
}
mr.prototype = mi.prototype = {
  constructor: mr,
  engine: yf,
  addImage: gf,
  keyMode: wf,
  ...
  tweenPaths: Ef,
  tweenShapes: xf,
  convertEqualSidedPolygons: bf,
  tweenPrecision: Bf,
  growEnteringEdges: Lf,
  zoom: vh,
  resetZoom: yh,
  zoomBehavior: mh,
  zoomSelection: Eh,
  zoomScaleExtent: gh,
  zoomTranslateExtent: wh,
  render: Dh,
  layout: of,
  dot: af,
  data: Bh,
  ...
  drawEdge: Of,
  updateDrawnEdge: Rf,
  moveDrawnEdgeEndPoint: Sf,
  insertDrawnEdge: $f,
  removeDrawnEdge: mn,
  removeDrawnEdge: mn,
  drawnEdgeSelection: En,
  drawnEdgeSelection: En,
  drawNode: Pf,
  updateDrawnNode: zf,
  moveDrawnNode: Tf,
...
function Wf(t) {
  return at(this.size() > 0 ? this.node().querySelector(t) : null);
}
jt.prototype.graphviz = Uf;
jt.prototype.selectWithoutDataPropagation = Wf;
const Hf = bo("div", { target: "e17jn71d0" })(
    ({ theme: t, shouldUseFullWidth: e, shouldUseFullHeight: r }) => ({
      "& *": {
...
function Qf({
  ...
  const a = `st-graphviz-chart-${t.elementId}`,
    { width: c, height: u, elementRef: f } = Bo(),
    { expanded: d, width: _, height: v, expand: x, collapse: b } = Lo(Oo),
    E = Io(r) || t.useContainerWidth,
    R = Do(i);
  return (
    Fn.useEffect(() => {
      try {
        const B = mi(`#${a}`).zoom(!1);
        (i?.useStretch && B.width(c < 0 ? 0 : c).height(u < 0 ? 0 : u),
          B.fit(!0).scale(1).engine(t.engine).renderDot(t.spec));
      } catch (B) {
        Kf.error(B);
      }
    }, [a, t.engine, t.spec, c, u, d, i?.useStretch]),
    Mo(cn, {
      width: _ ?? 0,
      height: d ? (v ?? void 0) : (i?.pixelHeight ?? void 0),
      useContainerWidth: d || E,
      useContainerHeight: R,
      children: [
        un(Ro, {
          target: cn,
          isFullScreen: d,
        ...
        un(Hf, {
          ...
          id: a,
          shouldUseFullWidth: d || E,
          shouldUseFullHeight: d || R,
          ref: f,
        }),
      ],
    })
