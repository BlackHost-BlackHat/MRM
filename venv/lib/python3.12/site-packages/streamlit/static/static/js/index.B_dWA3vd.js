...
import { u as we } from "./useBasicWidgetState.D6sOH6oI.js";
import "./FormClearHelper.BB1Km6eP.js";
var se = { vertical: "vertical", horizontal: "horizontal" };
function le(e, t) {
  var n = Object.keys(e);
...
var E = 0,
  ...
  T = 2;
function z(e) {
  return e.$isActive ? T : e.$isHovered ? L : E;
}
function Me(e) {
  ...
  else return o ? t.borderSelected : i ? t.tickBorderError : t.tickBorder;
  return null;
}
function ke(e) {
  var t = e.$theme.colors;
...
var X = _("label", function (e) {
  ...
  return (
    ...
    O(t, "margin".concat(p), c ? a.scale200 : null),
    O(t, "marginBottom", r && !c ? null : a.scale200),
    t
  );
});
X.displayName = "Root";
...
var Z = _("div", function (e) {
  var t,
    ...
    r = e.$align,
    o = r === "horizontal",
    i = n.direction === "rtl" ? "Right" : "Left",
    s = n.direction === "rtl" ? "Left" : "Right";
  return D(
    D({}, n.typography.ParagraphSmall),
    {},
    ((t = { color: n.colors.contentSecondary, cursor: "auto" }),
    O(t, "margin".concat(i), r === "horizontal" ? null : n.sizing.scale900),
    O(t, "margin".concat(s), o ? n.sizing.scale200 : null),
    O(t, "maxWidth", "240px"),
    t),
  );
});
...
var pe = (function (e) {
  ...
  function n() {
    ...
    return (
      ...
      j(A(r), "state", { isFocusVisible: !1, focusedRadioIndex: -1 }),
      j(A(r), "handleFocus", function (a, c) {
        (ye(a) && r.setState({ isFocusVisible: !0 }),
          r.setState({ focusedRadioIndex: c }),
          r.props.onFocus && r.props.onFocus(a));
      }),
      j(A(r), "handleBlur", function (a, c) {
        (r.state.isFocusVisible !== !1 && r.setState({ isFocusVisible: !1 }),
    ...
    ze(n, [
      {
        ...
        value: function () {
          ...
          return u.createElement(
            ...
            u.Children.map(this.props.children, function (f, l) {
              if (!u.isValidElement(f)) return null;
              ...
              return u.cloneElement(f, {
                ...
                name: o.props.name,
                onBlur: function (b) {
                  return o.handleBlur(b, l);
                },
                onFocus: function (b) {
                  return o.handleFocus(b, l);
                },
...
var rt = function (t) {
  ...
  fe = (function (e) {
    ...
    function n() {
      ...
      return (
        (r = t.call.apply(t, [this].concat(i))),
        F(k(r), "state", { isActive: !1, isHovered: !1 }),
        ...
        },
        {
          ...
          value: function () {
            var o = this.props.overrides,
              ...
              v = I[0],
              h = I[1],
              m = $(i.RadioMarkInner, K),
              ee = M(m, 2),
              de = ee[0],
              he = ee[1],
              ge = $(i.RadioMarkOuter, J),
              te = M(ge, 2),
              be = te[0],
              ve = te[1],
              w = {
            ...
            return u.createElement(
              ...
              u.createElement(
                ...
                et(this.props.labelPlacement) && re,
                u.createElement(
                  be,
                  y({}, w, ve),
                  u.createElement(de, y({}, w, he)),
                ),
                u.createElement(
                  P,
                  y(
                ...
                tt(this.props.labelPlacement) && re,
              ),
              !!this.props.description &&
                u.createElement(v, y({}, w, h), this.props.description),
            );
          },
        },
      ]),
...
function nt(e) {
  const t = parseFloat(e.sizes.checkbox),
    n = parseFloat(e.spacing.threeXS),
    r = ie(t.toString()),
    o = Math.round(r * 0.375);
  let i = Math.round(ie((t - n).toString()));
  return (i >= r && (i -= 1), [ae(o, "px"), ae(i, "px")]);
}
function ot({
  disabled: e,
  horizontal: t,
  ...
  const [p, g] = u.useState(n ?? null);
  u.useEffect(() => {
    n !== p && g(n ?? null);
  }, [n]);
  const f = u.useCallback(
      (v) => {
        const h = parseInt(v.target.value, 10);
        (g(h), r(h));
      },
      [r],
    ),
  ...
  return ne("div", {
    ...
    children: [
      R(Se, {
        ...
        children:
          c &&
          R(Re, { children: R(Oe, { content: c, placement: _e.TOP_RIGHT }) }),
      }),
      R(pe, {
        onChange: f,
        value: p !== null ? p.toString() : void 0,
        disabled: P,
        align: t ? se.horizontal : se.vertical,
        "aria-label": s,
              ...
              overrides: {
                Root: {
                  style: ({ $isFocusVisible: m }) => ({
                    ...
                    backgroundColor: m ? l.colors.darkenedBgMix25 : "",
                  }),
                },
                RadioMarkOuter: {
                  style: ({ $checked: m }) => ({
                    ...
                    backgroundColor:
                      m && !P ? l.colors.primary : l.colors.fadedText40,
                  }),
                },
                RadioMarkInner: {
                  style: ({ $checked: m }) => ({
...
const it = u.memo(ot);
function at({ disabled: e, element: t, widgetMgr: n, fragmentId: r }) {
  const [o, i] = we({
      getStateFromWidgetMgr: st,
      getDefaultStateFromProto: lt,
      getCurrStateFromProto: ut,
      updateWidgetMgrState: ct,
      element: t,
      widgetMgr: n,
      fragmentId: r,
    }),
...
function ct(e, t, n, r) {
  t.setIntValue(e, n.value ?? null, { fromUi: n.fromUi }, r);
}
const gt = u.memo(at);
