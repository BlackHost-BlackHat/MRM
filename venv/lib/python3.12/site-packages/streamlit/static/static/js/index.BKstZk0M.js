...
import { u as Wn } from "./useBasicWidgetState.D6sOH6oI.js";
...
function Kn() {
  ...
  var u = (re.flattenNames = function h() {
    var p = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [],
      f = [];
    return (
      (0, l.default)(p, function (d) {
        Array.isArray(d)
          ? h(d).map(function (b) {
              return f.push(b);
            })
          : (0, i.default)(d)
            ? (0, n.default)(d, function (b, g) {
                (b === !0 && f.push(g), f.push(g + "-" + b));
              })
            : (0, e.default)(d) && f.push(d);
      }),
      f
    );
  });
...
function Yn() {
  ...
  var o = (ne.mergeClasses = function (s) {
    var u = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [],
      h = (s.default && (0, n.default)(s.default)) || {};
    return (
      u.map(function (p) {
        var f = s[p];
        return (
          f &&
            (0, e.default)(f, function (d, b) {
              (h[b] || (h[b] = {}), (h[b] = a({}, h[b], f[b])));
            }),
          p
        );
      }),
...
function Zn() {
  ...
  var a = {
      borderRadius: function (l) {
        return {
          msBorderRadius: l,
          MozBorderRadius: l,
          OBorderRadius: l,
          WebkitBorderRadius: l,
          borderRadius: l,
        };
      },
      boxShadow: function (l) {
        return {
          msBoxShadow: l,
          MozBoxShadow: l,
          OBoxShadow: l,
      ...
      userSelect: function (l) {
        return {
          WebkitTouchCallout: l,
          KhtmlUserSelect: l,
          MozUserSelect: l,
          msUserSelect: l,
          WebkitUserSelect: l,
      ...
      flexBasis: function (l) {
        return { WebkitFlexBasis: l, flexBasis: l };
      },
      justifyContent: function (l) {
        return { WebkitJustifyContent: l, justifyContent: l };
      },
    ...
    i = (ae.autoprefix = function (l) {
      var s = {};
      return (
        (0, e.default)(l, function (u, h) {
          var p = {};
          ((0, e.default)(u, function (f, d) {
            var b = a[d];
            b ? (p = r({}, p, b(f))) : (p[d] = f);
          }),
            (s[h] = p));
  ...
  var l = (ie.hover = function (u) {
    ...
    return (function (p) {
      ...
      function f() {
        var d, b, g, m;
        a(this, f);
        for (var w = arguments.length, C = Array(w), O = 0; O < w; O++)
          C[O] = arguments[O];
        return (
          (m =
            ((b =
              ((g = i(
                this,
                (d = f.__proto__ || Object.getPrototypeOf(f)).call.apply(
                  d,
                  [this].concat(C),
                ),
              )),
            ...
            (g.handleMouseOver = function () {
              return g.setState({ hover: !0 });
            }),
            (g.handleMouseOut = function () {
              return g.setState({ hover: !1 });
            }),
            (g.render = function () {
              return r.default.createElement(
                h,
                {
                  onMouseOver: g.handleMouseOver,
                  onMouseOut: g.handleMouseOut,
                },
                r.default.createElement(u, t({}, g.props, g.state)),
              );
            }),
            b)),
          i(g, m)
        ...
        return (
          (m =
            ((b =
              ...
              g)),
            (g.state = { active: !1 }),
            (g.handleMouseDown = function () {
              return g.setState({ active: !0 });
            }),
            (g.handleMouseUp = function () {
              return g.setState({ active: !1 });
            }),
            (g.render = function () {
              return r.default.createElement(
                h,
                { onMouseDown: g.handleMouseDown, onMouseUp: g.handleMouseUp },
                r.default.createElement(u, t({}, g.props, g.state)),
              );
            }),
            b)),
...
function ea() {
  if (lr) return Ie;
  ((lr = 1), Object.defineProperty(Ie, "__esModule", { value: !0 }));
  var t = function (r, n) {
    var a = {},
      i = function (l) {
        var s =
...
function ta() {
  ...
  ((T.hover = l.default),
    ...
    (T.loop = p.default));
  var d = (T.ReactCSS = function (g) {
    for (
      var m = arguments.length, w = Array(m > 1 ? m - 1 : 0), C = 1;
      C < m;
      C++
    )
      w[C - 1] = arguments[C];
    ...
    if (n === "vertical") {
      ...
      if (
        (p < 0
          ...
          : p > l
            ? (f = 1)
            : (f = Math.round((p * 100) / l) / 100),
        r.a !== f)
      )
        return { h: r.h, s: r.s, l: r.l, a: f, source: "rgb" };
    } else {
      var d = void 0;
      if (
        (h < 0
      ...
      u = y({
        default: {
          grid: {
            ...
            background: "url(" + aa(r, n, a, i.canvas) + ") center left",
          },
        },
      });
    return A.isValidElement(s)
      ? c.cloneElement(
          s,
          ur({}, s.props, { style: ur({}, s.props.style, u.grid) }),
        )
           ...
           rgba(` +
            ...
            return c.createElement(
              ...
              c.createElement(
                "div",
                { style: i.checkboard },
                c.createElement(Ce, { renderers: this.props.renderers }),
              ),
...
var da = 1,
  ...
  E = (function (t) {
    ...
    function e(r) {
      ha(this, e);
      var n = pa(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this));
      return (
        ...
        (n.handleKeyDown = function (a) {
          var i = xa(a.target.value);
          if (!isNaN(i) && va(a.keyCode)) {
            var o = n.getArrowOffset(),
              l = a.keyCode === Qr ? i + o : i - o;
            n.setUpdatedValue(l, a);
          }
        }),
        ...
        (n.inputId = "rc-editable-input-" + ma++),
        n
      );
    }
    return (
      ua(e, [
        ...
        },
        {
          ...
          value: function (n) {
            return ca({}, this.props.label, n);
          },
        },
        {
          key: "getArrowOffset",
          value: function () {
            return this.props.arrowOffset || da;
          },
        },
        {
          key: "setUpdatedValue",
  ...
  ya = function (e, r, n, a) {
    var i = a.clientWidth,
      ...
      s = typeof e.pageY == "number" ? e.pageY : e.touches[0].pageY,
    ...
    return (
      (i =
        ((n =
          ...
          a)),
        (a.handleChange = function (u) {
          var h = ya(u, a.props.direction, a.props.hsl, a.container);
          h && typeof a.props.onChange == "function" && a.props.onChange(h, u);
        }),
        (a.handleMouseDown = function (u) {
          (a.handleChange(u),
            window.addEventListener("mousemove", a.handleChange),
...
function Ra(t) {
  ...
  if (r < 0) return !1;
  var n = e.length - 1;
  return (r == n ? e.pop() : Oa.call(e, r, 1), --this.size, !0);
}
function Aa(t) {
  var e = this.__data__,
    r = Je(e, t);
...
var en =
  ...
  N = en || Ba || Function("return this")(),
  V = N.Symbol,
  tn = Object.prototype,
  Ha = tn.hasOwnProperty,
  Da = tn.toString,
  Ae = V ? V.toStringTag : void 0;
function Na(t) {
  var e = Ha.call(t, Ae),
    r = t[Ae];
  try {
  ...
  var a = Da.call(t);
  return (n && (e ? (t[Ae] = r) : delete t[Ae]), a);
}
...
function _t(t) {
  if (!B(t)) return !1;
  var e = Z(t);
  return e == Wa || e == qa || e == Ua || e == Va;
}
var ut = N["__core-js_shared__"],
  fr = (function () {
...
function di(t) {
  var e = this.__data__;
  return He ? e[t] !== void 0 : fi.call(e, t);
}
...
Y.prototype.clear = oi;
Y.prototype.delete = li;
Y.prototype.get = hi;
Y.prototype.has = di;
Y.prototype.set = bi;
function vi() {
  ((this.size = 0),
    (this.__data__ = { hash: new Y(), map: new (Be || z)(), string: new Y() }));
}
function xi(t) {
  var e = typeof t;
...
L.prototype.clear = Ma;
L.prototype.delete = ka;
L.prototype.get = Fa;
L.prototype.has = $a;
L.prototype.set = Ci;
var We = (function () {
...
function Ot(t, e, r) {
  e == "__proto__" && We
    ? We(t, e, { configurable: !0, enumerable: !0, value: r, writable: !0 })
    : (t[e] = r);
}
function dt(t, e, r) {
  ((r !== void 0 && !Ne(t[e], r)) || (r === void 0 && !(e in t))) &&
    Ot(t, e, r);
}
function _i(t) {
  return function (e, r, n) {
    for (var a = -1, i = Object(e), o = n(e), l = o.length; l--; ) {
      var s = o[++a];
...
var rn = _i(),
  ...
  dr = nn && typeof module == "object" && module && !module.nodeType && module,
  Oi = dr && dr.exports === nn,
  gr = Oi ? N.Buffer : void 0;
gr && gr.allocUnsafe;
function Ri(t, e) {
  return t.slice();
}
...
var on = an(Object.getPrototypeOf, Object),
  ki = Object.prototype;
function Rt(t) {
  var e = t && t.constructor,
    r = (typeof e == "function" && e.prototype) || ki;
  return t === r;
}
function Fi(t) {
  return typeof t.constructor == "function" && !Rt(t) ? Mi(on(t)) : {};
}
function X(t) {
...
var ln = Object.prototype,
  Bi = ln.hasOwnProperty,
  Hi = ln.propertyIsEnumerable,
  Ve = vr(
    (function () {
      return arguments;
    })(),
    ...
    ? vr
    : function (t) {
        return X(t) && Bi.call(t, "callee") && !Hi.call(t, "callee");
      },
  $ = Array.isArray,
  Di = 9007199254740991;
function At(t) {
...
function Oe(t) {
  return t != null && At(t.length) && !_t(t);
}
function Ni(t) {
  return X(t) && Oe(t);
}
...
var sn = typeof exports == "object" && exports && !exports.nodeType && exports,
  xr = sn && typeof module == "object" && module && !module.nodeType && module,
  ji = xr && xr.exports === sn,
  mr = ji ? N.Buffer : void 0,
  Ii = mr ? mr.isBuffer : void 0,
  Xe = Ii || Li,
  zi = "[object Object]",
  ...
  qi = un.call(Object);
function Vi(t) {
  if (!X(t) || Z(t) != zi) return !1;
  var e = on(t);
  if (e === null) return !0;
  var r = Wi.call(e, "constructor") && e.constructor;
  return typeof r == "function" && r instanceof r && un.call(r) == qi;
}
var Xi = "[object Arguments]",
  ...
  S = {};
S[uo] = S[co] = S[ho] = S[po] = S[fo] = S[go] = S[bo] = S[vo] = S[xo] = !0;
S[Xi] =
  S[Ki] =
  S[lo] =
  S[Yi] =
...
var cn = typeof exports == "object" && exports && !exports.nodeType && exports,
  $e = cn && typeof module == "object" && module && !module.nodeType && module,
  wo = $e && $e.exports === cn,
  ct = wo && en.process,
  yr = (function () {
    try {
...
function Co(t, e, r) {
  var n = t[e];
  (!(So.call(t, e) && Ne(n, r)) || (r === void 0 && !(e in t))) && Ot(t, e, r);
}
function _o(t, e, r, n) {
  var a = !r;
  r || (r = {});
  for (var i = -1, o = e.length; ++i < o; ) {
    var l = e[i],
      s = void 0;
    (s === void 0 && (s = t[l]), a ? Ot(r, l, s) : Co(r, l, s));
  }
  return r;
}
function Oo(t, e) {
...
var ko = Object.prototype,
  Fo = ko.hasOwnProperty;
function $o(t) {
  if (!B(t)) return Mo(t);
  var e = Rt(t),
    r = [];
  for (var n in t) (n == "constructor" && (e || !Fo.call(t, n))) || r.push(n);
  return r;
}
function pn(t) {
  return Oe(t) ? hn(t, !0) : $o(t);
}
function Bo(t) {
  return _o(t, pn(t));
}
function Ho(t, e, r, n, a, i, o) {
  var l = gt(t, r),
    s = gt(e, r),
    u = o.get(s);
  if (u) {
          ...
          : Ni(l)
            ...
            : d
              ...
              : b
                ...
                : (h = [])
        : Vi(s) || Ve(s)
          ? ((h = l), Ve(l) ? (h = Bo(l)) : (!B(l) || _t(l)) && (h = Fi(s)))
          : (p = !1));
  }
  (p && (o.set(s, h), a(h, s, n, i, o), o.delete(s)), dt(t, r, h));
}
function fn(t, e, r, n, a) {
  t !== e &&
    rn(
      e,
      function (i, o) {
        if ((a || (a = new L()), B(i))) Ho(t, e, o, r, fn, n, a);
        else {
          var l = n ? n(gt(t, o), i, o + "", t, e, a) : void 0;
          (l === void 0 && (l = i), dt(t, o, l));
        }
      },
      pn,
    );
...
function No(t, e, r) {
  return (
    (e = Er(e === void 0 ? t.length - 1 : e, 0)),
    function () {
      for (
        var n = arguments, a = -1, i = Er(n.length - e, 0), o = Array(i);
        ++a < i;
...
var Wo = Uo(jo);
function qo(t, e) {
  return Wo(No(t, e, et), t + "");
}
function Vo(t, e, r) {
  if (!B(r)) return !1;
  var n = typeof e;
  return (n == "number" ? Oe(r) && Tt(e, r.length) : n == "string" && e in r)
    ? Ne(r[e], t)
    : !1;
}
function Xo(t) {
  return qo(function (e, r) {
    ...
    for (
      i = t.length > 3 && typeof i == "function" ? (a--, i) : void 0,
        o && Vo(r[0], r[1], o) && ((i = a < 3 ? void 0 : i), (a = 1)),
        e = Object(e);
      ++n < a;
...
var M = Xo(function (t, e, r) {
  ...
  Le = function (e) {
    ...
    return c.createElement(
      "div",
      { style: s.wrap },
      c.createElement("div", { style: s.bg }),
      c.createElement("div", { style: s.content }, i),
    );
  };
Le.propTypes = {
  background: v.string,
  zDepth: v.oneOf([0, 1, 2, 3, 4, 5]),
  radius: v.number,
  styles: v.object,
};
Le.defaultProps = { background: "#fff", zDepth: 1, radius: 2, styles: {} };
var ht = function () {
    return N.Date.now();
  },
  Ko = /\s/;
...
var Zo = /^\s+/;
function Jo(t) {
  return t && t.slice(0, Yo(t) + 1).replace(Zo, "");
}
var Qo = "[object Symbol]";
function tt(t) {
  return typeof t == "symbol" || (X(t) && Z(t) == Qo);
}
var Sr = NaN,
  el = /^[-+]0x[0-9a-f]+$/i,
  tl = /^0b[01]+$/i,
...
function Cr(t) {
  ...
  t = Jo(t);
  var r = tl.test(t);
  return r || rl.test(t) ? nl(t.slice(2), r ? 2 : 8) : el.test(t) ? Sr : +t;
}
...
function dn(t, e, r) {
  ...
  ((e = Cr(e) || 0),
    B(r) &&
      ((h = !!r.leading),
      (p = "maxWait" in r),
      (i = p ? il(Cr(r.maxWait) || 0, e) : i),
      (f = "trailing" in r ? !!r.trailing : f)));
  function d(R) {
    var W = n,
      Re = a;
    return ((n = a = void 0), (u = R), (o = t.apply(Re, W)), o);
  }
  function b(R) {
    return ((u = R), (l = setTimeout(w, e)), h ? d(R) : o);
  }
  function g(R) {
    var W = R - s,
      Re = R - u,
      Yt = e - W;
    return p ? ol(Yt, i - Re) : Yt;
  }
  function m(R) {
    var W = R - s,
      Re = R - u;
    return s === void 0 || W >= e || W < 0 || (p && Re >= i);
  }
  function w() {
    var R = ht();
    if (m(R)) return C(R);
  ...
  function C(R) {
    return ((l = void 0), f && n ? d(R) : ((n = a = void 0), o));
  }
  function O() {
    (l !== void 0 && clearTimeout(l), (u = 0), (n = s = a = l = void 0));
  }
  function P() {
    return l === void 0 ? o : C(ht());
  }
  function U() {
    var R = ht(),
      W = m(R);
    if (((n = arguments), (a = this), (s = R), W)) {
      if (l === void 0) return b(s);
      if (p) return (clearTimeout(l), (l = setTimeout(w, e)), d(s));
    }
    return (l === void 0 && (l = setTimeout(w, e)), o);
  }
  return ((U.cancel = O), (U.flush = P), U);
}
var ll = "Expected a function";
function sl(t, e, r) {
  var n = !0,
    a = !0;
  if (typeof t != "function") throw new TypeError(ll);
  return (
    B(r) &&
      ((n = "leading" in r ? !!r.leading : n),
      (a = "trailing" in r ? !!r.trailing : a)),
    dn(t, e, { leading: n, maxWait: e, trailing: a })
  );
}
var ul = function (e, r, n) {
    var a = n.getBoundingClientRect(),
      ...
      h = s - (n.getBoundingClientRect().top + window.pageYOffset);
    (u < 0 ? (u = 0) : u > i && (u = i), h < 0 ? (h = 0) : h > o && (h = o));
    var p = u / i,
      f = 1 - h / o;
    return { h: r.h, s: p, v: f, a: r.a, source: "hsv" };
  },
  cl = (function () {
    function t(e, r) {
      for (var n = 0; n < r.length; n++) {
...
var je = (function (t) {
  ...
  function e(r) {
    hl(this, e);
    var n = pl(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, r));
    return (
      (n.handleChange = function (a) {
        typeof n.props.onChange == "function" &&
          n.throttle(n.props.onChange, ul(a, n.props.hsl, n.container), a);
      }),
      (n.handleMouseDown = function (a) {
        n.handleChange(a);
    ...
    cl(e, [
      ...
      },
      {
        ...
        `,
            ...
            c.createElement(
              "div",
              { style: h.white, className: "saturation-white" },
              c.createElement("div", {
                style: h.black,
              ...
              c.createElement(
                ...
                this.props.pointer
                  ? c.createElement(this.props.pointer, this.props)
                  : c.createElement("div", { style: h.circle }),
              ),
            ),
          );
        },
...
var gl = an(Object.keys, Object),
  bl = Object.prototype,
  vl = bl.hasOwnProperty;
function xl(t) {
  if (!Rt(t)) return gl(t);
  var e = [];
  for (var r in Object(t)) vl.call(t, r) && r != "constructor" && e.push(r);
  return e;
}
function Mt(t) {
  return Oe(t) ? hn(t) : xl(t);
}
function ml(t, e) {
  return t && rn(t, e, Mt);
}
...
var Sl = /^\s+/,
  Cl = /\s+$/;
function x(t, e) {
  if (((t = t || ""), (e = e || {}), t instanceof x)) return t;
...
x.prototype = {
  ...
  toHsv: function () {
    var e = Or(this._r, this._g, this._b);
  ...
  toHsl: function () {
    var e = _r(this._r, this._g, this._b);
  ...
  toHex: function (e) {
    return Rr(this._r, this._g, this._b, e);
  },
  toHexString: function (e) {
    return "#" + this.toHex(e);
  },
  toHex8: function (e) {
    return Pl(this._r, this._g, this._b, this._a, e);
  },
  ...
  toName: function () {
    return this._a === 0
      ...
      : this._a < 1
        ? !1
        : Il[Rr(this._r, this._g, this._b, !0)] || !1;
  },
  toFilter: function (e) {
    var r = "#" + Ar(this._r, this._g, this._b, this._a),
      n = r,
      a = this._gradientType ? "GradientType = 1, " : "";
    if (e) {
      var i = x(e);
      n = "#" + Ar(i._r, i._g, i._b, i._a);
    }
    return (
  ...
  lighten: function () {
    return this._applyModification(Fl, arguments);
  },
  brighten: function () {
  ...
  analogous: function () {
    return this._applyCombination(Ll, arguments);
  },
  complement: function () {
  ...
  splitcomplement: function () {
    return this._applyCombination(Nl, arguments);
  },
  triad: function () {
    return this._applyCombination(Pr, [3]);
  },
  tetrad: function () {
    return this._applyCombination(Pr, [4]);
  },
};
x.fromRatio = function (t, e) {
  if (Ke(t) == "object") {
    var r = {};
    for (var n in t)
      t.hasOwnProperty(n) && (n === "a" ? (r[n] = t[n]) : (r[n] = Me(t[n])));
    t = r;
  }
  return x(t, e);
};
...
function Ol(t, e, r) {
  return { r: _(t, 255) * 255, g: _(e, 255) * 255, b: _(r, 255) * 255 };
}
function _r(t, e, r) {
...
function Rl(t, e, r) {
  ...
  if (e === 0) n = a = i = r;
    ...
    var l = r < 0.5 ? r * (1 + e) : r + e - r * e,
      s = 2 * r - l;
    ((n = o(s, l, t + 1 / 3)), (a = o(s, l, t)), (i = o(s, l, t - 1 / 3)));
  }
...
x.equals = function (t, e) {
  return !t || !e ? !1 : x(t).toRgbString() == x(e).toRgbString();
};
x.random = function () {
  return x.fromRatio({ r: Math.random(), g: Math.random(), b: Math.random() });
};
function Tl(t, e) {
  e = e === 0 ? 0 : e || 10;
  var r = x(t).toHsl();
  return ((r.s -= e / 100), (r.s = rt(r.s)), x(r));
}
function Ml(t, e) {
  e = e === 0 ? 0 : e || 10;
  var r = x(t).toHsl();
...
function kl(t) {
  return x(t).desaturate(100);
}
function Fl(t, e) {
  e = e === 0 ? 0 : e || 10;
  var r = x(t).toHsl();
  return ((r.l += e / 100), (r.l = rt(r.l)), x(r));
}
function $l(t, e) {
  e = e === 0 ? 0 : e || 10;
  var r = x(t).toRgb();
...
function Dl(t) {
  var e = x(t).toHsl();
  return ((e.h = (e.h + 180) % 360), x(e));
}
function Pr(t, e) {
  if (isNaN(e) || e <= 0)
    throw new Error("Argument to polyad must be a positive number");
  for (var r = x(t).toHsl(), n = [x(t)], a = 360 / e, i = 1; i < e; i++)
    n.push(x({ h: (r.h + i * a) % 360, s: r.s, l: r.l }));
  return n;
}
function Nl(t) {
  var e = x(t).toHsl(),
  ...
  return [
    x(t),
    x({ h: (r + 72) % 360, s: e.s, l: e.l }),
    x({ h: (r + 216) % 360, s: e.s, l: e.l }),
  ];
}
function Ll(t, e, r) {
  ((e = e || 6), (r = r || 30));
...
function jl(t, e) {
  e = e || 6;
  for (
    var r = x(t).toHsv(), n = r.h, a = r.s, i = r.v, o = [], l = 1 / e;
    e--;

  )
    (o.push(x({ h: n, s: a, v: i })), (i = (i + l) % 1));
  return o;
}
x.mix = function (t, e, r) {
  r = r === 0 ? 0 : r || 50;
  var n = x(t).toRgb(),
    a = x(e).toRgb(),
    i = r / 100,
...
x.isReadable = function (t, e, r) {
  var n = x.readability(t, e),
    a,
    i;
  switch (((i = !1), (a = ql(r)), a.level + a.size)) {
    case "AAsmall":
    case "AAAlarge":
      i = n >= 4.5;
      break;
...
x.mostReadable = function (t, e, r) {
  var n = null,
    ...
    l,
    s;
  ((r = r || {}), (o = r.includeFallbackColors), (l = r.level), (s = r.size));
  for (var u = 0; u < e.length; u++)
    ((i = x.readability(t, e[u])), i > a && ((a = i), (n = x(e[u]))));
  return x.isReadable(t, n, { level: l, size: s }) || !o
    ? n
    : ((r.includeFallbackColors = !1), x.mostReadable(t, ["#fff", "#000"], r));
};
var bt = (x.names = {
    aliceblue: "f0f8ff",
    antiquewhite: "faebd7",
...
function Wl(t) {
  t = t.replace(Sl, "").replace(Cl, "").toLowerCase();
  var e = !1;
  if (bt[t]) ((t = bt[t]), (e = !0));
...
var Mr = function (e) {
  ...
  K = function (e) {
    ...
    return e.length !== 4 + r && e.length < 7 + r && x(e).isValid();
  },
  kt = function (e) {
    if (!e) return "#fff";
    var r = ke(e);
...
var k = function (e) {
    var r = (function (n) {
      ...
      function a(i) {
        Xl(this, a);
        var o = Kl(this, (a.__proto__ || Object.getPrototypeOf(a)).call(this));
        return (
          (o.handleChange = function (l, s) {
            var u = Mr(l);
            if (u) {
              var h = ke(l, l.h || o.state.oldHue);
              (o.setState(h),
                o.props.onChangeComplete &&
                  o.debounce(o.props.onChangeComplete, h, s),
                o.props.onChange && o.props.onChange(h, s));
            }
          }),
          (o.handleSwatchHover = function (l, s) {
            ...
            if (u) {
              var h = ke(l, l.h || o.state.oldHue);
              o.props.onSwatchHover && o.props.onSwatchHover(h, s);
            }
          }),
          (o.state = Pe({}, ke(i.color, 0))),
          (o.debounce = dn(function (l, s, u) {
            l(s, u);
          }, 100)),
          o
        );
    ...
    return (
      (r.propTypes = Pe({}, e.propTypes)),
      (r.defaultProps = Pe({}, e.defaultProps, {
...
var ts = function (e) {
    ...
    return (function (n) {
      ...
      function a() {
        var i, o, l, s;
        Ql(this, a);
        for (var u = arguments.length, h = Array(u), p = 0; p < u; p++)
          h[p] = arguments[p];
        return (
          (s =
            ((o =
        ...
        Jl(a, [
          {
            ...
            value: function () {
              return c.createElement(
                ...
                c.createElement(e, Zl({}, this.props, this.state)),
              );
            },
          },
        ]),
  ...
  ns = function (e) {
    ...
    return (
      ...
      c.createElement(
        "div",
        Fr(
          { style: b.swatch, onClick: g, title: s, tabIndex: 0, onKeyDown: m },
          C,
        ),
        u,
        d &&
...
var as = function (e) {
  ...
  xn = function (e) {
    ...
    return c.createElement(
      "div",
      { style: d.picker, className: "alpha-picker " + f },
      c.createElement(
        Ct,
        is({}, d.alpha, {
          rgb: r,
...
function ls(t) {
  return (this.__data__.set(t, os), this);
}
function ss(t) {
  return this.__data__.has(t);
}
...
Ye.prototype.add = Ye.prototype.push = ls;
Ye.prototype.has = ss;
function us(t, e) {
...
function yn(t, e, r, n, a, i) {
  ...
  var p = -1,
    f = !0,
    d = r & ps ? new Ye() : void 0;
  for (i.set(t, e), i.set(e, t); ++p < l; ) {
    var b = t[p],
      g = e[p];
    if (n) var m = o ? n(g, b, p, e, t, i) : n(b, g, p, t, e, i);
    if (m !== void 0) {
      if (m) continue;
      f = !1;
      break;
    ...
    if (d) {
      if (
        !us(e, function (w, C) {
          if (!cs(d, C) && (b === w || a(b, w, r, n, i))) return d.push(C);
        })
      ) {
        f = !1;
        break;
      }
    } else if (!(b === g || a(b, g, r, n, i))) {
      f = !1;
      break;
    }
  }
...
var gs = 1,
  ...
  Rs = "[object DataView]",
  $r = V ? V.prototype : void 0,
  ft = $r ? $r.valueOf : void 0;
function As(t, e, r, n, a, i, o) {
  switch (r) {
    case Rs:
    ...
    case Os:
      return !(t.byteLength != e.byteLength || !i(new qe(t), new qe(e)));
    case vs:
    case xs:
    case ws:
      return Ne(+t, +e);
    ...
    case Ss:
      var s = n & gs;
      if ((l || (l = ds), t.size != e.size && !s)) return !1;
      var u = o.get(t);
      if (u) return u == e;
      ((n |= bs), o.set(t, e));
      var h = yn(l(t), l(e), n, a, i, o);
      return (o.delete(t), h);
    case _s:
...
function Ls(t, e, r, n, a, i) {
  ...
  for (var p = s; p--; ) {
    var f = l[p];
    if (!(o ? f in e : Ns.call(e, f))) return !1;
  }
  var d = i.get(t),
    b = i.get(e);
  if (d && b) return d == e && b == t;
  var g = !0;
  (i.set(t, e), i.set(e, t));
  for (var m = o; ++p < s; ) {
    f = l[p];
    var w = t[f],
      C = e[f];
    if (n) var O = o ? n(C, w, f, e, t, i) : n(w, C, f, t, e, i);
    if (!(O === void 0 ? w === C || a(w, C, r, n, i) : O)) {
      g = !1;
      break;
    }
    m || (m = f == "constructor");
...
var vt = Q(N, "DataView"),
  ...
  Ws = J(yt),
  q = Z;
((vt && q(new vt(new ArrayBuffer(1))) != Ir) ||
  (Be && q(new Be()) != Dr) ||
  (xt && q(xt.resolve()) != Nr) ||
  (mt && q(new mt()) != Lr) ||
  (yt && q(new yt()) != jr)) &&
...
function Xs(t, e, r, n, a, i) {
  var o = $(t),
    l = $(e),
    s = o ? Gr : q(t),
    u = l ? Gr : q(e);
  ((s = s == zr ? ze : s), (u = u == zr ? ze : u));
  var h = s == ze,
    p = u == ze,
    f = s == u;
  if (f && Xe(t)) {
  ...
  if (f && !h)
    return (
      i || (i = new L()),
      o || Pt(t) ? yn(t, e, r, n, a, i) : As(t, e, s, r, n, a, i)
    );
  if (!(r & qs)) {
    var d = h && Ur.call(t, "__wrapped__"),
      b = p && Ur.call(e, "__wrapped__");
    if (d || b) {
      var g = d ? t.value() : t,
        m = b ? e.value() : e;
      return (i || (i = new L()), a(g, m, r, n, i));
    }
  }
  return f ? (i || (i = new L()), Ls(t, e, r, n, a, i)) : !1;
}
function Ft(t, e, r, n, a) {
  return t === e
    ? !0
    : t == null || e == null || (!X(t) && !X(e))
      ? t !== t && e !== e
      : Xs(t, e, r, n, Ft, a);
}
var Ks = 1,
...
function Zs(t, e, r, n) {
  ...
  for (; ++a < i; ) {
    ...
    var l = o[0],
      ...
      u = o[1];
    if (o[2]) {
      if (s === void 0 && !(l in t)) return !1;
    } else {
      var h = new L(),
        p;
      if (!(p === void 0 ? Ft(u, s, Ks | Ys, n, h) : p)) return !1;
    }
  }
  return !0;
}
...
function $t(t, e) {
  if ($(t)) return !1;
  var r = typeof t;
  return r == "number" || r == "symbol" || r == "boolean" || t == null || tt(t)
    ? !0
    : tu.test(t) || !eu.test(t) || (e != null && t in Object(e));
}
...
function Bt(t, e) {
  ...
  return ((r.cache = new (Bt.Cache || G)()), r);
}
Bt.Cache = G;
var nu = 500;
function au(t) {
...
var iu =
  ...
  lu = au(function (t) {
    ...
    return (
      ...
      t.replace(iu, function (r, n, a, i) {
        e.push(a ? i.replace(ou, "$1") : n || r);
      }),
      e
    );
  }),
  Wr = V ? V.prototype : void 0,
  qr = Wr ? Wr.toString : void 0;
function Sn(t) {
  if (typeof t == "string") return t;
  if ($(t)) return mn(t, Sn) + "";
  if (tt(t)) return qr ? qr.call(t) : "";
  var e = t + "";
...
function _n(t, e) {
  e = Cn(e, t);
  for (var r = 0, n = e.length; t != null && r < n; ) t = t[nt(e[r++])];
  return r && r == n ? t : void 0;
}
function uu(t, e, r) {
  var n = t == null ? void 0 : _n(t, e);
  return n === void 0 ? r : n;
}
function cu(t, e) {
...
function hu(t, e, r) {
  ...
  return i || ++n != a
    ? i
    : ((a = t == null ? 0 : t.length),
      !!a && At(a) && Tt(o, a) && ($(t) || Ve(t)));
}
function pu(t, e) {
  return t != null && hu(t, e, cu);
}
var fu = 1,
  du = 2;
function gu(t, e) {
  return $t(t) && wn(e)
    ...
    : function (r) {
        var n = uu(r, t);
        return n === void 0 && n === e ? pu(r, t) : Ft(e, n, fu | du);
      };
}
function bu(t) {
  return function (e) {
...
var wu = function (e) {
  ...
  Ht = function (e) {
        ...
        M(
          {
            default: {
              ...
              body: { padding: "10px" },
              label: { fontSize: "18px", color: kt(a), position: "relative" },
              triangle: {
                width: "0px",
                height: "0px",
                borderStyle: "solid",
    ...
    return c.createElement(
      ...
      c.createElement("div", { style: b.triangle }),
      c.createElement(
        "div",
        { style: b.head },
        f && c.createElement(Ce, { borderRadius: "6px 6px 0 0" }),
        c.createElement("div", { style: b.label }, a),
      ),
      c.createElement(
        "div",
        { style: b.body },
        c.createElement(wu, { colors: i, onClick: d, onSwatchHover: n }),
        c.createElement(E, {
          style: { input: b.input },
          value: a,
          onChange: d,
...
var le = {
  ...
  Fe = { 100: "#c8e6c9", 300: "#81c784", 500: "#4caf50", 700: "#388e3c" },
  be = {
    100: "#dcedc8",
    300: "#aed581",
    500: "#8bc34a",
      ...
      u = y(
        {
          default: {
            ...
            Swatch: {
              ...
              boxShadow: "inset 0 0 0 " + (l / 2 + 1) + "px " + r,
...
On.defaultProps = { circleSize: 28, circleSpacing: 14 };
const Eu = St.handleHover(On);
var Dt = function (e) {
  var r = e.width,
    n = e.onChange,
    a = e.onSwatchHover,
  ...
  return c.createElement(
    ...
    te(i, function (g) {
      return c.createElement(Eu, {
        key: g,
        color: g,
        onClick: b,
        onSwatchHover: a,
        active: o === g.toLowerCase(),
        circleSize: l,
        circleSpacing: h,
      });
    }),
...
function Su() {
  if (Xr) return Ge;
  ((Xr = 1), Object.defineProperty(Ge, "__esModule", { value: !0 }));
  var t =
      Object.assign ||
      function (o) {
        for (var l = 1; l < arguments.length; l++) {
  ...
  var i = 24;
  return (
    (Ge.default = function (o) {
      var l = o.fill,
        s = l === void 0 ? "currentColor" : l,
        u = o.width,
        h = u === void 0 ? i : u,
        p = o.height,
        f = p === void 0 ? i : p,
        d = o.style,
        b = d === void 0 ? {} : d,
        g = a(o, ["fill", "width", "height", "style"]);
      return r.default.createElement(
        "svg",
        t(
          {
            viewBox: "0 0 " + i + " " + i,
            style: t({ fill: s, width: h, height: f }, b),
          },
          g,
        ),
...
var Rn = (function (t) {
  ...
  function e(r) {
    Ru(this, e);
    var n = Au(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this));
    return (
      ...
      (n.handleChange = function (a, i) {
        a.hex
          ? K(a.hex) && n.props.onChange({ hex: a.hex, source: "hex" }, i)
          : a.r || a.g || a.b
            ? n.props.onChange(
                {
                  r: a.r || n.props.rgb.r,
            ...
            : a.a
              ...
              : (a.h || a.s || a.l) &&
                ...
                n.props.onChange(
                  {
                    h: a.h || n.props.hsl.h,
                    s: Number(Vr(a.s) ? n.props.hsl.s : a.s),
                    l: Number(Vr(a.l) ? n.props.hsl.l : a.l),
                    source: "hsl",
                  },
                  i,
                ));
        ...
        c.createElement(
          ...
          c.createElement(
            ...
            c.createElement(
              "div",
              { style: g.swatch },
              c.createElement("div", { style: g.active }),
              c.createElement(Ce, { renderers: u }),
            ),
          ),
          c.createElement(
            "div",
...
Nt.propTypes = {
  ...
  disableAlpha: v.bool,
  styles: v.object,
  defaultView: v.oneOf(["hex", "rgb", "hsl"]),
};
...
var ku = function (e) {
    ...
    return c.createElement(
      ...
      c.createElement("div", { style: l.dot }),
    );
  },
  Fu = function (e) {
    var r = e.hex,
      ...
      o = function (s, u) {
        s.r || s.g || s.b
          ? a({ r: s.r || n.r, g: s.g || n.g, b: s.b || n.b, source: "rgb" }, u)
  ...
  Lt = function (e) {
    var r = e.onChange,
      ...
      f = function (b, g) {
        b.hex ? K(b.hex) && r({ hex: b.hex, source: "hex" }, g) : r(b, g);
      };
    return c.createElement(
      Le,
      { style: p.Compact, styles: s },
      c.createElement(
        "div",
        { style: p.compact, className: "compact-picker " + h },
        c.createElement(
          "div",
          null,
          te(a, function (d) {
        ...
        c.createElement(Fu, { hex: i, rgb: o, onChange: f }),
      ),
    );
  };
Lt.propTypes = { colors: v.arrayOf(v.string), styles: v.object };
Lt.defaultProps = {
  colors: [
    "#4D4D4D",
    "#999999",
...
var $u = function (e) {
  ...
  return c.createElement(
    "div",
    { style: l.swatch },
    c.createElement(ee, { color: n, onClick: a, onHover: i, focusStyle: o }),
  );
};
const Bu = St.handleHover($u);
var jt = function (e) {
  var r = e.width,
    n = e.colors,
    a = e.onChange,
    ...
    f = function (b, g) {
      return a({ hex: b, source: "hex" }, g);
    };
  return c.createElement(
    "div",
    { style: p.card, className: "github-picker " + h },
    c.createElement("div", { style: p.triangleShadow }),
    c.createElement("div", { style: p.triangle }),
    te(n, function (d) {
      return c.createElement(Bu, {
        color: d,
        key: d,
        onClick: f,
        onSwatchHover: i,
...
var Hu = function (e) {
  ...
  It = function (e) {
    ...
    return c.createElement(
      ...
      c.createElement(
        _e,
        Du({}, f.hue, { hsl: i, pointer: l, onChange: d, direction: o }),
      ),
    );
  };
It.propTypes = { styles: v.object };
It.defaultProps = {
  width: "316px",
  height: "16px",
  direction: "horizontal",
...
var Nu = function (e) {
  var r = e.onChange,
    ...
    h = function (f, d) {
      f.hex
        ? K(f.hex) && r({ hex: f.hex, source: "hex" }, d)
        : (f.r || f.g || f.b) &&
          r({ r: f.r || a.r, g: f.g || a.g, b: f.b || a.b, source: "rgb" }, d);
    };
  return c.createElement(
    Le,
    { styles: o },
...
var zt = (function (t) {
  ...
  function e(r) {
    Uu(this, e);
    var n = Wu(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this));
    ...
    Gu(e, [
      {
        ...
        value: function () {
          ...
          return c.createElement(
            ...
            c.createElement("div", { style: s.head }, this.props.header),
            c.createElement(
              "div",
...
zt.propTypes = { header: v.string, styles: v.object };
zt.defaultProps = { header: "Color Picker", styles: {} };
k(zt);
var Vu = function (e) {
    var r = e.onChange,
      n = e.rgb,
      ...
      s = function (h, p) {
        h.hex
          ? K(h.hex) && r({ hex: h.hex, source: "hex" }, p)
          : h.r || h.g || h.b
            ? r(
                {
                  r: h.r || n.r,
            ...
            : h.a &&
              (h.a < 0 ? (h.a = 0) : h.a > 100 && (h.a = 100),
              (h.a /= 100),
              r({ h: a.h, s: a.s, l: a.l, a: h.a, source: "rgb" }, p));
      };
    return c.createElement(
      "div",
...
An.propTypes = {
  colors: v.arrayOf(
    v.oneOfType([v.string, v.shape({ color: v.string, title: v.string })]),
  ).isRequired,
};
var Ku =
    Object.assign ||
  ...
  Gt = function (e) {
    ...
    return c.createElement(
      ...
      c.createElement(
        ...
        c.createElement(
          ...
          c.createElement(
            "div",
            { style: m.hue },
            c.createElement(_e, { style: m.Hue, hsl: o, onChange: l }),
          ),
          c.createElement(
            "div",
            { style: m.alpha },
      ...
      c.createElement(An, { colors: h, onClick: l, onSwatchHover: s }),
    );
  };
Gt.propTypes = {
  disableAlpha: v.bool,
...
var Te = function (e) {
    var r = e.hsl,
      ...
      h = function (f) {
        return i({ h: r.h, s: 0.5, l: n, source: "hsl" }, f);
      };
    return c.createElement("div", { style: u.swatch, onClick: h });
  },
  Yu = function (e) {
    var r = e.onClick,
      n = e.hsl,
  ...
  Ut = function (e) {
    ...
    return c.createElement(
      ...
      c.createElement(
        "div",
        { style: u.hue },
        c.createElement(_e, { style: u.Hue, hsl: r, pointer: a, onChange: n }),
      ),
      c.createElement(
        "div",
        { style: u.swatches },
        c.createElement(Yu, { hsl: r, onClick: n }),
      ),
    );
  };
Ut.propTypes = { styles: v.object };
Ut.defaultProps = { pointer: Zu, styles: {} };
k(Ut);
var Ue = {},
  Zr;
function Ju() {
  if (Zr) return Ue;
  ((Zr = 1), Object.defineProperty(Ue, "__esModule", { value: !0 }));
  var t =
      Object.assign ||
      function (o) {
        for (var l = 1; l < arguments.length; l++) {
...
var tc = function (e) {
      ...
      u = y(
        {
          default: {
            ...
            check: { color: kt(r), marginLeft: "8px", display: "none" },
          },
    ...
    return c.createElement(
      ...
      c.createElement("div", { style: u.check }, c.createElement(ec, null)),
    );
  },
  rc = function (e) {
    var r = e.onClick,
      ...
      c.createElement(
        ...
        c.createElement(
          ...
          c.createElement(
            ...
            c.createElement("div", { style: f.clear }),
          ),
        ),
      ),
    );
...
Wt.propTypes = {
  ...
  colors: v.arrayOf(v.arrayOf(v.string)),
  styles: v.object,
};
Wt.defaultProps = {
  width: 320,
  ...
  colors: [
    ...
    [Ee[900], Ee[700], Ee[500], Ee[300], Ee[100]],
    [Se[900], Se[700], Se[500], Se[300], Se[100]],
...
var qt = function (e) {
  var r = e.onChange,
    ...
    d = function (g, m) {
      K(g) && r({ hex: g, source: "hex" }, m);
    };
  return c.createElement(
    "div",
    { style: f.card, className: "twitter-picker " + p },
    c.createElement("div", { style: f.triangleShadow }),
    c.createElement("div", { style: f.triangle }),
    c.createElement(
      "div",
      { style: f.body },
      te(i, function (b, g) {
        return c.createElement(ee, {
          ...
          onClick: d,
          onHover: n,
          focusStyle: { boxShadow: "0 0 4px " + b },
        });
      }),
      c.createElement("div", { style: f.hash }, "#"),
      c.createElement(E, {
        label: null,
        style: { input: f.input },
        value: a.replace("#", ""),
...
qt.propTypes = {
  width: v.oneOfType([v.string, v.number]),
  triangle: v.oneOf(["hide", "top-left", "top-right"]),
  colors: v.arrayOf(v.string),
  styles: v.object,
};
qt.defaultProps = {
...
Vt.propTypes = {
  hsl: v.shape({ h: v.number, s: v.number, l: v.number, a: v.number }),
};
Vt.defaultProps = { hsl: { a: 1, h: 249.94, l: 0.2, s: 0.5 } };
var Xt = function (e) {
  var r = y({
    default: {
      picker: {
...
Xt.defaultProps = { hsl: { a: 1, h: 249.94, l: 0.2, s: 0.5 } };
var nc = function (e) {
    var r = e.onChange,
      n = e.rgb,
      a = e.hsl,
      ...
      o = e.hsv,
      l = function (d, b) {
        if (d.hex) K(d.hex) && r({ hex: d.hex, source: "hex" }, b);
        else if (d.rgb) {
          var g = d.rgb.split(",");
          pt(d.rgb, "rgb") &&
            r({ r: g[0], g: g[1], b: g[2], a: 1, source: "rgb" }, b);
        } else if (d.hsv) {
          var m = d.hsv.split(",");
          pt(d.hsv, "hsv") &&
            ((m[2] = m[2].replace("%", "")),
  ...
  Kt = function (e) {
    ...
    return c.createElement(
      ...
      c.createElement("div", { style: d.head }, s),
      c.createElement("div", { style: d.swatch }),
      c.createElement(
        "div",
        { style: d.saturation },
        c.createElement(je, { hsl: i, hsv: o, pointer: Vt, onChange: n }),
      ),
      c.createElement(
        "div",
        { style: d.body },
        ...
        c.createElement(nc, { rgb: a, hsl: i, hex: l, hsv: o, onChange: n }),
      ),
    );
  };
Kt.propTypes = {
...
Kt.defaultProps = { width: 652, styles: {}, header: "Color picker" };
k(Kt);
const ac = De("div", { target: "e16b190t0" })(({ disabled: t, theme: e }) => ({
  ...
  ic = De("div", { target: "e16b190t1" })(({ theme: t }) => ({
    div: { fontFamily: `${t.genericFonts.bodyFont} !important` },
    label: {
      fontSize: `${t.fontSizes.sm} !important`,
      color: `${t.colors.bodyText} !important`,
    },
    input: {
      fontSize: `${t.fontSizes.md} !important`,
      height: `${t.sizes.minElementHeight} !important`,
      backgroundColor: `${t.colors.secondaryBg} !important`,
      color: `${t.colors.bodyText} !important`,
      borderRadius: `${t.radii.default} !important`,
      boxShadow: "none !important",
      "&:focus-visible": {
        outline: `${t.sizes.borderWidth} solid ${t.colors.primary} !important`,
      },
    },
    svg: { fill: `${t.colors.bodyText} !important` },
  })),
  oc = De("div", { target: "e16b190t2" })(({ disabled: t, theme: e }) => ({
  ...
  lc = De("div", { target: "e16b190t3" })(
    ({ backgroundColor: t, disabled: e, theme: r }) => ({
      width: r.sizes.minElementHeight,
      height: r.sizes.minElementHeight,
      borderRadius: r.radii.default,
      borderColor: r.colors.borderColor,
      borderWidth: r.sizes.borderWidth,
      opacity: e ? "0.4" : "",
      backgroundColor: t,
      borderStyle: "solid",
      cursor: "pointer",
  ...
  sc = De("div", { target: "e16b190t4" })({
    display: "flex",
    alignItems: "center",
  });
je.prototype.getContainerRenderWindow = function () {
  const t = this.container;
  let e = window,
    r = window;
  try {
    for (; !e.document.contains(t) && e.parent !== e; )
      ((r = e), (e = e.parent));
  } catch {
    e = r;
  }
...
const uc = (t) => {
    ...
    const p = A.useCallback((b) => {
      ...
      d = {
        default: {
          picker: {
            borderRadius: h.radii.default,
            boxShadow: "none",
            backgroundColor: h.colors.bgColor,
          },
          saturation: {
            borderRadius: `${h.radii.default} ${h.radii.default} 0 0`,
            userSelect: "none",
          },
          body: { padding: h.spacing.xl },
        },
      };
    return Zt(ac, {
      ...
      children: [
        I(zn, {
          ...
          children:
            l &&
            I(Ln, { children: I(jn, { content: l, placement: In.TOP_RIGHT }) }),
        }),
        I(Gn, {
          onClose: f,
  ...
  cc = A.memo(uc),
  hc = (t, e) => t.getStringValue(e),
  pc = (t) => t.default ?? null,
  fc = (t) => t.value ?? null,
  dc = (t, e, r, n) => {
    e.setStringValue(t, r.value, { fromUi: r.fromUi }, n);
  },
  gc = ({ element: t, disabled: e, widgetMgr: r, fragmentId: n }) => {
    const [a, i] = Wn({
        getStateFromWidgetMgr: hc,
        getDefaultStateFromProto: pc,
        getCurrStateFromProto: fc,
        updateWidgetMgrState: dc,
        element: t,
        widgetMgr: r,
        fragmentId: n,
      }),
    ...
    return I(cc, {
      label: t.label,
      labelVisibility: Un(t.labelVisibility?.value),
      help: t.help,
      onChange: o,
      disabled: e,
      value: a,
