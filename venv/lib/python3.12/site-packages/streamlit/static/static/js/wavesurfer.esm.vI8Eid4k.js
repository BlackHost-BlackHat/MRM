...
const R = {
  decode: function (p, t) {
    return y(this, void 0, void 0, function* () {
      ...
      return e.decodeAudioData(p).finally(() => e.close());
    });
  },
  createBuffer: function (p, t) {
    return (
      typeof p[0] == "number" && (p = [p]),
      (function (e) {
        const i = e[0];
        if (i.some((s) => s > 1 || s < -1)) {
          const s = i.length;
          let n = 0;
          for (let r = 0; r < s; r++) {
            const h = Math.abs(i[r]);
            h > n && (n = h);
          }
          for (const r of e) for (let h = 0; h < s; h++) r[h] /= n;
        }
      })(p),
      {
        duration: t,
        length: p[0].length,
        sampleRate: p[0].length / t,
        numberOfChannels: p.length,
        getChannelData: (e) => p?.[e],
...
function _(p, t) {
  const e = t.xmlns
    ? document.createElementNS(t.xmlns, p)
...
var B = Object.freeze({ __proto__: null, createElement: N, default: N });
const $ = {
  fetchBlob: function (p, t, e) {
    return y(this, void 0, void 0, function* () {
      const i = yield fetch(p, e);
      if (i.status >= 400)
        throw new Error(`Failed to fetch ${p}: ${i.status} (${i.statusText})`);
      return (
        (function (s, n) {
          y(this, void 0, void 0, function* () {
            if (!s.body || !s.headers) return;
            const r = s.body.getReader(),
              h = Number(s.headers.get("Content-Length")) || 0;
            let l = 0;
            const a = (c) =>
                y(this, void 0, void 0, function* () {
                  l += c?.length || 0;
                  const d = Math.round((l / h) * 100);
                  n(d);
                }),
              o = () =>
                y(this, void 0, void 0, function* () {
...
class j extends T {
  ...
  setSrc(t, e) {
    ...
    const s =
      e instanceof Blob && (this.canPlayType(e.type) || !t)
        ...
        : t;
    if ((i && this.media.removeAttribute("src"), s || t))
      try {
        this.media.src = s;
      } catch {
        this.media.src = t;
  ...
  setPlaybackRate(t, e) {
    (e != null && (this.media.preservesPitch = e),
...
class D extends T {
  ...
  onContainerResize() {
    ...
    (t === this.lastContainerWidth && this.options.height !== "auto") ||
      ((this.lastContainerWidth = t), this.reRender());
  }
  initDrag() {
    this.subscriptions.push(
      (function (t, e, i, s, n = 3, r = 0, h = 100) {
        if (!t) return () => {};
        ...
        const o = (c) => {
          ...
          const w = Date.now(),
            g = (f) => {
              ...
              const S = f.clientX,
                ...
                M = S - d,
                k = P - u;
              if (m || Math.abs(M) > n || Math.abs(k) > n) {
            ...
            b = (f) => {
              (f.relatedTarget &&
                f.relatedTarget !== document.documentElement) ||
                v(f);
            },
            E = (f) => {
          ...
          (document.addEventListener("pointermove", g),
            ...
            document.addEventListener("pointerout", b),
            ...
            (a = () => {
              (document.removeEventListener("pointermove", g),
                ...
                document.removeEventListener("pointerout", b),
        ...
        return (
          ...
          () => {
            (a(), t.removeEventListener("pointerdown", o));
          }
        );
      })(
        this.wrapper,
  ...
  getHeight(t, e) {
    var i;
    const s =
      ((i = this.audioData) === null || i === void 0
        ? void 0
    ...
    if (t === "auto") {
      ...
      return e?.every((r) => !r.overlay) ? n / s : n;
    }
    return 128;
  }
  initHtml() {
  ...
  setOptions(t) {
    ...
    ((t.dragToSeek !== !0 && typeof this.options.dragToSeek != "object") ||
      this.initDrag(),
      (this.options = t),
      this.reRender());
  }
  ...
  destroy() {
    ...
    (this.subscriptions.forEach((i) => i()),
      ...
      (e = this.unsubscribeOnScroll) === null ||
        e === void 0 ||
        e.forEach((i) => i()),
      (this.unsubscribeOnScroll = []));
  }
  ...
  renderBarWaveform(t, e, i, s) {
    const n = t[0],
      r = t[1] || t[0],
      h = n.length,
      { width: l, height: a } = i.canvas,
      o = a / 2,
      c = this.getPixelRatio(),
      d = e.barWidth ? e.barWidth * c : 1,
      u = e.barGap ? e.barGap * c : e.barWidth ? d / 2 : 0,
      m = e.barRadius || 0,
      w = l / (d + u) / h,
      g = m && "roundRect" in i ? "roundRect" : "rect";
    i.beginPath();
    let v = 0,
      b = 0,
      E = 0;
    for (let C = 0; C <= h; C++) {
      const f = Math.round(C * w);
      if (f > v) {
        const M = Math.round(b * o * s),
          k = M + Math.round(E * o * s) || 1;
        let x = o - M;
        (e.barAlign === "top"
          ? (x = 0)
          : e.barAlign === "bottom" && (x = a - k),
          i[g](v * (d + u), x, d, k, m),
          (v = f),
          (b = 0),
          (E = 0));
      }
      const S = Math.abs(n[C] || 0),
        P = Math.abs(r[C] || 0);
      (S > b && (b = S), P > E && (E = P));
    }
    (i.fill(), i.closePath());
  ...
  renderLineWaveform(t, e, i, s) {
    const n = (r) => {
      ...
      let d = 0,
        u = 0;
      for (let m = 0; m <= l; m++) {
        const w = Math.round(m * c);
        if (w > d) {
          const v = o + (Math.round(u * o * s) || 1) * (r === 0 ? -1 : 1);
          (i.lineTo(d, v), (d = w), (u = 0));
        }
        const g = Math.abs(h[m] || 0);
        g > u && (u = g);
      }
      i.lineTo(d, o);
    };
  ...
  renderWaveform(t, e, i) {
    ...
    let s = e.barHeight || 1;
    if (e.normalize) {
      const n = Array.from(t[0]).reduce((r, h) => Math.max(r, Math.abs(h)), 0);
      s = n ? 1 / n : 1;
    }
  ...
  renderSingleCanvas(t, e, i, s, n, r, h) {
    const l = this.getPixelRatio(),
      a = document.createElement("canvas");
    ((a.width = Math.round(i * l)),
      (a.height = Math.round(s * l)),
      (a.style.width = `${i}px`),
      (a.style.height = `${s}px`),
      (a.style.left = `${Math.round(n)}px`),
      r.appendChild(a));
    const o = a.getContext("2d");
    if ((this.renderWaveform(t, e, o), a.width > 0 && a.height > 0)) {
      const c = a.cloneNode(),
        d = c.getContext("2d");
      (d.drawImage(a, 0, 0),
        (d.globalCompositeOperation = "source-in"),
        (d.fillStyle = this.convertColorValues(e.progressColor)),
  ...
  renderMultiCanvas(t, e, i, s, n, r) {
    const h = this.getPixelRatio(),
      { clientWidth: l } = this.scrollContainer,
      a = i / h;
    let o = Math.min(D.MAX_CANVAS_WIDTH, l, a),
      c = {};
    if (e.barWidth || e.barGap) {
      const g = e.barWidth || 0.5,
        v = g + (e.barGap || g / 2);
      o % v != 0 && (o = Math.floor(o / v) * v);
    }
    if (o === 0) return;
    const d = (g) => {
        if (g < 0 || g >= u || c[g]) return;
        c[g] = !0;
        const v = g * o;
        let b = Math.min(a - v, o);
        if (e.barWidth || e.barGap) {
          const C = e.barWidth || 0.5,
            f = C + (e.barGap || C / 2);
          b = Math.floor(b / f) * f;
        }
        if (b <= 0) return;
        const E = t.map((C) => {
          const f = Math.floor((v / a) * C.length),
            S = Math.floor(((v + b) / a) * C.length);
          return C.slice(f, S);
        });
        this.renderSingleCanvas(E, e, b, s, v, n, r);
      },
      u = Math.ceil(a / o);
    if (!this.isScrollable) {
      for (let g = 0; g < u; g++) d(g);
      return;
    }
    const m = this.scrollContainer.scrollLeft / a,
      w = Math.floor(m * u);
    if ((d(w - 1), d(w), d(w + 1), u > 1)) {
      const g = this.on("scroll", () => {
        const { scrollLeft: v } = this.scrollContainer,
          b = Math.floor((v / a) * u);
        (Object.keys(c).length > D.MAX_NODES &&
    ...
    var { overlay: n } = e,
      r = (function (o, c) {
        ...
        if (o != null && typeof Object.getOwnPropertySymbols == "function") {
          var m = 0;
          for (u = Object.getOwnPropertySymbols(o); m < u.length; m++)
            c.indexOf(u[m]) < 0 &&
              Object.prototype.propertyIsEnumerable.call(o, u[m]) &&
              (d[u[m]] = o[u[m]]);
        }
        return d;
      })(e, ["overlay"]);
    const h = document.createElement("div"),
      l = this.getHeight(r.height, r.splitChannels);
    ((h.style.height = `${l}px`),
      n && s > 0 && (h.style.marginTop = `-${l}px`),
      (this.canvasWrapper.style.minHeight = `${l}px`),
      this.canvasWrapper.appendChild(h));
    const a = h.cloneNode();
    (this.progressWrapper.appendChild(a),
      this.renderMultiCanvas(t, r, i, l, h, a));
  }
  render(t) {
    return y(this, void 0, void 0, function* () {
      var e;
      (this.timeouts.forEach((l) => l()),
        (this.timeouts = []),
      ...
      if (
        ...
        for (let l = 0; l < t.numberOfChannels; l++) {
          const a = Object.assign(
            ...
            (e = this.options.splitChannels) === null || e === void 0
              ? void 0
              : e[l],
          );
          this.renderChannel([t.getChannelData(l)], a, h, l);
        }
      else {
        const l = [t.getChannelData(0)];
        (t.numberOfChannels > 1 && l.push(t.getChannelData(1)),
          this.renderChannel(l, this.options, h, 0));
      }
  ...
  reRender() {
    if (
      (this.unsubscribeOnScroll.forEach((i) => i()),
      (this.unsubscribeOnScroll = []),
      !this.audioData)
    )
      return;
  ...
  scrollIntoView(t, e = !1) {
    ...
    if (this.isDragging)
      r + 30 > l
        ...
        : r - 30 < h && (this.scrollContainer.scrollLeft -= 30);
    else {
      (r < h || r > l) &&
        (this.scrollContainer.scrollLeft =
          r - (this.options.autoCenter ? a : 0));
      const o = r - i - a;
      e &&
        this.options.autoCenter &&
        o > 0 &&
        (this.scrollContainer.scrollLeft += Math.min(o, 10));
    }
    {
      const o = this.scrollContainer.scrollLeft,
        c = o / s,
        d = (o + n) / s;
      this.emit("scroll", c, d, o, o + n);
    }
  }
  renderProgress(t, e) {
    if (isNaN(t)) return;
        ...
        Array.from(s).map(
          (n) =>
            new Promise((r, h) => {
              n.toBlob(
                (l) => {
                  l ? r(l) : h(new Error("Could not export image"));
                },
                t,
                e,
              );
...
class L extends T {
  ...
  _play() {
    ...
    ((this.paused = !1),
      (t = this.bufferNode) === null || t === void 0 || t.disconnect(),
  ...
  _pause() {
    var t;
    ((this.paused = !0),
      (t = this.bufferNode) === null || t === void 0 || t.stop(),
      (this.playedDuration +=
  ...
  stopAt(t) {
    const e = t - this.currentTime,
      i = this.bufferNode;
    (i?.stop(this.audioContext.currentTime + e),
      i?.addEventListener(
        "ended",
        () => {
  ...
  get duration() {
    var t, e;
    return (t = this._duration) !== null && t !== void 0
      ? t
      : ((e = this.buffer) === null || e === void 0 ? void 0 : e.duration) || 0;
  }
  set duration(t) {
    this._duration = t;
  }
...
class W extends j {
  ...
  constructor(t) {
    const e = t.media || (t.backend === "WebAudio" ? new L() : void 0);
    (super({
      media: e,
    ...
    ((this.renderer = new D(this.options, i)),
    ...
    Promise.resolve().then(() => {
      this.emit("init");
      const { peaks: n, duration: r } = this.options;
      (s || (n && r)) && this.load(s, n, r).catch(() => null);
    });
  }
  ...
  initPlugins() {
    var t;
    !((t = this.options.plugins) === null || t === void 0) &&
      t.length &&
  ...
  setOptions(t) {
    ((this.options = Object.assign({}, this.options, t)),
      t.duration &&
        !t.peaks &&
        (this.decodedData = R.createBuffer(this.exportPeaks(), t.duration)),
      t.peaks &&
        t.duration &&
        (this.decodedData = R.createBuffer(t.peaks, t.duration)),
      this.renderer.setOptions(this.options),
      t.audioRate && this.setPlaybackRate(t.audioRate),
      t.mediaControls != null &&
  ...
  registerPlugin(t) {
    ...
    const e = t.once("destroy", () => {
      ((this.plugins = this.plugins.filter((i) => i !== t)),
        (this.subscriptions = this.subscriptions.filter((i) => i !== e)));
    });
  ...
  loadAudio(t, e, i, s) {
    return y(this, void 0, void 0, function* () {
      ...
      if (
        ...
        const h = this.options.fetchParams || {};
        window.AbortController &&
          !h.signal &&
          ((this.abortController = new AbortController()),
          (h.signal =
            (n = this.abortController) === null || n === void 0
              ? void 0
              : n.signal));
        const l = (o) => this.emit("loading", o);
        e = yield $.fetchBlob(t, l, h);
        const a = this.options.blobMimeType;
        a && (e = new Blob([e], { type: a }));
      }
      this.setSrc(t, e);
      const r = yield new Promise((h) => {
        const l = s || this.getDuration();
        l
          ? h(l)
          : this.mediaSubscriptions.push(
              this.onMediaEvent("loadedmetadata", () => h(this.getDuration()), {
                once: !0,
              }),
            );
      });
      if (!t && !e) {
        const h = this.getMediaElement();
        h instanceof L && (h.duration = r);
      }
      if (i) this.decodedData = R.createBuffer(i, r || 0);
      else if (e) {
        const h = yield e.arrayBuffer();
        this.decodedData = yield R.decode(h, this.options.sampleRate);
      }
      (this.decodedData &&
  ...
  exportPeaks({
    ...
    const s = Math.min(t, this.decodedData.numberOfChannels),
      n = [];
    for (let r = 0; r < s; r++) {
      const h = this.decodedData.getChannelData(r),
        l = [],
        a = h.length / e;
      for (let o = 0; o < e; o++) {
        const c = h.slice(Math.floor(o * a), Math.ceil((o + 1) * a));
        let d = 0;
        for (let u = 0; u < c.length; u++) {
          const m = c[u];
          Math.abs(m) > Math.abs(d) && (d = m);
        }
        l.push(Math.round(d * i) / i);
      }
      n.push(l);
    }
    return n;
  ...
  play(t, e) {
    ...
    return y(this, void 0, void 0, function* () {
      ...
      return (
        e != null &&
          (this.media instanceof L
            ? this.media.stopAt(e)
            : (this.stopAtPosition = e)),
        s
      );
    });
  }
  ...
  destroy() {
    var t;
    (this.emit("destroy"),
      (t = this.abortController) === null || t === void 0 || t.abort(),
...
((W.BasePlugin = class extends T {
  ...
  destroy() {
    (this.emit("destroy"),
      this.subscriptions.forEach((p) => p()),
      (this.subscriptions = []),
      (this.isDestroyed = !0),
