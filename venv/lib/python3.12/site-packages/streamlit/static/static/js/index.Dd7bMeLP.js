...
import { u as D } from "./useBasicWidgetState.D6sOH6oI.js";
import "./FormClearHelper.BB1Km6eP.js";
const U = C("div", { target: "euzcfsp0" })(({ theme: o }) => ({
    "span[aria-disabled='true']": { background: o.colors.fadedText05 },
  })),
  Y = (o, t) => o.getStringArrayValue(t),
  j = (o) => o.default.map((t) => o.options[t]) ?? null,
  K = (o) => o.rawValues ?? null,
  X = (o, t, a, l) => {
    t.setStringArrayValue(o, a.value, { fromUi: a.fromUi }, l);
  },
  G = (o) => {
    const { element: t, widgetMgr: a, fragmentId: l } = o,
      e = W(),
      S = n.useContext(I),
      [i, d] = D({
        getStateFromWidgetMgr: Y,
      ...
      p = t.maxSelections > 0 && i.length >= t.maxSelections,
      f = n.useMemo(() => {
        if (t.maxSelections === 0) return "No results";
      ...
      b = n.useCallback(
        (s) => {
          (t.maxSelections &&
            s.type === "select" &&
            i.length >= t.maxSelections) ||
            d({ value: u(s), fromUi: !0 });
        },
      ...
      T = n.useCallback((s, h) => (p ? [] : m(i)(s, h)), [m, p, i]),
      c = o.disabled || v,
      w = n.useMemo(() => g(i), [g, i]),
      R = n.useMemo(() => {
    ...
    return H("div", {
      ...
      children: [
        r(B, {
          label: t.label,
          disabled: c,
          labelVisibility: L(t.labelVisibility?.value),
          children:
            t.help &&
            r(N, {
              children: r(P, { content: t.help, placement: $.TOP_RIGHT }),
            }),
        }),
        r(U, {
          children: r(E, {
            ...
            overrides: {
              Popover: {
                props: {
                  ignoreBoundary: S,
                  overrides: {
                    Body: { style: () => ({ marginTop: e.spacing.px }) },
                  },
                },
              },
              SelectArrow: {
              ...
              IconsContainer: { style: () => ({ paddingRight: e.spacing.sm }) },
              ControlContainer: {
                style: {
                  maxHeight: R,
                  ...
                  overrides: {
                    Svg: {
                      style: {
                        ...
                        cursor: "pointer",
                        ":hover": { fill: e.colors.bodyText },
                      },
                    },
                  },
                },
              },
              SearchIcon: { style: { color: e.colors.grayTextColor } },
              Tag: {
                props: {
                  overrides: {
                    Root: {
                    ...
                    ActionIcon: {
                      props: {
                        overrides: {
                          Svg: {
                            style: { width: "0.625em", height: "0.625em" },
                          },
                        },
                      },
                    },
              ...
              MultiValue: {
                props: {
                  overrides: { Root: { style: { fontSize: e.fontSizes.sm } } },
                },
              },
              Input: { props: { readOnly: M } },
              Dropdown: { component: F },
            },
          }),
        }),
      ],
