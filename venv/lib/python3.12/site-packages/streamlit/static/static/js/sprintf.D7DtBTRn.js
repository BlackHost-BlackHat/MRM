        ...
        (function () {
          ...
          function v(t, o) {
            ...
            for (a = 0; a < c; a++)
              if (typeof t[a] == "string") p += t[a];
                ...
                if (
                  (i.not_type.test(r.type) &&
                    i.not_primitive.test(r.type) &&
                    e instanceof Function &&
                    (e = e()),
                  i.numeric_arg.test(r.type) &&
                    typeof e != "number" &&
                    isNaN(e))
                )
                  throw new TypeError(
                    f("[sprintf] expecting number but found %T", e),
                  );
                switch ((i.number.test(r.type) && (y = e >= 0), r.type)) {
                  ...
                  case "j":
                    e = JSON.stringify(
                      e,
                      null,
                      r.width ? parseInt(r.width) : 0,
                    );
                    break;
                  case "e":
                    e = r.precision
                      ? parseFloat(e).toExponential(r.precision)
                      : parseFloat(e).toExponential();
                    break;
                  case "f":
                    e = r.precision
                      ? parseFloat(e).toFixed(r.precision)
                      : parseFloat(e);
                    break;
                  case "g":
                    e = r.precision
                      ? String(Number(e.toPrecision(r.precision)))
                      : parseFloat(e);
                    break;
                  case "o":
          ...
          function S(t) {
            ...
            for (var o = t, n, c = [], e = 0; o; ) {
              if ((n = i.text.exec(o)) !== null) c.push(n[0]);
              else if ((n = i.modulo.exec(o)) !== null) c.push("%");
                ...
                if (n[2]) {
                  ...
                  if ((s = i.key.exec(a)) !== null)
                    for (p.push(s[1]); (a = a.substring(s[0].length)) !== ""; )
                      if ((s = i.key_access.exec(a)) !== null) p.push(s[1]);
          ...
          ((k.sprintf = f),
            (k.vsprintf = w),
            typeof window < "u" &&
              ((window.sprintf = f), (window.vsprintf = w)));
        })();
      })(b)),
    b
  );
