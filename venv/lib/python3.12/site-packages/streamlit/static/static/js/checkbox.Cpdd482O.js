...
function P(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2
      ? U(Object(o), !0).forEach(function (r) {
          q(e, r, o[r]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(o))
        : U(Object(o)).forEach(function (r) {
...
function ae(e) {
  ...
  return (
    r.direction === "rtl" && n === "Left"
      ? (n = "Right")
      : r.direction === "rtl" && n === "Right" && (n = "Left"),
...
function le(e) {
  ...
  return t
    ...
    : i && (r || o)
      ? n
        ? c.tickFillErrorSelectedHoverActive
        : a
          ? c.tickFillErrorSelectedHover
          : c.tickFillErrorSelected
      : i
        ? n
          ? c.tickFillErrorHoverActive
          : a
            ? c.tickFillErrorHover
            : c.tickFillError
        : r || o
          ? n
            ? c.tickFillSelectedHoverActive
            : a
              ? c.tickFillSelectedHover
              : c.tickFillSelected
          : n
            ? c.tickFillActive
            : a
...
var E = $("span", function (e) {
  var t = e.$checked,
    ...
    c = a.animation,
    s = o
      ? a.colors.tickMarkFillDisabled
      : r
        ? a.colors.tickMarkFillError
        : a.colors.tickMarkFill,
  ...
  return {
    ...
    backgroundImage: i
      ? "url('data:image/svg+xml,".concat(w, "');")
      : t
        ? "url('data:image/svg+xml,".concat(y, "');")
        : null,
    ...
    function o() {
      ...
      return (
        ...
        f(d(r), "onMouseEnter", function (l) {
          (r.setState({ isHovered: !0 }), r.props.onMouseEnter(l));
        }),
        ...
        f(d(r), "onMouseDown", function (l) {
          (r.setState({ isActive: !0 }), r.props.onMouseDown(l));
        }),
        f(d(r), "onMouseUp", function (l) {
          (r.setState({ isActive: !1 }), r.props.onMouseUp(l));
        }),
        f(d(r), "onFocus", function (l) {
          (r.setState({ isFocused: !0 }),
            r.props.onFocus(l),
            ie(l) && r.setState({ isFocusVisible: !0 }));
        }),
        f(d(r), "onBlur", function (l) {
          (r.setState({ isFocused: !1 }),
            r.props.onBlur(l),
            r.state.isFocusVisible !== !1 &&
        ...
        },
        {
          ...
          value: function () {
            var i = this.props,
              ...
              s =
                c === void 0
                  ? this.props.checkmarkType === T.toggle
                    ? "left"
                    : "right"
                  : c,
              w = i.inputRef,
              ...
              Q = v(A) || _,
              ee = v(N) || B,
              te = { onChange: l, onFocus: this.onFocus, onBlur: this.onBlur },
              re = {
            ...
            return u.createElement(
              ...
              this.props.checkmarkType === T.toggle
                ? u.createElement(
                    ee,
                    g({}, m, p(N)),
                    u.createElement(Q, g({}, m, p(A))),
                  )
                : u.createElement(X, g({}, m, p(z))),
              u.createElement(
                J,
                g(
                  {
