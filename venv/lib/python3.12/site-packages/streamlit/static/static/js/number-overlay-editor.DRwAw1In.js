import { aj as X, r as T } from "./index.CAj-7vWz.js";
import { s as Te } from "./index.DKb_NvmG.js";
import "./withFullScreenWrapper.zothJIsI.js";
import "./Toolbar.D8nHCkuz.js";
...
function ge(e, t, r) {
  ...
  i &&
    ...
    (c = i
      .split("")
      .reverse()
      .reduce(function (I, C, g) {
        return I.length > g
          ? (Number(I[0]) + Number(C)).toString() + I.substring(1, I.length)
          : C + I;
      }, h[0]));
  var x = ye(h[1] || "", t, r),
    y = m ? "-" : "",
...
var Ve = Fe(function (e, t) {
    ...
    return { from: { start: r, end: a - n }, to: { start: r, end: i - n } };
  }),
  Pe = function (e, t) {
...
function Ge(e, t, r, n, a, i, l) {
  ...
  for (
    var p = r.length, h = e.length, c = {}, x = new Array(p), y = 0;
    y < p;
    y++
  ) {
    x[y] = -1;
  ...
  for (var g = n; g < p && (x[g] === -1 || !i(r[g])); ) g++;
  var B = g === p || x[g] === -1 ? h : x[g];
  for (g = n - 1; g > 0 && x[g] === -1; ) g--;
  ...
  var l = Me(function (s, I) {
      ...
      return (
        pe(s)
          ? ((g = ""), (C = ""))
          : typeof s == "number" || I
            ? ((g = typeof s == "number" ? be(s) : s), (C = n(g)))
            : ((g = a(s, void 0)), (C = n(g))),
        { formattedValue: C, numAsString: g }
      );
    }),
    ...
    p = m[1],
    h = function (s, I) {
      (s.formattedValue !== S.formattedValue &&
        p({ formattedValue: s.formattedValue, numAsString: s.value }),
        i(s, I));
    },
    c = e,
    x = r;
...
function He(e) {
  ...
  var k = e.isCharacterSame,
    ...
    W = z[1],
    M = T.useRef(),
    U = T.useRef({ formattedValue: V, numAsString: L }),
    $ = function (o, u) {
      ((U.current = { formattedValue: o.formattedValue, numAsString: o.value }),
        W(o, u));
    },
    J = T.useState(!1),
    ee = J[0],
    d = J[1],
    f = T.useRef(null),
    N = T.useRef({ setCaretTimeout: null, focusTimeout: null });
  T.useEffect(function () {
    return (
      d(!0),
      function () {
        (clearTimeout(N.current.setCaretTimeout),
          clearTimeout(N.current.focusTimeout));
      }
    );
  }, []);
  var R = l,
    A = function (o, u) {
      var v = parseFloat(u);
      return { formattedValue: o, value: u, floatValue: isNaN(v) ? void 0 : v };
    },
    E = function (o, u, v) {
      (o.selectionStart === 0 && o.selectionEnd === o.value.length) ||
        (H(o, u),
        (N.current.setCaretTimeout = setTimeout(function () {
  ...
  T.useEffect(
    function () {
      var o = U.current,
        u = o.formattedValue,
        v = o.numAsString;
      (V !== u || L !== v) && $(A(V, L), { event: void 0, source: re.props });
    },
    [V, L],
  );
  var te = f.current ? ce(f.current) : void 0,
    ne = typeof window < "u" ? T.useLayoutEffect : T.useEffect;
  ne(
    function () {
      var o = f.current;
  ...
  var ue = function (o, u, v) {
      var w = u.target,
        _ = M.current ? Pe(M.current, w.selectionEnd) : Ve(V, o),
        D = Object.assign(Object.assign({}, _), { lastValue: V }),
        b = m(o, D),
        K = R(b);
    ...
    Ie = function (o) {
      ...
      D === void 0 && (D = "");
      var b;
      v === "ArrowLeft" || v === "Backspace"
        ? (b = Math.max(w - 1, 0))
        : v === "ArrowRight"
          ? (b = Math.min(w + 1, D.length))
          : v === "Delete" && (b = w);
      var K = 0;
      v === "Delete" && w === _ && (K = 1);
      ...
      if (G) {
        ...
        v === "Delete" && !F(D[b])
          ? (Z = O(D, b, "right"))
          : v === "Backspace" && !F(D[b]) && (Z = O(D, b, "left"));
      (Z !== b && E(u, Z, D), y(o), le(u, K));
    },
    Ce = function (o) {
      var u = o.target,
        v = function () {
          var w = u.selectionStart,
            _ = u.selectionEnd,
            D = u.value;
          if ((D === void 0 && (D = ""), w === _)) {
            var b = O(D, w);
    ...
    Ee = function (o) {
      ...
      var u = o.target,
        v = o.currentTarget;
      ((f.current = u),
        (N.current.focusTimeout = setTimeout(function () {
          var w = u.selectionStart,
            _ = u.selectionEnd,
            D = u.value;
          D === void 0 && (D = "");
          var b = O(D, w);
          (b !== w && !(w === 0 && _ === D.length) && E(u, b, D),
            I(Object.assign(Object.assign({}, o), { currentTarget: v })));
        }, 0)));
    },
    Re = function (o) {
      ((f.current = null),
    ...
    ve = Object.assign({ inputMode: Ae }, j, {
      type: t,
      value: V,
      onChange: De,
      onKeyDown: Ie,
  ...
  if (r === "text")
    return a
      ? X.createElement(X.Fragment, null, a(V, j) || null)
      : X.createElement("span", Object.assign({}, j, { ref: i }), V);
  if (n) {
    var Oe = n;
...
function he(e, t) {
  ...
  var l = t.allowNegative,
    m = t.thousandsGroupStyle;
  if ((m === void 0 && (m = "thousand"), e === "" || e === "-")) return e;
  var S = ie(t),
    p = S.thousandSeparator,
    h = S.decimalSeparator,
    c = (r !== 0 && e.indexOf(".") !== -1) || (r && n),
    x = se(e, l),
    y = x.beforeDecimal,
    s = x.afterDecimal,
    I = x.addNegation;
...
function ie(e) {
  ...
  return (
    r === !0 && (r = ","),
    n || (n = [t, "."]),
    { decimalSeparator: t, thousandSeparator: r, allowedDecimalSeparators: n }
  );
}
function Je(e, t) {
  e === void 0 && (e = "");
...
function Ye(e, t, r) {
  ...
  var l = r.suffix;
  l === void 0 && (l = "");
  var m = r.decimalScale,
    S = t.from,
    p = t.to,
    h = p.start,
    c = p.end,
    x = ie(r),
    y = x.allowedDecimalSeparators,
    s = x.decimalSeparator,
    I = e[c] === s;
  if (ae(e) && (e === i || e === l) && t.lastValue === "") return e;
  ...
  var g = function (f, N, R) {
      ...
      i.startsWith("-")
        ...
        : f.startsWith("--")
          ? ((A = !1), (E = !0))
          : l.startsWith("-") && f.length === l.length
            ? (A = !1)
            : f[0] === "-" && (A = !0);
      var O = A ? 1 : 0;
      return (
        E && (O = 2),
        O && ((f = f.substring(O)), (N -= O), (R -= O)),
        { value: f, start: N, end: R, hasNegation: A }
      );
    },
    B = g(e, h, c),
    F = B.hasNegation;
  ((n = B), (e = n.value), (h = n.start), (c = n.end));
  var k = g(t.lastValue, S.start, S.end),
    j = k.start,
    z = k.end,
    P = k.value,
    V = e.substring(h, c);
  e.length &&
    P.length &&
    (j > P.length - l.length || z < i.length) &&
    !(V && l.startsWith(V)) &&
    (e = P);
  var L = 0;
  (e.startsWith(i) ? (L += i.length) : h < i.length && (L = h),
    (e = e.substring(L)),
    (c -= L));
  var W = e.length,
    M = e.length - l.length;
  (e.endsWith(l) ? (W = M) : (c > M || c > e.length - l.length) && (W = c),
    (e = e.substring(0, W)),
    (e = Je(F ? "-" + e : e, a)),
    (e = (e.match(Qe(s)) || []).join("")));
  var U = e.indexOf(s);
...
function rt(e) {
  ...
  var h = e.defaultValue,
    ...
    j = x ?? Xe(k, p, t);
  Y(c)
    ? Y(h) || (j = j || typeof h == "number")
    : (j = j || typeof c == "number");
  var z = function (d) {
      return pe(d)
        ? d
        : (typeof d == "number" && (d = be(d)),
          j && typeof m == "number" ? ge(d, m, !!S) : d);
    },
    P = Ne(z(c), z(h), !!j, B, F, y),
    V = P[0],
    L = V.numAsString,
    W = V.formattedValue,
    M = P[1],
    U = function (d) {
      ...
      if (
        (E === void 0 && (E = ""),
        (N === "Backspace" || N === "Delete") && A < p.length)
      ) {
        d.preventDefault();
        return;
      }
      ...
      (N === "Backspace" && E[0] === "-" && R === p.length + 1 && r && H(f, 1),
        m &&
          S &&
          (N === "Backspace" && E[R - 1] === C
            ? (H(f, R - 1), d.preventDefault())
            : N === "Delete" && E[R] === C && d.preventDefault()),
        g?.includes(N) && E[R] === C && H(f, R + 1));
      var O = l === !0 ? "," : l;
      (N === "Backspace" && E[R - 1] === O && H(f, R - 1),
        N === "Delete" && E[R] === O && H(f, R + 1),
        a(d));
    },
    $ = function (d) {
      var f = L;
      if (
        ...
        var N = he(f, e);
        M(
          { formattedValue: N, value: f, floatValue: parseFloat(f) },
          { event: d, source: re.event },
        );
      }
      i(d);
    },
    ...
    ee = function (d) {
      ...
      return c === 0 && S && m && f[te.start] === C && ne(f) < A && ne(R) > E
        ? !1
        : A >= te.start && A < te.end && g && g.includes(O) && Q === C
          ? !0
          : O === Q;
    };
  ...
  return (
    ...
    T.createElement(
      ...
      T.createElement(at, {
        ...
        className: "gdg-input",
        onFocus: (c) =>
          c.target.setSelectionRange(
            a ? 0 : c.target.value.length,
            c.target.value.length,
          ),
        disabled: n === !0,
        decimalScale: l,
        allowNegative: m,
