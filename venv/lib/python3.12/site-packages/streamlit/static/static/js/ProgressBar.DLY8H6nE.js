...
var y = { small: "small", medium: "medium", large: "large" },
  _;
function L() {
  return (
    (L = Object.assign
...
var D = f("div", function (e) {
  ...
  return P(
    ...
    n < 2
      ? {}
      : { marginLeft: o.scale300, ":first-child": { marginLeft: "0" } },
  );
});
...
var H = f("div", function (e) {
  ...
  var S = $.useRoundedCorners ? B.scale0 : 0,
    h = { transform: "translateX(-".concat(x, ")") },
    C =
      d === m.inProgress
        ? {
  ...
  return P(
    P(
      ...
      n
        ...
        : { borderTopRightRadius: g, borderBottomRightRadius: g },
    ),
    {},
    { height: R },
    B,
  ...
  return function (t) {
    return I.createElement(
      ...
      L(
        {
          viewBox: "0 0 "
            .concat(c[t.$size].width, " ")
            .concat(c[t.$size].height),
...
V(U, function (e) {
  return function (t) {
    return I.createElement(e, L({ d: c[t.$size].d }, t));
  };
});
...
var le = f("div", function (e) {
  var r = e.$theme,
    t = e.$size;
  return P({ color: r.colors.contentPrimary }, r.typography[c[t].typography]);
});
            ...
            for (var ne = [], E = 0; E < R; E++)
              ne.push(
                u.createElement(
                  he,
                  p({ key: E }, v, ve),
                  u.createElement(Pe, p({ $index: E }, v, Re)),
                ),
              );
            return ne;
          }
            ...
            u.createElement(
              ...
              d
                ? u.createElement(
                    u.Fragment,
                    null,
                    u.createElement(re, p({ $isLeft: !0, $size: v.$size }, te)),
                    u.createElement(re, p({ $size: v.$size }, te)),
                  )
                : Be(),
            ),
            m && u.createElement(Se, p({}, v, Oe), s(l, h, $)),
          );
        },
      },
    ]),
...
var de = u.forwardRef(function (e, r) {
  return u.createElement(ue, p({ forwardedRef: r }, e));
});
...
function Ke({ value: e, size: r = "sm", overrides: t }) {
  const n = Le(),
    a = {
      xs: n.spacing.twoXS,
      sm: n.spacing.sm,
  ...
  return xe(de, { value: e, overrides: ke(o, t) });
}
export { Ke as P, Ze as S };
