...
(self["webpackChunk_jupyterlab_application_top"] =
  ...
  [785],
  {
    ...
    60785: (t, e, n) => {
      ...
      var h = {};
      n.r(h);
      n.d(h, { crossfilter: () => DB, resolvefilter: () => CB });
      var p = n(26372);
      var m = {},
        g = {},
        y = 34,
      ...
      function R(t) {
        return B(t, O.apply(this, arguments));
      }
      function O(t, e, n) {
        var i, r, s;
      ...
      const Bt = {
        ...
        [st]: (t) => bt(t),
        [nt]: (t) => xt(t),
        [nt + rt]: (t, e) => zt(xt(t), t.getDay(), _t(e)),
        [rt]: (t, e) => zt(1, t.getDay(), _t(e)),
      };
      const $t = { [tt]: (t) => 3 * t, [nt]: (t, e) => zt(t, 0, _t(e)) };
      function Rt(t, e) {
        return Ft(t, e || 1, Bt, $t, wt);
      }
      const Ot = {
        ...
        [st]: (t) => Et(t),
        [nt]: (t) => Mt(t),
        [rt]: (t, e) => zt(1, t.getUTCDay(), Dt(e)),
        [nt + rt]: (t, e) => zt(Mt(t), t.getUTCDay(), Dt(e)),
      };
      const Tt = { [tt]: (t) => 3 * t, [nt]: (t, e) => zt(t, 0, Dt(e)) };
      function Nt(t, e) {
      ...
      function Xs(t) {
        Bi.call(this, [undefined, undefined], t);
      }
      Xs.Definition = {
        type: "Extent",
        metadata: {},
      ...
      function Ru() {
        var t = pu(zu()).domain([1, 10]);
        t.copy = function () {
          return Bu(t, Ru()).base(t.base());
        };
        return su.K.apply(t, arguments);
      }
      function Ou() {
        var t = ku(zu());
        t.copy = function () {
          return Bu(t, Ou()).constant(t.constant());
        };
        return su.K.apply(t, arguments);
      }
      function Tu() {
        var t = bu(zu());
        t.copy = function () {
          return Bu(t, Tu()).exponent(t.exponent());
        };
        return su.K.apply(t, arguments);
      }
      function Nu() {
      ...
      function Uu() {
        var t = ku(Pu());
        t.copy = function () {
          return Bu(t, Uu()).constant(t.constant());
        };
        return su.K.apply(t, arguments);
      }
      function ju() {
      ...
      const Bc = (t) => Mc[t.type] || t.bins;
      function $c(t, e, n, i, r, s, a) {
        const o =
          Dc[e.type] && s !== ml && s !== gl
            ? Fc(t, e, r)
            : kc(t, e, n, r, s, a);
        return i === mc && Bc(e) ? Rc(o) : i === gc ? Tc(o) : Nc(o);
      }
      const Rc = (t) => (e, n, i) => {
      ...
      function hf(t, e, n, i, r, s, a, o, u) {
        ...
        const B = Math.ceil(Math.abs(z / (of + 0.001)));
        const $ = [];
        for (let R = 0; R < B; ++R) {
          const t = F + (R * z) / B;
          const e = F + ((R + 1) * z) / B;
      ...
      const td = (0, ho.A)()
        ...
        rd = zf().x(Rf).y(Of).width(Tf).height(Nf).cornerRadius(Wf, Xf, Hf, Vf),
        sd = Vo().type(Jf).size(Qf),
        ad = Bf().x(Rf).y(Of).defined(Zf).size(Kf);
      function od(t) {
        return (
          t.cornerRadius ||
      ...
      class jm extends hm {
        constructor(t, e) {
          ...
          this._events = {};
          this.events = Pm;
          this.pointermove = Hm([km, Fm], [Mm, zm], [Em, Sm]);
        ...
        initialize(t, e, n) {
          ...
          [Bm, Dm, wm, km, Em, xm].forEach((t) => Ym(this, t));
      ...
      class Rg extends mm {
        ...
        initialize(t, e, n, i, r) {
          ...
          if (t) {
            ...
            this._svg.setAttributeNS(Bg, "xmlns", $g);
            this._svg.setAttributeNS(Bg, "xmlns:xlink", Vh["xmlns:xlink"]);
            this._svg.setAttribute("version", Vh["version"]);
            this._svg.setAttribute("class", "marks");
            lm(t, 1);
            this._root = um(this._svg, zg, "g", $g);
            Wg(this._root, Sg);
            lm(this._svg, zg + 1);
          }
      ...
      function Rv(t, e, n) {
        ...
        if (o && Bv(n.center, rv) && c !== 1) {
          for (A = 0; A < d; ++A) {
            M = o === tv ? v : y[~~(A / c)];
            z = M - _[A].y2 - e[A].y - x[A];
            if (z > 0) x[A] += z / 2;
          }
        }
        for (A = 0; A < d; ++A) {
      ...
      function Ov(t, e, n) {
        ...
        if (i.rowtitle) {
          p = Bv(n.titleAnchor, rv);
          g = Bv(a, "rowTitle");
          g = p === By ? d + g : c - g;
          m = Bv(n.titleBand, rv, 0.5);
          Pv(t, i.rowtitle, g, 0, y, m);
        }
        if (i.coltitle) {
          p = Bv(n.titleAnchor, iv);
          g = Bv(a, "columnTitle");
          g = p === By ? h + g : f - g;
          m = Bv(n.titleBand, iv, 0.5);
      ...
      function Uv(t, e, n, i, r, s, a) {
        ...
        switch (e) {
          ...
          case My:
            ...
            break;
          case Dy:
            f.anchor = { x: s - u, y: u, column: By };
            break;
          case Cy:
            f.anchor = { x: u, y: a - u, row: By };
            break;
          case Fy:
            f.anchor = { x: s - u, y: a - u, column: By, row: By };
            break;
        }
        return f;
      }
      ...
      function Wv(t, e, n, i, r, s, a) {
        const o = t.datum.type !== "symbol",
          ...
          d = u && s ? 0 : c,
          h = r <= 0 ? 0 : $p(n);
        return Math.round(i === Sy ? f : i === By ? d - h : 0.5 * (c - h));
      }
      function Xv(t, e, n, i) {
        e.x += n;
        e.y += i;
      ...
      function Ew(t, e) {
        ...
        function a(t, e) {
          var a = xx(e),
            ...
            l = Dx(e),
            c = l * n + o * i;
          return [bx(u * r - c * s, o * n - l * i), Bx(c * r + u * s)];
        }
        a.invert = function (t, e) {
          var a = xx(e),
            ...
            l = Dx(e),
            c = l * r - u * s;
          return [bx(u * r + l * s, o * n + c * i), Bx(c * n - o * i)];
        };
        return a;
      }
      function Mw(t) {
      ...
      function Hw(t, e) {
        ...
        a.invert = function (t, e) {
          ...
          return [a / i, Bx((r - (t * t + n * n) * i * i) / (2 * i))];
        };
        return a;
      }
      function Vw() {
      ...
      function Bk() {
        ...
        function s(n, i, r) {
          ...
          while (++l < e - 1) {
            ...
            f = n[l * t + t] >= i;
            d = n[l * t] >= i;
            zk[(f << 1) | (d << 2)].forEach(p);
            while (++u < t - 1) {
              ((c = f), (f = n[l * t + t + u + 1] >= i));
              ((h = d), (d = n[l * t + u + 1] >= i));
              zk[c | (f << 1) | (d << 2) | (h << 3)].forEach(p);
            }
            zk[f | (d << 3)].forEach(p);
          }
          u = -1;
      ...
      function XM(t, e) {
        ...
        jM(i, n, (r = t[2]));
        ((n = new WM(n)), (i = new WM(i)), (r = new WM(r)));
        n.next = r.previous = i;
        i.next = n.previous = r;
        r.next = i.previous = n;
        t: for (u = 3; u < s; ++u) {
          (jM(n._, i._, (r = t[u])), (r = new WM(r)));
      ...
      function QM() {
        ...
        function r(r) {
          ...
          if (t) {
            r.eachBefore(KM(t))
              .eachAfter(ZM(i, 0.5, s))
              .eachBefore(JM(1));
          } else {
            r.eachBefore(KM(VM))
              .eachAfter(ZM(MM.P, 1, s))
              .eachAfter(ZM(i, r.r / Math.min(e, n), s))
              .eachBefore(JM(Math.min(e, n) / (2 * r.r)));
          }
          return r;
        }
        r.radius = function (e) {
          return arguments.length ? ((t = (0, EM.l)(e)), r) : t;
        };
        r.size = function (t) {
        ...
        r.padding = function (t) {
          return arguments.length
            ? ((i = typeof t === "function" ? t : (0, MM.A)(+t)), r)
            : i;
        };
        return r;
      }
      ...
      function uD() {
        ...
        function i(i) {
          ...
          for (l = 0, o = r.length; l < o; ++l) {
            ((u = r[l]), (d = r[l] = new kM.bP(u)));
            if ((h = s(u, l, i)) != null && (h += "")) {
              p = d.id = h;
              m.set(p, m.has(p) ? rD : d);
            }
            if ((h = a(u, l, i)) != null && (h += "")) {
              d.parent = h;
            }
          ...
          for (l = 0; l < o; ++l) {
            ...
            if ((h = d.parent)) {
              ...
              if (f === rD) throw new Error("ambiguous: " + h);
          ...
          if (n != null) {
            while (c.data === sD && c.children.length === 1) {
              ((c = c.children[0]), --o);
            }
        ...
        i.id = function (e) {
          return arguments.length ? ((t = (0, EM.l)(e)), i) : t;
        };
        i.parentId = function (t) {
          return arguments.length ? ((e = (0, EM.l)(t)), i) : e;
        };
        i.path = function (t) {
          return arguments.length ? ((n = (0, EM.l)(t)), i) : n;
        };
        return i;
      }
      function lD(t) {
        t = `${t}`;
        let e = t.length;
        if (fD(t, e - 1) && !fD(t, e - 2)) t = t.slice(0, -1);
        return t[0] === "/" ? t : `/${t}`;
      }
      function cD(t) {
        let e = t.length;
        if (e < 2) return "";
        while (--e > 1) if (fD(t, e)) break;
        return t.slice(0, e);
      }
      function fD(t, e) {
        if (t[e] === "/") {
      ...
      vD.prototype = Object.create(kM.bP.prototype);
      function bD(t) {
        var e = new vD(t, 0),
          n,
          i = [e],
        ...
        while ((n = i.pop())) {
          if ((s = n._.children)) {
            ...
            for (a = o - 1; a >= 0; --a) {
              i.push((r = n.children[a] = new vD(s[a], a)));
              r.parent = n;
            }
          }
        }
        (e.parent = new vD(null, 0)).children = [e];
        return e;
      }
      function xD() {
        var t = dD,
          ...
          if ((a = t._squarify) && a.ratio === e) {
            ...
            while (++c < d) {
              ...
              for (l = o.value = 0, f = u.length; l < f; ++l)
                o.value += u[l].value;
              if (o.dice)
                (0, eD.A)(o, n, i, r, h ? (i += ((s - i) * o.value) / h) : s);
              else
                (0, SD.A)(o, n, i, h ? (n += ((r - n) * o.value) / h) : r, s);
              h -= o.value;
            }
          } else {
            t._squarify = a = (0, BD.AI)(e, t, n, i, r, s);
            a.ratio = e;
          }
        }
        n.ratio = function (e) {
      ...
      const qD = (t, e) => (t.parent === e.parent ? 1 : 2);
      (0, p.B)(PD, Bi, {
        transform(t, e) {
          if (!e.source || !e.source.root) {
            (0, p.z3)(
          ...
          ID(n, this.params, t);
          if (n.separation) {
            n.separation(t.separation !== false ? qD : p.xH);
          }
          try {
            this.value = n(r);
          } catch (a) {
      ...
      const YD = ["x0", "y0", "x1", "y1", "depth", "children"];
      function WD(t) {
        PD.call(this, t);
      }
      WD.Definition = {
      ...
      (0, p.B)(XD, Bi, {
        transform(t, e) {
          ...
          if (s) {
            n = r.source.length
              ? OD(uD().id(t.key).parentId(t.parentKey)(r.source), t.key, p.vN)
              : OD(uD()([{}]), t.key, t.key);
          }
      ...
      const HD = { tidy: xD, cluster: CD };
      const VD = ["x", "y", "depth", "children"];
      function QD(t) {
        PD.call(this, t);
      }
      QD.Definition = {
      ...
      const JD = ["x0", "y0", "x1", "y1", "depth", "children"];
      function tC(t) {
        PD.call(this, t);
      }
      tC.Definition = {
      ...
      function sC(t, e, n) {
        ...
        if (i === "group") {
          ...
          Qp[i].draw(t, { items: n ? e.map(aC) : e });
        }
      }
      function aC(t) {
        const e = _n(t, {});
      ...
      const oC = 5,
        uC = 31,
        lC = 32,
        cC = new Uint32Array(lC + 1),
        fC = new Uint32Array(lC + 1);
      fC[0] = 0;
      cC[0] = ~fC[0];
      for (let WY = 1; WY <= lC; ++WY) {
        fC[WY] = (fC[WY - 1] << 1) | 1;
        cC[WY] = ~fC[WY];
      }
      function dC(t, e) {
        const n = new Uint32Array(~~((t * e + lC) / lC));
        function i(t, e) {
          n[t] |= e;
        }
        function r(t, e) {
        ...
        return {
          ...
          getRange: (e, i, r, s) => {
            ...
            for (; a >= i; --a) {
              ...
              c = u >>> oC;
              if (l === c) {
                if (n[l] & cC[o & uC] & fC[(u & uC) + 1]) {
                  return true;
                }
              } else {
                if (n[l] & cC[o & uC]) return true;
                if (n[c] & fC[(u & uC) + 1]) return true;
                for (let t = l + 1; t < c; ++t) {
                  if (n[t]) return true;
                }
              }
      ...
      function yC(t, e, n, i) {
        ...
        function u(e, n, i, u, l) {
          ...
          if (
            !mC(c, f, u, l, r, s) &&
            !gC(t, c, f, l, u, d, a, o) &&
            !gC(t, c, f, l, u, l, a, null)
          ) {
            while (h - d >= 1) {
              p = (d + h) / 2;
              if (gC(t, c, f, l, u, p, a, o)) {
                h = p;
              } else {
                d = p;
              }
          ...
          for (let i = 0; i < c; ++i) {
            ...
            while (h.length) {
              ...
              if (
                !mC(w, A, d, f, r, s) &&
                !gC(t, w, A, f, d, M, a, o) &&
                !gC(t, w, A, f, d, f, a, null)
              ) {
                while (D - M >= 1) {
                  C = (M + D) / 2;
                  if (gC(t, w, A, f, d, C, a, o)) {
                    D = C;
                  } else {
                    M = C;
                  }
      ...
      const _C = ["right", "center", "left"],
        wC = ["bottom", "middle", "top"];
      function AC(t, e, n, i) {
        const r = t.width,
          s = t.height,
          a = e[0],
      ...
      function kC(t, e, n, i, r, s, a, o, u, l, c, f) {
        return !(
      ...
      const BC = { naive: pC, "reduced-search": yC, floodfill: xC };
      function $C(t, e, n, i, r, s, a, o, u, l, c) {
        ...
        if (!b) {
          ...
          k = s.length || i ? iC(A, i || [], s, e, g) : nC(A, a && w);
        }
        const E = g ? BC[c](A, k, a, u) : AC(A, k, h, d);
      ...
      const LC = ["x", "y", "opacity", "align", "baseline"];
      const PC = [
        "top-left",
        "left",
        "bottom-left",
      ...
      qC.Definition = {
        ...
        params: [
          ...
          { name: "sort", type: "compare" },
          { name: "anchor", type: "string", array: true, default: PC },
      ...
      const GC = (t, e) => (t === "poly" ? e : t === "quad" ? 2 : 1);
      function YC(t) {
        Bi.call(this, null, t);
      }
      YC.Definition = {
      ...
      const WC = 11102230246251565e-32;
      const XC = 134217729;
      const HC = (3 + 8 * WC) * WC;
      ...
      function QC(t, e, n, i, r, s, a, o) {
        return VC(VC(t, e, n, i, a), a, r, s, o);
      }
      function KC(t, e, n, i) {
        let r, s, a, o, u;
        let l, c, f, d, h, p;
      ...
      const eF = (3 + 16 * WC) * WC;
      const nF = (2 + 12 * WC) * WC;
      const iF = (9 + 64 * WC) * WC * WC;
      const rF = tF(4);
      const sF = tF(8);
      const aF = tF(12);
      const oF = tF(16);
      const uF = tF(4);
      function lF(t, e, n, i, r, s, a) {
        let o, u, l, c;
        ...
        uF[2] = v - (k - f) + (y - f);
        uF[3] = k;
        const $ = VC(B, aF, 4, uF, oF);
        return oF[$ - 1];
      }
      function cF(t, e, n, i, r, s) {
        const a = (e - s) * (n - r);
        const o = (t - r) * (i - s);
        const u = a - o;
        if (a === 0 || o === 0 || a > 0 !== o > 0) return u;
        const l = Math.abs(a + o);
        if (Math.abs(u) >= eF * l) return u;
        return -lF(t, e, n, i, r, s, l);
      }
      ...
      function NF(t, e, n, i, r, s, a, o, u, l, c, f, d) {
        let h;
        let p, m, g;
        let y, v, b;
        let x, _, w;
        let A, k, E, M, D, C, F, S, z, B, $, R, O, T, N;
        const L = t - l;
        const P = i - l;
        const q = a - l;
        const I = e - c;
        ...
        yF[3] = N;
        h = sum(
          sum(scale(4, mF, G, CF), CF, scale(4, gF, Y, FF), FF, SF),
          SF,
          scale(4, yF, W, CF),
          CF,
          BF,
        ...
        const V = OF(p, y, P, U, q, j, vF, bF);
        const Q = OF(m, v, q, j, L, I, xF, _F);
        const K = OF(g, b, L, I, P, U, wF, AF);
        const Z = sum(Q, xF, K, AF, kF);
        h = RF(h, scale(Z, kF, G, SF), SF);
        const J = sum(K, wF, V, bF, EF);
        h = RF(h, scale(J, EF, Y, SF), SF);
        const tt = sum(V, vF, Q, _F, MF);
        h = RF(h, scale(tt, MF, W, SF), SF);
        if (x !== 0) {
          h = RF(h, scale(4, mF, x, zF), zF);
          h = RF(h, scale(Z, kF, x, SF), SF);
        }
        if (_ !== 0) {
          h = RF(h, scale(4, gF, _, zF), zF);
          h = RF(h, scale(J, EF, _, SF), SF);
        }
        if (w !== 0) {
          h = RF(h, scale(4, yF, w, zF), zF);
          h = RF(h, scale(tt, MF, w, SF), SF);
        }
        if (p !== 0) {
          if (v !== 0) {
      ...
      function LF(t, e, n, i, r, s, a, o, u, l, c, f) {
        const d = t - l;
        const h = i - l;
        const p = a - l;
        const m = e - c;
        ...
        return NF(t, e, n, i, r, s, a, o, u, l, c, f, C);
      }
      function PF(t, e, n, i, r, s, a, o, u, l, c, f) {
        const d = t - l;
        const h = i - l;
        const p = a - l;
        const m = e - c;
      ...
      const qF = (10 + 96 * WC) * WC;
      const IF = (4 + 48 * WC) * WC;
      const UF = (44 + 576 * WC) * WC * WC;
      const jF = tF(4);
      const GF = tF(4);
      const YF = tF(4);
      const WF = tF(4);
      ...
      function xS(t, e, n, i, r, s, a, o, u) {
        ...
        l = sum(
          sum(
            sum(
              scale(scale(4, jF, G, lS), lS, G, cS),
              cS,
              scale(scale(4, jF, X, lS), lS, X, fS),
              fS,
              hS,
            ),
            hS,
            sum(
              scale(scale(4, GF, Y, lS), lS, Y, cS),
              cS,
              scale(scale(4, GF, H, lS), lS, H, fS),
              fS,
              pS,
            ),
            pS,
          ...
          gS,
          sum(
            scale(scale(4, YF, W, lS), lS, W, cS),
            cS,
            scale(scale(4, YF, V, lS), lS, V, fS),
            fS,
            hS,
          ),
          hS,
        ...
        K = UF * u + resulterrbound * Math.abs(Q);
        Q +=
        ...
        if (c !== 0) {
          ...
          l = bS(
            ...
            sum_three(
              scale(g, KF, 2 * G, cS),
              cS,
              scale(scale(4, HF, c, lS), lS, H, fS),
              fS,
              scale(scale(4, XF, c, lS), lS, -V, dS),
              dS,
              hS,
              mS,
            ),
        ...
        if (h !== 0) {
          ...
          l = bS(
            ...
            sum_three(
              scale(y, ZF, 2 * X, cS),
              cS,
              scale(scale(4, XF, h, lS), lS, W, fS),
              fS,
              scale(scale(4, HF, h, lS), lS, -Y, dS),
              dS,
              hS,
              mS,
            ),
        ...
        if (f !== 0) {
          ...
          l = bS(
            ...
            sum_three(
              scale(v, JF, 2 * Y, cS),
              cS,
              scale(scale(4, WF, f, lS), lS, V, fS),
              fS,
              scale(scale(4, HF, f, lS), lS, -X, dS),
              dS,
              hS,
              mS,
            ),
        ...
        if (p !== 0) {
          ...
          l = bS(
            ...
            sum_three(
              scale(b, tS, 2 * H, cS),
              cS,
              scale(scale(4, HF, p, lS), lS, G, fS),
              fS,
              scale(scale(4, WF, p, lS), lS, -W, dS),
              dS,
              hS,
              mS,
            ),
        ...
        if (d !== 0) {
          ...
          l = bS(
            ...
            sum_three(
              scale(x, eS, 2 * W, cS),
              cS,
              scale(scale(4, XF, d, lS), lS, X, fS),
              fS,
              scale(scale(4, WF, d, lS), lS, -H, dS),
              dS,
              hS,
              mS,
            ),
        ...
        if (m !== 0) {
          ...
          l = bS(
            ...
            sum_three(
              scale(_, nS, 2 * V, cS),
              cS,
              scale(scale(4, WF, m, lS), lS, Y, fS),
              fS,
              scale(scale(4, XF, m, lS), lS, -G, dS),
              dS,
              hS,
              mS,
            ),
        ...
        if (c !== 0 || h !== 0) {
          ...
          if (c !== 0) {
            const t = scale(A, rS, c, dS);
            l = bS(
              l,
              sum(scale(g, KF, c, cS), cS, scale(t, dS, 2 * G, hS), hS, mS),
              mS,
            );
            const e = scale(M, oS, c, lS);
            l = bS(
              l,
              sum_three(
                scale(e, lS, 2 * G, cS),
            ...
            if (p !== 0) {
              l = bS(l, scale(scale(4, HF, c, lS), lS, p, cS), cS);
            }
            if (m !== 0) {
              l = bS(l, scale(scale(4, XF, -c, lS), lS, m, cS), cS);
            }
          }
          if (h !== 0) {
            const t = scale(A, rS, h, dS);
            l = bS(
              l,
              sum(scale(y, ZF, h, cS), cS, scale(t, dS, 2 * X, hS), hS, mS),
              mS,
            );
            const e = scale(M, oS, h, lS);
            l = bS(
              l,
              sum_three(
                scale(e, lS, 2 * X, cS),
        ...
        if (f !== 0 || p !== 0) {
          ...
          if (f !== 0) {
            const t = scale(k, sS, f, dS);
            l = bS(
              l,
              sum(scale(v, JF, f, cS), cS, scale(t, dS, 2 * Y, hS), hS, mS),
              mS,
            );
            const e = scale(D, uS, f, lS);
            l = bS(
              l,
              sum_three(
                scale(e, lS, 2 * Y, cS),
            ...
            if (m !== 0) {
              l = bS(l, scale(scale(4, WF, f, lS), lS, m, cS), cS);
            }
            if (h !== 0) {
              l = bS(l, scale(scale(4, HF, -f, lS), lS, h, cS), cS);
            }
          }
          if (p !== 0) {
            const t = scale(k, sS, p, dS);
            l = bS(
              l,
              sum(scale(b, tS, p, cS), cS, scale(t, dS, 2 * H, hS), hS, mS),
              mS,
            );
            const e = scale(D, uS, p, lS);
            l = bS(
              l,
              sum_three(
                scale(e, lS, 2 * H, cS),
        ...
        if (d !== 0 || m !== 0) {
          ...
          if (d !== 0) {
            const t = scale(w, iS, d, dS);
            l = bS(
              l,
              sum(scale(x, eS, d, cS), cS, scale(t, dS, 2 * W, hS), hS, mS),
              mS,
            );
            const e = scale(E, aS, d, lS);
            l = bS(
              l,
              sum_three(
                scale(e, lS, 2 * W, cS),
            ...
            if (h !== 0) {
              l = bS(l, scale(scale(4, XF, d, lS), lS, h, cS), cS);
            }
            if (p !== 0) {
              l = bS(l, scale(scale(4, WF, -d, lS), lS, p, cS), cS);
            }
          }
          if (m !== 0) {
            const t = scale(w, iS, m, dS);
            l = bS(
              l,
              sum(scale(_, nS, m, cS), cS, scale(t, dS, 2 * V, hS), hS, mS),
              mS,
            );
            const e = scale(E, aS, m, lS);
            l = bS(
              l,
              sum_three(
                scale(e, lS, 2 * V, cS),
      ...
      const AS = (16 + 224 * WC) * WC;
      const kS = (5 + 72 * WC) * WC;
      const ES = (71 + 1408 * WC) * WC * WC;
      const MS = tF(4);
      const DS = tF(4);
      const CS = tF(4);
      const FS = tF(4);
      ...
      function mz(t, e, n, i, r, s, a, o, u, l, c, f) {
        const d = sum(
          sum(t, e, n, i, az),
          az,
          negate(sum(r, s, a, o, oz), oz),
          oz,
          uz,
        );
        return sum_three(
          scale(scale(d, uz, u, lz), lz, u, cz),
          cz,
          scale(scale(d, uz, l, lz), lz, l, fz),
          fz,
          scale(scale(d, uz, c, lz), lz, c, dz),
          dz,
          hz,
          f,
        );
      }
      function gz(t, e, n, i, r, s, a, o, u, l, c, f, d, h, p) {
        ...
        OS[2] = w - (C - m) + (_ - m);
        OS[3] = C;
        const F = pz(MS, DS, zS, u, n, -s, TS);
        const S = pz(DS, CS, BS, f, s, -u, NS);
        const z = pz(CS, FS, $S, p, u, -f, LS);
        const B = pz(FS, SS, RS, n, f, -p, PS);
        const $ = pz(SS, MS, OS, s, p, -n, qS);
        const R = pz(MS, BS, RS, f, n, s, IS);
        const O = pz(DS, $S, OS, p, s, u, US);
        const T = pz(CS, RS, zS, n, u, f, jS);
        const N = pz(FS, OS, BS, s, f, p, GS);
        const L = pz(SS, zS, $S, u, p, n, YS);
        const P = sum_three(
          mz(z, LS, O, US, N, GS, S, NS, t, e, n, WS),
          WS,
          mz(B, PS, T, jS, L, YS, z, LS, i, r, s, XS),
          XS,
          sum_three(
            mz($, qS, N, GS, R, IS, B, PS, a, o, u, HS),
            HS,
            mz(F, TS, L, YS, O, US, $, qS, l, c, f, VS),
            VS,
            mz(S, NS, R, IS, T, jS, F, TS, d, h, p, QS),
            QS,
            ZS,
            JS,
          ),
      ...
      const bz = tF(96);
      const xz = tF(1152);
      function _z(t, e, n, i, r, s, a, o, u, l) {
        const c = pz(t, e, n, i, r, s, sz);
        return sum_three(
          scale(scale(c, sz, a, az), az, a, yz),
          yz,
          scale(scale(c, sz, o, az), az, o, vz),
          vz,
          scale(scale(c, sz, u, az), az, u, bz),
          bz,
          lz,
          l,
        );
      }
      function wz(t, e, n, i, r, s, a, o, u, l, c, f, d, h, p, m) {
        let g, y, v, b, x, _;
        let w, A, k, E;
        let M, D, C, F;
        let S, z, B, $;
        ...
        const st = sum(
          sum(
            negate(_z(DS, CS, BS, rt, nt, -it, X, K, et, WS), WS),
            WS,
            _z(CS, RS, zS, et, it, rt, H, Z, nt, XS),
            XS,
            KS,
          ),
          KS,
          sum(
            negate(_z(RS, MS, BS, nt, rt, et, V, J, it, HS), HS),
            HS,
            _z(MS, DS, zS, it, et, -nt, Q, tt, rt, VS),
            VS,
            ZS,
          ),
          ZS,
        ...
        ot = ES * m + resulterrbound * Math.abs(at);
        ...
        at +=
          (H * H + Z * Z + nt * nt) *
            (it * ft + rt * dt + et * ct + (B * b + $ * x + S * v)) +
          (Q * Q + tt * tt + rt * rt) *
            (et * lt - nt * dt + it * ut + (S * y - z * x + B * g)) -
          ((X * X + K * K + et * et) *
            (nt * ct - it * ht + rt * lt + (z * v - B * _ + $ * y)) +
            (V * V + J * J + it * it) *
              (rt * ut + et * ht + nt * ft + ($ * g + S * _ + z * b))) +
          2 *
            ((H * A + Z * D + nt * z) * (it * b + rt * x + et * v) +
              (Q * E + tt * F + rt * $) * (et * y - nt * x + it * g) -
              ((X * w + K * M + et * S) * (nt * v - it * _ + rt * y) +
                (V * k + J * C + it * B) * (rt * g + et * _ + nt * b)));
        if (at >= ot || -at >= ot) {
          return at;
        }
        return gz(t, e, n, i, r, s, a, o, u, l, c, f, d, h, p);
      }
      function Az(t, e, n, i, r, s, a, o, u, l, c, f, d, h, p) {
        const m = t - d;
        const g = i - d;
        const y = a - d;
        const v = l - d;
        ...
        return -wz(t, e, n, i, r, s, a, o, u, l, c, f, d, h, p, gt);
      }
      function kz(t, e, n, i, r, s, a, o, u, l, c, f, d, h, p) {
        const m = t - d;
        const g = i - d;
        const y = a - d;
        const v = l - d;
      ...
      const Ez = Math.pow(2, -52);
      const Mz = new Uint32Array(512);
      class Dz {
        static from(t, e = Oz, n = Tz) {
          const i = t.length;
        ...
        update() {
          ...
          for (let E = 0; E < s; E++) {
            if (E === h || E === p) continue;
            const e = zz(g, y, v, b, t[2 * E], t[2 * E + 1]);
            if (e < x) {
              m = E;
              x = e;
            }
          ...
          const A = Bz(g, y, v, b, _, w);
          this._cx = A.x;
          this._cy = A.y;
          for (let E = 0; E < s; E++) {
            this._dists[E] = Fz(t[2 * E], t[2 * E + 1], A.x, A.y);
          }
          $z(this._ids, this._dists, 0, s - 1);
          this._hullStart = h;
          let k = 3;
          ...
          for (let E = 0, M, D; E < this._ids.length; E++) {
            ...
            const a = t[2 * s];
            const o = t[2 * s + 1];
            if (E > 0 && Math.abs(a - M) <= Ez && Math.abs(o - D) <= Ez)
              continue;
            M = a;
            D = o;
            ...
            while (
              ((c = n[l]),
              cF(a, o, t[2 * l], t[2 * l + 1], t[2 * c], t[2 * c + 1]) >= 0)
            ) {
              l = c;
              if (l === u) {
                l = -1;
            ...
            while (
              ((c = n[d]),
              cF(a, o, t[2 * d], t[2 * d + 1], t[2 * c], t[2 * c + 1]) < 0)
            ) {
            ...
            if (l === u) {
              while (
                ((c = e[l]),
                cF(a, o, t[2 * c], t[2 * c + 1], t[2 * l], t[2 * l + 1]) < 0)
              ) {
        ...
        _hashKey(t, e) {
          return (
            Math.floor(Cz(t - this._cx, e - this._cy) * this._hashSize) %
            this._hashSize
          );
        }
        _legalize(t) {
      ...
      function $z(t, e, n, i) {
        if (i - n <= 20) {
          ...
          let a = i;
          Rz(t, r, s);
          if (e[t[n]] > e[t[i]]) Rz(t, n, i);
          if (e[t[s]] > e[t[i]]) Rz(t, s, i);
          if (e[t[n]] > e[t[s]]) Rz(t, n, s);
          const o = t[s];
          const u = e[o];
          while (true) {
            do {
      ...
      class Lz {
        ...
        arc(t, e, n) {
          ...
          else if (Math.abs(this._x1 - i) > Nz || Math.abs(this._y1 - r) > Nz)
            this._ += "L" + i + "," + r;
          if (!n) return;
        ...
        _clipSegment(t, e, n, i, r, s) {
          ...
          while (true) {
            ...
            let o,
              ...
              l = r || s;
            if (l & 8)
              ((o = t + ((n - t) * (this.ymax - e)) / (i - e)),
                (u = this.ymax));
            else if (l & 4)
              ((o = t + ((n - t) * (this.ymin - e)) / (i - e)),
                (u = this.ymin));
            else if (l & 2)
              ((u = e + ((i - e) * (this.xmax - t)) / (n - t)),
                (o = this.xmax));
            else
              ((u = e + ((i - e) * (this.xmin - t)) / (n - t)),
                (o = this.xmin));
      ...
      class Xz {
        static from(t, e = jz, n = Gz, i) {
          return new Xz(
            "length" in t ? Hz(t, e, n, i) : Float64Array.from(Vz(t, e, n, i)),
          );
        }
        constructor(t) {
          this._delaunator = new Dz(t);
        ...
        _init() {
          const t = this._delaunator,
            e = this.points;
          if (t.hull && t.hull.length > 2 && Yz(t)) {
            ...
            for (let s = 0, a = e.length / 2; s < a; ++s) {
              const t = Wz(e[2 * s], e[2 * s + 1], r);
              e[2 * s] = t[0];
              e[2 * s + 1] = t[1];
            }
            this._delaunator = new Dz(e);
          } else {
        ...
        *neighbors(t) {
        ...
        _step(t, e, n) {
          ...
          let l = t;
          let c = Uz(e - u[t * 2], 2) + Uz(n - u[t * 2 + 1], 2);
          const f = i[t];
          let d = f;
          do {
            let i = o[d];
            const f = Uz(e - u[i * 2], 2) + Uz(n - u[i * 2 + 1], 2);
            if (f < c) ((c = f), (l = i));
            d = d % 3 === 2 ? d - 2 : d + 1;
            if (o[d] !== t) break;
            d = a[d];
            if (d === -1) {
              d = r[(s[t] + 1) % r.length];
              if (d !== i) {
                if (Uz(e - u[d * 2], 2) + Uz(n - u[d * 2 + 1], 2) < c) return d;
              }
              break;
            }
          } while (d !== f);
        ...
        transform(t, e) {
          ...
          r = r
            ...
            : (r = t.extent)
              ...
              : Kz;
          const s = (this.value = Xz.from(i, t.x, t.y).voronoi(r));
          for (let a = 0, o = i.length; a < o; ++a) {
            const t = s.cellPolygon(a);
            i[a][n] = t && !Jz(t) ? Zz(t) : null;
          }
          return e.reflow(t.modified()).modifies(n);
        },
      });
      ...
      function rB(t, e, n, i) {
        ...
        while (++i < l) {
          ...
          d = e.size << 1;
          if (e.rotate) {
            var m = Math.sin(e.rotate * tB),
              g = Math.cos(e.rotate * tB),
              y = c * g,
              v = c * m,
              b = d * g,
              x = d * m;
          ...
          if (e.rotate) r.rotate(e.rotate * tB);
        ...
        var _ = r.getImageData(0, 0, (eB << 5) / s, nB / s).data,
          w = [];
        while (--i >= 0) {
          e = n[i];
      ...
      var dB = { archimedean: uB, rectangular: lB };
      const hB = [
        "x",
        "y",
        "font",
      ...
      mB.Definition = {
        ...
        params: [
          ...
          { name: "as", type: "string", array: true, length: 7, default: hB },
        ],
      };
      (0, p.B)(mB, Bi, {
        transform(t, e) {
          ...
          const i = t.modified();
          if (!(i || e.changed(e.ADD_REM) || pB.some(n))) return;
          const r = e.materialize(e.SOURCE).source,
            s = this.value,
            a = t.as || hB;
          let o = t.fontSize || 14,
      ...
      const yB = (t) => new Uint8Array(t);
      const vB = (t) => new Uint16Array(t);
      const bB = (t) => new Uint32Array(t);
      function xB() {
        let t = 8,
          e = [],
          n = bB(0),
      ...
      function wB(t, e, n) {
        const i = (e < 257 ? yB : e < 65537 ? vB : bB)(t);
        if (n) i.set(n);
        return i;
      }
      function AB(t, e, n) {
      ...
      const zB = "Property";
      const BB = "Identifier";
      const $B = "ArrayExpression";
      const RB = "BinaryExpression";
      const OB = "CallExpression";
      const TB = "ConditionalExpression";
      const NB = "LogicalExpression";
      const LB = "MemberExpression";
      const PB = "ObjectExpression";
      const qB = "UnaryExpression";
      function IB(t) {
        this.type = t;
      }
      IB.prototype.visit = function (t) {
        let e, n, i;
        if (t(this)) return 1;
        for (e = UB(this), n = 0, i = e.length; n < i; ++n) {
      ...
      var p$ = "Unexpected token %0",
        ...
        v$ = "Unexpected reserved word",
        b$ = "Unexpected end of input",
        x$ = "Invalid regular expression",
        _$ = "Invalid regular expression: missing /",
        w$ = "Octal literals are not allowed in strict mode.",
        A$ =
      ...
      function R$(t) {
        return (
          ...
          (t >= 97 && t <= 122) ||
          t === 92 ||
          (t >= 128 && M$.test(String.fromCharCode(t)))
        );
      }
      function O$(t) {
        return (
      ...
      function q$() {
        ...
        if (t === 92) {
          if (GB.charCodeAt(YB) !== 117) {
            dR({}, p$, k$);
          }
          ++YB;
          t = L$("u");
          if (!t || t === "\\" || !R$(t.charCodeAt(0))) {
            dR({}, p$, k$);
          }
          e = t;
        }
      ...
      function I$() {
        ...
        return GB.slice(t, YB);
      }
      function U$() {
        var t, e, n;
        t = YB;
        e = GB.charCodeAt(YB) === 92 ? q$() : I$();
        if (e.length === 1) {
          n = QB;
        ...
        return { type: n, value: e, start: t, end: YB };
      }
      function j$() {
        var t = YB,
          e = GB.charCodeAt(YB),
        ...
        if (a === ">>>=") {
          YB += 4;
          return { type: t$, value: a, start: t, end: YB };
        }
        s = a.substr(0, 3);
        if (s === ">>>" || s === "<<=" || s === ">>=") {
          YB += 3;
          return { type: t$, value: s, start: t, end: YB };
        }
        r = s.substr(0, 2);
        if ((i === r[1] && "+-<>&|".includes(i)) || r === "=>") {
          YB += 2;
          return { type: t$, value: r, start: t, end: YB };
        }
        if (r === "//") {
          dR({}, p$, k$);
        }
        if ("<>=!+-*%&|^/".includes(i)) {
          ++YB;
          return { type: t$, value: i, start: t, end: YB };
        }
        dR({}, p$, k$);
      }
      function G$(t) {
        ...
        if (R$(GB.charCodeAt(YB))) {
          dR({}, p$, k$);
        }
        return { type: JB, value: parseInt("0x" + e, 16), start: t, end: YB };
      }
      function Y$(t) {
        let e = "0" + GB[YB++];
        while (YB < WB) {
        ...
        if (R$(GB.charCodeAt(YB)) || F$(GB.charCodeAt(YB))) {
          dR({}, p$, k$);
        }
        return {
          type: JB,
      ...
      function W$() {
        ...
        if (n !== ".") {
          ...
          if (t === "0") {
            ...
            if (n && F$(n.charCodeAt(0))) {
              dR({}, p$, k$);
            }
          }
          while (F$(GB.charCodeAt(YB))) {
            t += GB[YB++];
          }
          n = GB[YB];
        }
        ...
        return { type: JB, value: parseFloat(t), start: e, end: YB };
      }
      function X$() {
        var t = "",
          e,
              ...
              switch (i) {
                ...
                default:
                  if (z$(i)) {
                    ...
                    if (YB < WB && z$(GB[YB])) {
                      s = true;
                      r = r * 8 + "01234567".indexOf(GB[YB++]);
                      if ("0123".includes(i) && YB < WB && z$(GB[YB])) {
                        r = r * 8 + "01234567".indexOf(GB[YB++]);
                      }
                    }
        ...
        return { type: e$, value: t, octal: s, start: n, end: YB };
      }
      function H$(t, e) {
        let n = t;
        if (e.includes("u")) {
      ...
      function V$() {
        var t, e, n, i, r;
        t = GB[YB];
        C$(t === "/", "Regular expression literal must start with a slash");
        e = GB[YB++];
        n = false;
        i = false;
        while (YB < WB) {
      ...
      function Z$(t) {
        return t.type === QB || t.type === KB || t.type === HB || t.type === ZB;
      }
      function J$() {
        N$();
        if (YB >= WB) {
          return { type: VB, start: YB, end: YB };
        }
        const t = GB.charCodeAt(YB);
        if (R$(t)) {
          return U$();
      ...
      function dR(t, e) {
        var n,
          ...
          r = e.replace(/%(\d)/g, (t, e) => {
            C$(e < i.length, "Message reference must be in range");
            return i[e];
          });
        n = new Error(r);
        n.index = YB;
      ...
      function pR(t) {
        const e = tR();
        if (e.type !== t$ || e.value !== t) {
          hR(e);
        }
      }
      function mR(t) {
        return XB.type === t$ && XB.value === t;
      }
      function gR(t) {
        return XB.type === KB && XB.value === t;
      }
      function yR() {
        const t = [];
        YB = XB.start;
      ...
      function SR() {
        ...
        if (XB.type !== t$ && XB.type !== KB) {
          ...
          e = SR();
          e = fR(t.value, e);
        } else if (gR("delete") || gR("void") || gR("typeof")) {
          throw new Error(E$);
        } else {
          e = FR();
        }
      ...
      var JR, tO, eO, nO, iO, rO, sO, aO, oO, uO, lO;
      var cO = {
        point: fO,
        lineStart: hO,
        lineEnd: pO,
      ...
      function dO(t, e) {
        ...
        if (aO) {
          ...
          if (c ^ (o * iO < u && u < o * t)) {
            ...
            ((u = ((u + 360) % 360) - 180), c ^ (o * iO < u && u < o * t))
          ) {
            l = -s[1] * mx;
            if (l < tO) tO = l;
          } else {
          ...
          if (c) {
            if (t < iO) {
              if (vO(JR, t) > vO(JR, eO)) eO = t;
            } else {
              if (vO(t, eO) > vO(JR, eO)) JR = t;
            }
          } else {
            if (eO >= JR) {
              if (t < JR) JR = t;
      ...
      function mO(t, e) {
        if (aO) {
          var n = t - iO;
          oO.add(yx(n) > 180 ? n + (n > 0 ? 360 : -360) : n);
        } else {
          ((rO = t), (sO = e));
        }
        XR.point(t, e);
      ...
      function _O(t) {
        var e, n, i, r, s, a, o;
        nO = eO = -(JR = tO = Infinity);
        uO = [];
        sx(t, cO);
        if ((n = uO.length)) {
          uO.sort(bO);
          for (e = 1, i = uO[0], s = [i]; e < n; ++e) {
            r = uO[e];
            if (xO(i, r[0]) || xO(i, r[1])) {
              if (vO(i[0], r[1]) > vO(i[0], i[1])) i[1] = r[1];
              if (vO(r[0], i[1]) > vO(i[0], i[1])) i[0] = r[0];
            } else {
              s.push((i = r));
            }
          }
          for (
            ...
            r = s[e];
            if ((o = vO(i[1], r[0])) > a) ((a = o), (JR = r[0]), (eO = i[1]));
          }
        }
        uO = lO = null;
        return JR === Infinity || tO === Infinity
          ? [
              [NaN, NaN],
              [NaN, NaN],
            ]
      ...
      var wO, AO, kO, EO, MO, DO, CO, FO, SO, zO, BO, $O, RO, OO, TO, NO;
      var LO = {
        sphere: Rx,
        point: PO,
        lineStart: IO,
      ...
      function VO(t) {
        ...
        if (r < cx) {
          ((e = DO), (n = CO), (i = FO));
          if (AO < lx) ((e = kO), (n = EO), (i = MO));
          r = kx(e, n, i);
          if (r < cx) return [NaN, NaN];
        }
        return [bx(n, e) * mx, Bx(i / r) * mx];
      }
      var QO = n(14180);
      var KO = n(30352);
      function ZO(...t) {
      ...
      function tT(t) {
        return t instanceof KO.v ? t : new KO.v(t);
      }
      const eT = Symbol("vega_selection_getter");
      function nT(t) {
        if (!t.getter || !t.getter[eT]) {
      ...
      function CT(t, e, n) {
        ...
        if (cT(r[u]) !== o) return false;
        if (s && a) {
          if (s.size === 1) return true;
          if (DT(r, o) - u < s.size) return false;
        }
        return true;
      }
      function FT(t, e) {
        return t.map((t) =>
          (0, p.X$)(
            e.fields
              ? { values: e.fields.map((e) => nT(e)(t.datum)) }
              : { [lT]: cT(t.datum) },
            e,
          ),
        );
      ...
      function ST(t, e, n, i) {
        ...
        e = e || rT;
        if (a[lT]) {
          a[lT] = zT[`${lT}_${e}`](...Object.values(a[lT]));
        } else {
          Object.keys(a).forEach((t) => {
            a[t] = Object.keys(a[t])
              .map((e) => a[t][e])
              .reduce((n, i) =>
                n === undefined ? i : zT[`${u[t]}_${e}`](n, i),
              );
          });
        }
        s = Object.keys(o);
      ...
      const qT = PT("format");
      const IT = PT("timeFormat");
      const UT = PT("utcFormat");
      const jT = PT("timeParse");
      const GT = PT("utcParse");
      const YT = new Date(2e3, 0, 1);
      function WT(t, e, n) {
        if (!Number.isInteger(t) || !Number.isInteger(e)) return "";
        YT.setYear(2e3);
        YT.setMonth(t);
        YT.setDate(e);
        return IT.call(this, YT, n);
      }
      function XT(t) {
        return WT.call(this, t, 1, "%B");
      }
      function HT(t) {
        return WT.call(this, t, 1, "%b");
      }
      function VT(t) {
        return WT.call(this, 0, 2 + t, "%A");
      }
      function QT(t) {
        return WT.call(this, 0, 2 + t, "%a");
      }
      ...
      const uN = oN("area", ZR);
      const lN = oN("bounds", _O);
      const cN = oN("centroid", VO);
      function fN(t, e) {
      ...
      function pN() {
        return hN(this.context.dataflow, "warn", arguments);
      }
      function mN() {
        return hN(this.context.dataflow, "info", arguments);
      }
      function gN() {
        return hN(this.context.dataflow, "debug", arguments);
      }
      function yN(t) {
        const e = t / 255;
        if (e <= 0.03928) {
      ...
      function EN(t, e, n, i, r, s) {
        ...
        if (n) {
          f = n === true ? p.vN : (0, p.cy)(n) || gn(n) ? n : kN(n);
          c.remove(f);
        }
        if (e) {
          c.insert(e);
      ...
      function NN(t) {
        return SN(t).slice().reverse();
      }
      function LN(t) {
        return SN(t).slice().sort(p.V_);
      }
      function PN(t, e, n) {
      ...
      function KN(t, e, n) {
        const i = QN(t, this),
          r = i[e],
          s = i[n];
        return r && s ? r.path(s).map(VN) : undefined;
      }
      function ZN(t, e) {
        const n = QN(t, this)[e];
        return n ? n.ancestors().map(VN) : undefined;
      }
      const JN = () => (typeof window !== "undefined" && window) || null;
      function tL() {
        const t = JN();
        return t ? t.screen : {};
      }
      ...
      function oL(t, e, n) {
        ...
        return o.filter((t) => uL(t.x, t.y, e));
      }
      function uL(t, e, n) {
        let i = 0;
      ...
      const cL = ["view", "item", "group", "xy", "x", "y"],
        fL = "event.vega.",
        dL = "this.",
        hL = {};
      const pL = {
      ...
      yL("geoArea", uN, iN);
      yL("geoBounds", lN, iN);
      yL("geoCentroid", cN, iN);
      yL("geoShape", XN, iN);
      yL("geoScale", fN, iN);
      yL("indata", TT, nN);
      yL("data", OT, eN);
      yL("treePath", KN, eN);
      yL("treeAncestors", ZN, eN);
      yL("vlSelectionTest", kT, RT);
      yL("vlSelectionIdTest", CT, RT);
      yL("vlSelectionResolve", ST, RT);
      yL("vlSelectionTuples", FT);
      function vL(t, e) {
        const n = {};
        let i;
        try {
      ...
      const xL = (0, p.M1)(["rule"]),
        _L = (0, p.M1)(["group", "image", "rect"]);
      function wL(t, e) {
        let n = "";
        if (xL[e]) return n;
        if (t.x2) {
      ...
      var CL = {
        operator: (t, e) => ML(t, ["_"], e.code),
        parameter: (t, e) => ML(t, ["datum", "_"], e.code),
        event: (t, e) => ML(t, ["event"], e.code),
        handler: (t, e) => {
          const n = `var datum=event.item&&event.item.datum;return ${e.code};`;
          return ML(t, ["_", "event"], n);
        },
        encode: (t, e) => {
      ...
      function zL(t, e) {
        ...
        for (const i in t) {
          const r = t[i];
          e[i] = (0, p.cy)(r) ? r.map((t) => BL(t, n, e)) : BL(r, n, e);
        }
        return e;
      }
      function BL(t, e, n) {
        if (!t || !(0, p.Gv)(t)) return t;
        for (let i = 0, r = $L.length, s; i < r; ++i) {
          s = $L[i];
          if ((0, p.mQ)(t, s.key)) {
      ...
      var $L = [
        ...
        { key: "$field", parse: NL },
        { key: "$encode", parse: PL },
        { key: "$compare", parse: LL },
        { key: "$context", parse: qL },
        { key: "$subflow", parse: IL },
        { key: "$tupleid", parse: UL },
      ];
      function RL(t, e) {
      ...
      function HL(t, e, n, i) {
        return new VL(t, e, n, i);
      }
      function VL(t, e, n, i) {
        this.dataflow = t;
        this.transforms = e;
        this.events = t.events.bind(t);
        ((this.expr = i || CL), (this.signals = {}));
        this.scales = {};
        this.nodes = {};
        this.data = {};
        this.fn = {};
      ...
      VL.prototype = QL.prototype = {
        ...
        transform(t, e) {
          this.add(t, this.dataflow.add(this.transforms[AL(e)]));
        },
        stream(t, e) {
          this.set(t.id, e);
        },
      ...
      function nP(t) {
        const e =
          t._signals.cursor ||
          (t._signals.cursor = t.add({ user: eP, item: null }));
        t.on(t.events("view", "pointermove"), e, (t, n) => {
          const i = e.value,
            r = i ? ((0, p.Kg)(i) ? i : i.user) : eP,
      ...
      function sP(t, e) {
        return arguments.length < 2
          ? rP(this, t).values.value
          : aP.call(this, t, En().remove(p.vN).insert(e));
      }
      function aP(t, e) {
        if (!kn(e)) {
      ...
      function oP(t, e) {
        return aP.call(this, t, En().insert(e));
      }
      function uP(t, e) {
        return aP.call(this, t, En().remove(e));
      }
      function lP(t) {
        var e = t.padding();
      ...
      function AP(t, e, n) {
        ...
        if (t === gP) {
          ...
          if (wP(i, "view", e)) {
            i.addEventListener(e, s, vP);
          }
        } else {
          if (t === yP) {
            if (wP(i, "window", e) && typeof window !== "undefined") {
              a = [window];
            }
      ...
      function DP(t, e) {
        t = [t || "hover"];
        e = [e || "update", t[0]];
        this.on(this.events("view", "pointerover", kP), EP, MP(t));
        this.on(this.events("view", "pointerout", kP), EP, MP(e));
        return this;
      }
      function CP() {
        var t = this._tooltip,
      ...
      function $P(t, e, n) {
        ...
        const s = i.input == null && i.element ? RP : TP;
        s(r, e, i, t);
        if (!r.active) {
      ...
      function TP(t, e, n, i) {
        ...
        const s = FP("div", { class: SP });
        const a = n.input === "radio" ? s : s.appendChild(FP("label"));
        a.appendChild(FP("span", { class: zP }, n.name || n.signal));
        e.appendChild(s);
        let o = NP;
        switch (n.input) {
          case "checkbox":
      ...
      function PP(t, e, n, i) {
        const r = FP("select", { name: n.signal }),
          s = n.labels || [];
        n.options.forEach((t, e) => {
          const n = { value: t };
          if (UP(t, i)) n.selected = true;
          r.appendChild(FP("option", n, (s[e] || t) + ""));
        });
        e.appendChild(r);
      ...
      function qP(t, e, n, i) {
        ...
        t.set = (e) => {
          const n = t.elements,
            i = n.length;
          for (let t = 0; t < i; ++t) {
            if (UP(n[t].value, e)) n[t].checked = true;
          }
        };
      }
      function IP(t, e, n, i) {
      ...
      function jP(t, e, n, i, r, s) {
        e = e || new i(t.loader());
        return e
          .initialize(n, lP(t), cP(t), fP(t), r, s)
      ...
      function YP(t, e, n, i) {
        const r = new i(t.loader(), GP(t, t.tooltip()))
      ...
      function WP(t, e) {
        const n = this,
          ...
          s = ly(i);
        t = n._el = t ? XP(n, t, true) : null;
        ZL(n);
        if (!s) n.error("Unrecognized renderer type: " + i);
        const a = s.handler || jm,
          o = t ? s.renderer : s.headless;
        n._renderer = !o ? null : jP(n, n._renderer, t, o);
        n._handler = YP(n, n._handler, t, a);
        n._redraw = true;
        if (t && r !== "none") {
          e = e
            ? (n._elBind = XP(n, e, true))
            : t.appendChild(FP("form", { class: "vega-bindings" }));
          n._bind.forEach((t) => {
            if (t.param.element && r !== "container") {
              t.element = XP(n, t.param.element, !!t.param.input);
            }
          });
          n._bind.forEach((t) => {
            $P(n, t.element || e, t);
      ...
      const HP = (t) => +t || 0;
      const VP = (t) => ({ top: t, bottom: t, left: t, right: t });
      function QP(t) {
        return (0, p.Gv)(t)
          ? {
              top: HP(t.top),
      ...
      async function KP(t, e, n, i) {
        ...
        await t.runAsync();
        return jP(t, null, null, s, n, i).renderAsync(t._scenegraph.root);
      }
      async function ZP(t, e) {
        if (t !== oy.Canvas && t !== oy.SVG && t !== oy.PNG) {
          (0, p.z3)("Unrecognized image type: " + t);
        }
        const n = await KP(this, t, e);
        return t === oy.SVG
          ? JP(n.svg(), "image/svg+xml")
      ...
      async function tq(t, e) {
        const n = await KP(this, oy.Canvas, t, e);
        return n.canvas();
      }
      async function eq(t) {
        const e = await KP(this, oy.SVG, t);
        return e.svg();
      }
      function nq(t, e, n) {
        return HL(t, $i, lL, n).parse(e);
      }
      function iq(t) {
      ...
      function uq(t, e) {
        var n = t.autosize(),
          i = t.padding();
        return e - (n && n.contains === aq ? i.left + i.right : 0);
      }
      function lq(t, e) {
        var n = t.autosize(),
          i = t.padding();
        return e - (n && n.contains === aq ? i.top + i.bottom : 0);
      }
      function cq(t) {
        var e = t._signals,
          n = e[rq],
      ...
      function dq(t) {
        return this._runtime.getState(
          t || { data: hq, signals: pq, recurse: true },
        );
      }
      function hq(t, e) {
        return (
      ...
      function gq(t, e) {
        ...
        this._timers.push(KL(n, e));
      }
      function yq(t, e, n, i) {
        const r = t.element();
        if (r) r.setAttribute("title", vq(i));
      }
      function vq(t) {
        return t == null
          ? ""
      ...
      function bq(t) {
        return Object.keys(t)
          .map((e) => {
            const n = t[e];
            return e + ": " + ((0, p.cy)(n) ? xq(n) : _q(n));
          })
          .join("\n");
      }
      function xq(t) {
        return "[" + t.map(_q).join(", ") + "]";
      }
      function _q(t) {
      ...
      function Aq(t, e) {
        ...
        n._renderer = null;
        ((n._tooltip = e.tooltip || yq), (n._redraw = true));
        ...
        n._eventListeners = [];
        n._resizeListeners = [];
        n._eventConfig = bP(t.eventConfig);
        n.globalCursor(n._eventConfig.globalCursor);
        const r = nq(n, t, e.expr);
        n._runtime = r;
        ...
        n._width = n.width();
        n._height = n.height();
        n._viewWidth = uq(n, n._width);
        n._viewHeight = lq(n, n._height);
        n._origin = [0, 0];
        n._resize = 0;
        n._autosize = 1;
        cq(n);
      ...
      (0, p.B)(Aq, Si, {
        ...
        description(t) {
          if (arguments.length) {
            ...
            if (e !== this._desc) JL(this._el, (this._desc = e));
            return this;
          }
          return this._desc;
        },
        ...
        padding(t) {
          return arguments.length
            ? this.signal("padding", QP(t))
            : QP(this.signal("padding"));
        },
        autosize(t) {
          return arguments.length
        ...
        resize() {
          this._autosize = 1;
          return this.touch(kq(this, "autosize"));
        },
        _resetRenderer() {
          if (this._renderer) {
            this._renderer = null;
        ...
        addSignalListener(t, e) {
          return Mq(this, t, kq(this, t), e);
        },
        removeSignalListener(t, e) {
          return Dq(this, kq(this, t), e);
        },
        addDataListener(t, e) {
          return Mq(this, t, rP(this, t).values, e);
        },
        removeDataListener(t, e) {
          return Dq(this, rP(this, t).values, e);
        },
        globalCursor(t) {
          if (arguments.length) {
            if (this._globalCursor !== !!t) {
              const e = iP(this, null);
      ...
      const Sq = (t) => +t || 0;
      const zq = (t) => ({ top: t, bottom: t, left: t, right: t });
      function Bq(t) {
        return !(0, p.Gv)(t)
          ? zq(Sq(t))
          : t.signal
      ...
      const qq = "scope";
      const Iq = "axis";
      const Uq = "axis-domain";
      const jq = "axis-grid";
      const Gq = "axis-label";
      const Yq = "axis-tick";
      const Wq = "axis-title";
      const Xq = "legend";
      const Hq = "legend-band";
      const Vq = "legend-entry";
      const Qq = "legend-gradient";
      const Kq = "legend-label";
      const Zq = "legend-symbol";
      const Jq = "legend-title";
      const tI = "title";
      const eI = "title-text";
      const nI = "title-subtitle";
      function iI(t, e, n, i, r) {
        const s = {},
          a = {};
        let o, u, l, c;
        u = "lineBreak";
        if (e === "text" && r[u] != null && !Nq(u, t)) {
          rI(s, u, r[u]);
        }
        if (n == "legend" || String(n).startsWith("axis")) {
          n = null;
        }
        c = n === Pq ? r.group : n === Lq ? (0, p.X$)({}, r.mark, r[e]) : null;
        for (u in c) {
          l =
            Nq(u, t) ||
            ((u === "fill" || u === "stroke") &&
              (Nq("fill", t) || Nq("stroke", t)));
          if (!l) rI(s, u, c[u]);
        }
        (0, p.YO)(i).forEach((e) => {
      ...
      const sI = (t) =>
        (0, p.Kg)(t) ? (0, p.r$)(t) : t.signal ? `(${t.signal})` : fI(t);
      function aI(t) {
        if (t.gradient != null) {
          return lI(t);
        }
      ...
      const oI = (t, e, n, i) => `(${t}(${[e, n, i].map(aI).join(",")})+'')`;
      function uI(t) {
        return t.c
          ? oI("hcl", t.h, t.c, t.l)
          : t.h || t.s
      ...
      function cI(t) {
        return (0, p.Gv)(t) ? "(" + aI(t) + ")" : t;
      }
      function fI(t) {
        return dI((0, p.Gv)(t) ? t : { datum: t });
      }
      function dI(t) {
        let e, n, i;
        if (t.signal) {
        ...
        if (!t.signal) {
          i = (0, p.Kg)(i) ? (0, p.iv)(i).map(p.r$).join("][") : dI(i);
        }
        return e + "[" + i + "]";
      }
      function hI(t, e) {
      ...
      const bI = "outer",
        xI = ["value", "update", "init", "react", "bind"];
      function _I(t, e) {
      ...
      function wI(t, e) {
        const n = t.name;
        if (t.push === bI) {
          if (!e.signals[n]) _I("No prior signal definition", n);
          xI.forEach((e) => {
            if (t[e] !== undefined) _I("Invalid property ", e);
          });
        } else {
      ...
      function kI(t, e, n, i) {
        return new AI(t, e, n, i);
      }
      function EI(t, e) {
        return kI("operator", t, e);
      }
      function MI(t) {
        const e = { $ref: t.id };
      ...
      function YI(t, e) {
        const n = t.merge.map((t) => jI(t, e)),
          i = HI({ merge: n }, t, e);
        return e.addStream(i).id;
      }
      function WI(t, e) {
        const n = jI(t.stream, e),
          i = HI({ stream: n }, t, e);
        return e.addStream(i).id;
      }
      function XI(t, e) {
        let n;
        if (t.type === UI) {
          n = e.event(UI, t.throttle);
          t = { between: t.between, filter: t.filter };
        } else {
          n = e.event(GI(t.source), t.type);
        }
        const i = HI({ stream: n }, t, e);
      ...
      function HI(t, e, n) {
        ...
        if (i) {
          ...
          t.between = [jI(i[0], n), jI(i[1], n)];
        }
        i = e.filter ? [].concat(e.filter) : [];
        if (e.marktype || e.markname || e.markrole) {
          i.push(VI(e.marktype, e.markname, e.markrole));
        }
        if (e.source === OI) {
          i.push("inScope(event.item)");
        }
        if (i.length) {
          t.filter = vL("(" + i.join(")&&(") + ")", n).$expr;
        }
        ...
        r.update = (0, p.Kg)(a)
          ...
          : a.expr != null
            ...
            : a.value != null
              ? a.value
              : a.signal != null
                ? { $expr: QI, $params: { $value: e.signalRef(a.signal) } }
                : (0, p.z3)("Invalid signal update specification.");
        if (t.force) {
          r.options = { force: true };
        }
        o.forEach((t) => e.addUpdate((0, p.X$)(ZI(t, e), r)));
      }
      function ZI(t, e) {
        return {
          source: t.signal
      ...
      function tU(t, e) {
        ...
        if (t.on) {
          t.on.forEach((t) => KI(t, e, n.id));
        }
      }
      const eU = (t) => (e, n, i) => kI(t, n, e || undefined, i);
      const nU = eU("aggregate");
      const iU = eU("axisticks");
      const rU = eU("bound");
      const sU = eU("collect");
      const aU = eU("compare");
      const oU = eU("datajoin");
      const uU = eU("encode");
      const lU = eU("expression");
      const cU = eU("facet");
      const fU = eU("field");
      const dU = eU("key");
      const hU = eU("legendentries");
      const pU = eU("load");
      const mU = eU("mark");
      const gU = eU("multiextent");
      const yU = eU("multivalues");
      const vU = eU("overlap");
      const bU = eU("params");
      const xU = eU("prefacet");
      const _U = eU("projection");
      const wU = eU("proxy");
      const AU = eU("relay");
      const kU = eU("render");
      const EU = eU("scale");
      const MU = eU("sieve");
      const DU = eU("sortitems");
      const CU = eU("viewlayout");
      const FU = eU("values");
      let SU = 0;
      const zU = { min: "min", max: "max", count: "sum" };
      function BU(t, e) {
      ...
      function OU(t, e) {
        return t.signal ? e.signalRef(t.signal) : t.map((t) => RU(t, e));
      }
      function TU(t) {
      ...
      function NU(t, e, n) {
        ...
        return t.signal
          ...
          : ((0, p.cy)(t) ? LU : t.fields ? qU : PU)(t, e, n);
      }
      function LU(t, e, n) {
        return t.map((t) => RU(t, n));
      }
      function PU(t, e, n) {
        const i = n.getData(t.data);
        if (!i) TU(t.data);
        return Vl(e.type)
          ? i.valuesRef(n, t.field, jU(t.sort, false))
          : tc(e.type)
      ...
      function qU(t, e, n) {
        ...
        return (Vl(e.type) ? UU : tc(e.type) ? GU : YU)(t, n, r);
      }
      function IU(t, e) {
        const n = "_:vega:_" + SU++,
          i = sU({});
        ...
        e.addDataPipeline(n, [i, MU({})]);
        return { data: n, field: "data" };
      }
      function UU(t, e, n) {
        const i = jU(t.sort, true);
        let r, s;
        const a = n.map((t) => {
        ...
        const o = { groupby: CI, pulse: a };
        if (i) {
          r = i.op || "count";
          s = i.field ? RI(r, i.field) : "count";
          o.ops = [zU[r]];
          o.fields = [e.fieldRef(s)];
          o.as = [s];
        }
        r = e.add(nU(o));
        const u = e.add(sU({ pulse: MI(r) }));
        s = e.add(FU({ field: CI, sort: e.sortRef(i), pulse: MI(u) }));
        return MI(s);
      }
      function jU(t, e) {
        if (t) {
      ...
      function YU(t, e, n) {
        ...
        return MI(e.add(gU({ extents: i })));
      }
      function WU(t, e) {
        return t.signal || (0, p.cy)(t) ? OU(t, e) : e.objectProperty(t);
      }
      function XU(t, e) {
        return t.signal
          ? e.signalRef(t.signal)
          : (0, p.Gv)(t)
            ? { interval: RU(t.interval), step: RU(t.step) }
            : RU(t);
      }
      function HU(t, e) {
        e.interpolate = RU(t.type || t);
        if (t.gamma != null) {
          e.interpolateGamma = RU(t.gamma);
        }
      }
      function VU(t, e, n) {
        ...
        if (r.signal) {
          ...
          n.scheme = (0, p.cy)(r.scheme) ? OU(r.scheme, e) : RU(r.scheme, e);
          if (r.extent) n.schemeExtent = OU(r.extent, e);
          if (r.count) n.schemeCount = RU(r.count, e);
          return;
        } else if (r.step) {
          n.rangeStep = RU(r.step, e);
          return;
        ...
        return r.map((t) => ((0, p.cy)(t) ? OU : RU)(t, e));
      }
      function QU(t, e) {
      ...
      const fj = "perc2";
      const dj = "value";
      const hj = "guide-label";
      const pj = "guide-title";
      const mj = "group-title";
      const gj = "group-subtitle";
      const yj = "symbol";
      const vj = "gradient";
      const bj = "discrete";
      const xj = "size";
      ...
      const wj = "fill";
      const Aj = "stroke";
      const kj = "strokeWidth";
      const Ej = "strokeDash";
      const Mj = "opacity";
      const Dj = [xj, _j, wj, Aj, kj, Ej, Mj];
      const Cj = { name: 1, style: 1, interactive: 1 };
      const Fj = { value: 0 };
      const Sj = { value: 1 };
      const zj = "group";
      const Bj = "rect";
      ...
      function Nj(t, e) {
        ...
        n.gradientLength = () =>
          qI(t.gradientLength, e.gradientLength || e.gradientWidth);
        n.gradientThickness = () =>
          qI(t.gradientThickness, e.gradientThickness || e.gradientHeight);
        n.entryColumns = () =>
          qI(t.columns, qI(e.columns, +n.isVertical(true)));
        return n;
      }
      function Lj(t, e) {
      ...
      function qj(t, e, n) {
        return `item.anchor === '${rj}' ? ${t} : item.anchor === '${aj}' ? ${e} : ${n}`;
      }
      const Ij = qj((0, p.r$)(JU), (0, p.r$)(tj), (0, p.r$)(nj));
      function Uj(t) {
        const e = t("tickBand");
        let n = t("tickOffset"),
          i,
      ...
      function jj(t, e) {
        return !e
          ...
          : !t
            ...
            : !(0, p.Gv)(t)
              ? { value: t, offset: e }
              : Object.assign({}, t, { offset: jj(t.offset, e) });
      }
      function Gj(t, e) {
        if (e) {
          t.name = e.name;
      ...
      function Yj(t, e, n, i) {
        ...
        return Gj({ type: Bj, role: Qq, encode: h }, i);
      }
      function Wj(t, e, n, i, r) {
        const s = Nj(t, n),
          a = s.isVertical(),
        ...
        const m = { opacity: Fj, fill: { scale: e, field: dj } };
        m[l] = { signal: h + "datum." + cj, mult: u };
        m[c] = Fj;
        m[f] = { signal: h + "datum." + fj, mult: u };
        m[d] = $q(o);
        const g = {
          enter: m,
          update: (0, p.X$)({}, m, { opacity: Sj }),
          exit: { opacity: Fj },
        };
        Oq(
          g,
        ...
        return Gj({ type: Bj, role: Hq, key: dj, from: r, encode: g }, i);
      }
      const Xj = `datum.${cj}<=0?"${JU}":datum.${cj}>=1?"${tj}":"${nj}"`,
        Hj = `datum.${cj}<=0?"${ej}":datum.${cj}>=1?"${ZU}":"${sj}"`;
      function Vj(t, e, n, i) {
        const r = Nj(t, e),
          s = r.isVertical(),
          a = $q(r.gradientThickness()),
          o = r.gradientLength();
        ...
        const p = {
          enter: (l = { opacity: Fj }),
          update: (c = { opacity: Sj, text: { field: uj } }),
          exit: { opacity: Fj },
        };
        Oq(p, {
          fill: r("labelColor"),
          ...
          limit: qI(t.labelLimit, e.gradientLabelLimit),
        });
        if (s) {
          l.align = { value: "left" };
          l.baseline = c.baseline = { signal: Hj };
          f = "y";
          d = "x";
          h = "1-";
        } else {
          l.align = c.align = { signal: Xj };
          l.baseline = { value: "top" };
          f = "x";
          d = "y";
        }
        l[f] = c[f] = { signal: h + "datum." + cj, mult: o };
        l[d] = c[d] = a;
        a.offset = qI(t.labelOffset, e.gradientLabelOffset) || 0;
        u = u
          ? {
      ...
      function Qj(t, e, n, i, r) {
        ...
        g = {
          ...
          update: (v = { opacity: Sj, x: y.x, y: y.y }),
          exit: { opacity: Fj },
        };
        let _ = null,
          w = null;
        ...
        g = {
          enter: (y = { opacity: Fj, x: { signal: d, offset: k }, y: h }),
          update: (v = { opacity: Sj, text: { field: uj }, x: y.x, y: y.y }),
          exit: { opacity: Fj },
        };
        Oq(g, {
          align: s("labelAlign"),
        ...
        const E = Gj(
          { type: Oj, role: Kq, style: hj, key: dj, from: f, encode: g },
          n.labels,
        );
        g = {
          enter: {
        ...
        i = { facet: { data: i, name: "value", groupby: oj } };
        return Tj({
          role: qq,
          from: i,
          encode: Tq(g, a, Cj),
      ...
      const Zj = 'item.orient === "left"',
        Jj = 'item.orient === "right"',
        tG = `(${Zj} || ${Jj})`,
        eG = `datum.vgrad && ${tG}`,
        nG = qj('"top"', '"bottom"', '"middle"'),
        iG = qj('"right"', '"left"', '"center"'),
        rG = `datum.vgrad && ${Jj} ? (${iG}) : (${tG} && !(datum.vgrad && ${Zj})) ? "left" : ${Ij}`,
        sG = `item._anchor || (${tG} ? "middle" : "start")`,
        aG = `${eG} ? (${Zj} ? -90 : 90) : 0`,
        oG = `${tG} ? (datum.vgrad ? (${Jj} ? "bottom" : "top") : ${nG}) : "top"`;
      function uG(t, e, n, i) {
        const r = Nj(t, e);
        const s = {
          enter: { opacity: Fj },
        ...
        return Gj({ type: Oj, role: Jq, style: pj, from: i, encode: s }, n);
      }
      function lG(t, e) {
        let n;
        if ((0, p.Gv)(t)) {
          if (t.signal) {
            ...
            n = "geoShape(" + cG(t.sphere) + ', {type: "Sphere"})';
          }
        }
      ...
      function pG(t, e) {
        ...
        const i = kI(n.type.toLowerCase(), null, mG(n, t, e));
      ...
      function gG(t, e, n) {
        ...
        return t.array && !NI(r) ? r.map((e) => yG(t, e, n)) : yG(t, r, n);
      }
      function yG(t, e, n) {
        const i = t.type;
        if (NI(e)) {
      ...
      function xG(t, e, n) {
        ...
        const s = (0, p.X$)(mG(r, e, n), r.key);
        return MI(n.add(bU(s)));
      }
      const _G = (t) => t && t.expr;
      const wG = (t) => t && t.field;
      const AG = (t) => t === "data";
      const kG = (t) => t === "expr";
      const EG = (t) => t === "field";
      const MG = (t) => t === "compare";
      function DG(t, e, n) {
        let i, r, s, a, o;
        if (!t) {
          a = MI(n.add(sU(null, [{}])));
          ...
          if (i.field != null) {
            ...
            if (!t.data) {
              ...
              s.params.pulse = CG(i, n);
              a = o = MI(n.add(s));
            } else {
              o = MI(n.getData(t.data).aggregate);
            }
      ...
      FG.fromEntries = function (t, e) {
        ...
        t.add(e[0]);
        for (; o < n; ++o) {
          e[o].params.pulse = MI(e[o - 1]);
          t.add(e[o]);
          if (e[o].type === "aggregate") a = e[o];
        }
        return new FG(t, s, r, i, a);
      };
      function SG(t) {
        return (0, p.Kg)(t) ? t : null;
      }
      function zG(t, e, n) {
        const i = RI(n.op, n.field);
        let r;
        if (e.ops) {
      ...
      function BG(t, e, n, i, r, s, a) {
        ...
        if (!c) {
          const n = s
            ? { field: CI, pulse: e.countsRef(t, r, s) }
            : { field: t.fieldRef(r), pulse: MI(e.output) };
          if (u) n.sort = t.sortRef(s);
          f = t.add(kI(i, undefined, n));
          if (a) e.index[r] = f;
          c = MI(f);
          if (l != null) o[l] = c;
        }
      ...
      FG.prototype = {
        countsRef(t, e, n) {
          ...
          if (!a) {
            u = { groupby: t.fieldRef(e, "key"), pulse: MI(i.output) };
            if (n && n.field) zG(t, u, n);
            o = t.add(nU(u));
            a = t.add(sU({ pulse: MI(o) }));
            a = { agg: o, ref: MI(a) };
            if (s != null) r[s] = a;
          } else if (n && n.field) {
            zG(t, a.agg.params, n);
        ...
        extentRef(t, e) {
          return BG(t, this, "extent", "extent", e, false);
        },
        domainRef(t, e) {
          return BG(t, this, "domain", "values", e, false);
        },
        valuesRef(t, e, n) {
          return BG(t, this, "vals", "values", e, n || true);
        },
        lookupRef(t, e) {
          return BG(t, this, "lookup", "tupleindex", e, false);
        },
        indataRef(t, e) {
          return BG(t, this, "indata", "tupleindex", e, true, true);
        },
      };
      function $G(t, e, n) {
        ...
        if (i.field) {
          a = e.add(xU({ field: e.fieldRef(i.field), pulse: s }));
        } else if (i.groupby) {
          a = e.add(
            cU({
              key: e.keyRef(i.groupby),
              group: MI(e.proxy(n.parent)),
              pulse: s,
            }),
          );
        } else {
        ...
        const o = e.fork(),
          u = o.add(sU()),
          l = o.add(MU({ pulse: MI(u) }));
        o.addData(r, new FG(o, u, u, l));
        o.addSignal("parent", null);
        a.params.subflow = { $subflow: o.parse(t).toRuntime() };
      }
      function RG(t, e, n) {
        const i = e.add(xU({ pulse: n.pulse })),
          r = e.fork();
        r.add(MU());
      ...
      function TG(t, e) {
        ...
        let a = t.layout || n === qq || n === Pq,
          ...
          h;
        const m = n === Lq || a || r;
        const g = DG(t.from, i, e);
        u = e.add(
          oU({
            key: g.key || (t.key ? DI(t.key) : undefined),
            pulse: g.pulse,
            clean: !i,
          }),
        );
        ...
        u = e.add(
          mU({
            markdef: dG(t),
            interactive: hG(t.interactive, e),
            clip: lG(t.clip, e),
        ...
        const v = MI(u);
        u = c = e.add(
          uU(mI(t.encode, t.type, n, t.style, e, { mod: false, pulse: v })),
        );
        ...
        if (t.sort) {
          u = e.add(DU({ sort: e.compareRef(t.sort), pulse: MI(u) }));
        }
        const b = MI(u);
        if (r || a) {
          a = e.add(
        ...
        const x = e.add(rU({ mark: v, pulse: d || b }));
        h = MI(x);
        if (i) {
          if (m) {
            o = e.operators;
          ...
          e.pushState(b, d || h, y);
          r ? $G(t, e, g) : m ? RG(t, e, g) : e.parse(t);
          e.popState();
          if (m) {
            if (a) o.push(a);
            o.push(x);
        ...
        const _ = e.add(kU({ pulse: h })),
          w = e.add(MU({ pulse: MI(_) }, undefined, e.parent()));
        if (t.name != null) {
          f = t.name;
          e.addData(f, new FG(e, l, _, w));
          if (t.on)
            t.on.forEach((t) => {
      ...
      function NG(t, e, n) {
        const i = t.method,
          ...
          s = t.separation;
        const a = {
          separation: NI(s) ? n.signalRef(s.signal) : s,
        ...
        if (r) {
          const t = r.tolerance;
          a.boundTolerance = NI(t) ? n.signalRef(t.signal) : +t;
          a.boundScale = n.scaleRef(r.scale);
          a.boundOrient = r.orient;
        }
        return MI(n.add(vU(a)));
      }
      function LG(t, e) {
        ...
        let c = 0,
          ...
          d,
          h;
        Dj.forEach((e) => (t[e] ? ((l[e] = t[e]), (c = c || t[e])) : 0));
        if (!c) (0, p.z3)("Missing valid scale for legend.");
        const m = PG(t, e.scaleType(c));
        const g = {
          title: t.title != null,
          scales: l,
          type: m,
        ...
        if (m === vj) {
          h = [Yj(t, c, n, i.gradient), Vj(t, n, i.labels, b)];
          d.count =
            d.count ||
            e.signalRef(`max(2,2*floor((${II(r.gradientLength())})/100))`);
        } else if (m === bj) {
          h = [Wj(t, c, n, i.gradient, b), Vj(t, n, i.labels, b)];
        } else {
          f = Kj(t, n);
          h = [Qj(t, n, i, b, II(f.columns))];
          d.size = UG(t, e, h[0].marks);
        }
        h = [
          Tj({
            role: Vq,
        ...
        if (g.title) {
          h.push(uG(t, n, i.title, y));
        }
        return TG(
          Tj({
            role: Xq,
            from: y,
            encode: Tq(IG(r, t, n), s, Cj),
            marks: h,
            aria: r("aria"),
      ...
      function PG(t, e) {
        let n = t.type || yj;
        if (!t.type && qG(t) === 1 && (t.fill || t.stroke)) {
          n = Hl(e) ? vj : Ql(e) ? bj : yj;
        }
        return n !== vj ? n : Ql(e) ? bj : vj;
      }
      function qG(t) {
        return Dj.reduce((e, n) => e + (t[n] ? 1 : 0), 0);
      }
      function IG(t, e, n) {
      ...
      function UG(t, e, n) {
        const i = II(jG("size", t, n)),
          r = II(jG("strokeWidth", t, n)),
          s = II(GG(n[1].encode, e, hj));
        return vL(`max(ceil(sqrt(${i})+${r}),${s})`, e);
      }
      function jG(t, e, n) {
        return e[t] ? `scale("${e[t]}",datum)` : Lj(t, n[0].encode);
      }
      function GG(t, e, n) {
        return Lj("fontSize", t) || Pj("fontSize", e, n);
      }
      const YG = `item.orient==="${JU}"?-90:item.orient==="${tj}"?90:0`;
      function WG(t, e) {
        t = (0, p.Kg)(t) ? { text: t } : t;
        const n = Nj(t, e.config.title),
          i = t.encode || {},
          r = i.group || {},
          s = r.name || undefined,
          a = r.interactive,
          ...
          u = [];
        const l = {},
          c = MI(e.add(sU(null, [l])));
        u.push(VG(t, n, XG(t), c));
        if (t.subtitle) {
          u.push(QG(t, n, i.subtitle, c));
        }
        return TG(
          Tj({
            role: tI,
      ...
      function VG(t, e, n, i) {
        ...
        return Gj({ type: Oj, role: eI, style: mj, from: i, encode: a }, n);
      }
      function QG(t, e, n, i) {
        const r = { value: 0 },
          s = t.subtitle,
        ...
        return Gj({ type: Oj, role: nI, style: gj, from: i, encode: a }, n);
      }
      function KG(t, e) {
        const n = [];
        if (t.transform) {
        ...
        e.addDataPipeline(t.name, ZG(t, e, n));
      }
      function ZG(t, e, n) {
        const i = [];
        let r = null,
          ...
          f;
        if (t.values) {
          if (NI(t.values) || PI(t.format)) {
            i.push(tY(e, t));
            i.push((r = JG()));
          } else {
            i.push((r = JG({ $ingest: t.values, $format: t.format })));
          }
        } else if (t.url) {
          if (PI(t.url) || PI(t.format)) {
            i.push(tY(e, t));
            i.push((r = JG()));
          } else {
            i.push((r = JG({ $request: t.url, $format: t.format })));
          }
        } else if (t.source) {
          r = o = (0, p.YO)(t.source).map((t) => MI(e.getData(t).output));
          i.push(null);
        }
        for (u = 0, l = n.length; u < l; ++u) {
          c = n[u];
      ...
      const eY = (t) => t === ej || t === ZU;
      const nY = (t, e, n) =>
        NI(t) ? lY(t.signal, e, n) : t === JU || t === ZU ? e : n;
      const iY = (t, e, n) => (NI(t) ? oY(t.signal, e, n) : eY(t) ? e : n);
      const rY = (t, e, n) => (NI(t) ? uY(t.signal, e, n) : eY(t) ? n : e);
      const sY = (t, e, n) =>
        NI(t) ? cY(t.signal, e, n) : t === ZU ? { value: e } : { value: n };
      const aY = (t, e, n) =>
        NI(t) ? fY(t.signal, e, n) : t === tj ? { value: e } : { value: n };
      const oY = (t, e, n) => dY(`${t} === '${ZU}' || ${t} === '${ej}'`, e, n);
      const uY = (t, e, n) => dY(`${t} !== '${ZU}' && ${t} !== '${ej}'`, e, n);
      const lY = (t, e, n) => pY(`${t} === '${JU}' || ${t} === '${ZU}'`, e, n);
      const cY = (t, e, n) => pY(`${t} === '${ZU}'`, e, n);
      const fY = (t, e, n) => pY(`${t} === '${tj}'`, e, n);
      const dY = (t, e, n) => {
        e = e != null ? $q(e) : e;
        n = n != null ? $q(n) : n;
        if (hY(e) && hY(n)) {
      ...
      const hY = (t) => t == null || Object.keys(t).length === 1;
      const pY = (t, e, n) => ({ signal: `${t} ? (${gY(e)}) : (${gY(n)})` });
      const mY = (t, e, n, i, r) => ({
        signal:
          (i != null ? `${t} === '${JU}' ? (${gY(i)}) : ` : "") +
          (n != null ? `${t} === '${ej}' ? (${gY(n)}) : ` : "") +
      ...
      const gY = (t) => (NI(t) ? t.signal : t == null ? null : (0, p.r$)(t));
      const yY = (t, e) =>
        e === 0
          ? 0
          : NI(t)
      ...
      function _Y(t, e) {
        var n = e.config,
          ...
          l;
        if (NI(a)) {
          const t = xY([n.axisX, n.axisY]),
            e = xY([n.axisTop, n.axisBottom, n.axisLeft, n.axisRight]);
          o = {};
          for (l of t) {
            o[l] = iY(a, bY(l, n.axisX, r, i), bY(l, n.axisY, r, i));
          }
          u = {};
          for (l of e) {
            u[l] = mY(
              a.signal,
              bY(l, n.axisTop, r, i),
              bY(l, n.axisBottom, r, i),
              bY(l, n.axisLeft, r, i),
              bY(l, n.axisRight, r, i),
            );
          }
        } else {
          o = a === ZU || a === ej ? n.axisX : n.axisY;
      ...
      function wY(t, e, n, i) {
        ...
        a.y = o.y = rY(s, l, Fj);
        a.y2 = o.y2 = rY(s, c);
        return Gj({ type: $j, role: Uq, from: i, encode: u }, n);
      }
      function AY(t, e) {
      ...
      function kY(t, e, n, i, r) {
        ...
        const g = iY(a, { signal: "height" }, { signal: "width" });
        const y = o
        ...
        f.x = iY(a, m);
        f.y = rY(a, m);
        return Gj({ type: $j, role: jq, key: dj, from: i, encode: h }, n);
      }
      function EY(t, e) {
        if (e === 1);
        else if (!(0, p.Gv)(t)) {
          t = NI(e) ? { signal: `(${e.signal}) * (${t || 0})` } : e * (t || 0);
        } else {
          let n = (t = (0, p.X$)({}, t));
          while (n.mult != null) {
            if (!(0, p.Gv)(n.mult)) {
      ...
      function MY(t, e, n, i, r, s) {
        ...
        f.x2 = l.x2 = rY(o, h);
        c.y = rY(o, p);
        return Gj({ type: $j, role: Yq, key: dj, from: i, encode: d }, n);
      }
      ...
      function CY(t, e, n, i, r, s) {
        ...
        const g = $q(r);
        g.mult = l;
        g.offset = $q(a("labelPadding") || 0);
        g.offset.mult = l;
        const y = {
          scale: u,
          field: dj,
          band: 0.5,
          offset: jj(s.offset, a("labelOffset")),
        };
        const v = iY(
          o,
          p ? DY(u, c, '"left"', '"right"', '"center"') : { value: "center" },
          aY(o, "left", "right"),
        );
        const b = iY(
          o,
          sY(o, "bottom", "top"),
          p ? DY(u, c, '"top"', '"bottom"', '"middle"') : { value: "middle" },
        );
        const x = DY(u, c, `-(${f})`, f, 0);
        p = p && f;
        const _ = { opacity: Fj, x: iY(o, y, g), y: rY(o, y, g) };
        const w = {
          enter: _,
          update: (m = {
            opacity: Sj,
          ...
          exit: { opacity: Fj, x: _.x, y: _.y },
        };
        Oq(w, { dx: !d && p ? iY(o, x) : null, dy: !h && p ? rY(o, x) : null });
        Oq(
          w,
          {
            angle: a("labelAngle"),
        ...
        k =
          k || A
            ...
            : undefined;
        if (m.align !== v) {
          m.align = vY(m.align, v);
        }
        if (m.baseline !== b) {
          m.baseline = vY(m.baseline, b);
        }
        return Gj(
          {
            type: Oj,
      ...
      function FY(t, e, n, i) {
        ...
        const l = {
          enter: (o = {
            opacity: Fj,
            anchor: $q(r("titleAnchor", null)),
            align: { signal: Ij },
          }),
          update: (u = (0, p.X$)({}, o, { opacity: Sj, text: $q(t.title) })),
          exit: { opacity: Fj },
        };
        const c = { signal: `lerp(range("${t.scale}"), ${qj(0, 1, 0.5)})` };
        u.x = iY(s, c);
        u.y = rY(s, c);
        o.angle = iY(s, Fj, yY(a, 90));
        o.baseline = iY(s, sY(s, ej, ZU), { value: ej });
        u.angle = o.angle;
        ...
        SY(r, s, l, n);
        l.update.align = vY(l.update.align, o.align);
        l.update.angle = vY(l.update.angle, o.angle);
        l.update.baseline = vY(l.update.baseline, o.baseline);
        return Gj({ type: Oj, role: Wq, style: pj, from: i, encode: l }, n);
      }
      function SY(t, e, n, i) {
        const r = (t, e) =>
          t != null
            ? ((n.update[e] = vY($q(t), n.update[e])), false)
            : !Nq(e, i)
              ? true
              : false;
        const s = r(t("titleX"), "x"),
          a = r(t("titleY"), "y");
        n.enter.auto = a === s ? $q(a) : iY(e, $q(a), $q(s));
      }
      function zY(t, e) {
        const n = _Y(t, e),
          i = t.encode || {},
        ...
        let p;
        if (c.grid) {
          h.push(kY(t, n, i.grid, d, l));
        }
        if (c.ticks) {
          p = u("tickSize");
          h.push(MY(t, n, i.ticks, d, p, l));
        }
        if (c.labels) {
          p = c.ticks ? p : 0;
          h.push(CY(t, n, i.labels, d, p, l));
        }
        if (c.domain) {
          h.push(wY(t, n, i.domain, f));
        }
        if (c.title) {
          h.push(FY(t, n, i.title, f));
        }
        return TG(
          Tj({
            role: Iq,
            from: f,
            encode: Tq(BY(u, t), r, Cj),
            marks: h,
            aria: u("aria"),
      ...
      function $Y(t, e, n) {
        const i = (0, p.YO)(t.signals),
          r = (0, p.YO)(t.scales);
        if (!n) i.forEach((t) => wI(t, e));
        (0, p.YO)(t.projections).forEach((t) => QU(t, e));
        r.forEach((t) => BU(t, e));
        (0, p.YO)(t.data).forEach((t) => KG(t, e));
        r.forEach((t) => $U(t, e));
        (n || i).forEach((t) => tU(t, e));
        (0, p.YO)(t.axes).forEach((t) => zY(t, e));
        (0, p.YO)(t.marks).forEach((t) => TG(t, e));
        (0, p.YO)(t.legends).forEach((t) => LG(t, e));
        if (t.title) WG(t.title, e);
        e.parseLambdas();
        return e;
      }
      const RY = (t) =>
      ...
      function OY(t, e) {
        ...
        const s = e.add(sU());
        const a = e.add(
          uU(mI(RY(t.encode), zj, Pq, t.style, e, { pulse: MI(s) })),
        );
        const o = e.add(
          CU({
            layout: e.objectProperty(t.layout),
        ...
        e.operators.pop();
        e.pushState(MI(a), MI(o), null);
        $Y(t, e, r);
        e.operators.push(o);
        let u = e.add(rU({ mark: i, pulse: MI(o) }));
        u = e.add(kU({ pulse: MI(u) }));
        u = e.add(MU({ pulse: MI(u) }));
        e.addData("root", new FG(e, s, s, u));
        return e;
      }
      function TY(t, e) {
        return e && e.signal
      ...
      function NY(t, e) {
        const n = (n) => qI(t[n], e[n]),
          i = [
            TY("background", n("background")),
            TY("autosize", Fq(n("autosize"))),
            TY("padding", Bq(n("padding"))),
            TY("width", n("width") || 0),
            TY("height", n("height") || 0),
          ],
      ...
      LY.prototype = PY.prototype = {
        ...
        proxy(t) {
          const e = t instanceof AI ? MI(t) : t;
          return this.add(wU({ value: e }));
        },
        addStream(t) {
          this.streams.push(t);
          t.id = this.id();
        ...
        pushState(t, e, n) {
          this._encode.push(MI(this.add(MU({ pulse: t }))));
          this._parent.push(e);
          this._lookup.push(n ? MI(this.proxy(n)) : null);
        ...
        fieldRef(t, e) {
          ...
          if (!i) {
            ...
            if (e) t.as = e;
            this.field[n] = i = MI(this.add(fU(t)));
          }
          return i;
        },
        compareRef(t) {
          ...
          return e ? MI(this.add(aU({ fields: i, orders: r }))) : FI(i, r);
        },
        keyRef(t, e) {
          let n = false;
          const i = (t) => (NI(t) ? ((n = true), MI(r[t.signal])) : t);
          const r = this.signals;
          t = (0, p.YO)(t).map(i);
          return n ? MI(this.add(dU({ fields: t, flat: e }))) : SI(t, e);
        },
        sortRef(t) {
          if (!t) return t;
          const e = RI(t.op, t.field),
            n = t.order || zI;
          return n.signal
            ? MI(this.add(aU({ fields: e, orders: this.signalRef(n.signal) })))
            : FI(e, n);
        },
        event(t, e) {
          const n = t + ":" + e;
        ...
        addSignal(t, e) {
          ...
          const n = e instanceof AI ? e : this.add(EI(e));
        ...
        signalRef(t) {
          if (this.signals[t]) {
            return MI(this.signals[t]);
          } else if (!(0, p.mQ)(this.lambdas, t)) {
            this.lambdas[t] = this.add(EI(null));
          }
          return MI(this.lambdas[t]);
        },
        parseLambdas() {
        ...
        objectProperty(t) {
          return !t || !(0, p.Gv)(t) ? t : this.signalRef(t.signal || qY(t));
        },
        exprRef(t, e) {
          const n = { expr: vL(t, this) };
          if (e) n.expr.$name = e;
          return MI(this.add(lU(n)));
        },
        addBinding(t, e) {
          if (!this.bindings) {
        ...
        addScale(t, e) {
          this.addScaleProj(t, EU(e));
        },
        addProjection(t, e) {
          this.addScaleProj(t, _U(e));
        },
        getScale(t) {
          if (!this.scales[t]) {
        ...
        addDataPipeline(t, e) {
          ...
          return this.addData(t, FG.fromEntries(this, e));
        },
      };
      function qY(t) {
        return ((0, p.cy)(t) ? IY : UY)(t);
      }
      function IY(t) {
        const e = t.length;
        let n = "[";
        for (let i = 0; i < e; ++i) {
          ...
          n +=
            (i > 0 ? "," : "") +
            ((0, p.Gv)(e) ? e.signal || qY(e) : (0, p.r$)(e));
        }
        return n + "]";
      }
      function UY(t) {
        ...
        for (i in t) {
          ...
          e +=
            ...
            (0, p.r$)(i) +
            ":" +
            ((0, p.Gv)(r) ? r.signal || qY(r) : (0, p.r$)(r));
        }
        return e + "}";
      }
      function jY() {
      ...
      function GY(t, e, n) {
        ...
        e = (0, p.io)(jY(), e, t.config);
        return OY(t, new LY(e, n)).toRuntime();
      }
      var YY = "5.33.0";
