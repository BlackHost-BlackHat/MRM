    ...
    6701: (t, i, e) => {
      ...
      var r = (function () {
        ...
        var v = {
          ...
          table: [
            ...
            t(R, [2, 51]),
            t(_, [2, 10]),
            t(_, [2, 22], { 30: 41, 29: 56, 24: A, 27: w }),
            t(_, [2, 24]),
            t(_, [2, 25]),
            { 31: [1, 57] },
            {
      ...
      var p = class {
        ...
        recalculateOuterPaddingToDrawBar() {
          if (d * this.getTickDistance() > this.outerPadding * 2) {
            this.outerPadding = Math.floor((d * this.getTickDistance()) / 2);
          }
          this.recalculateScale();
        }
      ...
      (0, h.K2)(z, "getChartDefaultConfig");
      function B() {
        return {
      ...
      (0, h.K2)(U, "setYAxisRangeFromPlotData");
      function j(t) {
        let i = [];
        if (t.length === 0) {
          return i;
        ...
        if (!I) {
          ...
          X(Math.min(i, 1), Math.max(e, t.length));
        }
        if (!$) {
          U(t);
        }
      ...
      (0, h.K2)(it, "getXYChartData");
      var et = (0, h.K2)(function () {
        (0, h.IU)();
        D = 0;
        L = z();
        E = B();
      ...
      var at = (0, h.K2)((t, i, e, s) => {
        const a = s.db;
        const o = a.getChartThemeConfig();
        const r = a.getChartConfig();
        const l = a.getXYChartData().plots[0].data.map((t) => t[1]);
        function c(t) {
          return t === "top" ? "text-before-edge" : "middle";
        }
        (0, h.K2)(c, "getDominantBaseLine");
        function u(t) {
          return t === "left" ? "start" : t === "right" ? "end" : "middle";
        }
        (0, h.K2)(u, "getTextAnchor");
        function g(t) {
          return `translate(${t.x}, ${t.y}) rotate(${t.rotation || 0})`;
        }
        (0, h.K2)(g, "getTextTransformation");
        h.Rm.debug("Rendering xychart chart\n" + t);
        const x = (0, n.D)(i);
        const d = x.append("g").attr("class", "main");
        const f = d
          .append("rect")
          .attr("width", r.width)
          .attr("height", r.height)
          .attr("class", "background");
        (0, h.a$)(x, r.height, r.width, true);
        x.attr("viewBox", `0 0 ${r.width} ${r.height}`);
        f.attr("fill", o.backgroundColor);
        a.setTmpSVGG(x.append("g").attr("class", "mermaid-tmp-group"));
        ...
        function m(t) {
          ...
          for (const [s] of t.entries()) {
            ...
            i = y[e];
            if (!i) {
              i = y[e] = a.append("g").attr("class", t[s]);
            }
          }
          return i;
        }
        ...
        for (const n of p) {
          ...
          switch (n.type) {
            case "rect":
              ...
              if (r.showDataLabel) {
                if (r.chartOrientation === "horizontal") {
                  let i = function (t, i) {
                    const { data: s, label: a } = t;
                    const n = i * a.length * e;
                    return n <= s.width - 10;
                  };
                  var b = i;
                  (0, h.K2)(i, "fitsHorizontally");
                  const e = 0.7;
                  const s = n.data
                    .map((t, i) => ({ data: t, label: l[i].toString() }))
                  ...
                  let i = function (t, i, e) {
                    const { data: s, label: a } = t;
                    const n = 0.7;
                    const h = i * a.length * n;
                    const o = s.x + s.width / 2;
                    const r = o - h / 2;
                    const l = o + h / 2;
                    const c = r >= s.x && l <= s.x + s.width;
                    const u = s.y + e + i <= s.y + s.height;
                    return c && u;
                  };
                  var k = i;
                  (0, h.K2)(i, "fitsInBar");
            ...
            case "text":
              t.selectAll("text")
                ...
                .attr("dominant-baseline", (t) => c(t.verticalPos))
                .attr("text-anchor", (t) => u(t.horizontalPos))
                .attr("transform", (t) => g(t))
                .text((t) => t.text);
              break;
            case "path":
              t.selectAll("path")
      ...
      var nt = { draw: at };
      var ht = { parser: l, db: st, renderer: nt };
    },
  },
]);
