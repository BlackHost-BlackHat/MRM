...
(self["webpackChunk_jupyterlab_application_top"] =
  ...
  [4728, 5606],
  {
      ...
      class S {
        constructor(e, t, r) {
          ...
          if (
            ...
            i = w(t);
          } else if (t instanceof S || t instanceof u) {
            i = w(t.root);
            if (t.map) {
    ...
    45781: (e) => {
      ...
      const S = /.[\r\n"'(/\\]/;
      const T = /[\da-f]/i;
      e.exports = function e(E, A = {}) {
        let C = E.css.valueOf();
        let O = A.ignoreErrors;
        let k, I, N, L, D;
        let P, q, M, B, R;
        let j = C.length;
        let _ = 0;
        ...
        function G(e) {
          ...
          if (_ >= j) return;
          let E = e ? e.ignoreUnclosed : false;
          k = C.charCodeAt(_);
          switch (k) {
            case s:
            case o:
            ...
            case i: {
              ...
              if (
                ...
                I += 1;
                if (T.test(C.charAt(I))) {
                  while (T.test(C.charAt(I + 1))) {
                    I += 1;
                  }
                  if (C.charCodeAt(I + 1) === o) {
                    I += 1;
                  }
                }
              }
              R = ["word", C.slice(_, I + 1), _, I];
              _ = I;
              break;
            }
            default: {
              if (k === n && C.charCodeAt(_ + 1) === y) {
                I = C.indexOf("*/", _ + 2) + 1;
                if (I === 0) {
                  if (O || E) {
                    I = C.length;
        ...
        return { back: W, endOfFile: z, nextToken: G, position: V };
      };
    },
    6156: (e) => {
      "use strict";
    ...
    74728: (e, t, r) => {
      ...
      function y(e, t, r) {
        ...
        u.forEach(function (e) {
          if (S(e) && !t.allowVulnerableTags) {
            console.warn(
              `\n\n⚠️ Your \`allowedTags\` option includes, \`${e}\`, which is inherently\nvulnerable to XSS attacks. Please remove it from \`allowedTags\`.\nOr, to disable this warning, add the \`allowVulnerableTags\` option\nand ensure you are accounting for this risk.\n\n`,
            );
          }
        });
        const T = t.nonTextTags || ["script", "style", "textarea", "option"];
        let E;
        let A;
        ...
        const j = new i.Parser(
          {
            onopentag: function (e, r) {
              ...
              if (
                !S(e) ||
                (t.disallowedTagsMode === "recursiveEscape" && !d(P)) ||
        ...
        function F(e, t) {
          ...
          if (i) {
            e.nodes[0].nodes = r.nodes.reduce(G(i), []);
          }
          return e;
        }
        function z(e) {
