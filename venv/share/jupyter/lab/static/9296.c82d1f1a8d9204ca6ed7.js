  ...
  [9296],
  {
    49296: (t, e, i) => {
      ...
      i.d(e, {
        ...
        WidgetType: () => Mt,
        __test: () => Wr,
        closeHoverTooltips: () => _n,
        crosshairCursor: () => xn,
        drawSelection: () => Lo,
        dropCursor: () => Ko,
        getDialog: () => er,
        getDrawSelectionConfig: () => Po,
        getPanel: () => $n,
        getTooltip: () => qn,
        gutter: () => cr,
        gutterLineClass: () => lr,
        gutterWidgetClass: () => ar,
        gutters: () => ur,
        hasHoverTooltips: () => Kn,
        highlightActiveLine: () => hn,
        highlightActiveLineGutter: () => Rr,
        highlightSpecialChars: () => Zo,
        highlightTrailingWhitespace: () => Fr,
        highlightWhitespace: () => Nr,
        hoverTooltip: () => In,
        keymap: () => go,
        layer: () => Ro,
        lineNumberMarkers: () => Sr,
        lineNumberWidgetMarker: () => xr,
        lineNumbers: () => Dr,
        logException: () => xe,
        panels: () => jn,
        placeholder: () => un,
        rectangularSelection: () => bn,
        repositionTooltips: () => Xn,
        runScopeHandlers: () => vo,
        scrollPastEnd: () => an,
        showDialog: () => tr,
        showPanel: () => Zn,
      ...
      function p(t) {
        var e =
          (c && (t.ctrlKey || t.altKey || t.metaKey)) ||
          (f && t.shiftKey && t.key && t.key.length == 1) ||
          t.key == "Unidentified";
        var i =
          (!e && t.key) ||
      ...
      function b(t) {
        if (t.nodeType == 3)
          return P(t, 0, t.nodeValue.length).getClientRects();
        else if (t.nodeType == 1) return t.getClientRects();
        else return [];
      }
      function y(t, e, i, s) {
        return i ? M(t, e, i, s, -1) || M(t, e, i, s, 1) : false;
      }
      function S(t) {
        for (var e = 0; ; e++) {
          t = t.previousSibling;
      ...
      function O(t, e, i, s, o, n, r, l) {
        let a = t.ownerDocument,
          h = a.defaultView || window;
        for (let f = t, c = false; f && !c; ) {
          if (f.nodeType == 1) {
            let t,
              d = f == a.body;
            let u = 1,
            ...
            if (d) {
              ...
              if (/^(fixed|sticky)$/.test(getComputedStyle(f).position))
                c = true;
              if (
              ...
              ({ scaleX: u, scaleY: p } = D(f, e));
              t = {
                left: e.left,
                right: e.left + f.clientWidth * u,
                top: e.top,
                bottom: e.top + f.clientHeight * p,
              };
            }
            let g = 0,
              m = 0;
      ...
      class E {
        ...
        setRange(t) {
          ...
          this.set(
            e,
            Math.min(t.anchorOffset, e ? C(e) : 0),
            i,
            Math.min(t.focusOffset, i ? C(i) : 0),
          );
        }
        set(t, e, i, s) {
          this.anchorNode = t;
      ...
      let L;
      function P(t, e, i = e) {
        let s = L || (L = document.createRange());
        s.setEnd(t, i);
        s.setStart(t, e);
        return s;
      }
      ...
      class q {
        ...
        static before(t, e) {
          return new q(t.parentNode, S(t), e);
        }
        static after(t, e) {
          return new q(t.parentNode, S(t) + 1, e);
        }
      }
      const K = [];
      class Y {
        ...
        localPosFromDOM(t, e) {
          ...
          while (i && !Y.get(i)) i = i.nextSibling;
        ...
        domBoundsAround(t, e, i = 0) {
          ...
          for (let l = 0, a = i, h = i; l < this.children.length; l++) {
            let i = this.children[l],
              f = a + i.length;
            if (a < t && f > e) return i.domBoundsAround(t, e, a);
            if (f >= t && s == -1) {
              s = l;
              o = a;
            }
        ...
        childCursor(t = this.length) {
          return new X(this.children, t, this.children.length);
        }
        childPos(t, e = 1) {
      ...
      function G(t, e, i, s, o, n, r, l, a) {
        let { children: h } = t;
        let f = h.length ? h[e] : null;
        let c = n.length ? n[n.length - 1] : null;
        let d = c ? c.breakAfter : r;
        if (
          e == s &&
          f &&
          !r &&
          !d &&
          n.length < 2 &&
          f.merge(i, o, n.length ? c : null, i == 0, l, a)
        )
          return;
        if (s < h.length) {
          let t = h[s];
          if (
            ...
            (o < t.length ||
              (t.breakAfter &&
                (c === null || c === void 0 ? void 0 : c.breakAfter)))
          ) {
            if (e == s) {
              t = t.split(o);
              o = 0;
            }
            if (!d && c && t.merge(0, o, c, true, 0, a)) {
              n[n.length - 1] = t;
            } else {
        ...
        if (f) {
          f.breakAfter = r;
          if (i > 0) {
            if (!r && n.length && f.merge(i, f.length, n[0], false, l, 0)) {
              f.breakAfter = n.shift().breakAfter;
            } else if (
              i < f.length ||
              (f.children.length &&
                f.children[f.children.length - 1].length == 0)
            ) {
              f.merge(i, f.length, null, false, l, 0);
            }
            e++;
          }
        }
      ...
      function j(t, e, i, s, o, n) {
        let r = t.childCursor();
        let { i: l, off: a } = r.findPos(i, 1);
        let { i: h, off: f } = r.findPos(e, -1);
        let c = e - i;
        for (let d of s) c += d.length;
        t.length += c;
        G(t, h, f, l, a, s, 0, o, n);
      }
      let $ =
      ...
      const Q = /Edge\/(\d+)/.exec($.userAgent);
      const J = /MSIE \d/.test($.userAgent);
      const Z = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec($.userAgent);
      const tt = !!(J || Z || Q);
      const et = !tt && /gecko\/(\d+)/i.test($.userAgent);
      const it = !tt && /Chrome\/(\d+)/.exec($.userAgent);
      const st = "webkitFontSmoothing" in U.documentElement.style;
      const ot = !tt && /Apple Computer/.test($.vendor);
      const nt =
        ot && (/Mobile\/\w+/.test($.userAgent) || $.maxTouchPoints > 2);
      var rt = {
        mac: nt || /Mac/.test($.platform),
        windows: /Win/.test($.platform),
        linux: /Linux|X11/.test($.platform),
        ie: tt,
        ie_version: J ? U.documentMode || 6 : Z ? +Z[1] : Q ? +Q[1] : 0,
        gecko: et,
        gecko_version: et
          ? +(/Firefox\/(\d+)/.exec($.userAgent) || [0, 0])[1]
          : 0,
        chrome: !!it,
        chrome_version: it ? +it[1] : 0,
        ios: nt,
        android: /Android\b/.test($.userAgent),
        webkit: st,
        safari: ot,
        webkit_version: st
          ? +(/\bAppleWebKit\/(\d+)/.exec($.userAgent) || [0, 0])[1]
          : 0,
        tabSize:
          U.documentElement.style.tabSize != null
            ? "tab-size"
            : "-moz-tab-size",
      };
      const lt = 256;
      class at extends Y {
        ...
        split(t) {
          let e = new at(this.text.slice(t));
      ...
      class ht extends Y {
        ...
        merge(t, e, i, s, o, n) {
          if (
            i &&
            (!(i instanceof ht && i.mark.eq(this.mark)) ||
              (t && o <= 0) ||
              (e < this.length && n <= 0))
          )
            return false;
          j(this, t, e, i ? i.children.slice() : [], o - 1, n - 1);
          this.markDirty();
          return true;
        }
        split(t) {
      ...
      function ft(t, e, i) {
        ...
        let l = P(t, o, n).getClientRects();
        if (!l.length) return null;
        let a = l[(r ? r < 0 : i >= 0) ? 0 : l.length - 1];
        if (rt.safari && !r && a.width == 0)
      ...
      class ct extends Y {
        ...
        domAtPos(t) {
          return (this.length ? t == 0 : this.side > 0)
            ? q.before(this.dom)
            : q.after(this.dom, t == this.length);
        }
        domBoundsAround() {
          return null;
        }
      ...
      class dt extends Y {
        ...
        become(t) {
          return t instanceof dt && t.side == this.side;
        }
        split() {
          return new dt(this.side);
        }
        sync() {
          if (!this.dom) {
      ...
      at.prototype.children = ct.prototype.children = dt.prototype.children = K;
      function ut(t, e) {
        let i = t.dom,
          { children: s } = t,
          o = 0;
      ...
      function pt(t, e, i) {
        ...
        if (
          ...
          e instanceof ht &&
          o.length &&
          (s = o[o.length - 1]) instanceof ht &&
          s.mark.eq(e.mark)
        ) {
          pt(s, e.children[0], i - 1);
        } else {
          o.push(e);
          e.setParent(t);
        }
          ...
          for (let a = 0, h = 0; a < t.children.length && h <= e; a++) {
            ...
            if (c >= e) {
              if (f.children.length) {
                ...
                (!n || (n.isHidden && (i > 0 || wt(n, f)))) &&
                (c > e || (h == c && f.getSide() > 0))
              ) {
                n = f;
                r = e - h;
              } else if (h < e || (h == c && f.getSide() < 0 && !f.isHidden)) {
                s = f;
                o = e - h;
              }
            }
      ...
      class kt extends s.RangeValue {
        ...
        static widget(t) {
          ...
          return new Ot(t, e, e, i, t.widget || null, false);
        }
        static replace(t) {
          let e = !!t.block,
            i,
          ...
          if (t.isBlockGap) {
            ...
            let { start: o, end: n } = Tt(t, e);
            i = (o ? (e ? -3e8 : -1) : 5e8) - 1;
            s = (n ? (e ? 2e8 : 1) : -6e8) + 1;
          }
          return new Ot(t, i, s, e, t.widget || null, true);
        }
        static line(t) {
          return new Dt(t);
        }
      ...
      kt.none = s.RangeSet.empty;
      class At extends kt {
        constructor(t) {
          let { start: e, end: i } = Tt(t);
      ...
      class Dt extends kt {
        ...
        eq(t) {
          return (
            ...
            yt(this.spec.attributes, t.spec.attributes)
          );
        }
        range(t, e = t) {
          if (e != t)
      ...
      Dt.prototype.mapMode = s.MapMode.TrackBefore;
      ...
      class Bt extends Y {
        ...
        merge(t, e, i, s, o, n) {
          ...
          j(this, t, e, i ? i.children.slice() : [], o, n);
          return true;
        }
        split(t) {
          let e = new Bt();
        ...
        addLineDeco(t) {
          let e = t.spec.attributes,
            i = t.spec.class;
          if (e) this.attrs = vt(e, this.attrs || {});
          if (i) this.attrs = vt({ class: i }, this.attrs || {});
        }
        domAtPos(t) {
          return ut(this, t);
        }
        ...
        sync(t, e) {
          ...
          while (s && Y.get(s) instanceof ht) s = s.lastChild;
          if (
            !s ||
            !this.length ||
            (s.nodeName != "BR" &&
              ((i = Y.get(s)) === null || i === void 0
                ? void 0
                : i.isEditable) == false &&
              (!rt.ios || !this.children.some((t) => t instanceof at)))
          ) {
        ...
        measureTextSize() {
          ...
          let t = 0,
            e;
          for (let i of this.children) {
            if (!(i instanceof at) || /[^ -~]/.test(i.text)) return null;
            let s = b(i.dom);
      ...
      class Lt extends Y {
        ...
        split(t) {
          let e = this.length - t;
          this.length = t;
          let i = new Lt(this.widget, e, this.deco);
        ...
        coordsAt(t, e) {
          let i = this.widget.coordsAt(this.dom, t, e);
          if (i) return i;
          if (this.widget instanceof Pt) return null;
          return k(
      ...
      class Ht {
        ...
        posCovered() {
          ...
          return !(t.breakAfter || (t instanceof Lt && t.deco.endSide < 0));
        }
        getLine() {
          if (!this.curLine) {
        ...
        flushBuffer(t = this.bufferMarks) {
          if (this.pendingBuffer) {
            this.curLine.append(Nt(new dt(-1), t), t.length);
            this.pendingBuffer = 0;
          }
        }
        addBlockWidget(t) {
        ...
        finish(t) {
          ...
          if (
            ...
            !(
              t &&
              this.content.length &&
              this.content[this.content.length - 1] instanceof Lt
            )
          )
            this.getLine();
        }
        buildText(t, e, i) {
          while (t > 0) {
            ...
            this.getLine().append(
              Nt(new at(this.text.slice(this.textOff, this.textOff + s)), e),
              i,
            );
            this.atCursorPos = true;
            this.textOff += s;
        ...
        point(t, e, i, s, o, n) {
          if (this.disallowBlockEffectsFor[n] && i instanceof Ot) {
            if (i.block)
              throw new RangeError(
          ...
          if (i instanceof Ot) {
            if (i.block) {
              ...
              this.addBlockWidget(new Lt(i.widget || Vt.block, r, i));
            } else {
              let n = ct.create(i.widget || Vt.inline, r, r ? 0 : i.startSide);
              let l =
                this.atCursorPos &&
                !n.isEditable &&
                o <= s.length &&
      ...
      function Nt(t, e) {
        for (let i of e) t = new ht(i, [t], t.length);
        return t;
      }
      class Vt extends Mt {
        constructor(t) {
      ...
      function Qt(t, e, i, s, o) {
        for (let n = 0; n <= s.length; n++) {
          ...
          for (let t = r, e = a, s = a; t < l; t++) {
            let o = Ut[t];
            if (o == 128) {
              if (t < l - 1 && e == Ut[t + 1] && e & 24) o = Ut[t] = e;
              else Ut[t] = 256;
            } else if (o == 64) {
              let o = t + 1;
              while (o < l && Ut[o] == 64) o++;
              let n =
                (t && e == 8) || (o < i && Ut[o] == 8) ? (s == 1 ? 1 : 8) : 256;
      ...
      function Jt(t, e, i, s, o) {
        let n = o == 1 ? 2 : 1;
        for (let r = 0, l = 0, a = 0; r <= s.length; r++) {
          let h = r ? s[r - 1].to : e,
            f = r < s.length ? s[r].from : i;
          for (let e = h, i, s, r; e < f; e++) {
            if ((s = Yt[(i = t.charCodeAt(e))])) {
              if (s < 0) {
            ...
            t: for (;;) {
              if (h < n.length && u == n[h].from) {
                ...
                if (c) {
                  ...
                  if (p.from > a) r.push(new jt(a, p.from, d));
                  let e = (p.direction == Wt) != !(d % 2);
                  ee(t, e ? s + 1 : s, o, p.inner, p.from, p.to, r);
                  a = p.to;
                }
                u = p.to;
              } else if (u == i || (e ? Ut[u] != l : Ut[u] == l)) {
                break;
              } else {
                u++;
              }
            }
            if (c) te(t, a, u, s + 1, o, c, r);
            else if (a < u) r.push(new jt(a, u, d));
            a = u;
          }
        } else {
              ...
              if (h && u == n[h - 1].to) {
                ...
                if (!i)
                  for (let t = p.from, i = h; ; ) {
                    ...
                    else if (Ut[t - 1] == l) break t;
                    else break;
                  }
                if (c) {
                  c.push(p);
                } else {
                  if (p.to < a) r.push(new jt(p.to, a, d));
                  let e = (p.direction == Wt) != !(d % 2);
                  ee(t, e ? s + 1 : s, o, p.inner, p.from, p.to, r);
                  a = p.from;
                }
                u = p.from;
              } else if (u == e || (i ? Ut[u - 1] != l : Ut[u - 1] == l)) {
                break;
              } else {
                u--;
              }
            }
            if (c) te(t, u, a, s + 1, o, c, r);
            else if (u < a) r.push(new jt(u, a, d));
            a = u;
          }
        }
      }
      function ee(t, e, i, s, o, n, r) {
        let l = e % 2 ? 2 : 1;
        Qt(t, o, n, s, l);
        Jt(t, o, n, s, l);
        Zt(o, n, s, l);
      ...
      function ie(t, e, i) {
        if (!t) return [new jt(0, 0, e == zt ? 1 : 0)];
        if (e == Wt && !i.length && !Gt.test(t)) return se(t.length);
        if (i.length) while (t.length > Ut.length) Ut[Ut.length] = 256;
        let s = [],
          o = e == Wt ? 0 : 1;
        ee(t, o, o, i, 0, t.length, s);
        return s;
      }
      function se(t) {
        return [new jt(0, t, 0)];
      ...
      function ne(t, e, i, o, n) {
        ...
        let c = (0, s.findClusterBreak)(t.text, l, h.forward(n, i));
        if (c < h.from || c > h.to) c = f;
        oe = t.text.slice(Math.min(l, c), Math.max(l, c));
        let d = a == (n ? e.length - 1 : 0) ? null : e[a + (n ? 1 : -1)];
        if (d && c == f && d.level + (n ? 0 : 1) < h.level)
      ...
      function re(t, e, i) {
        for (let s = e; s < i; s++) {
          let e = Xt(t.charCodeAt(s));
          if (e == 1) return Wt;
          if (e == 2 || e == 4) return zt;
        }
        return Wt;
      }
      ...
      const ge = s.Facet.define();
      const me = s.Facet.define({ combine: (t) => t.some((t) => t) });
      const we = s.Facet.define({ combine: (t) => t.some((t) => t) });
      const ve = s.Facet.define();
      class be {
      ...
      const ye = s.StateEffect.define({ map: (t, e) => t.map(e) });
      const Se = s.StateEffect.define();
      function xe(t, e, i) {
        let s = t.facet(fe);
        if (s.length) s[0](e);
        else if (
      ...
      const Me = s.Facet.define({ combine: (t) => (t.length ? t[0] : true) });
      let Ce = 0;
      const ke = s.Facet.define({
        combine(t) {
          return t.filter((e, i) => {
            for (let s = 0; s < i; s++)
              if (t[s].plugin == e.plugin) return false;
            return true;
          });
        },
      });
      class Ae {
        constructor(t, e, i, s, o) {
          ...
          this.extension = this.baseExtensions.concat(
            ke.of({ plugin: this, arg: undefined }),
          );
        }
        of(t) {
          return this.baseExtensions.concat(ke.of({ plugin: this, arg: t }));
        }
        static define(t, e) {
          const {
            eventHandlers: i,
          ...
          return new Ae(Ce++, t, i, s, (t) => {
            let e = [];
            if (n)
              e.push(
                Ee.of((e) => {
                  let i = e.plugin(t);
                  return i ? n(i) : kt.none;
                }),
              );
            if (o) e.push(o(t));
            return e;
        ...
        static fromClass(t, e) {
          return Ae.define((e, i) => new t(e, i), e);
        }
      }
      class De {
        constructor(t) {
          ...
          if (!this.value) {
            if (this.spec) {
              try {
                ...
                xe(t.state, e, "CodeMirror plugin crashed");
                this.deactivate();
              }
            }
        ...
        static extendWithRanges(t, e) {
          ...
          for (let s = 0, o = 0, n = 0, r = 0; ; s++) {
            ...
            while (o < e.length && e[o] < h) {
              ...
              let n = Math.max(r, t),
                l = Math.min(h, s);
              if (n <= l) new Fe(n + a, l + a, n, l).addToSet(i);
              if (s > h) break;
              else o += 2;
            }
            if (!l) return i;
            new Fe(l.fromA, l.toA, l.fromB, l.toB).addToSet(i);
            n = l.toA;
            r = l.toB;
          }
        }
      ...
      class ze extends Y {
        ...
        constructor(t) {
          ...
          this.updateDeco();
          this.updateInner([new Fe(0, 0, 0, t.state.doc.length)], 0, null);
        }
        update(t) {
          var e;
          ...
          if (
            ...
            else if (!je(t.changes, this.hasComposition) && !t.selectionSet)
              s = t.state.selection.main.head;
          }
          let o = s > -1 ? Ke(this.view, t.changes, s) : null;
          this.domChanged = null;
          ...
          let n = this.decorations,
            r = this.updateDeco();
          let l = Xe(n, r, t.changes);
          i = Fe.extendWithRanges(i, l);
        ...
        updateInner(t, e, i) {
          ...
          if (
            ...
            for (let n of this.children)
              if (n instanceof Lt && n.widget instanceof Pt) o.push(n.dom);
          s.updateGaps(o);
        }
        ...
        compositionView(t) {
          let e = new at(t.text.nodeValue);
          e.flags |= 8;
          for (let { deco: s } of t.marks) e = new ht(s, [e], e.length);
          let i = new Bt();
          i.append(e, 0);
          return i;
        }
        ...
        updateSelection(t = false, e = false) {
          ...
          let o =
            !s &&
            !(this.view.state.facet(Me) || this.dom.tabIndex > -1) &&
            v(this.dom, this.view.observer.selectionRange) &&
          ...
          if (rt.gecko && r.empty && !this.hasComposition && Ie(l)) {
          ...
          if (
            n ||
            !h.focusNode ||
            ((!y(l.node, l.offset, h.anchorNode, h.anchorOffset) ||
              !y(a.node, a.offset, h.focusNode, h.focusOffset)) &&
            ...
            this.view.observer.ignore(() => {
              if (
                ...
                Ge(h.focusNode, this.dom)
              ) {
                this.dom.blur();
                this.dom.focus({ preventScroll: true });
              }
              let t = m(this.view.root);
              if (!t);
              else if (r.empty) {
                if (rt.gecko) {
                  let t = Ye(l.node, l.offset);
                  if (t && t != (1 | 2)) {
                    let e = (t == 1 ? z : I)(l.node, l.offset);
                    if (e) l = new q(e.node, e.offset);
                  }
                }
          ...
          this.impreciseAnchor = l.precise
            ? null
            : new q(h.anchorNode, h.anchorOffset);
          this.impreciseHead = a.precise
            ? null
            : new q(h.focusNode, h.focusOffset);
        }
        ...
        enforceCursorAssoc() {
          ...
          if (t.docView.posFromDOM(f.anchorNode, f.anchorOffset) != e.from)
            i.collapse(s, o);
        }
        moveToLine(t) {
          let e = this.dom,
        ...
        coordsAt(t, e) {
          ...
          for (let o = this.length, n = this.children.length - 1; n >= 0; n--) {
            ...
            if (
              ...
              (a < t || r.covers(-1)) &&
              (l > t || r.covers(1)) &&
              (!i || (r instanceof Bt && !(i instanceof Bt && e >= 0)))
            ) {
              i = r;
              s = a;
            } else if (
        ...
        coordsForChar(t) {
          ...
          if (!(o instanceof at)) return null;
          let n = (0, s.findClusterBreak)(o.text, i);
          if (n == i) return null;
          let r = P(o.dom, i, n).getClientRects();
        ...
        measureVisibleLineHeights(t) {
          ...
          let r = -1,
            l = this.view.textDirection == Ft.LTR;
        ...
        childCursor(t = this.length) {
          ...
          return new X(this.children, t, e);
        }
        computeBlockGapDeco() {
          let t = [],
        ...
        scrollIntoView(t) {
          ...
          for (let h of this.view.state.facet(ve)) {
            try {
              if (h(this.view, t.range, t)) return true;
            } catch (a) {
              xe(this.view.state, a, "scroll handler");
            }
          }
          let { range: e } = t;
          let i = this.coordsAt(
          ...
          O(
            ...
            this.view.textDirection == Ft.LTR,
          );
        }
      }
      function Ie(t) {
      ...
      function qe(t, e) {
        ...
        let s = z(i.focusNode, i.focusOffset);
        let o = I(i.focusNode, i.focusOffset);
        let n = s || o;
        if (o && s && o.node != s.node) {
          let e = Y.get(o.node);
          if (!e || (e instanceof at && e.text != o.node.nodeValue)) {
            n = o;
          } else if (t.docView.lastCompositionAfterCursor) {
            let t = Y.get(s.node);
            if (!(!t || (t instanceof at && t.text != s.node.nodeValue))) n = o;
          }
        }
      ...
      function Ke(t, e, i) {
        ...
        let h = new Fe(a.mapPos(n), a.mapPos(r), n, r);
        let f = [];
        for (let c = o.parentNode; ; c = c.parentNode) {
          let e = Y.get(c);
          if (e instanceof ht) f.push({ node: c, deco: e.mark });
          else if (
            e instanceof Bt ||
            (c.nodeName == "DIV" && c.parentNode == t.contentDOM)
          )
            return { range: h, text: o, marks: f, line: c };
          else if (c != t.contentDOM)
            f.push({
              node: c,
              deco: new At({
                inclusive: true,
      ...
      function ei(t, e, i) {
        ...
        for (let p = t.firstChild; p; p = p.nextSibling) {
          ...
          for (let d = 0; d < t.length; d++) {
            let u = t[d];
            if (o && Je(o, u)) u = Ze(ti(u, o.bottom), o.top);
            let g = Ue(e, u),
              m = Qe(i, u);
            if (g == 0 && m == 0)
              return p.nodeType == 3 ? ii(p, e, i) : ei(p, e, i);
            if (!s || r > m || (r == m && n > g)) {
              s = p;
              o = u;
              n = g;
              r = m;
              l = !g ? true : e < u.left ? d > 0 : d < t.length - 1;
            }
            if (g == 0) {
              if (i > u.bottom && (!f || f.bottom < u.bottom)) {
                a = p;
                f = u;
              } else if (i < u.top && (!c || c.top > u.top)) {
                h = p;
                c = u;
              }
            } else if (f && Je(f, u)) {
        ...
        if (s.nodeType == 3) return ii(s, d, i);
        if (l && s.contentEditable != "false") return ei(s, d, i);
        let u =
      ...
      function ii(t, e, i) {
        ...
        let o = -1,
          ...
          r = 0;
        for (let l = 0; l < s; l++) {
          let s = P(t, l, l + 1).getClientRects();
          for (let a = 0; a < s.length; a++) {
            let h = s[a];
            if (h.top == h.bottom) continue;
            if (!r) r = e - h.left;
            let f = (h.top > i ? h.top - i : i - h.bottom) - 1;
            if (h.left - 1 <= e && h.right + 1 >= e && f < n) {
              let i = e >= (h.left + h.right) / 2,
                s = i;
              if (rt.chrome || rt.gecko) {
                let e = P(t, l).getBoundingClientRect();
                if (e.left == h.right) s = !i;
              }
              if (f <= 0) return { node: t, offset: l + (s ? 1 : 0) };
              o = l + (s ? 1 : 0);
              n = f;
            }
          }
      ...
      function si(t, e, i, s = -1) {
        ...
        if (u < t.viewport.from)
          return t.viewport.from == 0 ? 0 : i ? null : oi(t, r, a, f, c);
        if (u > t.viewport.to)
        ...
        let m = g.elementFromPoint(f, c);
        if (m && !t.contentDOM.contains(m)) m = null;
        if (!m) {
          f = Math.max(r.left + 1, Math.min(r.right - 1, f));
          m = g.elementFromPoint(f, c);
          if (m && !t.contentDOM.contains(m)) m = null;
        }
        let w,
          v = -1;
        if (
          ...
          if (p.caretPositionFromPoint) {
            let t = p.caretPositionFromPoint(f, c);
            if (t) ({ offsetNode: w, offset: v } = t);
          } else if (p.caretRangeFromPoint) {
            let e = p.caretRangeFromPoint(f, c);
            if (e) {
      ...
      function ni(t, e, i) {
        ...
        for (;;) {
          let t = o.nextSibling;
          if (t) {
            if (t.nodeName == "BR") break;
            return false;
          } else {
            let t = o.parentNode;
            if (!t || t.nodeName == "DIV") break;
            o = t;
          }
        }
        return P(t, s - 1, s).getBoundingClientRect().right > i;
      }
      function ri(t, e, i) {
        if (e != 0) return false;
        for (let o = t; ; ) {
        ...
        let s =
          t.nodeType == 1
            ...
            : P(t, 0, Math.max(t.nodeValue.length, 1)).getBoundingClientRect();
        return i - s.left > 5;
      }
      function li(t, e, i) {
      ...
      function ai(t, e, i, o) {
        let n = li(t, e.head, e.assoc || -1);
        let r =
          !o || n.type != Ct.Text || !(t.lineWrapping || n.widgetLineBreaks)
            ? null
            : t.coordsAtPos(
        ...
        if (r) {
          ...
          let l = t.posAtCoords({
            x: i == (o == Ft.LTR) ? e.right - 1 : e.left + 1,
            y: (r.top + r.bottom) / 2,
          });
      ...
      function ci(t, e, i, o) {
        ...
        let f = t.coordsAtPos(n, e.assoc || -1),
          c = t.documentTop;
        if (f) {
          if (l == null) l = f.left - h.left;
          a = r < 0 ? f.top : f.bottom;
        } else {
        ...
        findPointInside(t, e) {
          for (let i of this.points)
            if (t.nodeType == 3 ? i.node == t : t.contains(i.node))
              i.pos = this.text.length + (mi(t, i.node, i.offset) ? e : 0);
        }
      }
      function mi(t, e, i) {
        for (;;) {
          if (!e || i < C(e)) return false;
          if (e == t) return true;
          i = S(e) + 1;
          e = e.parentNode;
        }
      ...
      function bi(t, e) {
        ...
        if (e.bounds) {
          ...
          let a = n.from,
            h = null;
          if (r === 8 || (rt.android && e.text.length < l - o)) {
            a = n.to;
            h = "end";
          }
          let f = xi(t.state.doc.sliceString(o, l, pi), e.text, a - o, h);
          if (f) {
            if (
              rt.chrome &&
              r == 13 &&
              f.toB == f.from + 2 &&
              e.text.slice(f.from, f.toB) == pi + pi
            )
              f.toB--;
            i = {
              from: o + f.from,
              to: o + f.toA,
              insert: s.Text.of(e.text.slice(f.from, f.toB).split(pi)),
            };
          }
        } else if (o && ((!t.hasFocus && t.state.facet(Me)) || o.main.eq(n))) {
          o = null;
        }
        if (!i && !o) return false;
      ...
      function yi(t, e, i, s = -1) {
        if (rt.ios && t.inputState.flushIOSKey(e)) return true;
        ...
        let r;
        let l = () => r || (r = Si(t, e, i));
        if (!t.state.facet(de).some((i) => i(t, e.from, e.to, n, l)))
          t.dispatch(l());
        return true;
      }
      function Si(t, e, i) {
        ...
        if (
          ...
          if (
            ...
            let f,
              c = i && qe(t, i.main.head);
            if (c) {
              let t = e.insert.length - (e.to - e.from);
              f = { from: c.from, to: c.to - t };
            } else {
              f = t.state.doc.lineAt(r.head);
            }
            let d = r.to - e.to,
              u = r.to - r.from;
            o = n.changeByRange((i) => {
              ...
              if (
                i.to - i.from != u ||
                t.state.sliceDoc(c, o) != h ||
                (i.to >= f.from && i.from <= f.to)
              )
                return { range: i };
              let p = n.changes({ from: c, to: o, insert: e.insert }),
                g = i.to - r.to;
              return {
                changes: p,
                range: !a
      ...
      class ki {
        ...
        constructor(t) {
          ...
          if (rt.safari) t.contentDOM.addEventListener("input", () => null);
          if (rt.gecko) fs(t.contentDOM.ownerDocument);
        }
        handleEvent(t) {
          if (!Fi(this.view, t) || this.ignoreDuringComposition(t)) return;
        ...
        keydown(t) {
          ...
          if (
            ...
            !t.altKey &&
            !t.metaKey &&
            (((e = Oi.find((e) => e.keyCode == t.keyCode)) && !t.ctrlKey) ||
              (Ti.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey))
          ) {
      ...
      function Di(t) {
        ...
        for (let s of t) {
          let t = s.spec,
            e = t && t.plugin.domEventHandlers,
            o = t && t.plugin.domEventObservers;
          if (e)
            for (let n in e) {
              let t = e[n];
              if (t) i(n).handlers.push(Ai(s.value, t));
            }
          if (o)
            for (let n in o) {
              let t = o[n];
              if (t) i(n).observers.push(Ai(s.value, t));
            }
        }
        for (let s in Wi) i(s).handlers.push(Wi[s]);
        for (let s in zi) i(s).observers.push(zi[s]);
        return e;
      }
      const Oi = [
      ...
      const Ti = "dthko";
      const Ei = [16, 17, 18, 20, 91, 92, 224, 225];
      const Ri = 6;
      function Bi(t) {
      ...
      class Pi {
        constructor(t, e, i, o) {
          ...
          this.scrolling = -1;
          this.lastEvent = e;
          this.scrollParents = T(t.contentDOM);
          this.atoms = t.state.facet(Be).map((e) => e(t));
          ...
          this.multiple =
            t.state.facet(s.EditorState.allowMultipleSelections) && Hi(t, e);
          this.dragging = Vi(t, e) && Zi(e) == 1 ? null : false;
        }
        start(t) {
        ...
        move(t) {
          ...
          if (
            this.dragging ||
            (this.dragging == null && Li(this.startEvent, t) < 10)
          )
            return;
          ...
          let l = Ne(this.view);
          if (t.clientX - l.left <= s + Ri) e = -Bi(s - t.clientX);
          else if (t.clientX + l.right >= n - Ri) e = Bi(t.clientX - n);
          if (t.clientY - l.top <= o + Ri) i = -Bi(o - t.clientY);
          else if (t.clientY + l.bottom >= r - Ri) i = Bi(t.clientY - r);
        ...
        skipAtoms(t) {
          ...
          for (let i = 0; i < t.ranges.length; i++) {
            let o = t.ranges[i],
              n = null;
            if (o.empty) {
              let t = di(this.atoms, o.from, 0);
              if (t != o.from) n = s.EditorSelection.cursor(t, -1);
            } else {
              let t = di(this.atoms, o.from, -1);
              let e = di(this.atoms, o.to, 1);
              if (t != o.from || e != o.to)
      ...
      function Hi(t, e) {
        let i = t.state.facet(le);
        return i.length ? i[0](e) : rt.mac ? e.metaKey : e.ctrlKey;
      }
      function Ni(t, e) {
        let i = t.state.facet(ae);
        return i.length ? i[0](e) : rt.mac ? !e.altKey : !e.ctrlKey;
      }
      function Vi(t, e) {
      ...
      function Fi(t, e) {
        ...
        for (let i = e.target, s; i != t.contentDOM; i = i.parentNode)
          if (!i || i.nodeType == 11 || ((s = Y.get(i)) && s.ignoreEvent(e)))
            return false;
        return true;
      }
      ...
      const Ii =
        (rt.ie && rt.ie_version < 15) || (rt.ios && rt.webkit_version < 604);
      function qi(t) {
      ...
      Wi.mousedown = (t, e) => {
        ...
        let i = null;
        for (let s of t.state.facet(he)) {
          i = s(t, e);
          if (i) break;
        }
        if (!i && e.button == 0) i = ts(t, e);
        if (i) {
          let s = !t.hasFocus;
          t.inputState.startMouseSelection(new Pi(t, e, i, s));
          if (s)
            t.observer.ignore(() => {
              B(t.contentDOM);
      ...
      function Gi(t, e, i, s) {
        ...
        if (r && Xi(i, s, r)) return -1;
        let l = o.coordsAt(n, 1);
        if (l && Xi(i, s, l)) return 1;
        return r && r.bottom >= s ? -1 : 1;
      }
      function ji(t, e) {
        let i = t.posAtCoords({ x: e.clientX, y: e.clientY }, false);
        return { pos: i, bias: Gi(t, i, e.clientX, e.clientY) };
      }
      const $i = rt.ie && rt.ie_version <= 11;
      let Ui = null,
        Qi = 0,
        Ji = 0;
      function Zi(t) {
        if (!$i) return t.detail;
        let e = Ui,
          i = Ji;
        Ui = t;
        Ji = Date.now();
      ...
      function ts(t, e) {
        ...
        return {
          ...
          get(e, r, l) {
            let a = ji(t, e),
              h;
            let f = _i(t, a.pos, a.bias, o);
            if (i.pos != a.pos && !r) {
              let e = _i(t, i.pos, i.bias, o);
              let n = Math.min(e.from, f.from),
                r = Math.max(e.to, f.to);
              f =
                n < f.from
                  ? s.EditorSelection.range(n, r)
                  : s.EditorSelection.range(r, n);
            }
            if (r) return n.replaceRange(n.main.extend(f.from, f.to));
            else if (l && o == 1 && n.ranges.length > 1 && (h = es(n, a.pos)))
              return h;
            else if (l) return n.addRange(f);
            else return s.EditorSelection.create([f]);
          },
        };
      }
      function es(t, e) {
      ...
      Wi.dragstart = (t, e) => {
        ...
        if (e.dataTransfer) {
          e.dataTransfer.setData(
            "Text",
            Ki(t.state, ge, t.state.sliceDoc(i.from, i.to)),
          );
      ...
      function is(t, e, i, s) {
        ...
        let r = s && n && Ni(t, e) ? { from: n.from, to: n.to } : null;
      ...
      Wi.paste = (t, e) => {
        if (t.state.readOnly) return true;
        t.observer.flush();
        let i = Ii ? null : e.clipboardData;
        if (i) {
          Yi(t, i.getData("text/plain") || i.getData("text/uri-list"));
          return true;
        } else {
          qi(t);
          return false;
      ...
      function os(t) {
        ...
        return { text: Ki(t, ge, e.join(t.lineBreak)), ranges: i, linewise: s };
      }
      let ns = null;
      Wi.copy = Wi.cut = (t, e) => {
        let { text: i, ranges: s, linewise: o } = os(t.state);
        if (!i && !o) return false;
        ns = o ? i : null;
      ...
      const rs = s.Annotation.define();
      function ls(t, e) {
        let i = [];
        for (let s of t.facet(ue)) {
          let o = s(t, e);
          if (o) i.push(o);
        }
        return i.length
          ? t.update({ effects: i, annotations: rs.of(true) })
          : null;
      }
      function as(t) {
        setTimeout(() => {
      ...
      zi.compositionstart = zi.compositionupdate = (t) => {
      ...
      Wi.beforeinput = (t, e) => {
        ...
        if (e.inputType == "insertReplacementText" && t.observer.editContext) {
          ...
          if (s && o.length) {
            ...
            yi(t, { from: i, to: n, insert: t.state.toText(s) }, null);
            return true;
          }
        }
        let o;
        if (
          rt.chrome &&
          rt.android &&
          (o = Oi.find((t) => t.inputType == e.inputType))
        ) {
        ...
        if (rt.ios && e.inputType == "deleteContentForward") {
          t.observer.flushSoon();
        }
        if (
          rt.safari &&
          ...
          setTimeout(() => zi.compositionend(t, e), 20);
        }
        return false;
      };
      const hs = new Set();
      ...
      class ms {
        ...
        get widget() {
          return this._content instanceof Ot ? this._content.widget : null;
        }
      ...
      class bs {
        ...
        setHeight(t) {
          if (this.height != t) {
            if (Math.abs(this.height - t) > vs) ds = true;
            this.height = t;
          }
        }
        replace(t, e, i) {
        ...
        applyChanges(t, e, i, s) {
          ...
          for (let r = s.length - 1; r >= 0; r--) {
            let { fromA: l, toA: a, fromB: h, toB: f } = s[r];
            let c = o.lineAt(l, ws.ByPosNoHeight, i.setDoc(e), 0, 0);
            let d = c.to >= a ? c : o.lineAt(a, ws.ByPosNoHeight, i, 0, 0);
            f += d.to - a;
            a = d.to;
            while (r > 0 && c.from <= s[r - 1].toA) {
              l = s[r - 1].fromA;
              h = s[r - 1].fromB;
              r--;
              if (l < c.from) c = o.lineAt(l, ws.ByPosNoHeight, i, 0, 0);
            }
            h += c.from - l;
            l = c.from;
            let u = Ds.build(i.setDoc(n), t, h, f);
            o = ys(o, o.replace(l, a, u));
          }
        ...
        static of(t) {
          ...
          return new Cs(bs.of(t.slice(0, e)), n, bs.of(t.slice(i)));
        }
      }
      function ys(t, e) {
        if (t == e) return t;
        if (t.constructor != e.constructor) ds = true;
        return e;
      }
      bs.prototype.size = 1;
      class Ss extends bs {
        ...
        blockAt(t, e, i, s) {
          return new ms(s, this.length, i, this.height, this.deco || 0);
        }
        lineAt(t, e, i, s, o) {
      ...
      class xs extends Ss {
        ...
        blockAt(t, e, i, s) {
          return new ms(s, this.length, i, this.height, this.breaks);
        }
        replace(t, e, i) {
          let s = i[0];
          if (
            i.length == 1 &&
            (s instanceof xs || (s instanceof Ms && s.flags & 4)) &&
            Math.abs(this.length - s.length) < 10
          ) {
            if (s instanceof Ms) s = new xs(s.length, this.height);
      ...
      class Ms extends bs {
        ...
        blockAt(t, e, i, s) {
          ...
          if (e.lineWrapping) {
            ...
            return new ms(n.from, n.length, h, a, 0);
          } else {
            let s = Math.max(0, Math.min(n - o, Math.floor((t - i) / r)));
            let { from: l, length: a } = e.doc.line(o + s);
            return new ms(l, a, i + r * s, r, 0);
          }
        }
        lineAt(t, e, i, s, o) {
          if (e == ws.ByHeight) return this.blockAt(t, i, s, o);
          if (e == ws.ByPosNoHeight) {
            let { from: e, to: s } = i.doc.lineAt(t);
            return new ms(e, s - e, 0, 0, 0);
          }
          let {
            firstLine: n,
            perLine: r,
          ...
          let a = i.doc.lineAt(t),
            h = r + a.length * l;
          let f = a.number - n;
          let c = s + r * f + l * (a.from - o - f);
          return new ms(
            a.from,
            a.length,
            Math.max(s, Math.min(c, s + this.height - h)),
            h,
            0,
          );
        }
        forEachLine(t, e, i, s, o, n) {
          ...
          for (let h = t, f = s; h <= e; ) {
            ...
            let s = l + a * e.length;
            n(new ms(e.from, e.length, f, s, 0));
            f += s;
            h = e.to + 1;
          }
        }
        replace(t, e, i) {
          ...
          if (s > 0) {
            let t = i[i.length - 1];
            if (t instanceof Ms) i[i.length - 1] = new Ms(t.length + s);
            else i.push(null, new Ms(s - 1));
          }
          if (t > 0) {
            let e = i[0];
            if (e instanceof Ms) i[0] = new Ms(t + e.length);
            else i.unshift(new Ms(t - 1), null);
          }
          return bs.of(i);
        }
        decomposeLeft(t, e) {
          e.push(new Ms(t - 1), null);
        }
        decomposeRight(t, e) {
          e.push(null, new Ms(this.length - t - 1));
        }
        updateHeight(t, e = 0, i = false, s) {
          let o = e + this.length;
          if (s && s.from <= e + this.length && s.more) {
            let i = [],
              n = Math.max(e, s.from),
              r = -1;
            if (s.from > e) i.push(new Ms(s.from - e - 1).updateHeight(t, e));
            while (n <= o && s.more) {
              let e = t.doc.lineAt(n).length;
              if (i.length) i.push(null);
              let o = s.heights[s.index++];
              if (r == -1) r = o;
              else if (Math.abs(o - r) >= vs) r = -2;
              let l = new xs(e, o);
              l.outdated = false;
              i.push(l);
              n += e + 1;
            }
            if (n <= o) i.push(null, new Ms(o - n).updateHeight(t, n));
            let l = bs.of(i);
            if (
              r < 0 ||
              Math.abs(l.height - this.height) >= vs ||
              Math.abs(r - this.heightMetrics(t, e).perLine) >= vs
            )
              ds = true;
            return ys(this, l);
          } else if (i || this.outdated) {
      ...
      class Cs extends bs {
        ...
        forEachLine(t, e, i, s, o, n) {
          ...
          if (this.break) {
            ...
            let a = this.lineAt(l, ws.ByPos, i, s, o);
        ...
        balanced(t, e) {
          if (t.size > 2 * e.size || e.size > 2 * t.size)
            return bs.of(this.break ? [t, null, e] : [t, e]);
          this.left = ys(this.left, t);
          this.right = ys(this.right, e);
      ...
      function ks(t, e) {
        ...
        if (
          t[e] == null &&
          (i = t[e - 1]) instanceof Ms &&
          (s = t[e + 1]) instanceof Ms
        )
          t.splice(e - 1, 3, new Ms(i.length + 1 + s.length));
      }
      const As = 5;
      class Ds {
        constructor(t, e) {
        ...
        span(t, e) {
          if (this.lineStart > -1) {
            ...
            if (i instanceof xs) i.length += t - this.pos;
            else if (t > this.pos || !this.isCovered)
              this.nodes.push(new xs(t - this.pos, -1));
            this.writtenTo = t;
            if (e > t) {
        ...
        enterLine() {
          ...
          if (this.pos > t) this.nodes.push(new xs(this.pos - t, -1));
        ...
        finish(t) {
          ...
          if (this.lineStart > -1 && !(e instanceof xs) && !this.isCovered)
            this.nodes.push(new xs(0, -1));
          else if (this.writtenTo < this.pos || e == null)
            this.nodes.push(this.blankContent(this.writtenTo, this.pos));
          let i = t;
          for (let s of this.nodes) {
            if (s instanceof xs) s.updateHeight(this.oracle, i);
            i += s ? s.length : 1;
          }
          return this.nodes;
        }
      ...
      class Ls {
        ...
        draw(t, e) {
          return kt
            .replace({
              widget: new Ps(this.displaySize * (e ? t.scaleY : t.scaleX), e),
            })
      ...
      class Hs {
        constructor(t) {
          ...
          this.defaultTextDirection = Ft.LTR;
          this.visibleRanges = [];
          ...
          this.stateDeco = t.facet(Ee).filter((t) => typeof t != "function");
          this.heightMap = bs
            .empty()
            .applyChanges(
              this.stateDeco,
        ...
        updateScaler() {
          ...
          this.scaler =
            this.heightMap.height <= 7e6
              ? Is
              : new qs(this.heightOracle, this.heightMap, this.viewports);
        ...
        updateViewportLines() {
          ...
          this.heightMap.forEachLine(
            ...
            0,
            (t) => {
              this.viewportLines.push(Ks(t, this.scaler));
            },
          );
        }
        update(t, e = null) {
          ...
          if (this.heightMap.height != r || ds) t.flags |= 2;
          if (l) {
        ...
        measure(t) {
          ...
          let n = i.whiteSpace;
          this.defaultTextDirection = i.direction == "rtl" ? Ft.RTL : Ft.LTR;
          ...
          if (this.paddingTop != c || this.paddingBottom != d) {
            this.paddingTop = c;
          ...
          this.scrolledToBottom = W(t.scrollDOM);
          let p = (this.printing ? Bs : Es)(e, this.paddingTop);
          ...
          if (!this.inView && !this.scrollTarget && !Rs(t.dom)) return 0;
          let v = l.width;
          if (
          ...
          if (a) {
            ...
            if (
              ...
              r = i > 0 && o.refresh(n, i, s, l, Math.max(5, v / s), e);
              if (r) {
                t.docView.minWidth = 0;
                h |= 16;
              }
            }
            if (g > 0 && m > 0) f = Math.max(g, m);
            else if (g < 0 && m < 0) f = Math.min(g, m);
            us();
                ...
                r
                  ? bs
                      ...
                      .applyChanges(
                        ...
                        s.Text.empty,
                        this.heightOracle,
                        [new Fe(0, 0, 0, t.state.doc.length)],
                      )
                  : this.heightMap
              ).updateHeight(o, 0, r, new gs(i.from, n));
            }
            if (ds) h |= 2;
          }
          let b =
        ...
        getViewport(t, e) {
          ...
          let l = new Ns(
            s.lineAt(n - i * 1e3, ws.ByHeight, o, 0, 0).from,
            s.lineAt(r + (1 - i) * 1e3, ws.ByHeight, o, 0, 0).to,
          );
          if (e) {
            let { head: t } = e.range;
            if (t < l.from || t > l.to) {
              ...
              let n = s.lineAt(t, ws.ByPos, o, 0, 0),
                r;
              ...
              l = new Ns(
                s.lineAt(r - 1e3 / 2, ws.ByHeight, o, 0, 0).from,
                s.lineAt(r + i + 1e3 / 2, ws.ByHeight, o, 0, 0).to,
              );
            }
          }
          return l;
        ...
        mapViewport(t, e) {
          ...
          return new Ns(
            ...
            this.heightMap.lineAt(s, ws.ByPos, this.heightOracle, 0, 0).to,
          );
        }
        ...
        mapLineGaps(t, e) {
          ...
          for (let s of t)
            if (!e.touchesRange(s.from, s.to))
              i.push(
                new Ls(e.mapPos(s.from), e.mapPos(s.to), s.size, s.displaySize),
              );
          return i;
        }
        ensureLineGaps(t, e) {
          ...
          let o = i ? 1e4 : 2e3,
            n = o >> 1,
            r = o << 1;
          if (this.defaultTextDirection != Ft.LTR && !i) return [];
          let l = [];
          let a = (o, r, h, f) => {
            if (r - o < n) return;
            let c = this.state.selection.main,
              d = [c.from];
            if (!c.empty) d.push(c.to);
            for (let t of d) {
              if (t > o && t < r) {
                a(o, t - 10, h, f);
                a(t + 10, r, h, f);
          ...
          let h = (e) => {
            if (e.length < r || e.type != Ct.Text) return;
            let s = Vs(e.from, e.to, this.stateDeco);
            if (s.total < r) return;
            ...
            if (i) {
              ...
              let f = this.pixelViewport.left + a,
                c = this.pixelViewport.right + a;
              let d, u;
              if (n != null) {
                let t = Ws(s, n);
                let e = ((c - f) / 2 + r) / i;
      ...
      function Fs({ total: t, ranges: e }, i) {
      ...
      class qs {
        constructor(t, e, i) {
          ...
          this.viewports = i.map(({ from: i, to: o }) => {
            let n = e.lineAt(i, ws.ByPos, t, 0, 0).top;
            let r = e.lineAt(o, ws.ByPos, t, 0, 0).bottom;
            s += r - n;
            return {
              from: i,
              to: o,
        ...
        eq(t) {
          if (!(t instanceof qs)) return false;
          return (
            this.scale == t.scale &&
      ...
      function Ks(t, e) {
        ...
        return new ms(
          ...
          Array.isArray(t._content)
            ? t._content.map((t) => Ks(t, e))
            : t._content,
        );
      }
      const Ys = s.Facet.define({ combine: (t) => t.join(" ") });
      const _s = s.Facet.define({ combine: (t) => t.indexOf(true) > -1 });
      const Xs = o.StyleModule.newName(),
        Gs = o.StyleModule.newName(),
        js = o.StyleModule.newName();
      const $s = { "&light": "." + Gs, "&dark": "." + js };
      function Us(t, e, i) {
      ...
      const Zs = rt.ie && rt.ie_version <= 11;
      class to {
        constructor(t) {
          this.view = t;
          this.active = false;
          ...
          this.observer = new MutationObserver((e) => {
            ...
            if (
              ((rt.ie && rt.ie_version <= 11) || (rt.ios && t.composing)) &&
              e.some(
                (t) =>
          ...
          if (
            ...
            !(rt.chrome && rt.chrome_version < 126)
          ) {
            this.editContext = new oo(t);
            if (t.state.facet(Me))
        ...
        onSelectionChange(t) {
          ...
          if (
            ((rt.ie && rt.ie_version <= 11) || (rt.android && rt.chrome)) &&
        ...
        start() {
          ...
          this.observer.observe(this.dom, Js);
          if (Zs)
        ...
        readMutation(t) {
          ...
          if (t.type == "childList") {
            let i = eo(e, t.previousSibling || t.target.previousSibling, -1);
            let s = eo(e, t.nextSibling || t.target.nextSibling, 1);
            return {
        ...
        update(t) {
          if (this.editContext) {
            ...
            if (t.startState.facet(Me) != t.state.facet(Me))
              t.view.contentDOM.editContext = t.state.facet(Me)
      ...
      function io(t, e) {
        ...
        if (y(r.node, r.offset, o, n)) [i, s, o, n] = [o, n, i, s];
            ...
            for (let t of e.getTextFormats()) {
              ...
              if (e != "None" && s != "None") {
                ...
                if (o < n) {
                  ...
                  i.push(kt.mark({ attributes: { style: t } }).range(o, n));
                }
              }
            }
            t.dispatch({ effects: Se.of(kt.set(i)) });
          };
      ...
      class no {
        ...
        constructor(t = {}) {
          ...
          this._root = t.root || N(t.parent) || document;
          this.viewState = new Hs(t.state || s.EditorState.create(t));
          if (t.scrollTo && t.scrollTo.is(ye))
            this.viewState.scrollTarget = t.scrollTo.value.clip(
              this.viewState.state,
            );
          this.plugins = this.state.facet(ke).map((t) => new De(t));
          for (let s of this.plugins) s.update(this);
          this.observer = new to(this);
          this.inputState = new ki(this);
          this.inputState.ensureHandlers(this.plugins);
          this.docView = new ze(this);
          this.mountStyles();
          this.updateAttrs();
          this.updateState = 0;
          this.requestMeasure();
        ...
        update(t) {
          ...
          try {
            ...
            for (let e of t) {
              ...
              for (let t of e.effects)
                if (t.is(ye)) c = t.value.clip(this.state);
            }
            this.viewState.update(o, c);
            this.bidiCache = ao.update(this.bidiCache, o.changes);
            if (!o.empty) {
              this.updatePlugins(o);
              this.inputState.update(o);
            }
            e = this.docView.update(o);
            if (this.state.facet(Ve) != this.styleModules) this.mountStyles();
            i = this.updateAttrs();
          ...
          if (o.startState.facet(Ys) != o.state.facet(Ys))
          ...
          if (a || f)
            Promise.resolve().then(() => {
              ...
              if (f) {
                if (!bi(this, f) && h.force)
                  H(this.contentDOM, h.key, h.keyCode);
              }
            });
        }
        setState(t) {
          ...
          try {
            ...
            this.viewState = new Hs(t);
            this.plugins = t.facet(ke).map((t) => new De(t));
          ...
          for (let e of this.plugins) {
            ...
            if (i && i.docViewUpdate) {
              try {
                ...
                xe(this.state, t, "doc view update listener");
              }
            }
          }
        }
        measure(t = true) {
          ...
          try {
            for (let t = 0; ; t++) {
              ...
              let f = We.create(this, this.state, []),
                c = false;
              f.flags |= l;
              if (!e) e = f;
              else e.flags |= l;
              ...
              if (!f.empty) {
                ...
                this.updateAttrs();
                c = this.docView.update(f);
                if (c) this.docViewUpdate();
              }
              ...
              if (c) this.docView.updateSelection(true);
        ...
        updateAttrs() {
          ...
          let e = {
            ...
            translate: "no",
            contenteditable: !this.state.facet(Me) ? "false" : "true",
            class: "cm-content",
          ...
          let i = this.observer.ignore(() => {
            ...
            let s = St(this.dom, this.editorAttrs, t);
            return i || s;
          });
          this.editorAttrs = t;
          this.contentAttrs = e;
        ...
        mountStyles() {
          ...
          let t = this.state.facet(no.cspNonce);
          o.StyleModule.mount(
            this.root,
            this.styleModules.concat(Qs).reverse(),
            t ? { nonce: t } : undefined,
          );
        }
        readMeasured() {
        ...
        moveByChar(t, e, i) {
          return ui(this, t, hi(this, t, e, i));
        }
        moveByGroup(t, e) {
          return ui(
            this,
            t,
            hi(this, t, e, (e) => fi(this, t.head, e)),
          );
        }
        visualLineSide(t, e) {
        ...
        moveToLineBoundary(t, e, i = true) {
          return ai(this, t, e, i);
        }
        moveVertically(t, e, i) {
          return ui(this, t, ci(this, t, e, i));
        }
        domAtPos(t) {
        ...
        coordsAtPos(t, e = 1) {
          ...
          let s = this.state.doc.lineAt(t),
            o = this.bidiSpans(s);
          let n = o[jt.find(o, t - s.from, -1, e)];
          return k(i, (n.dir == Ft.LTR) == e > 0);
        }
        coordsForChar(t) {
          this.readMeasured();
        ...
        bidiSpans(t) {
          if (t.length > ro) return se(t.length);
          ...
          for (let o of this.bidiCache) {
            if (
              o.from == t.from &&
              o.dir == e &&
              (o.fresh || $t(o.isolates, (i = Pe(this, t))))
            )
              return o.order;
          }
          if (!i) i = Pe(this, t);
          let s = ie(t.text, e, i);
          this.bidiCache.push(new ao(t.from, t.to, e, i, true, s));
          return s;
        }
        get hasFocus() {
          var t;
        ...
        static domEventHandlers(t) {
          return Ae.define(() => ({}), { eventHandlers: t });
        }
        static domEventObservers(t) {
          return Ae.define(() => ({}), { eventObservers: t });
        }
        static theme(t, e) {
          let i = o.StyleModule.newName();
          let s = [Ys.of(i), Ve.of(Us(`.${i}`, t))];
          if (e && e.dark) s.push(_s.of(true));
          return s;
        }
        static baseTheme(t) {
          return s.Prec.lowest(Ve.of(Us("." + Xs, t, $s)));
        }
        static findFromDOM(t) {
          var e;
          let i = t.querySelector(".cm-content");
          let s = (i && Y.get(i)) || Y.get(t);
          return (
      ...
      no.styleModule = Ve;
      no.inputHandler = de;
      no.clipboardInputFilter = pe;
      no.clipboardOutputFilter = ge;
      no.scrollHandler = ve;
      no.focusChangeEffect = ue;
      no.perLineTextDirection = me;
      no.exceptionSink = fe;
      no.updateListener = ce;
      no.editable = Me;
      no.mouseSelectionStyle = he;
      no.dragMovesSelection = ae;
      no.clickAddsSelectionRange = le;
      no.decorations = Ee;
      no.outerDecorations = Re;
      no.atomicRanges = Be;
      no.bidiIsolatedRanges = Le;
      no.scrollMargins = He;
      no.darkTheme = _s;
      no.cspNonce = s.Facet.define({ combine: (t) => (t.length ? t[0] : "") });
      no.contentAttributes = Te;
      no.editorAttributes = Oe;
      no.lineWrapping = no.contentAttributes.of({ class: "cm-lineWrapping" });
      no.announce = s.StateEffect.define();
      const ro = 4096;
      const lo = {};
      class ao {
        ...
        static update(t, e) {
          ...
          let i = [],
            s = t.length ? t[t.length - 1].dir : Ft.LTR;
      ...
      const po = s.Prec.default(
        no.domEventHandlers({
          keydown(t, e) {
            return Mo(wo(e.state), t, e, "editor");
          },
        }),
      );
      const go = s.Facet.define({ enables: po });
      const mo = new WeakMap();
      function wo(t) {
        let e = t.facet(go);
        let i = mo.get(e);
        if (!i) mo.set(e, (i = So(e.reduce((t, e) => t.concat(e), []))));
        return i;
      }
      function vo(t, e, i) {
        return Mo(wo(t.state), e, t, i);
      }
      let bo = null;
      const yo = 4e3;
      function So(t, e = fo) {
        ...
        let n = (t, s, n, r, l) => {
          var a, h;
          let f = i[t] || (i[t] = Object.create(null));
          let c = s.split(/ (?!$)/).map((t) => co(t, e));
          for (let e = 1; e < c.length; e++) {
            ...
            if (!f[i])
              f[i] = {
                ...
                run: [
                  (e) => {
                    let s = (bo = { view: e, prefix: i, scope: t });
                    setTimeout(() => {
                      if (bo == s) bo = null;
                    }, yo);
                    return true;
          ...
          let u =
            ...
            (f[d] = {
              ...
              run:
                ((h =
                  (a = f._any) === null || a === void 0 ? void 0 : a.run) ===
                  null || h === void 0
                  ? void 0
                  : h.slice()) || [],
            });
        ...
        for (let r of t) {
          ...
          if (r.any)
            for (let e of t) {
              ...
              let { any: s } = r;
              for (let e in t) t[e].run.push((t) => s(t, xo));
            }
          let s = r[e] || r.key;
          if (!s) continue;
          for (let e of t) {
      ...
      function Mo(t, e, i, o) {
        ...
        let f = "",
          ...
          d = false,
          u = false;
        if (bo && bo.view == i && bo.scope == o) {
          f = bo.prefix + " ";
          if (Ei.indexOf(e.keyCode) < 0) {
            d = true;
            bo = null;
          }
        }
        ...
        if (w) {
          if (m(w[f + uo(l, e, !h)])) {
            ...
            !(rt.windows && e.ctrlKey && e.altKey) &&
            !(rt.mac && e.altKey && !e.ctrlKey) &&
            (v = n[e.keyCode]) &&
            v != l
          ) {
            if (m(w[f + uo(v, e, true)])) {
              c = true;
            } else if (
              e.shiftKey &&
              (b = r[e.keyCode]) != l &&
          ...
          } else if (h && e.shiftKey && m(w[f + uo(l, e, true)])) {
            c = true;
          }
          if (!c && m(w._any)) c = true;
        }
        if (d) c = true;
        if (c && u) e.stopPropagation();
        xo = null;
        return c;
      }
      class Co {
        ...
        static forRange(t, e, i) {
          if (i.empty) {
            ...
            let o = ko(t);
            return [
              new Co(e, s.left - o.left, s.top - o.top, null, s.bottom - s.top),
            ];
          } else {
            return Do(t, e, i);
          }
      ...
      function Do(t, e, i) {
        ...
        let n = t.textDirection == Ft.LTR;
        let r = t.contentDOM,
          l = r.getBoundingClientRect(),
          a = ko(t);
        let h = r.querySelector(".cm-line"),
          f = h && window.getComputedStyle(h);
        let c =
          l.left +
          (f
            ? parseInt(f.paddingLeft) + Math.min(0, parseInt(f.textIndent))
            : 0);
        let d = l.right - (f ? parseInt(f.paddingRight) : 0);
        let u = li(t, s, 1),
          p = li(t, o, -1);
        let g = u.type == Ct.Text ? u : null;
        let m = p.type == Ct.Text ? p : null;
        if (g && (t.lineWrapping || u.widgetLineBreaks)) g = Ao(t, s, 1, g);
        if (m && (t.lineWrapping || p.widgetLineBreaks)) m = Ao(t, o, -1, m);
        if (g && m && g.from == m.from && g.to == m.to) {
          ...
          if (
            ...
            o.push(w(c, e.bottom, d, s.top));
          else if (
            e.bottom < s.top &&
            t.elementAtHeight((e.bottom + s.top) / 2).type == Ct.Text
          )
            e.bottom = s.top = (e.bottom + s.top) / 2;
          return v(e).concat(o).concat(v(s));
        }
        function w(t, i, s, o) {
          return new Co(e, t - a.left, i - a.top, s - t, o - i);
        }
        ...
        function b(e, i, s) {
          ...
          if (l.length == 0) a(h, e == null, f, i == null, t.textDirection);
      ...
      class To {
        ...
        update(t) {
          if (t.startState.facet(Eo) != t.state.facet(Eo))
            this.setOrder(t.state);
      ...
      const Eo = s.Facet.define();
      function Ro(t) {
        return [Ae.define((e) => new To(e, t)), Eo.of(t)];
      }
      const Bo = s.Facet.define({
        combine(t) {
      ...
      function Lo(t = {}) {
        return [Bo.of(t), No, Fo, Wo, we.of(true)];
      }
      function Po(t) {
        return t.facet(Bo);
      }
        ...
        markers(t) {
          ...
          for (let n of e.selection.ranges) {
            ...
            if (n.empty || i.drawRangeCursor) {
              ...
              for (let s of Co.forRange(t, e, i)) o.push(s);
            }
          }
          return o;
        },
      ...
      const Fo = Ro({
        ...
        markers(t) {
          return t.state.selection.ranges
            .map((e) =>
              e.empty ? [] : Co.forRange(t, "cm-selectionBackground", e),
            )
            .reduce((t, e) => t.concat(e));
        },
        update(t, e) {
          return t.docChanged || t.selectionSet || t.viewportChanged || Ho(t);
        },
        class: "cm-selectionLayer",
      });
      const Wo = s.Prec.highest(
        no.theme({
          ".cm-line": {
            "& ::selection, &::selection": {
      ...
      const zo = s.StateEffect.define({
        map(t, e) {
          return t == null ? null : e.mapPos(t);
        },
      });
      const Io = s.StateField.define({
        create() {
          return null;
        },
        update(t, e) {
          if (t != null) t = e.changes.mapPos(t);
          return e.effects.reduce((t, e) => (e.is(zo) ? e.value : t), t);
        },
      });
      const qo = Ae.fromClass(
        class {
          constructor(t) {
            this.view = t;
            this.cursor = null;
          ...
          setDropPos(t) {
            if (this.view.state.field(Io) != t)
              this.view.dispatch({ effects: zo.of(t) });
          }
        },
        {
          eventObservers: {
      ...
      class Xo {
        ...
        createDeco(t) {
          let e = new s.RangeSetBuilder(),
            i = e.add.bind(e);
          for (let { from: s, to: o } of _o(t, this.maxLength))
            Yo(t.state.doc, this.regexp, s, o, (e, s) =>
        ...
        updateRange(t, e, i, s) {
          for (let o of t.visibleRanges) {
            ...
            if (r >= n) {
              ...
              let h = [],
                f;
              let c = (t, e, i) => h.push(i.range(t, e));
              if (i == s) {
                this.regexp.lastIndex = l - i.from;
                while ((f = this.regexp.exec(i.text)) && f.index < a - i.from)
                  this.addMatch(f, t, f.index + i.from, c);
              } else {
                Yo(t.state.doc, this.regexp, l, a, (e, i) =>
                  this.addMatch(i, t, e, c),
                );
              }
              e = e.update({
                filterFrom: l,
      ...
      function Qo() {
        var t;
        if (Uo == null && typeof document != "undefined" && document.body) {
        ...
        return (
          ...
          (tn = Ae.fromClass(
            class {
              constructor(t) {
                this.view = t;
                this.decorations = kt.none;
                this.decorationCache = Object.create(null);
                this.decorator = this.makeDecorator(t.state.facet(Jo));
                ...
                return new Xo({
                  ...
                  decoration: (e, i, o) => {
                    ...
                    return (
                      ...
                      (this.decorationCache[r] = kt.replace({
                        widget: new nn(t, r),
                      }))
                    );
                  },
              ...
              update(t) {
                let e = t.state.facet(Jo);
                if (t.startState.facet(Jo) != e) {
      ...
      class nn extends Mt {
        ...
        toDOM(t) {
          ...
          let i =
            ...
            " " +
            ($o[this.code] || "0x" + this.code.toString(16));
      ...
      const fn = kt.line({ class: "cm-activeLine" });
      const cn = Ae.fromClass(
        class {
          constructor(t) {
        ...
        let e = Ae.fromClass(
          class {
            constructor(e) {
              this.view = e;
              this.placeholder = t
                ? kt.set([kt.widget({ widget: new dn(t), side: 1 }).range(0)])
                : kt.none;
            }
            get decorations() {
              return this.view.state.doc.length ? kt.none : this.placeholder;
            }
          },
          { decorations: (t) => t.decorations },
        );
        return typeof t == "string"
          ? [e, no.contentAttributes.of({ "aria-placeholder": t })]
          : e;
      }
      const pn = 2e3;
      function gn(t, e, i) {
        ...
        let r = [];
        if (e.off > pn || i.off > pn || e.col < 0 || i.col < 0) {
      ...
      function bn(t) {
        ...
        return no.mouseSelectionStyle.of((t, i) => (e(i) ? vn(t, i) : null));
      }
      const yn = {
        Alt: [18, (t) => !!t.altKey],
      ...
      const Sn = { style: "cursor: crosshair" };
      function xn(t = {}) {
        let [e, i] = yn[t.key || "Alt"];
        let s = Ae.fromClass(
          class {
            constructor(t) {
              this.view = t;
        ...
        class {
          ...
          readMeasure() {
            ...
            if (this.position == "fixed" && this.manager.tooltipViews.length) {
              ...
              } else if (t.style.top == Mn && t.style.left == "0px") {
                let e = t.getBoundingClientRect();
          ...
          writeMeasure(t) {
            ...
            for (let l = 0; l < this.manager.tooltips.length; l++) {
              ...
              if (
                !c ||
                (a.clip !== false &&
                  (c.bottom <= Math.max(i.top, s.top) ||
                    c.top >= Math.min(i.bottom, s.bottom) ||
                    c.right < Math.max(i.left, s.left) - 0.1 ||
                    c.left > Math.min(i.right, s.right) + 0.1))
              ) {
                f.style.top = Mn;
                continue;
              }
              ...
              let g = d.right - d.left,
                m =
                  (e = On.get(h)) !== null && e !== void 0
                    ? e
                    : d.bottom - d.top;
              let w = h.offset || Bn,
                v = this.view.textDirection == Ft.LTR;
              let b =
                d.width > s.right - s.left
                  ...
                  : v
                    ? Math.max(
                        s.left,
                        Math.min(c.left - (u ? 14 : 0) + w.x, s.right - g),
                      )
                    : Math.min(
                        Math.max(s.left, c.left - g + (u ? 14 : 0) - w.x),
                        s.right - g,
                      );
              let y = this.above[l];
              if (
                ...
                (y
                  ? c.top - m - p - w.y < s.top
                  : c.bottom + m + p + w.y > s.bottom) &&
                y == s.bottom - c.bottom > c.top - s.top
              )
                y = this.above[l] = !y;
              let S = (y ? c.top - s.top : s.bottom - c.bottom) - p;
              if (S < m && h.resize !== false) {
                ...
                On.set(h, m);
                f.style.height = (m = S) / n + "px";
              } else if (f.style.height) {
                f.style.height = "";
              }
              let x = y ? c.top - m - p - w.y : c.bottom + p + w.y;
              let M = b + g;
              if (h.overlap !== true)
                for (let t of r)
                  if (
              ...
              if (this.position == "absolute") {
                f.style.top = (x - t.parent.top) / n + "px";
                En(f, (b - t.parent.left) / o);
              } else {
                f.style.top = x / n + "px";
                En(f, b / o);
              }
              if (u) {
                let t = c.left + (v ? w.x : -w.x) - (b + 14 - 7);
                u.style.left = t / o + "px";
              }
              if (h.overlap !== true)
                r.push({ left: b, top: x, right: M, bottom: x + m });
              f.classList.toggle("cm-tooltip-above", y);
              f.classList.toggle("cm-tooltip-below", !y);
      ...
      const Bn = { x: 0, y: 0 };
      const Ln = s.Facet.define({ enables: [Tn, Rn] });
      const Pn = s.Facet.define({
      ...
      class Vn {
        ...
        get tooltip() {
          let t = this.view.plugin(Tn);
          let e = t
            ? t.manager.tooltips.findIndex((t) => t.create == Hn.create)
            : -1;
        ...
        mousemove(t) {
          ...
          if ((s.length && o && !Wn(o.dom, t)) || this.pending) {
            ...
            if (
              o == n
                ...
                : !zn(this.view, o, n, t.clientX, t.clientY)
            ) {
      ...
      function In(t, e = {}) {
        ...
        return {
          ...
          extension: [
            o,
            Ae.define((s) => new Vn(s, t, o, i, e.hoverTime || 300)),
            Nn,
          ],
        };
      }
      ...
      function Kn(t) {
        return t.facet(Pn).some((t) => t);
      }
      const Yn = s.StateEffect.define();
      const _n = Yn.of(null);
      function Xn(t) {
        let e = t.plugin(Tn);
        if (e) e.maybeMeasure();
      }
      const Gn = s.Facet.define({
        combine(t) {
          let e, i;
          for (let s of t) {
            e = e || s.topContainer;
      ...
      const Un = Ae.fromClass(
        class {
          constructor(t) {
            this.input = t.state.facet(Zn);
            this.specs = this.input.filter((t) => t);
            this.panels = this.specs.map((e) => e(t));
            let e = t.state.facet(Gn);
            this.top = new Qn(t, true, e.topContainer);
            this.bottom = new Qn(t, false, e.bottomContainer);
          ...
          update(t) {
            ...
            if (this.bottom.container != e.bottomContainer) {
              this.bottom.sync([]);
              this.bottom = new Qn(t.view, false, e.bottomContainer);
            }
            this.top.syncClasses();
            this.bottom.syncClasses();
            let i = t.state.facet(Zn);
            if (i != this.input) {
              let e = i.filter((t) => t);
              let s = [],
                o = [],
      ...
      const Zn = s.Facet.define({ enables: Un });
      function tr(t, e) {
        let i;
        let o = new Promise((t) => (i = t));
        let n = (t) => nr(t, e, i);
        if (t.state.field(ir, false)) {
          t.dispatch({ effects: sr.of(n) });
        } else {
          t.dispatch({
            effects: s.StateEffect.appendConfig.of(ir.init(() => [n])),
          });
        }
        let r = or.of(n);
        return {
          close: r,
          result: o.then((e) => {
            let i = t.win.queueMicrotask || ((e) => t.win.setTimeout(e, 10));
            i(() => {
              if (t.state.field(ir).indexOf(n) > -1) t.dispatch({ effects: r });
            });
            return e;
          }),
        };
      ...
      function er(t, e) {
        let i = t.state.field(ir, false) || [];
        for (let s of i) {
          let i = $n(t, s);
          if (i && i.dom.classList.contains(e)) return i;
        }
        return null;
      }
      const ir = s.StateField.define({
        create() {
          return [];
        },
        update(t, e) {
          for (let i of e.effects) {
            if (i.is(sr)) t = [i.value].concat(t);
            else if (i.is(or)) t = t.filter((t) => t != i.value);
          }
          return t;
        },
        provide: (t) => Zn.computeN([t], (e) => e.field(t)),
      });
      const sr = s.StateEffect.define();
      const or = s.StateEffect.define();
      function nr(t, e, i) {
        let s = e.content ? e.content(t, () => r(null)) : null;
        if (!s) {
          s = (0, g.A)("form");
          if (e.input) {
            let t = (0, g.A)("input", e.input);
            if (/^(text|password|number|email|tel|url)$/.test(t.type))
              t.classList.add("cm-textfield");
            if (!t.name) t.name = "input";
            s.appendChild((0, g.A)("label", (e.label || "") + ": ", t));
          } else {
        ...
        let o = s.nodeName == "FORM" ? [s] : s.querySelectorAll("form");
        for (let l = 0; l < o.length; l++) {
          let t = o[l];
        ...
        if (e.class) n.className = e.class;
        n.classList.add("cm-dialog");
        function r(e) {
          if (n.contains(n.ownerDocument.activeElement)) t.focus();
          i(e);
        }
        return {
          dom: n,
          ...
          mount: () => {
            if (e.focus) {
              let t;
              if (typeof e.focus == "string") t = s.querySelector(e.focus);
              else t = s.querySelector("input") || s.querySelector("button");
              if (t && "select" in t) t.select();
              else if (t && "focus" in t) t.focus();
            }
          },
        };
      }
      class rr extends s.RangeValue {
        compare(t) {
          return this == t || (this.constructor == t.constructor && this.eq(t));
        }
        eq(t) {
      ...
      rr.prototype.toDOM = undefined;
      rr.prototype.mapMode = s.MapMode.TrackBefore;
      rr.prototype.startSide = rr.prototype.endSide = -1;
      rr.prototype.point = true;
      const lr = s.Facet.define();
      const ar = s.Facet.define();
      const hr = {
        class: "",
      ...
      const fr = s.Facet.define();
      function cr(t) {
        return [ur(), fr.of({ ...hr, ...t })];
      }
      const dr = s.Facet.define({ combine: (t) => t.some((t) => t) });
      function ur(t) {
        let e = [pr];
        if (t && t.fixed === false) e.push(dr.of(true));
        return e;
      }
      const pr = Ae.fromClass(
        class {
          constructor(t) {
            this.view = t;
            this.domAfter = null;
            ...
            this.gutters = t.state.facet(fr).map((e) => new vr(t, e));
            this.fixed = !t.state.facet(dr);
            for (let e of this.gutters) {
              if (e.config.side == "after")
                this.getDOMAfter().appendChild(e.dom);
              else this.dom.appendChild(e.dom);
            }
            if (this.fixed) {
          ...
          update(t) {
            ...
            if (t.geometryChanged) {
              ...
              if (this.domAfter) this.domAfter.style.minHeight = t;
            }
            if (this.view.state.facet(dr) != !this.fixed) {
          ...
          syncGutters(t) {
            ...
            let i = s.RangeSet.iter(
              this.view.state.facet(lr),
              this.view.viewport.from,
            );
            let o = [];
            let n = this.gutters.map(
              (t) =>
                new wr(t, this.view.viewport, -this.view.documentPadding.top),
            );
          ...
          updateGutters(t) {
            ...
            if (e == i) {
              ...
              for (let t of s) {
                if (t.config.side == "after")
                  this.getDOMAfter().appendChild(t.dom);
                else this.dom.appendChild(t.dom);
              }
              this.gutters = s;
            }
            return o;
      ...
      class vr {
        constructor(t, e) {
          ...
          this.markers = gr(e.markers(t));
          if (e.initialSpacer) {
            this.spacer = new br(t, 0, 0, [e.initialSpacer(t)]);
        ...
        update(t) {
          let e = this.markers;
          this.markers = gr(this.config.markers(t.view));
      ...
      class br {
        ...
        update(t, e, i, s) {
          ...
          if (!yr(this.markers, s)) this.setMarkers(t, s);
        }
        setMarkers(t, e) {
      ...
      const Ar = fr.compute([Mr], (t) => ({
        ...
        lineMarker(t, e, i) {
          ...
          return new Cr(kr(t, t.state.doc.lineAt(e.from).number));
        },
        widgetMarker: (t, e, i) => {
          for (let s of t.state.facet(xr)) {
            let o = s(t, e, i);
            if (o) return o;
          }
          return null;
        ...
        initialSpacer(t) {
          return new Cr(kr(t, Or(t.state.doc.lines)));
        },
        updateSpacer(t, e) {
          let i = kr(e.view, Or(e.view.state.doc.lines));
          return i == t.number ? t : new Cr(i);
        },
        domEventHandlers: t.facet(Mr).domEventHandlers,
        side: "before",
      }));
      function Dr(t = {}) {
        return [Mr.of(t), ur(), Ar];
      }
      function Or(t) {
        let e = 9;
        while (e < t) e = e * 10 + 9;
      ...
      const Tr = new (class extends rr {
        constructor() {
          super(...arguments);
          this.elementClass = "cm-activeLineGutter";
        }
      })();
      const Er = lr.compute(["selection"], (t) => {
        let e = [],
          i = -1;
      ...
      const Lr = kt.mark({ class: "cm-highlightTab" });
      const Pr = kt.mark({ class: "cm-highlightSpace" });
      const Hr = Br(
        new Xo({
          regexp: /\t| /g,
          decoration: (t) => (t[0] == "\t" ? Lr : Pr),
          boundary: /\S/,
        }),
      );
      function Nr() {
      ...
      const Vr = Br(
        new Xo({
          regexp: /\s+$/g,
          decoration: kt.mark({ class: "cm-trailingSpace" }),
        }),
      );
      function Fr() {
        return Vr;
      ...
      const Wr = {
        ...
        computeOrder: ie,
        moveVisually: ne,
        clearHeightChangeFlag: us,
        getHeightChangeFlag: () => ds,
      };
    },
    41107: (t, e, i) => {
      i.d(e, { A: () => s });
      function s() {
        var t = arguments[0];
        if (typeof t == "string") t = document.createElement(t);
        var e = 1,
          i = arguments[1];
        if (
          i &&
          ...
          for (var s in i)
            if (Object.prototype.hasOwnProperty.call(i, s)) {
              var n = i[s];
              if (typeof n == "string") t.setAttribute(s, n);
              else if (n != null) t[s] = n;
            }
          e++;
        }
