    ...
    73320: (t, e, n) => {
        ...
        arcTo: function (t, e, n, i, r) {
          ...
          if (this._x1 === null) {
            ...
            var f = n - s,
              ...
              g = Math.sqrt(d),
              _ = Math.sqrt(u),
              k = r * Math.tan((S - Math.acos((d + u - p) / (2 * g * _))) / 2),
              x = k / _,
              m = k / g;
            if (Math.abs(x - 1) > E) {
      ...
      var Y = (function () {
        ...
        var s = {
          ...
          parse: (0, i.K2)(function t(e) {
            ...
            while (true) {
              L = r[r.length - 1];
              if (this.defaultActions[L]) {
                E = this.defaultActions[L];
              } else {
      ...
      var ct = (0, i.K2)(function (t, e, n, s) {
        ...
        if (K === "gradient") {
          ...
          t.append("stop")
            .attr("offset", "0%")
            .attr("stop-color", (t) => S(t.source.id));
          t.append("stop")
            .attr("offset", "100%")
            .attr("stop-color", (t) => S(t.target.id));
        }
        let A;
        switch (K) {
          case "gradient":
            ...
            break;
          case "source":
            A = (0, i.K2)((t) => S(t.source.id), "coloring");
            break;
          case "target":
            A = (0, i.K2)((t) => S(t.target.id), "coloring");
            break;
          default:
            A = K;
        }
