...
(self["webpackChunk_jupyterlab_application_top"] =
  ...
  [3381],
  {
    ...
    35645: (e, t, s) => {
      s.d(t, { P: () => r });
      var i = s(6047);
      var r = (0, i.K2)((e, t, s, r) => {
        e.attr("class", s);
        const { width: u, height: o, x: l, y: c } = n(e, t);
        (0, i.a$)(e, o, u, r);
        const h = a(l, c, u, o, t);
        e.attr("viewBox", h);
    ...
    23381: (e, t, s) => {
      ...
      var m = class {
        constructor() {
          ...
          this.posCrossRef = [];
          this.funs = [];
          this.setAccTitle = b.SV;
          this.setAccDescription = b.EI;
          this.setDiagramTitle = b.ke;
          this.getAccTitle = b.iN;
          this.getAccDescription = b.m7;
          this.getDiagramTitle = b.ab;
        ...
        sanitizeText(e) {
          return b.Y2.sanitizeText(e, this.config);
        }
        lookUpDomId(e) {
        ...
        addVertex(e, t, s, i, n, a, u = {}, o) {
          ...
          if (h) {
            ...
            if (e?.curve !== void 0) {
              h.interpolate = e.curve;
            }
            return;
          }
          let d;
          let p = this.vertices.get(e);
          if (p === void 0) {
            p = {
              id: e,
              labelType: "text",
              domId: y + e + "-" + this.vertexCounter,
              styles: [],
              classes: [],
            };
            this.vertices.set(e, p);
          }
          this.vertexCounter++;
          if (t !== void 0) {
            this.config = (0, b.D7)();
          ...
          if (l !== void 0) {
            ...
            if (l?.constraint) {
              p.constraint = l.constraint;
            }
            if (l.w) {
              p.assetWidth = Number(l.w);
            }
            if (l.h) {
              p.assetHeight = Number(l.h);
            }
          }
        }
        addSingleLink(e, t, s, i) {
          ...
          if (i && !this.edges.some((e) => e.id === i)) {
            ...
            if (e.length === 0) {
              a.id = (0, f.rY)(a.start, a.end, { counter: 0, prefix: "L" });
            } else {
              a.id = (0, f.rY)(a.start, a.end, {
                counter: e.length + 1,
                prefix: "L",
              });
            }
        ...
        setLink(e, t, s) {
          e.split(",").forEach((e) => {
            ...
            if (i !== void 0) {
              i.link = f._K.formatUrl(t, this.config);
              i.linkTarget = s;
            }
          });
        ...
        setupToolTips(e) {
          ...
          const s = (0, k.Ltv)(e).select("svg");
          const i = s.selectAll("g.node");
          i.on("mouseover", (e) => {
            const s = (0, k.Ltv)(e.currentTarget);
        ...
        addSubGraph(e, t, s) {
          ...
          const u = a.nodeList;
          let o = a.dir;
          const l = (0, b.D7)().flowchart ?? {};
          o =
            o ??
            (l.inheritDir
              ? (this.getDirection() ?? (0, b.D7)().direction ?? void 0)
              : void 0);
          if (this.version === "gen-1") {
            for (let e = 0; e < u.length; e++) {
              u[e] = this.lookUpDomId(u[e]);
            }
          }
          ...
          b.Rm.info("Adding", c.id, c.nodes, c.dir);
          c.nodes = this.makeUniq(c, this.subGraphs).nodes;
          this.subGraphs.push(c);
          this.subGraphLookup.set(i, c);
          return i;
        }
        getPosForId(e) {
        ...
        getData() {
          ...
          u.forEach((t, i) => {
            ...
            const o = {
              id: (0, f.rY)(t.start, t.end, { counter: i, prefix: "L" }, t.id),
        ...
        defaultConfig() {
          return b.ME.flowchart;
        }
      };
      var E = (0, b.K2)(function (e, t) {
        return t.db.getClasses();
      }, "getClasses");
      var x = (0, b.K2)(async function (e, t, s, i) {
        b.Rm.info("REF0:");
        b.Rm.info("Drawing state diagram (v2)", t);
        const { securityLevel: r, flowchart: o, layout: l } = (0, b.D7)();
        let c;
        if (r === "sandbox") {
          c = (0, k.Ltv)("#i" + t);
        }
        const h = r === "sandbox" ? c.nodes()[0].contentDocument : document;
        b.Rm.debug("Before getData: ");
        const d = i.db.getData();
        b.Rm.debug("Data: ", d);
        const p = (0, n.A)(t, r);
        const g = i.db.getDirection();
        d.type = i.type;
        d.layoutAlgorithm = (0, u.q7)(l);
        if (d.layoutAlgorithm === "dagre" && l === "elk") {
          b.Rm.warn(
            "flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback.",
          );
        }
        d.direction = g;
        d.nodeSpacing = o?.nodeSpacing || 50;
        d.rankSpacing = o?.rankSpacing || 50;
        d.markers = ["point", "circle", "cross"];
        d.diagramId = t;
        b.Rm.debug("REF1:", d);
        await (0, u.XX)(d, p);
        const A = d.config.flowchart?.diagramPadding ?? 8;
        f._K.insertTitle(
          p,
          "flowchartTitleText",
          o?.titleTopMargin || 0,
        ...
        (0, a.P)(p, A, "flowchart", o?.useMaxWidth || false);
        for (const n of d.nodes) {
          const e = (0, k.Ltv)(`#${t} [id="${n.id}"]`);
          if (!e || !n.link) {
            continue;
          }
          const s = h.createElementNS("http://www.w3.org/2000/svg", "a");
          s.setAttributeNS("http://www.w3.org/2000/svg", "class", n.cssClasses);
          ...
          const a = e.select(".label-container");
          if (a) {
            i.append(function () {
              return a.node();
            });
      ...
      var D = { getClasses: E, draw: x };
      var C = (function () {
        var e = (0, b.K2)(function (e, t, s, i) {
        ...
        var st = {
          ...
          performAction: (0, b.K2)(function e(t, s, i, r, n, a, u) {
            var o = a.length - 1;
            switch (n) {
              case 2:
                this.$ = [];
          ...
          table: [
            ...
            { 31: [1, 217], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            e(We, [2, 86]),
            e(We, [2, 88]),
            e(We, [2, 89]),
            e(We, [2, 153]),
            ...
            e(We, [2, 155]),
            e(We, [2, 156]),
            { 49: [1, 219], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            {
              30: 220,
              67: Re,
              80: Ne,
            ...
            { 51: [1, 221], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            { 53: [1, 222], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            { 55: [1, 223], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            { 57: [1, 224], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            { 60: [1, 225] },
            { 64: [1, 226], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            { 66: [1, 227], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            {
              30: 228,
              67: Re,
              80: Ne,
            ...
            { 31: [1, 229], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            {
              67: Re,
              69: [1, 230],
              71: [1, 231],
            ...
            e(ie, [2, 75]),
            e(ie, [2, 74]),
            { 62: [1, 234], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            e(ie, [2, 77]),
            e(Ve, [2, 80]),
            ...
            e(We, [2, 87]),
            e(ee, [2, 57]),
            { 51: [1, 262], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            e(ee, [2, 64]),
            e(ee, [2, 59]),
            e(ee, [2, 60]),
            e(ee, [2, 61]),
            ...
            e(ee, [2, 63]),
            e(ee, [2, 65]),
            { 66: [1, 264], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            e(ee, [2, 67]),
            e(ee, [2, 68]),
            e(ee, [2, 70]),
            e(ee, [2, 69]),
            ...
            e(ie, [2, 78]),
            { 31: [1, 265], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            {
              6: 11,
              7: 12,
              8: a,
            ...
            e($e, [2, 114]),
            { 31: [1, 286], 67: Re, 82: 218, 116: Ke, 117: Ge, 118: Oe },
            {
              6: 11,
              7: 12,
              8: a,
          ...
          defaultActions: {},
          parseError: (0, b.K2)(function e(t, s) {
            if (s.recoverable) {
              this.trace(t);
            } else {
              var i = new Error(t);
        ...
        var it = (function () {
          var e = {
            ...
            more: (0, b.K2)(function () {
              this._more = true;
              return this;
            }, "more"),
            reject: (0, b.K2)(function () {
            ...
            less: (0, b.K2)(function (e) {
              this.unput(this.match.slice(e));
            }, "less"),
            pastInput: (0, b.K2)(function () {
            ...
            showPosition: (0, b.K2)(function () {
              var e = this.pastInput();
              var t = new Array(e.length + 1).join("-");
              return e + this.upcomingInput() + "\n" + t + "^";
            }, "showPosition"),
            test_match: (0, b.K2)(function (e, t) {
              var s, i, r;
              if (this.options.backtrack_lexer) {
                r = {
            ...
            begin: (0, b.K2)(function e(t) {
              this.conditionStack.push(t);
            }, "begin"),
            popState: (0, b.K2)(function e() {
            ...
            _currentRules: (0, b.K2)(function e() {
              if (
            ...
            pushState: (0, b.K2)(function e(t) {
              this.begin(t);
            }, "pushState"),
            stateStackSize: (0, b.K2)(function e() {
              return this.conditionStack.length;
            }, "stateStackSize"),
            options: {},
            performAction: (0, b.K2)(function e(t, s, i, r) {
              var n = r;
              switch (i) {
                case 0:
