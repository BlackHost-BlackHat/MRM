(self["webpackChunk_jupyter_widgets_jupyterlab_manager"] =
  ...
  ["packages_base-manager_lib_index_js"],
  {
  ...
  \************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ CONTROL_COMM_PROTOCOL_VERSION: () =>
            /* reexport safe */ _manager_base__WEBPACK_IMPORTED_MODULE_0__.CONTROL_COMM_PROTOCOL_VERSION,
          /* harmony export */ CONTROL_COMM_TARGET: () =>
            /* reexport safe */ _manager_base__WEBPACK_IMPORTED_MODULE_0__.CONTROL_COMM_TARGET,
          /* harmony export */ CONTROL_COMM_TIMEOUT: () =>
            /* reexport safe */ _manager_base__WEBPACK_IMPORTED_MODULE_0__.CONTROL_COMM_TIMEOUT,
          /* harmony export */ ManagerBase: () =>
            /* reexport safe */ _manager_base__WEBPACK_IMPORTED_MODULE_0__.ManagerBase,
          /* harmony export */ base64ToBuffer: () =>
            /* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_1__.base64ToBuffer,
          /* harmony export */ bufferToBase64: () =>
            /* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_1__.bufferToBase64,
          /* harmony export */ bufferToHex: () =>
            /* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_1__.bufferToHex,
          /* harmony export */ hexToBuffer: () =>
            /* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_1__.hexToBuffer,
          /* harmony export */ serialize_state: () =>
            /* reexport safe */ _manager_base__WEBPACK_IMPORTED_MODULE_0__.serialize_state,
          /* harmony export */
        });
        /* harmony import */ var _manager_base__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./manager-base */ "../../packages/base-manager/lib/manager-base.js",
          );
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./utils */ "../../packages/base-manager/lib/utils.js",
          );
...
|----------------------------------------------------------------------------*/
  ...
  \*******************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ CONTROL_COMM_PROTOCOL_VERSION: () =>
            /* binding */ CONTROL_COMM_PROTOCOL_VERSION,
          /* harmony export */ CONTROL_COMM_TARGET: () =>
            /* binding */ CONTROL_COMM_TARGET,
          /* harmony export */ CONTROL_COMM_TIMEOUT: () =>
            /* binding */ CONTROL_COMM_TIMEOUT,
          /* harmony export */ ManagerBase: () => /* binding */ ManagerBase,
          /* harmony export */ serialize_state: () =>
            /* binding */ serialize_state,
          /* harmony export */
        });
        ...
        /* harmony import */ var _latex__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./latex */ "../../packages/base-manager/lib/latex.js",
          );
        /* harmony import */ var sanitize_html__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! sanitize-html */ "../../node_modules/sanitize-html/index.js",
          );
        /* harmony import */ var sanitize_html__WEBPACK_IMPORTED_MODULE_4___default =
          /*#__PURE__*/ __webpack_require__.n(
            sanitize_html__WEBPACK_IMPORTED_MODULE_4__,
          );
        // Copyright (c) Jupyter Development Team.
        // Distributed under the terms of the Modified BSD License.

        const PROTOCOL_MAJOR_VERSION =
          _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.PROTOCOL_VERSION.split(
            ".",
            1,
          )[0];
        /**
        ...
        class ManagerBase {
          ...
          create_view(model, options = {}) {
            const id = (0,
            _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.uuid)();
            const viewPromise = (model.state_change = model.state_change.then(
              async () => {
                ...
                try {
                  ...
                  const ModelCls =
                    _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.createErrorWidgetModel(
                      e,
                      msg,
                    );
                  const errorModel = new ModelCls();
                  const view =
                    new _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.ErrorWidgetView(
                      {
                        model: errorModel,
                        options: this.setViewOptions(options),
                      },
          ...
          handle_comm_open(comm, msg) {
            ...
            (0, _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.put_buffers)(
              data.state,
              buffer_paths,
              buffers,
            );
          ...
          new_widget(options, serialized_state = {}) {
            ...
            if (options.comm) {
              ...
              commPromise = this._create_comm(
                ...
                {
                  version:
                    _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.PROTOCOL_VERSION,
                },
              );
            }
            ...
            return commPromise.then(
              (comm) => {
                ...
                const widget_model = this.new_model(
                  options_clone,
                  serialized_state,
                );
          ...
          async new_model(options, serialized_state = {}) {
            var _a, _b;
            const model_id =
              (_a = options.model_id) !== null && _a !== void 0
                ? _a
                : (_b = options.comm) === null || _b === void 0
                  ? void 0
                  : _b.comm_id;
            if (!model_id) {
              throw new Error(
          ...
          async _loadFromKernel() {
            ...
            try {
              const initComm = await this._create_comm(
                CONTROL_COMM_TARGET,
                (0, _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.uuid)(),
                {},
            ...
            await Promise.all(
              widget_comms.map(async ({ widget_id, comm }) => {
                ...
                if (widget_id in bufferPaths) {
                  (0,
                  _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.put_buffers)(
                    state,
                    bufferPaths[widget_id],
                    bufferGroups[widget_id],
                  );
                ...
                try {
                  if (comm) {
                    ...
                    const deserializedState =
                      await model.constructor._deserialize_state(
                        state.state,
                        this,
                      );
          ...
          async _loadFromKernelModels() {
            ...
            const widgets_info = await Promise.all(
              Object.keys(comm_ids).map(async (comm_id) => {
                ...
                let msg_id = "";
                const info =
                  new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_1__.PromiseDelegate();
                comm.on_msg((msg) => {
                  if (
                ...
                await this.new_model(
                  {
                    ...
                    model_module_version:
                      content.data.state._model_module_version,
          ...
          clear_state() {
            return (0,
            _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.resolvePromisesDict)(
              this._models,
            ).then((models) => {
                ...
                Object.keys(models).map((model_id) => {
                  ...
                  if (model.buffers) {
                    ...
                    const buffers = model.buffers.map(
                      (b) => new DataView(decode[b.encoding](b.data)),
                    );
                    (0,
                    _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.put_buffers)(
                      model.state,
                  ...
                  if (
                    Object.prototype.hasOwnProperty.call(live_comms, "model_id")
                  ) {
                    // live comm
          ...
          inline_sanitize(source) {
            const parts = (0, _latex__WEBPACK_IMPORTED_MODULE_3__.removeMath)(
              source,
            );
            // Sanitize tags for inline output.
            const sanitized = default_inline_sanitize(parts["text"]);
            return (0, _latex__WEBPACK_IMPORTED_MODULE_3__.replaceMath)(
              sanitized,
              parts["math"],
            );
          }
          async loadModelClass(className, moduleName, moduleVersion) {
            try {
              ...
              return _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.createErrorWidgetModel(
                error,
                msg,
              );
            }
          ...
          async loadViewClass(className, moduleName, moduleVersion) {
            try {
              ...
              return _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.createErrorWidgetView(
                error,
                msg,
              );
            }
          ...
          filterExistingModelState(serialized_state) {
            ...
            return Object.assign(Object.assign({}, serialized_state), {
              state: models,
            });
          }
        }
        ...
        function serialize_state(models, options = {}) {
          ...
          models.forEach((model) => {
            ...
            const split = (0,
            _jupyter_widgets_base__WEBPACK_IMPORTED_MODULE_0__.remove_buffers)(
              model.serialize(model.get_state(options.drop_defaults)),
            );
            const buffers = split.buffers.map((buffer, index) => {
              return {
                data: (0, _utils__WEBPACK_IMPORTED_MODULE_2__.bufferToBase64)(
                  buffer,
                ),
  ...
  \************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ base64ToBuffer: () =>
            /* binding */ base64ToBuffer,
          /* harmony export */ bufferToBase64: () =>
            /* binding */ bufferToBase64,
          /* harmony export */ bufferToHex: () => /* binding */ bufferToHex,
          /* harmony export */ hexToBuffer: () => /* binding */ hexToBuffer,
          /* harmony export */
        });
        /* harmony import */ var base64_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        function bufferToBase64(buffer) {
          return (0, base64_js__WEBPACK_IMPORTED_MODULE_0__.fromByteArray)(
        ...
        function base64ToBuffer(base64) {
          return (0, base64_js__WEBPACK_IMPORTED_MODULE_0__.toByteArray)(base64)
            .buffer;
        }
