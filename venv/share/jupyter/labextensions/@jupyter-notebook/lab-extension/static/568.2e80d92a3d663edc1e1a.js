    ...
    568: (e, o, t) => {
      ...
      const u = {
          ...
          optional: [
            l.INotebookTracker,
            r.ICommandPalette,
            b.INotebookPathOpener,
            b.INotebookShell,
            a.ILabShell,
            r.IToolbarWidgetRegistry,
          ],
          activate: (e, o, t, a, r, l, i, u) => {
            ...
            const y = () =>
              null !== t.currentWidget && t.currentWidget === p.currentWidget;
            let C;
            if (
              (f.forEach((e) => {
                const { command: o } = e;
              ...
              C = (e) => {
                const o = new d.CommandToolbarButton({
                  commands: m,
                  id: f[0].command,
                  label: f[0].commandLabel,
                  icon: d.launchIcon,
                });
