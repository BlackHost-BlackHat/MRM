  ...
  var e,
    ...
    S = {
      215: (e, r, t) => {
        var o = {
            "./index": () =>
              Promise.all([t.e(138), t.e(568)]).then(() => () => t(568)),
            "./extension": () =>
              Promise.all([t.e(138), t.e(568)]).then(() => () => t(568)),
  ...
  ((x.m = S),
    ...
    (x.u = (e) =>
      ...
      "." +
      {
        ...
        138: "9200b788901fb66f96de",
        390: "b345ef6395f75804c4f0",
        568: "2e80d92a3d663edc1e1a",
        928: "dbb8a2ac8d5f9c8d1844",
      }[e] +
      ".js?v=" +
      {
        93: "eae3497dd223d842d198",
        ...
        if ((n || (n = r[t] = {}), !(o.indexOf(n) >= 0))) {
          ...
          var a = x.S[t],
            ...
            l = (e, r, t, o) => {
              var n = (a[e] = a[e] || {}),
                l = n[r];
              (!l || (!l.loaded && (!o != !l.eager ? o : i > l.from))) &&
                (n[r] = { get: t, from: i, eager: !!o });
            },
            u = [];
          return (
            "default" === t &&
              (l("@jupyter-notebook/application", "7.4.7", () =>
                Promise.all([x.e(928), x.e(390), x.e(138)]).then(
                  () => () => x(30),
                ),
              ),
              l("@jupyter-notebook/lab-extension", "7.4.7", () =>
                Promise.all([x.e(138), x.e(568)]).then(() => () => x(568)),
              )),
    ...
    (l = (e, r) => {
      var t = e[r];
      return (
        (r = Object.keys(t).reduce((e, r) => (!e || o(e, r) ? r : e), 0)) &&
        t[r]
      );
    }),
    (u = (e, r) => {
    ...
    (s = (e, r, t, o) => {
      var n = u(e, t);
      return (a(o, n) || c(f(e, t, n, o)), h(e[t][n]));
    }),
    (d = (e, r, t) => {
      var n = e[r];
      return (
    ...
    (m = (v = (e) =>
      function (r, t, o, n) {
        var a = x.I(r);
        return a && a.then
          ? a.then(e.bind(e, r, x.S[r], t, o, n))
          : e(r, x.S[r], t, o, n);
      })((e, r, t, o) => (i(e, t), h(d(r, t, o) || b(r, e, t, o) || l(r, t))))),
    (g = v((e, r, t, o) => (i(e, t), s(r, 0, t, o)))),
    (y = v((e, r, t, o, n) => {
    ...
    (j = {}),
    (w = {
      339: () => g("default", "@jupyterlab/application", [1, 4, 4, 9]),
      344: () => g("default", "@jupyterlab/translation", [1, 4, 4, 9]),
      374: () => g("default", "@jupyterlab/coreutils", [1, 6, 4, 9]),
      729: () => g("default", "@jupyterlab/apputils", [1, 4, 5, 9]),
      805: () => g("default", "@jupyterlab/ui-components", [1, 4, 4, 9]),
      882: () => g("default", "@lumino/widgets", [1, 2, 3, 1, , "alpha", 0]),
      479: () => g("default", "@jupyterlab/notebook", [1, 4, 4, 9]),
      496: () =>
        y("default", "@jupyter-notebook/application", [1, 7, 4, 7], () =>
          Promise.all([x.e(928), x.e(390)]).then(() => () => x(30)),
        ),
      4: () => g("default", "@lumino/properties", [1, 2, 0, 0]),
      511: () => m("default", "@jupyterlab/docregistry", [1, 4, 4, 9]),
      633: () => g("default", "@lumino/messaging", [1, 2, 0, 0]),
      697: () => g("default", "@lumino/algorithm", [1, 2, 0, 0]),
      717: () => g("default", "@lumino/disposable", [1, 2, 0, 0]),
      763: () => g("default", "@jupyterlab/rendermime", [1, 4, 4, 9]),
      797: () => g("default", "@lumino/polling", [1, 2, 0, 0]),
      901: () => g("default", "@lumino/signaling", [1, 2, 0, 0]),
      930: () => g("default", "@lumino/coreutils", [1, 2, 0, 0]),
    }),
    (k = {
      138: [339, 344, 374, 729, 805, 882],
      390: [4, 511, 633, 697, 717, 763, 797, 901, 930],
      568: [479, 496],
    }),
    (x.f.consumes = (e, r) => {
      x.o(k, e) &&
    ...
    (() => {
      ...
      var r = (r, t) => {
          ...
          for (r && r(t); u < a.length; u++)
            ((n = a[u]), x.o(e, n) && e[n] && e[n][0](), (e[n] = 0));
        },
        t = (self.webpackChunk_jupyter_notebook_lab_extension =
