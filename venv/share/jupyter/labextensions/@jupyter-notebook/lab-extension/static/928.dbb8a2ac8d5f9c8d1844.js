...
(self.webpackChunk_jupyter_notebook_lab_extension =
  ...
  [928],
  {
    950: (t, e, r) => {
          ...
          return r && r.type
            ? "tab-area" === r.type
              ...
              : {
                  ...
                  sizes: r.sizes,
                  children: r.children.map(e).filter((t) => !!t),
                }
            : null;
        }
        function r(t, e) {
          ...
          if ("unknown" === n || ("tab-area" !== n && "split-area" !== n))
            return (
              console.warn(`Attempted to deserialize unknown type: ${n}`),
              null
            );
          if ("tab-area" === n) {
            const { currentIndex: r, widgets: n } = t,
              i = {
                type: "tab-area",
                currentIndex: r || 0,
                widgets: (n && n.map((t) => e.get(t)).filter((t) => !!t)) || [],
              };
            return (
              i.currentIndex > i.widgets.length - 1 && (i.currentIndex = 0),
              i
            );
          }
          ...
          return {
            ...
            orientation: i,
            sizes: a || [],
            children: (o && o.map((t) => r(t, e)).filter((t) => !!t)) || [],
          };
        }
        ((t.nameProperty = new d.AttachedProperty({
          name: "name",
          create: (t) => "",
        })),
          ...
          (t.deserializeMain = function (t, e) {
            ...
            const n = t.current || null,
              i = t.dock || null;
            return {
              currentWidget: (n && e.has(n) && e.get(n)) || null,
              dock: i ? { main: r(i, e) } : null,
            };
          }));
      })(y || (y = {}));
      const l = new c.Token(
                  ...
                  (function (t, e) {
                    return {
                      ...
                      activate: (r, n, a) => {
                        if (
                          (void 0 !== e.rank
                            ? n.addFactory(e.rendererFactory, e.rank)
                            : n.addFactory(e.rendererFactory),
                          !e.documentWidgetFactoryOptions)
                        )
                          return;
                        const o = r.docRegistry;
                        let c = [];
                        ((c = Array.isArray(e.documentWidgetFactoryOptions)
                          ? e.documentWidgetFactoryOptions
                          : [e.documentWidgetFactoryOptions]),
                          e.fileTypes &&
                            e.fileTypes.forEach((t) => {
                              (t.icon &&
                                (t = {
                                  ...t,
                                  icon: s.LabIcon.resolve({ icon: t.icon }),
                                }),
                                r.docRegistry.addFileType(t));
                            }),
                          c.forEach((r) => {
                            const s = r.toolbarFactory
                                ? (t) => r.toolbarFactory(t.content.renderer)
                                : void 0,
            ...
            activate: (t, e) => (
              e &&
                e.restore(r, {
                  ...
                  args: (t) => ({
                    path: t.context.path,
                    factory: m.factoryNameProperty.get(t),
                  }),
                  name: (t) =>
                    `${t.context.path}:${m.factoryNameProperty.get(t)}`,
                }),
              r
            ),
          }),
      ...
      var m;
      !(function (t) {
        t.factoryNameProperty = new d.AttachedProperty({
          name: "factoryName",
          create: () => {},
        });
      })(m || (m = {}));
    ...
    448: (t, e, r) => {
      ...
      class a {
        constructor(t) {
          ((this._busyCount = 0),
            (this._dirtyCount = 0),
            (this._busySignal = new i.Signal(t)),
            (this._dirtySignal = new i.Signal(t)));
        }
        get busySignal() {
